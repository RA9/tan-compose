...
`;h(cr,g({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${fe(e.variant)} s-${fe(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
      ...
      `},refs:{input:".cb"},events:{"change .cb":(e,t)=>{let r=e.target.checked,o=t.host;o.checked=r,o.internals?.setFormValue(r?o.value:null),t.emit("tc-change",{checked:r})}},afterMount(){let e=this,r=e.shadowRoot?.querySelector(".cb");r&&(r.indeterminate=e.indeterminate),e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function $e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var gr="tc-switch";h(gr,g({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-switch-track-off":"var(--tc-color-rule-strong, #d9cfb8)","tc-switch-track-on":"var(--tc-color-accent, #a16939)","tc-switch-thumb":"var(--tc-color-surface, #ffffff)","tc-switch-fg":"var(--tc-color-ink, #14171f)","tc-switch-helper":"var(--tc-color-ink-muted, #6b7280)","tc-switch-error":"var(--tc-color-danger, #b3261e)","tc-switch-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.error;return`
        <label class="row ${e.disabled?"is-disabled":""}">
          ...
          ${e.label?`<span class="label">${at(e.label)}</span>`:""}
        </label>
        ${e.error||e.helper?`<div class="${t?"error":"helper"}">${at(e.error||e.helper)}</div>`:""}
        <style>
...
`,Be=new WeakMap;h(br,g({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[g({tag:"style",template:vr}),g({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),g({tag:"div",className:"wrap",children:[g({tag:"table",children:[g({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],o=t;return`<tr>${r.map(n=>{let a=o.sortKey===n.key,s=n.sortable!==!1,i=a?o.sortDir==="asc"?"\u25B2":"\u25BC":"",l=a?o.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        ...
                        class="${s?"sortable":""}"
                        aria-sort="${l}"
                      >${Ee(n.label)}<span class="sort">${i}</span></th>`}).join("")}</tr>`}}),g({tag:"tbody",children:[g({tag:"tr",className:"empty",if:({props:e,state:t})=>st(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${Ee(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>st(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],a=e;return g({tag:"tr",attributes:{"data-row-id":String(a.id??t)},template:n.map(s=>`<td>${typeof s.render=="function"?s.render(a):Ee(a[s.key]??"")}</td>`).join("")})}}})]})]}),g({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,o=Se(e,r),n=e.pageSize??10,a=Math.max(1,Math.ceil(o.length/n)),s=Math.min(r.page??0,a-1),i=(e.rows??[]).length;return`
    ...
    `}));function Rr(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Nr(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Ir(t)})`:t}function Ir(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function Dr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var jr="tc-grid";h(jr,g({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
          ...
          ${r||e.copy?`
            <header class="bar">
              ...
              ${e.copy?`<button type="button" class="copy" aria-label="Copy code">
                    <span class="copy-icon" aria-hidden="true">${o?Fr:Or}</span>
      ...
      `},afterMount(){Gr(this)},unmount(){Me.get(this)?.observer?.disconnect(),Me.delete(this)}}));function Gr(e){Me.get(e)?.observer?.disconnect();let r=e,o=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),a=document.querySelector(o);if(!a)return;let s=Array.from(a.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),i=s.map(c=>(c.id||(c.id=Kr(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",i),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(c=>{let u=c.filter(m=>m.isIntersecting).sort((m,p)=>m.boundingClientRect.top-p.boundingClientRect.top)[0];if(!u)return;let f=u.target.id;f&&e.setState("activeId",f)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of s)l.observe(c);Me.set(e,{observer:l,activeId:""})}function Kr(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function _e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ur="tc-pagination";h(Ur,g({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=Yr(Number(e.current)|0,1,t),o=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let a=Wr(r,t,o,n),s=Te(String(e.size??"sm")),i=r<=1?" disabled":"",l=r>=t?" disabled":"",c=a.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${s}"
...
`;h(Xr,g({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],o=!!e.multiple,n=e.searchable!==!1,a=!!e.disabled,s=!!e.error,i=he(e.value),l=String(t.query??""),c=!!t.open&&!a,d=Number(t.focusedIndex??-1),u=vt(r,l),f=new Set(i),m=i.map($=>r.find(O=>O.value===$)).filter($=>!!$),p=n&&(c||o&&i.length===0),b=!o&&i.length===1&&(!c||!n),v=i.length===0&&!p&&!b,x=o?m.map($=>`<span class="chip" data-value="${R($.value)}">
          ...
          />`:"",H=u.length===0?`<div class="empty">${R(e["empty-text"]??"No results")}</div>`:u.map(($,O)=>{let N=f.has($.value);return`<div
            ...
            >
              ${o?`<span class="check" aria-hidden="true">${N?"\u2713":""}</span>`:""}
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;P(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;P(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let o=Number(r.dataset.index);if(!Number.isFinite(o))return;let n=t.host;P(n,o)},"keydown .root":(e,t)=>{let r=e,o=t.host,n=o.orientation==="vertical",a=He(o),s=n?"ArrowUp":"ArrowLeft",i=n?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),P(o,o.value-1)):r.key===i?(r.preventDefault(),P(o,o.value+1)):r.key==="Home"?(r.preventDefault(),P(o,0)):r.key==="End"&&(r.preventDefault(),P(o,a-1))}},afterMount(){let e=this,t=()=>wt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let o=e.shadowRoot,n=o?.querySelector("slot"),a=()=>t();n?.addEventListener("slotchange",a),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",a)};let s=()=>Oe(e),i=()=>{e.pauseOnHover&&kt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",i),e.addEventListener("focusin",s),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",s),e.removeEventListener("focusout",i)},eo(e),o?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&kt(e)},afterRender(){wt(this)},unmount(){let e=this;Oe(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function wt(e){let t=He(e),r=e.shadowRoot;if(!r)return;let o=r.querySelector(".root");if(o&&t>0){let i=$t(e.value,t,e.loop);i!==e.value&&(e.value=i),o.style.setProperty("--tc-carousel-index",String(i))}let n=r.querySelector(".indicators");if(n){let i=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===i?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function eo(e){let t=0,r=0,o=!1,n=40,a=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,o=!0))},s=l=>{if(!o)return;o=!1;let c=l.clientX-t,d=l.clientY-r,f=e.orientation==="vertical"?d:c;Math.abs(f)<n||P(e,e.value+(f<0?1:-1))},i=()=>{o=!1};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",i)}}var to="tc-accordion";h(to,g({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this,t=a=>{let s=a.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let i of Ce(e))i!==s&&i.open&&(i.open=!1);ro(e)}},r=a=>{let s=a.target;if(!s||s.tagName!=="SUMMARY")return;let i=Ce(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=i.indexOf(s);if(l===-1)return;let c=-1;a.key==="ArrowDown"?c=(l+1)%i.length:a.key==="ArrowUp"?c=(l-1+i.length)%i.length:a.key==="Home"?c=0:a.key==="End"&&(c=i.length-1),c!==-1&&(a.preventDefault(),i[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let o=()=>{for(let a of Ce(e)){let s=a.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",s.appendChild(i);let l=()=>{i.style.transform=a.open?"rotate(90deg)":"rotate(0)"};l(),a.addEventListener("toggle",l)}}};o();let n=new MutationObserver(o);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));function Ce(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function ro(e){let t=[];for(let r of Ce(e))if(r.open){let o=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(o)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var oo="tc-tooltip";function no(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(oo,g({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${no(e.text)}</span>`:""}
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){St(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},o=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&Mt(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",o,!0),globalThis.addEventListener("resize",o),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",o,!0),globalThis.removeEventListener("resize",o)},St(e)},unmount(){this._popoverCleanup?.()}}));function St(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let o=e.open,n=typeof r.showPopover=="function";if(o&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";Mt(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!o&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function Mt(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let o=t.getBoundingClientRect(),n=globalThis.innerWidth,a=globalThis.innerHeight,s=e.offset,i=e.placement||"bottom",l=u=>u==="top"?r.top-o.height-s>=4:u==="bottom"?r.bottom+o.height+s<=a-4:u==="left"?r.left-o.width-s>=4:u==="right"?r.right+o.width+s<=n-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"bottom")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-o.height-s,d=r.left+r.width/2-o.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-o.width/2):i==="left"?(c=r.top+r.height/2-o.height/2,d=r.left-o.width-s):i==="right"&&(c=r.top+r.height/2-o.height/2,d=r.right+s),c=Math.max(4,Math.min(a-o.height-4,c)),d=Math.max(4,Math.min(n-o.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var so="tc-drawer";var ie=new WeakMap;function Fe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(so,g({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Fe(e.size??"min(420px, 92vw)");return`
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Tt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let o=t.refs.dialog;o&&e.target===o&&Tt(r,"backdrop")}},afterRender(){io(this)},unmount(){let e=ie.get(this);e&&(e.cleanup(),ie.delete(this))}}));function io(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let o=e.open,n=ie.get(e);if(n&&n.dialog!==r&&(n.cleanup(),ie.delete(e)),o&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!ie.has(e)){let a=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",a),ie.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",a)})}}else if(!o&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Tt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var lo="tc-progress";function le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function co(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}h(lo,g({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),o=!!e.indeterminate,n=Number(e.value??0),a=Number(e.max??100),s=co(n,a),i=e.label||(o?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,f=(d-u)/2,m=2*Math.PI*f,p=o?m*.25:s/100*m,b=o?`role="progressbar" aria-valuetext="${le(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${a}"`;return`
          <div class="circ size-${le(r)} ${o?"indet":""}" ${b}>
    ...
    `,afterMount(){let e=this,t=()=>Ct(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){Ct(this)},unmount(){this._agroupCleanup?.()}}));function Ct(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),o=Array.from(e.children).filter(l=>l instanceof HTMLElement),n=0;for(let l of o)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),n<t||t===0?(l.hidden=!1,n++):l.hidden=!0);let a=o.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,s=Math.max(0,a-n),i=e.shadowRoot?.querySelector(".overflow");i&&(s>0?(i.hidden=!1,i.textContent=`+${s}`):i.hidden=!0)}var mo="tc-rating";function zt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var At="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";h(mo,g({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),o=Number(e.value??0),n=Number(t.hover??-1),a=n>=0?n:o,s=String(e.size??"md"),i=!!e.readonly,l=!!e.allowHalf,c=zt(e.ariaLabel??"Rating"),d=s==="sm"?18:s==="lg"?32:24,u=[];for(let f=1;f<=r;f++){let m=a-(f-1),p=m>=1?100:m>=.5&&l?50:m>0&&!l?100:0,b=p===50;u.push(`
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,o=t.host,n=Number(r.value);o.value!==n&&(o.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,o=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:o.value})}}}));var bo="tc-chart";function Rt(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),o=e/Math.pow(10,r),n;return t?o<1.5?n=1:o<3?n=2:o<7?n=5:n=10:o<=1?n=1:o<=2?n=2:o<=5?n=5:n=10,n*Math.pow(10,r)}function vo(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let o=Rt(t-e,!1),n=Rt(o/(r-1),!0),a=Math.floor(e/n)*n,s=Math.ceil(t/n)*n,i=[];for(let l=a;l<=s+n*.5;l+=n)i.push(Number(l.toFixed(10)));return{min:a,max:s,ticks:i}}function Ve(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(o=>`${o.x} ${o.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let o=0;o<e.length-1;o++){let n=e[o-1]??e[o],a=e[o],s=e[o+1],i=e[o+2]??s,l=a.x+(s.x-n.x)/6,c=a.y+(s.y-n.y)/6,d=s.x-(i.x-a.x)/6,u=s.y-(i.y-a.y)/6;r+=` C ${l},${c} ${d},${u} ${s.x},${s.y}`}return r}function ve(e,t,r,o){return{x:e+r*Math.sin(o),y:t-r*Math.cos(o)}}function yo(e,t,r,o,n,a){let s=a-n>Math.PI?1:0,i=ve(e,t,r,n),l=ve(e,t,r,a);if(o<=0)return`M ${e} ${t} L ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} Z`;let c=ve(e,t,o,a),d=ve(e,t,o,n);return`M ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} L ${c.x} ${c.y} A ${o} ${o} 0 ${s} 0 ${d.x} ${d.y} Z`}function E(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Z(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function ye(e,t){return t[e%t.length]}function xo(e,t){let{data:r,smooth:o,stacked:n,showAxes:a,showGrid:s,showLabels:i,showValues:l}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",f=u?4:16,m=u?4:a&&i?28:8,p=u?4:a?44:8,b=u?4:12,v=e.W-p-b,x=e.H-f-m,y=1/0,w=-1/0;if(n&&d.length>0){let M=c.length>0?c.map((k,L)=>d.reduce((z,q)=>z+(q.values?.[L]??0),0)):[];for(let k of M)k<y&&(y=k),k>w&&(w=k);y>0&&(y=0)}else for(let M of d)for(let k of M.values??[])k<y&&(y=k),k>w&&(w=k);(!Number.isFinite(y)||!Number.isFinite(w))&&(y=0,w=1),y===w&&(y-=1,w+=1);let C=vo(e.yMin??y,e.yMax??w,5),H=e.yMin??C.min,j=e.yMax??C.max,de=j-H||1,$=c.length||d[0]?.values?.length||0,O=M=>$===1?p+v/2:t==="bar"?p+(M+.5)*(v/$):p+M/($-1)*v,N=M=>f+x-(M-H)/de*x,Q=[];if(!u){if(s)for(let M of C.ticks){let k=N(M);Q.push(`<line class="grid" x1="${p}" x2="${e.W-b}" y1="${k}" y2="${k}"/>`)}if(a){for(let k of C.ticks){let L=N(k);Q.push(`<text class="axis-label y" x="${p-8}" y="${L}" text-anchor="end" dominant-baseline="middle">${E(Z(k))}</text>`)}if(i&&c.length>0){let k=Math.max(1,Math.ceil(c.length/8));c.forEach((L,z)=>{z%k!==0&&z!==c.length-1||Q.push(`<text class="axis-label x" x="${O(z)}" y="${e.H-m+16}" text-anchor="middle">${E(L)}</text>`)})}let M=H<=0&&j>=0?N(0):N(H);Q.push(`<line class="axis" x1="${p}" x2="${e.W-b}" y1="${M}" y2="${M}"/>`)}}let _=[];if(t==="bar"){let M=v/$,k=M*.18,L=M-k*2;d.forEach((z,q)=>{let W=`series series-${q}`,I=ye(q,e.palette),D=0;z.values?.forEach((T,B)=>{if(!Number.isFinite(T))return;let F=O(B),X,ke,we,je;if(n){X=F-L/2,ke=L;let ue=N(D+T),pe=N(D);we=Math.min(ue,pe),je=Math.abs(ue-pe),D+=T}else{let ue=L/d.length;X=F-L/2+q*ue,ke=ue*.86;let pe=N(T),Je=N(H<0&&j>0?0:H);we=Math.min(pe,Je),je=Math.abs(pe-Je)}let Xe=`${E(z.name)}${c[B]?` \xB7 ${E(c[B])}`:""}: ${E(Z(T))}`,Yt=(B*.04).toFixed(3);_.push(`<g class="${W}"><rect class="hit" x="${X}" y="${we}" width="${ke}" height="${je}" rx="2" fill="${I}" data-tip="${Xe}" data-color="${I}" style="animation-delay: ${Yt}s"><title>${Xe}</title></rect>`+(l?`<text class="value-label" x="${X+ke/2}" y="${we-4}" text-anchor="middle">${E(Z(T))}</text>`:"")+"</g>")})})}else if(n&&t==="area"){let M=new Array($).fill(0);d.forEach((k,L)=>{let z=ye(L,e.palette),q=[],W=[];for(let T=0;T<$;T++){let B=k.values?.[T]??0,F=M[T]+B;q.push({x:O(T),y:N(F)}),W.push({x:O(T),y:N(M[T])}),M[T]=F}let I=Ve(q,o)+" L "+W.slice().reverse().map(T=>`${T.x} ${T.y}`).join(" L ")+" Z",D=(L*.15).toFixed(3);_.push(`<path class="series-fill series-${L}" d="${I}" fill="${z}" fill-opacity="0.25" pointer-events="none" style="animation-delay: ${D}s"/>`),_.push(`<path class="series-line series-${L}" d="${Ve(q,o)}" stroke="${z}" fill="none" pointer-events="none" style="animation-delay: ${D}s"/>`),q.forEach((T,B)=>{let F=k.values?.[B]??0,X=`${E(k.name)}${c[B]?` \xB7 ${E(c[B])}`:""}: ${E(Z(F))}`;_.push(`<circle class="hit series-${L}" cx="${T.x}" cy="${T.y}" r="12" fill="transparent" data-tip="${X}" data-color="${z}"><title>${X}</title></circle>`)})})}else d.forEach((M,k)=>{let L=ye(k,e.palette),z=(M.values??[]).map((I,D)=>({x:O(D),y:N(I)})),q=Ve(z,o),W=(k*.15).toFixed(3);if(t==="area"){let I=N(H<0&&j>0?0:H),D=q+` L ${z[z.length-1].x} ${I} L ${z[0].x} ${I} Z`;_.push(`<path class="series-fill series-${k}" d="${D}" fill="${L}" fill-opacity="0.25" style="animation-delay: ${W}s"/>`)}_.push(`<path class="series-line series-${k}" d="${q}" stroke="${L}" fill="none" style="animation-delay: ${W}s"/>`),u||z.forEach((I,D)=>{let T=M.values?.[D],B=`${E(M.name)}${c[D]?` \xB7 ${E(c[D])}`:""}: ${E(Z(T??0))}`,F=(k*.15+D*.025+.55).toFixed(3);_.push(`<circle class="series-point series-${k}" cx="${I.x}" cy="${I.y}" r="3.5" fill="${L}" pointer-events="none" style="animation-delay: ${F}s"/>`),_.push(`<circle class="hit series-${k}" cx="${I.x}" cy="${I.y}" r="12" fill="transparent" data-tip="${B}" data-color="${L}"><title>${B}</title></circle>`),l&&_.push(`<text class="value-label" x="${I.x}" y="${I.y-8}" text-anchor="middle" pointer-events="none">${E(Z(T??0))}</text>`)})});return Q.join("")+_.join("")}function ko(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let o=e.W/2,n=e.H/2,a=Math.min(e.W,e.H)/2-4,s=Math.max(0,Math.min(.9,e.innerRadius))*a,i=0,l=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let f=u/r*Math.PI*2,m=i,p=i+f,b=yo(o,n,a,s,m,p-.01),v=ye(d,e.palette),x=(u/r*100).toFixed(1).replace(/\.0$/,""),y=`${E(c.name)}: ${E(Z(u))} (${x}%)`,w=(d*.08).toFixed(3);if(l.push(`<path class="series-segment hit series-${d}" d="${b}" fill="${v}" data-tip="${y}" data-color="${v}" style="animation-delay: ${w}s"><title>${y}</title></path>`),e.showValues){let C=(m+p)/2,H=(a+s)/2,j=ve(o,n,H,C);l.push(`<text class="value-label donut" x="${j.x}" y="${j.y}" text-anchor="middle" dominant-baseline="middle">${E(x)}%</text>`)}i=p}),l.join("")}function wo(e,t,r){return e.length===0?"":'<div class="legend" part="legend">'+e.map((o,n)=>{let a=ye(n,t),s=r.includes(o.name);return`<button class="${s?"legend-item is-hidden":"legend-item"}" type="button" data-series="${E(o.name)}" aria-pressed="${s?"true":"false"}" title="${s?"Show":"Hide"} series '${E(o.name)}'"><span class="swatch" style="background:${a}"></span>${E(o.name)}</button>`}).join("")+"</div>"}function $o(e,t){if(e==="donut"){let n=(t.series??[]).reduce((s,i)=>s+(i.value??0),0);return`Donut chart: ${(t.series??[]).filter(s=>(s.value??0)>0).map(s=>{let i=n>0?(s.value??0)/n*100:0;return`${s.name} ${i.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(n=>n.name).join(", "),o=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${o} data point${o===1?"":"s"}.`}var Eo=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],So=`
  <style>
...
`;h(To,g({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Start writing\u2026"},toolbar:{type:"string",default:Dt},readonly:{type:"boolean",default:!1,reflect:!0},minHeight:{type:"string",default:"180px"},maxHeight:{type:"string",default:""},pasteAs:{type:"string",default:"text"}},theme:{"tc-editor-bg":"var(--tc-color-surface, #ffffff)","tc-editor-fg":"var(--tc-color-ink, #14171f)","tc-editor-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-editor-toolbar-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-fg":"var(--tc-color-ink-soft, #4a5061)","tc-editor-toolbar-active-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-editor-toolbar-hover-bg":"rgba(20, 23, 31, 0.06)","tc-editor-placeholder":"var(--tc-color-ink-muted, #6b7280)","tc-editor-radius":"var(--tc-radius-md, 8px)","tc-editor-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-editor-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, 'SF Mono', monospace)","tc-editor-line-height":"1.6"},styles:{display:"block"},template:({props:e})=>{let t=String(e.toolbar??Dt),r=!!e.readonly,o=G(String(e.minHeight??"180px")),n=String(e.maxHeight??"").trim(),a=t.split(",").map(c=>c.trim()).filter(Boolean),s=a.map(c=>{if(c==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let d=Lo[c];if(!d)return"";let u=d.shortcut?` (${G(d.shortcut)})`:"";return`<button type="button" class="tb-btn" data-cmd="${G(d.command)}"${d.value?` data-val="${G(d.value)}"`:""} data-key="${G(d.key)}" title="${G(d.label)}${u}" aria-label="${G(d.label)}">${d.icon}</button>`}).join(""),i=a.length===0?"toolbar empty":r?"toolbar readonly":"toolbar";return`
        ...
        ${Ho}
      `},afterMount(){jt(this),Bt(this)},afterRender(){let e=this,r=e.shadowRoot?.querySelector(".surface");if(r){let o=r.innerHTML,n=String(e.value??"");n&&o!==n&&document.activeElement!==e&&(r.innerHTML=n),Ge(r)}jt(e),Bt(e)},unmount(){this._editorCleanup?.()}}));function Ge(e){let t=e.textContent?.trim()===""&&e.querySelector("img, hr, br")===null;e.dataset.empty=t?"true":"false"}function jt(e){let t=e;t._editorCleanup?.();let r=t.shadowRoot;if(!r)return;let o=r.querySelector(".surface");if(!o)return;o.dataset.bootstrapped||(t.value&&(o.innerHTML=String(t.value)),o.dataset.bootstrapped="1"),Ge(o);let n=(f,m)=>{if(!t.readonly){if(o.focus(),f==="code"){let b=r.getSelection?.()??globalThis.getSelection();if(!b||b.rangeCount===0)return;let v=b.getRangeAt(0),x=v.extractContents(),y=document.createElement("code");y.className="tc-code-inline",y.appendChild(x),v.insertNode(y),v.selectNodeContents(y),b.removeAllRanges(),b.addRange(v)}else if(f==="link"){let p=globalThis.prompt("URL")?.trim();if(!p)return;document.execCommand("createLink",!1,p)}else if(f==="math"){let p=globalThis.prompt("LaTeX (e.g. E = mc^2). Wrap with $$ for display.")?.trim();if(!p)return;let b=p.startsWith("$$")&&p.endsWith("$$"),v=b?p.replace(/^\$\$|\$\$$/g,"").trim():p;Co(t,v,b)}else if(f==="codeblock"){let p=r.getSelection?.()??globalThis.getSelection();if(!p||p.rangeCount===0)return;let b=p.getRangeAt(0),v=b.toString()||"// code",x=document.createElement("pre"),y=document.createElement("code");y.textContent=v,x.appendChild(y),b.deleteContents(),b.insertNode(x);let w=document.createRange();w.selectNodeContents(y),w.collapse(!1),p.removeAllRanges(),p.addRange(w)}else f==="formatBlock"?document.execCommand("formatBlock",!1,`<${m??"p"}>`):document.execCommand(f,!1,m);qt(t,o),_t(r,o)}},a=f=>{let m=f.target?.closest?.(".tb-btn");if(!m)return;f.preventDefault();let p=m.dataset.cmd;p&&n(p,m.dataset.val)},s=()=>{Ge(o),qt(t,o)},i=()=>{let f=o.innerHTML;t._lastEmitted!==f&&(t._lastEmitted=f,t.dispatchEvent(new CustomEvent("tc-change",{detail:{html:f},bubbles:!0,composed:!0})))},l=f=>{if(t.readonly||t.pasteAs!=="text")return;f.preventDefault();let m=f.clipboardData?.getData("text/plain")??"";document.execCommand("insertText",!1,m)},c=f=>{if(t.readonly||!(f.metaKey||f.ctrlKey))return;let m=f.key.toLowerCase();m==="b"?(f.preventDefault(),n("bold")):m==="i"?(f.preventDefault(),n("italic")):m==="u"?(f.preventDefault(),n("underline")):m==="k"&&(f.preventDefault(),n("link"))},d=()=>{let f=globalThis.getSelection();!f||!f.anchorNode||o.contains(f.anchorNode)&&_t(r,o)},u=r.querySelector(".toolbar");u?.addEventListener("click",a),o.addEventListener("input",s),o.addEventListener("blur",i),o.addEventListener("paste",l),o.addEventListener("keydown",c),document.addEventListener("selectionchange",d),t._editorCleanup=()=>{u?.removeEventListener("click",a),o.removeEventListener("input",s),o.removeEventListener("blur",i),o.removeEventListener("paste",l),o.removeEventListener("keydown",c),document.removeEventListener("selectionchange",d)}}function qt(e,t){let r=t.innerHTML;e.value=r,e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:r},bubbles:!0,composed:!0}))}function Co(e,t,r){let o=e.shadowRoot;if(!o)return;let n=o.querySelector(".surface");if(!n)return;let a=o.getSelection?.()??globalThis.getSelection();if(!a||a.rangeCount===0)return;let s=a.getRangeAt(0),i=document.createElement(r?"div":"span");i.className=r?"tc-math display":"tc-math inline",i.setAttribute("contenteditable","false"),i.dataset.latex=t,i.innerHTML=Ot(e,t,r),s.deleteContents(),s.insertNode(i);let l=document.createTextNode("\u200B");i.parentNode?.insertBefore(l,i.nextSibling);let c=document.createRange();c.setStartAfter(l),c.collapse(!0),a.removeAllRanges(),a.addRange(c),e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:n.innerHTML},bubbles:!0,composed:!0}))}function Ot(e,t,r){if(e.mathRenderer)try{return e.mathRenderer(t,r)}catch{}return`<code class="tc-math-src">${t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code>`}function Bt(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".surface");if(!r)return;r.querySelectorAll(".tc-math").forEach(n=>{let a=n,s=a.dataset.latex??"",i=a.classList.contains("display"),l=`${i?"d":"i"}:${s}`;a.dataset.stamp!==l&&(a.innerHTML=Ot(e,s,i),a.dataset.stamp=l)})}function _t(e,t){e.querySelectorAll(".tb-btn").forEach(o=>{let n=o,a=n.dataset.cmd??"",s=n.dataset.val,i=!1;try{a==="formatBlock"&&s?i=(document.queryCommandValue("formatBlock")||"").toLowerCase().replace(/^[<]|[>]$/g,"")===s:(a==="bold"||a==="italic"||a==="underline"||a==="strikeThrough"||a==="insertOrderedList"||a==="insertUnorderedList")&&(i=document.queryCommandState(a))}catch{i=!1}n.classList.toggle("is-active",i)})}var zo="tc-markdown";function S(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ae="\0M\0";function Ao(e,t){let r=[],o=(s,i)=>{let l=r.length;return r.push({latex:s,display:i}),`${Ae}${l}${Ae}`},n=e;n=n.replace(/\$\$([\s\S]+?)\$\$/g,(s,i)=>o(i.trim(),!0)),n=n.replace(/(^|[\s(])\$([^\$\n][^\$\n]*?)\$(?=[\s.,;:!?)\]]|$)/g,(s,i,l)=>`${i}${o(l.trim(),!1)}`);let a=S(n);return a=a.replace(/`([^`]+)`/g,"<code>$1</code>"),a=a.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),a=a.replace(/(?<!\*)\*([^*\n]+?)\*(?!\*)/g,"<em>$1</em>"),a=a.replace(/\b_(.+?)_\b/g,"<em>$1</em>"),a=a.replace(/~~(.+?)~~/g,"<del>$1</del>"),a=a.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(s,i,l)=>`<img src="${S(l)}" alt="${S(i)}" loading="lazy"/>`),a=a.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(s,i,l)=>`<a href="${S(l)}" target="_blank" rel="noopener">${i}</a>`),a=a.replace(new RegExp(`${Ae}(\\d+)${Ae}`,"g"),(s,i)=>{let l=r[Number(i)];if(!l)return"";let c=l.latex;if(t)try{let d=t(c,l.display);return l.display?`<div class="tc-md-math display" data-latex="${S(c)}">${d}</div>`:`<span class="tc-md-math inline" data-latex="${S(c)}">${d}</span>`}catch(d){return l.display?`<div class="tc-md-math error" title="${S(String(d))}">${S(c)}</div>`:`<span class="tc-md-math error" title="${S(String(d))}">${S(c)}</span>`}return l.display?`<div class="tc-md-math fallback display" data-latex="${S(c)}"><code>${S(c)}</code></div>`:`<span class="tc-md-math fallback inline" data-latex="${S(c)}"><code>${S(c)}</code></span>`}),a}function Ro(e){let t=e.match(/^\[([ xX])\]\s+(.*)$/);return t?`<li class="tc-md-task"><input type="checkbox" disabled${t[1].toLowerCase()==="x"?" checked":""}/><span>${t[2]}</span></li>`:""}function No(e,t){let r=(a,s,i)=>{let l=i&&i!=="left"?` style="text-align:${i}"`:"";return`<${s}${l}>${a}</${s}>`},o=e[0]?.map((a,s)=>r(a,"th",t[s])).join("")??"",n=e.slice(1).map(a=>`<tr>${a.map((s,i)=>r(s,"td",t[i])).join("")}</tr>`).join("");return`<table class="tc-md-table"><thead><tr>${o}</tr></thead><tbody>${n}</tbody></table>`}function Ue(e,t){let r=t?.mathRenderer,o=t?.highlight,n=e.replace(/\r\n?/g,`
`).split(`
`),a=[],s=0,i=l=>Ao(l,r);for(;s<n.length;){let l=n[s],c=l.match(/^:::\s*([a-zA-Z][\w-]*)(?:\s+(.+))?\s*$/);if(c){let p=c[1].toLowerCase(),b=(c[2]??"").trim(),v=[];for(s++;s<n.length&&!/^:::\s*$/.test(n[s]);)v.push(n[s]),s++;s<n.length&&s++;let x=Ue(v.join(`
`),t);a.push(`<div class="tc-md-callout v-${S(p)}" role="${p==="danger"?"alert":"note"}">${b?`<div class="callout-title">${i(b)}</div>`:""}<div class="callout-body">${x}</div></div>`);continue}let d=l.match(/^```(\S*)\s*$/);if(d){let p=d[1]??"",b=[];for(s++;s<n.length&&!/^```\s*$/.test(n[s]);)b.push(n[s]),s++;s<n.length&&s++;let v=b.join(`
`),x=o&&p?(()=>{try{return o(v,p)}catch{return S(v)}})():S(v),y=p?` class="lang-${S(p)}"`:"";a.push(`<pre><code${y}>${x}</code></pre>`);continue}let u=l.match(/^(#{1,6})\s+(.*)$/);if(u){let p=u[1].length;a.push(`<h${p}>${i(u[2])}</h${p}>`),s++;continue}if(/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(l.trim())){a.push("<hr/>"),s++;continue}if(/^\s*\|.+\|\s*$/.test(l)&&s+1<n.length&&/^\s*\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?\s*$/.test(n[s+1])){let p=l.trim().replace(/^\||\|$/g,"").split("|").map(y=>y.trim()),b=n[s+1].trim().replace(/^\||\|$/g,"").split("|").map(y=>{let w=y.trim(),C=w.startsWith(":"),H=w.endsWith(":");return C&&H?"center":H?"right":C?"left":""}),v=[];for(s+=2;s<n.length&&/^\s*\|.+\|\s*$/.test(n[s]);)v.push(n[s].trim().replace(/^\||\|$/g,"").split("|").map(y=>i(y.trim()))),s++;let x=[p.map(y=>i(y)),...v];a.push(No(x,b));continue}if(/^>\s?/.test(l)){let p=[];for(;s<n.length&&/^>\s?/.test(n[s]);)p.push(n[s].replace(/^>\s?/,"")),s++;a.push(`<blockquote>${i(p.join(" "))}</blockquote>`);continue}let f=l.match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(f){let p=!!f[3],b=p?"ol":"ul",v=[],x=!1;for(;s<n.length;){let w=n[s].match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(!w||!!w[3]!==p)break;let H=w[4],j=Ro(H);j?(x=!0,v.push(j)):v.push(`<li>${i(H)}</li>`),s++}let y=x?' class="tc-md-tasks"':"";a.push(`<${b}${y}>${v.join("")}</${b}>`);continue}if(l.trim()===""){s++;continue}let m=[l];for(s++;s<n.length;){let p=n[s];if(p.trim()===""||/^#{1,6}\s+/.test(p)||/^```/.test(p)||/^>\s?/.test(p)||/^:::/.test(p)||/^(\s*)(?:[-*+]|\d+\.)\s+/.test(p)||/^\s*\|.+\|\s*$/.test(p)||/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(p.trim()))break;m.push(p),s++}a.push(`<p>${i(m.join(" "))}</p>`)}return a.join(`
...
`).map(l=>o+l).join(`
`);return{text:e.slice(0,n)+i+e.slice(a),selStart:n,selEnd:n+i.length}}var Gt={bold:{key:"bold",label:"Bold",shortcut:"\u2318B",apply:(e,t,r)=>Ke(e,t,r,"**","**","bold text")},italic:{key:"italic",label:"Italic",shortcut:"\u2318I",apply:(e,t,r)=>Ke(e,t,r,"*","*","italic text")},heading:{key:"heading",label:"Heading",apply:(e,t,r)=>Re(e,t,r,"## ")},code:{key:"code",label:"Code",apply:(e,t,r)=>Ke(e,t,r,"`","`","code")},link:{key:"link",label:"Link",shortcut:"\u2318K",apply:(e,t,r)=>{let o=globalThis.prompt?.("URL")?.trim();if(!o)return{text:e,selStart:t,selEnd:r};let n=e.slice(t,r)||"link text";return{text:e.slice(0,t)+`[${n}](${o})`+e.slice(r),selStart:t+1,selEnd:t+1+n.length}}},bullet:{key:"bullet",label:"Bulleted list",apply:(e,t,r)=>Re(e,t,r,"- ")},ordered:{key:"ordered",label:"Numbered list",apply:(e,t,r)=>Re(e,t,r,"1. ")},quote:{key:"quote",label:"Quote",apply:(e,t,r)=>Re(e,t,r,"> ")}},Pt="bold,italic,heading,|,bullet,ordered,quote,|,link,code",Io=`
  <style>
    :host {
      display: block;
...
`;h(zo,g({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Write some markdown\u2026"},mode:{type:"string",default:"split"},readonly:{type:"boolean",default:!1},minHeight:{type:"string",default:"240px"},toolbar:{type:"string",default:Pt}},theme:{"tc-md-bg":"var(--tc-color-surface, #ffffff)","tc-md-fg":"var(--tc-color-ink, #14171f)","tc-md-rule":"var(--tc-color-rule, #ece5d3)","tc-md-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-md-preview-bg":"var(--tc-color-bg, #faf8f3)","tc-md-radius":"var(--tc-radius-md, 8px)","tc-md-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-md-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)"},styles:{display:"block"},refs:{source:"textarea",preview:".preview"},template:({props:e,state:t})=>{let r=String(t.mode??e.mode??"split"),o=String(e.value??""),n=String(e.toolbar??Pt).split(",").map(f=>f.trim()).filter(Boolean),a=n.map(f=>{if(f==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let m=Gt[f];if(!m||!Ft[m.key])return"";let p=m.shortcut?` (${S(m.shortcut)})`:"";return`<button type="button" class="tb-btn" data-op="${S(m.key)}" title="${S(m.label)}${p}" aria-label="${S(m.label)}">${Ft[m.key]}</button>`}).join(""),s=(f,m)=>`<button type="button" data-mode="${f}" class="${r===f?"is-active":""}" aria-pressed="${r===f?"true":"false"}">${m}</button>`,i=e,c=(i.render??(f=>Ue(f,{mathRenderer:i.mathRenderer,highlight:i.highlight})))(o),d=r==="source"?"panes source-only":r==="preview"?"panes preview-only":"panes";return`
        <div class="root" style="${`--tc-md-min-height: ${S(e.minHeight??"240px")};`}">
      ...
      `}}));function xe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Bo="site-footer";h(Bo,g({props:{base:{type:"string",default:""},year:{type:"string",default:"2026"}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??"");return`
        <footer class="foot">
          <div class="inner">
      ...
      `}}));function ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var _o="site-search";var U=null,Ie=null;function De(e){if(U)return Promise.resolve(U);if(Ie)return Ie;let t=`${e}search.json`;return Ie=fetch(t).then(r=>r.json()).then(r=>(U=r.docs??[],U)).catch(r=>(console.warn("[site-search] failed to load index:",r),U=[],U)),Ie}function Ut(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Kt(e,t){let r=e.trim().toLowerCase();if(!r)return[];let o=r.split(/\s+/).filter(Boolean).map(a=>({raw:a,re:new RegExp(Ut(a),"i")})),n=[];for(let a of t){let s=a.title.toLowerCase(),i=(a.description??"").toLowerCase(),l=(a.text??"").toLowerCase(),c=0;for(let u of o){let f=u.raw;s===f&&(c+=50),s.startsWith(f)&&(c+=20),s.includes(f)&&(c+=10),i.includes(f)&&(c+=5),l.includes(f)&&(c+=1)}o.every(u=>u.re.test(a.title)||u.re.test(i)||u.re.test(l))&&c!==0&&(a.category==="blog"&&a.date&&(Date.now()-new Date(a.date).getTime())/864e5<30&&(c+=3),n.push({doc:a,score:c}))}return n.sort((a,s)=>s.score-a.score),n.slice(0,12)}function Oo(e,t,r=140){let o=e.trim().toLowerCase().split(/\s+/)[0];if(!o)return t.slice(0,r);let a=t.toLowerCase().indexOf(o);if(a===-1)return t.slice(0,r);let s=Math.max(0,a-40),i=Math.min(t.length,s+r),l=s>0?"\u2026 ":"",c=i<t.length?" \u2026":"";return l+t.slice(s,i)+c}function Y(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function We(e,t){let r=t.trim();if(!r)return Y(e);let o=r.split(/\s+/).filter(Boolean),n=Y(e);for(let a of o){let s=new RegExp(`(${Ut(Y(a))})`,"gi");n=n.replace(s,"<mark>$1</mark>")}return n}function Fo(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var Po=`
        <style>
          :host { display: inline-block; }
...
`;h(_o,g({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),o=String(t.query??""),n=Number(t.focusIdx??0),a=t.results??[],s=`
      ...
      `,i=o.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':a.length===0?`<div class="empty">No results for "${Y(o)}". Try a shorter query.</div>`:a.map((c,d)=>{let u=d===n?"row focused":"row",f=r+c.doc.url.replace(/^\//,""),m=Oo(o,c.doc.text);return`
              <a class="${u}" data-index="${d}" href="${Y(f)}">
                <span class="row-cat ${Y(c.doc.category)}">${Y(c.doc.category)}</span>
                <div class="row-main">
                  <div class="row-title">${We(c.doc.title,o)}</div>
                  <div class="row-desc">${We(c.doc.description,o)}</div>
                  <div class="row-snippet">${We(m,o)}</div>
                </div>
              </a>
            `}).join(""),l=`
