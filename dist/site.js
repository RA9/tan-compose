...
`,X=!1;function Ie(){if(typeof document>"u"||X)return;if(document.querySelector("style[data-tc-tokens]")){X=!0;return}let e=document.createElement("style");e.setAttribute("data-tc-tokens",""),e.textContent=ze,document.head.insertBefore(e,document.head.firstChild),X=!0}Ie();var Ae=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],Re=new Set(["string","number","boolean","json"]);function d(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Ae){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,n]of Object.entries(t)){if(n===null||typeof n!="object"||Array.isArray(n))throw new TypeError(`describe(): props.${r} must be a record`);if(!Re.has(n.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var re=new Map,Ne=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,De=/^(\S+)(?:\s+(.+))?$/;function f(e,t){if(typeof e!="string"||!Ne.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(re.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),n=t.props??{},a=t.refs??{},o=Oe(t);class i extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let s=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),Be(s,o),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",s.appendChild(this.container),t.attributes&&le(this,t.attributes),this.ctx=je(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[s,l]of Object.entries(n)){let p=this.getAttribute(s),u=p!==null?ne(p,l.type):l.default;this.propValues.set(s,u),this.maybeSyncFormValue(s,u),Object.defineProperty(this,s,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(s),set:g=>{let m=Pe(g,l.type),b=this.propValues.get(s);Object.is(b,m)||(this.propValues.set(s,m),l.reflect&&_e(this,s,m,l.type),this.maybeSyncFormValue(s,m),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(s,l){if(!this.internals||s!=="value")return;let p=l==null?null:String(l);this.internals.setFormValue(p)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(s){console.error(`[tan-compose] beforeMount threw for <${e}>:`,s)}if(this.renderInternal(),t.action){let s=t.action;this.addEventListener("click",s),this.mountCleanups.push(()=>this.removeEventListener("click",s))}if(t.emit)for(let s of t.emit)this.addEventListener(s.name,s.handler),this.mountCleanups.push(()=>this.removeEventListener(s.name,s.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(s){console.error(`[tan-compose] afterMount threw for <${e}>:`,s)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(s){console.error(`[tan-compose] unmount threw for <${e}>:`,s)}T(this.mountCleanups),T(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){se(t,s=>{let l=this.listSlots.get(s);if(l){for(let p of l.cache.values())T(p.cleanups);l.cache.clear()}})}attributeChangedCallback(s,l,p){if(l!==p){if(Object.prototype.hasOwnProperty.call(n,s)){let u=n[s],g=p!==null?ne(p,u.type):u.default,m=this.propValues.get(s);Object.is(m,g)||(this.propValues.set(s,g),this.isMounted&&this.scheduleRender());return}this.state.set(s,p),this.isMounted&&this.scheduleRender()}}setState(s,l){let p=this.state.get(s);Object.is(p,l)||(this.state.set(s,l),this.isMounted&&this.scheduleRender())}getState(s){return this.state.get(s)}render(){this.renderInternal()}emitEvent(s,l){this.dispatchEvent(new CustomEvent(s,{detail:l,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(s){let l=this.listSlots.get(s);return l||(l={cache:new Map},this.listSlots.set(s,l)),l}renderInternal(){this.rendering=!0;let s=this.captureFocusInShadow();try{T(this.renderCleanups),this.container.replaceChildren();let l={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let p=typeof t.template=="function"?t.template(this.ctx):t.template;p&&(this.container.innerHTML=p)}if(t.children)for(let p of t.children){let u=ae(p,l,g=>this.getOrCreateSlot(g));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(s&&this.restoreFocusInShadow(s),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(l){console.error(`[tan-compose] afterRender threw for <${e}>:`,l)}}captureFocusInShadow(){let s=this.shadowRoot;if(!s)return null;let l=s.activeElement;if(!l)return null;let p=[],u=l;for(;u&&u!==s;){let b=u.parentNode;if(!b)break;let y=u.tagName,x=Array.from(b.children).filter(J=>J.tagName===y).indexOf(u);if(p.unshift({tag:y,idx:x}),u=b instanceof Element?b:null,!u&&b===s)break}let g=null,m=null;if(l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement)try{g=l.selectionStart,m=l.selectionEnd}catch{}return{path:p,selectionStart:g,selectionEnd:m}}restoreFocusInShadow(s){let l=this.shadowRoot;if(!l)return;let p=l;for(let g of s.path){let m=Array.from(p.children??[]),$=(m.length>0?m:Array.from(p.children??[])).filter(x=>x.tagName===g.tag)[g.idx];if(!$)return;p=$}let u=p;if(!(!u||typeof u.focus!="function")&&l.activeElement!==u&&(u.focus(),s.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(s.selectionStart,s.selectionEnd??s.selectionStart)}catch{}}refreshRefs(){let s={},l=this.shadowRoot;for(let[p,u]of Object.entries(a))s[p]=l?l.querySelector(u):null;this.currentRefs=s}formAssociatedCallback(s){try{t.formAssociatedCallback?.call(this,s)}catch(l){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,l)}}formDisabledCallback(s){try{t.formDisabledCallback?.call(this,s)}catch(l){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,l)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(s){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,s)}}formStateRestoreCallback(s,l){try{t.formStateRestoreCallback?.call(this,s,l)}catch(p){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,p)}}attachDelegatedEvents(s){let l=new Map;for(let[p,u]of Object.entries(s)){let g=De.exec(p.trim());if(!g)continue;let[,m,b]=g;l.has(m)||l.set(m,[]),l.get(m).push({selector:b??null,handler:u})}for(let[p,u]of l){let g=m=>{for(let{selector:b,handler:y}of u){if(!b){y(m,this.ctx);continue}let $=m.composedPath();for(let x of $){if(x===this.shadowRoot||x===this)break;if(x instanceof Element&&this.shadowRoot?.contains(x)&&x.matches(b)){y(m,this.ctx);break}}}};this.shadowRoot.addEventListener(p,g),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(p,g))}}}return re.set(e,i),customElements.define(e,i),e}function ae(e,t,r){return e.if&&!e.if(t.ctx)?null:oe(e,t,r)}function oe(e,t,r){let n=document.createElement(e.tag||"div");if(e.styles&&(n.style.cssText=Object.entries(e.styles).map(([a,o])=>`${a}: ${o}`).join("; ")),e.className&&(n.className=e.className),e.attributes&&le(n,e.attributes),e.template!==void 0){let a=typeof e.template=="function"?e.template(t.ctx):e.template;a&&(n.innerHTML=a)}if(e.children)for(let a of e.children){let o=ae(a,t,r);o&&n.appendChild(o)}if(e.for&&qe(n,e,t,r),e.action){let a=e.action;n.addEventListener("click",a),t.cleanups.push(()=>n.removeEventListener("click",a))}if(e.emit)for(let a of e.emit)n.addEventListener(a.name,a.handler),t.cleanups.push(()=>n.removeEventListener(a.name,a.handler));return n}function qe(e,t,r,n){let a=t.for,o=n(t),i=a.items(r.ctx),c=new Map;for(let s=0;s<i.length;s++){let l=i[s],p=a.key(l,s),u,g=o.cache.get(p);if(g&&Object.is(g.lastItem,l))u=g;else{let m=[],b=a.render(l,s,r.ctx),y=oe(b,{...r,cleanups:m},n);g&&T(g.cleanups),u={element:y,lastItem:l,cleanups:m}}c.set(p,u),e.appendChild(u.element)}for(let[s,l]of o.cache)c.has(s)||T(l.cleanups);o.cache=c}function se(e,t){if(e.for&&t(e),e.children)for(let r of e.children)se(r,t)}function je(e,t,r,n){return{host:e,get props(){let a={};for(let[o,i]of t)a[o]=i;return a},get state(){let a={};for(let[o,i]of r)a[o]=i;return a},get refs(){return n()},setState:(a,o)=>e.setState(a,o),getState:a=>e.getState(a),emit:(a,o)=>e.emitEvent(a,o)}}function Oe(e){let t=e.theme?Fe(e.theme):void 0,r=e.styles?Ve(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let a=[];if(t){let o=new CSSStyleSheet;o.replaceSync(t),a.push(o)}if(r){let o=new CSSStyleSheet;o.replaceSync(r),a.push(o)}return{kind:"adopted",sheets:a}}return{kind:"fallback",theme:t,styles:r}}function Be(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function le(e,t){for(let[r,n]of Object.entries(t))e.setAttribute(r,n)}function Fe(e){return`:host { ${Object.entries(e).map(([r,n])=>`--${r}: ${n};`).join(" ")} }`}function Ve(e){return`.container { ${Object.entries(e).map(([r,n])=>`${r}: ${n};`).join(" ")} }`}function T(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function ne(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function Pe(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function _e(e,t,r,n){if(n!=="json"){if(n==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var Ke="tc-button";var ie=`
      <style>
        .root {
...
`;f(Ke,d({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${R(e.variant)} s-${R(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
      ...
      `},refs:{input:".cb"},events:{"change .cb":(e,t)=>{let r=e.target.checked,n=t.host;n.checked=r,n.internals?.setFormValue(r?n.value:null),t.emit("tc-change",{checked:r})}},afterMount(){let e=this,r=e.shadowRoot?.querySelector(".cb");r&&(r.indeterminate=e.indeterminate),e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function F(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var We="tc-switch";f(We,d({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-switch-track-off":"var(--tc-color-rule-strong, #d9cfb8)","tc-switch-track-on":"var(--tc-color-accent, #a16939)","tc-switch-thumb":"var(--tc-color-surface, #ffffff)","tc-switch-fg":"var(--tc-color-ink, #14171f)","tc-switch-helper":"var(--tc-color-ink-muted, #6b7280)","tc-switch-error":"var(--tc-color-danger, #b3261e)","tc-switch-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.error;return`
        <label class="row ${e.disabled?"is-disabled":""}">
          ...
          ${e.label?`<span class="label">${ce(e.label)}</span>`:""}
        </label>
        ${e.error||e.helper?`<div class="${t?"error":"helper"}">${ce(e.error||e.helper)}</div>`:""}
        <style>
...
`;f(Ze,d({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[d({tag:"style",template:et}),d({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),d({tag:"div",className:"wrap",children:[d({tag:"table",children:[d({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],n=t;return`<tr>${r.map(a=>{let o=n.sortKey===a.key,i=a.sortable!==!1,c=o?n.sortDir==="asc"?"\u25B2":"\u25BC":"",s=o?n.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${V(a.key)}"
                        class="${i?"sortable":""}"
                        aria-sort="${s}"
                      >${V(a.label)}<span class="sort">${c}</span></th>`}).join("")}</tr>`}}),d({tag:"tbody",children:[d({tag:"tr",className:"empty",if:({props:e,state:t})=>de(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${V(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>de(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let a=r.props.columns??[],o=e;return d({tag:"tr",attributes:{"data-row-id":String(o.id??t)},template:a.map(i=>`<td>${typeof i.render=="function"?i.render(o):V(o[i.key]??"")}</td>`).join("")})}}})]})]}),d({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,n=P(e,r),a=e.pageSize??10,o=Math.max(1,Math.ceil(n.length/a)),i=Math.min(r.page??0,o-1),c=(e.rows??[]).length;return`
    ...
    `}));function he(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var dt="tc-stack";f(dt,d({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
    ...
    `}));function mt(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function bt(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${ht(t)})`:t}function ht(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function vt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var yt="tc-grid";f(yt,d({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${ve(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${ve(e.min)}, 1fr))`};
          --tc-grid-gap: ${xt(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `},events:{"click .copy":(e,t)=>{let r=t.host,n=r.shadowRoot?.querySelector("slot"),o=(n?n.assignedNodes({flatten:!0}):Array.from(r.childNodes)).map(c=>c.textContent??"").join(""),i=()=>{t.setState("copied",!0),t.emit("tc-copy",{text:o}),setTimeout(()=>t.setState("copied",!1),1600)};navigator.clipboard?.writeText?navigator.clipboard.writeText(o).then(i,i):i()}}}));var St='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>',$t='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>';function ye(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Et="tc-callout";f(Et,d({props:{variant:{type:"string",default:"note"},title:{type:"string",default:""},compact:{type:"boolean",default:!1}},theme:{"tc-callout-radius":"var(--tc-radius-md, 8px)","tc-callout-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-callout-note-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-callout-note-fg":"var(--tc-color-ink-soft, #4a5061)","tc-callout-note-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-callout-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-callout-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-callout-info-border":"var(--tc-color-info, #3a5b8c)","tc-callout-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-callout-success-fg":"var(--tc-color-success-fg, #155b40)","tc-callout-success-border":"var(--tc-color-success, #207a5b)","tc-callout-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-callout-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-callout-warning-border":"var(--tc-color-warning, #a87326)","tc-callout-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-callout-danger-fg":"var(--tc-color-danger-fg, #7a1a14)","tc-callout-danger-border":"var(--tc-color-danger, #b3261e)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"note"),r=xe[t]??xe.note;return`
        <aside
          class="callout v-${ke(t)} ${e.compact?"compact":""}"
          role="${t==="danger"?"alert":"note"}"
        >
          <span class="icon" aria-hidden="true">${r}</span>
          <div class="body">
            ${e.title?`<div class="title">${ke(e.title)}</div>`:""}
      ...
      `},afterMount(){Mt(this)},unmount(){_.get(this)?.observer?.disconnect(),_.delete(this)}}));function Mt(e){_.get(e)?.observer?.disconnect();let r=e,n=r.target||"main",a=(r.levels||"h2,h3").split(",").map(l=>l.trim().toLowerCase()).filter(Boolean),o=document.querySelector(n);if(!o)return;let i=Array.from(o.querySelectorAll(a.join(","))).filter(l=>l instanceof HTMLElement),c=i.map(l=>(l.id||(l.id=Ct(l.textContent??"")),{id:l.id,level:parseInt(l.tagName.slice(1),10),text:(l.textContent??"").trim()}));if(e.setState("items",c),typeof IntersectionObserver>"u")return;let s=new IntersectionObserver(l=>{let u=l.filter(m=>m.isIntersecting).sort((m,b)=>m.boundingClientRect.top-b.boundingClientRect.top)[0];if(!u)return;let g=u.target.id;g&&e.setState("activeId",g)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let l of i)s.observe(l);_.set(e,{observer:s,activeId:""})}function Ct(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Z(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Lt="tc-pagination";f(Lt,d({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=Ht(Number(e.current)|0,1,t),n=Math.max(0,Number(e.siblings)|0),a=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let o=zt(r,t,n,a),i=K(String(e.size??"sm")),c=r<=1?" disabled":"",s=r>=t?" disabled":"",l=o.map(p=>{if(p==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=p===r;return`<tc-button
            class="num"
            size="${i}"
            variant="${u?"primary":"ghost"}"
            data-page="${p}"${u?' aria-current="page"':""}
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let n=r.getAttribute("data-page");if(n==null)return;let a=Number(n),o=t.host,i=Math.max(1,Number(o.total)|0),c=Number(o.current)|0;!Number.isFinite(a)||a<1||a>i||a!==c&&t.emit("tc-page-change",{page:a})}}}));function Ht(e,t,r){return Math.min(r,Math.max(t,e))}function zt(e,t,r,n){let a=new Set;for(let c=1;c<=Math.min(n,t);c++)a.add(c);for(let c=Math.max(1,t-n+1);c<=t;c++)a.add(c);for(let c=Math.max(1,e-r);c<=Math.min(t,e+r);c++)a.add(c);let o=[...a].sort((c,s)=>c-s),i=[];for(let c=0;c<o.length;c++)c>0&&o[c]-o[c-1]>1&&i.push("\u2026"),i.push(o[c]);return i}function K(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var It="tc-combobox";function q(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function j(e){return e.join(",")}function At(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}f(It,d({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],n=!!e.multiple,a=e.searchable!==!1,o=!!e.disabled,i=!!e.error,c=q(e.value),s=String(t.query??""),l=!!t.open&&!o,p=Number(t.focusedIndex??-1),u=we(r,s),g=new Set(c),m=c.map(h=>r.find(B=>B.value===h)).filter(h=>!!h),b=a&&(l||n&&c.length===0),y=!n&&c.length===1&&(!l||!a),$=c.length===0&&!b&&!y,x=n?m.map(h=>`<span class="chip" data-value="${v(h.value)}">
          ...
          </span>`:"",Te=$?`<span class="placeholder">${v(e.placeholder??"")}</span>`:"",Me=b?`<input
            type="text"
            class="search"
            part="search"
            value="${v(s)}"
            ...
            role="combobox"
          />`:"",Ce=u.length===0?`<div class="empty">${v(e["empty-text"]??"No results")}</div>`:u.map((h,B)=>{let W=g.has(h.value);return`<div
              class="${["option",W?"selected":"",B===p?"focused":"",h.disabled?"disabled":""].filter(Boolean).join(" ")}"
              role="option"
            ...
            </div>`}).join(""),Le=e.label?`<label class="label">${v(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",He=i?`<div class="helper error">${v(e.error)}</div>`:e.helper?`<div class="helper">${v(e.helper)}</div>`:"";return`
        ${Le}
        <div
...
`;var ee={"alert-circle":'<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>',"alert-triangle":'<path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>',info:'<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>',check:'<polyline points="20 6 9 17 4 12"/>',"check-circle":'<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>',x:'<line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>',"x-circle":'<circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/>',"arrow-right":'<line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>',"arrow-left":'<line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/>',"arrow-up":'<line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/>',"arrow-down":'<line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/>',"chevron-right":'<polyline points="9 18 15 12 9 6"/>',"chevron-left":'<polyline points="15 18 9 12 15 6"/>',"chevron-up":'<polyline points="18 15 12 9 6 15"/>',"chevron-down":'<polyline points="6 9 12 15 18 9"/>',"external-link":'<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/>',plus:'<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>',minus:'<line x1="5" y1="12" x2="19" y2="12"/>',search:'<circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>',filter:'<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>',"more-horizontal":'<circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/>',"more-vertical":'<circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/>',settings:'<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/>',edit:'<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="m18.5 2.5 a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4Z"/>',trash:'<polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>',copy:'<rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/>',download:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',mail:'<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22 6 12 13 2 6"/>',calendar:'<rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>',clock:'<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',home:'<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',menu:'<line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/>',"log-out":'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>',"log-in":'<path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/>',moon:'<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>',sun:'<circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/>',eye:'<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>',"eye-off":'<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/>',loader:'<line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"/><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"/><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"/>',refresh:'<polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/>'},Nt=Object.freeze(Object.keys(ee));var Dt="tc-icon";f(Dt,d({props:{name:{type:"string",default:""},size:{type:"string",default:"1em"},stroke:{type:"string",default:"currentColor"},fill:{type:"string",default:"none"},title:{type:"string",default:""}},styles:{display:"inline-flex","align-items":"center","justify-content":"center","vertical-align":"middle","line-height":"1"},template:({props:e})=>{let t=String(e.name??""),r=ee[t],n=String(e.size??"1em"),a=String(e.stroke??"currentColor"),o=String(e.fill??"none"),i=String(e.title??"");if(!r)return`
      ...
      `}}));function O(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var jt="site-footer";f(jt,d({props:{base:{type:"string",default:""},year:{type:"string",default:"2026"}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??"");return`
        <footer class="foot">
          <div class="inner">
      ...
      `}}));function A(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ot="site-search";var w=null,U=null;function Y(e){if(w)return Promise.resolve(w);if(U)return U;let t=`${e}search.json`;return U=fetch(t).then(r=>r.json()).then(r=>(w=r.docs??[],w)).catch(r=>(console.warn("[site-search] failed to load index:",r),w=[],w)),U}function Ee(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function $e(e,t){let r=e.trim().toLowerCase();if(!r)return[];let n=r.split(/\s+/).filter(Boolean).map(o=>({raw:o,re:new RegExp(Ee(o),"i")})),a=[];for(let o of t){let i=o.title.toLowerCase(),c=(o.description??"").toLowerCase(),s=(o.text??"").toLowerCase(),l=0;for(let u of n){let g=u.raw;i===g&&(l+=50),i.startsWith(g)&&(l+=20),i.includes(g)&&(l+=10),c.includes(g)&&(l+=5),s.includes(g)&&(l+=1)}n.every(u=>u.re.test(o.title)||u.re.test(c)||u.re.test(s))&&l!==0&&(o.category==="blog"&&o.date&&(Date.now()-new Date(o.date).getTime())/864e5<30&&(l+=3),a.push({doc:o,score:l}))}return a.sort((o,i)=>i.score-o.score),a.slice(0,12)}function Bt(e,t,r=140){let n=e.trim().toLowerCase().split(/\s+/)[0];if(!n)return t.slice(0,r);let o=t.toLowerCase().indexOf(n);if(o===-1)return t.slice(0,r);let i=Math.max(0,o-40),c=Math.min(t.length,i+r),s=i>0?"\u2026 ":"",l=c<t.length?" \u2026":"";return s+t.slice(i,c)+l}function S(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function te(e,t){let r=t.trim();if(!r)return S(e);let n=r.split(/\s+/).filter(Boolean),a=S(e);for(let o of n){let i=new RegExp(`(${Ee(S(o))})`,"gi");a=a.replace(i,"<mark>$1</mark>")}return a}function Ft(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var Vt=`
        <style>
...
`;f(Ot,d({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),n=String(t.query??""),a=Number(t.focusIdx??0),o=t.results??[],i=`
      ...
      `,c=n.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':o.length===0?`<div class="empty">No results for "${S(n)}". Try a shorter query.</div>`:o.map((l,p)=>{let u=p===a?"row focused":"row",g=r+l.doc.url.replace(/^\//,""),m=Bt(n,l.doc.text);return`
              <a class="${u}" data-index="${p}" href="${S(g)}">
                <span class="row-cat ${S(l.doc.category)}">${S(l.doc.category)}</span>
                <div class="row-main">
                  <div class="row-title">${te(l.doc.title,n)}</div>
                  <div class="row-desc">${te(l.doc.description,n)}</div>
                  <div class="row-snippet">${te(m,n)}</div>
                </div>
              </a>
            `}).join(""),s=`
        <dialog class="modal" aria-label="Site search">
          ...
          <div class="results" role="listbox">${c}</div>
          <div class="footer">
