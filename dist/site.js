...
`;h(pr,m({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""},type:{type:"string",default:"button"}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-btn-padding-x":"initial","tc-btn-padding-y":"initial"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${ge(e.variant)} s-${ge(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
        <span class="content"><slot></slot></span>`,n=String(e.href??""),o=n.length>0,a=!!(e.disabled||e.loading);if(o){let l=e.target?` target="${ge(e.target)}"`:"",c=e.rel?String(e.rel):String(e.target)==="_blank"?"noopener":"",d=c?` rel="${ge(c)}"`:"",u=a?"":` href="${ge(n)}"`;return`
      <a
        part="button"
        class="${t}"${u}${l}${d}${a?' aria-disabled="true"':""}${a?' tabindex="-1"':""}
        role="button"
      >
        ${r}
      </a>${at}`}let s=String(e.type??"button");return`
      <button
        part="button"
        class="${t}"
        ${a?"disabled":""}
...
`,_e=new WeakMap;h(yr,m({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[m({tag:"style",template:xr}),m({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),m({tag:"div",className:"wrap",children:[m({tag:"table",children:[m({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],n=t;return`<tr>${r.map(o=>{let a=n.sortKey===o.key,s=o.sortable!==!1,i=a?n.sortDir==="asc"?"\u25B2":"\u25BC":"",l=a?n.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        ...
                        class="${s?"sortable":""}"
                        aria-sort="${l}"
                      >${Ee(o.label)}<span class="sort">${i}</span></th>`}).join("")}</tr>`}}),m({tag:"tbody",children:[m({tag:"tr",className:"empty",if:({props:e,state:t})=>it(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${Ee(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>it(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let o=r.props.columns??[],a=e;return m({tag:"tr",attributes:{"data-row-id":String(a.id??t)},template:o.map(s=>`<td>${typeof s.render=="function"?s.render(a):Ee(a[s.key]??"")}</td>`).join("")})}}})]})]}),m({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,n=Se(e,r),o=e.pageSize??10,a=Math.max(1,Math.ceil(n.length/o)),s=Math.min(r.page??0,a-1),i=(e.rows??[]).length;return`
    ...
    `}));function Ir(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Dr(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${jr(t)})`:t}function jr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function qr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Br="tc-grid";h(Br,m({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
      ...
      `}}));function vt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Kr="tc-toc";var Te=new WeakMap;h(Kr,m({props:{target:{type:"string",default:"main"},levels:{type:"string",default:"h2,h3"},sticky:{type:"boolean",default:!0},label:{type:"string",default:"On this page"}},theme:{"tc-toc-fg":"var(--tc-color-ink, #14171f)","tc-toc-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-toc-active":"var(--tc-color-accent, #a16939)","tc-toc-rule":"var(--tc-color-rule, #ece5d3)","tc-toc-label":"var(--tc-color-ink-soft, #4a5061)","tc-toc-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-toc-top":"80px"},styles:{display:"block"},template:({props:e,state:t})=>{let r=t.items??[],n=t.activeId??"";return`
        ...
        >
          ...
          ${r.length===0?'<p class="empty">No sections yet.</p>':`<ol class="list">${r.map(o=>`<li class="lvl-${o.level}${o.id===n?" active":""}"><a href="#${Oe(o.id)}">${Oe(o.text)}</a></li>`).join("")}</ol>`}
        </nav>
        <style>
...
`;h(Zr,m({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],n=!!e.multiple,o=e.searchable!==!1,a=!!e.disabled,s=!!e.error,i=be(e.value),l=String(t.query??""),c=!!t.open&&!a,d=Number(t.focusedIndex??-1),u=yt(r,l),p=new Set(i),g=i.map($=>r.find(O=>O.value===$)).filter($=>!!$),f=o&&(c||n&&i.length===0),b=!n&&i.length===1&&(!c||!o),v=i.length===0&&!f&&!b,x=n?g.map($=>`<span class="chip" data-value="${R($.value)}">
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;P(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;P(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let n=Number(r.dataset.index);if(!Number.isFinite(n))return;let o=t.host;P(o,n)},"keydown .root":(e,t)=>{let r=e,n=t.host,o=n.orientation==="vertical",a=Ce(n),s=o?"ArrowUp":"ArrowLeft",i=o?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),P(n,n.value-1)):r.key===i?(r.preventDefault(),P(n,n.value+1)):r.key==="Home"?(r.preventDefault(),P(n,0)):r.key==="End"&&(r.preventDefault(),P(n,a-1))}},afterMount(){let e=this,t=()=>$t(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let n=e.shadowRoot,o=n?.querySelector("slot"),a=()=>t();o?.addEventListener("slotchange",a),e._carouselSlotObs=()=>{r.disconnect(),o?.removeEventListener("slotchange",a)};let s=()=>Fe(e),i=()=>{e.pauseOnHover&&wt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",i),e.addEventListener("focusin",s),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",s),e.removeEventListener("focusout",i)},rn(e),n?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&wt(e)},afterRender(){$t(this)},unmount(){let e=this;Fe(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function $t(e){let t=Ce(e),r=e.shadowRoot;if(!r)return;let n=r.querySelector(".root");if(n&&t>0){let i=Mt(e.value,t,e.loop);i!==e.value&&(e.value=i),n.style.setProperty("--tc-carousel-index",String(i))}let o=r.querySelector(".indicators");if(o){let i=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===i?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;o.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function rn(e){let t=0,r=0,n=!1,o=40,a=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,n=!0))},s=l=>{if(!n)return;n=!1;let c=l.clientX-t,d=l.clientY-r,p=e.orientation==="vertical"?d:c;Math.abs(p)<o||P(e,e.value+(p<0?1:-1))},i=()=>{n=!1};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",i)}}var K="tc-accordion";h(K,m({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this;nn();let t=a=>{let s=a.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let i of ze(e))i!==s&&i.open&&(i.open=!1);on(e)}},r=a=>{let s=a.target;if(!s||s.tagName!=="SUMMARY")return;let i=ze(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=i.indexOf(s);if(l===-1)return;let c=-1;a.key==="ArrowDown"?c=(l+1)%i.length:a.key==="ArrowUp"?c=(l-1+i.length)%i.length:a.key==="Home"?c=0:a.key==="End"&&(c=i.length-1),c!==-1&&(a.preventDefault(),i[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let n=()=>{for(let a of ze(e)){let s=a.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",s.appendChild(i);let l=()=>{i.style.transform=a.open?"rotate(90deg)":"rotate(0)"};l(),a.addEventListener("toggle",l)}}};n();let o=new MutationObserver(n);o.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),o.disconnect()}},unmount(){this._accordionCleanup?.()}}));var Et="tc-accordion-light-styles";function nn(){if(typeof document>"u"||document.getElementById(Et))return;let e=document.createElement("style");e.id=Et,e.textContent=`
  ...
  `,(document.head||document.documentElement).appendChild(e)}function ze(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function on(e){let t=[];for(let r of ze(e))if(r.open){let n=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(n)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var an="tc-tooltip";function sn(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(an,m({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){Tt(this)},afterMount(){let e=this,t=o=>{!e.open||!e.dismissible||o.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=o=>{!e.open||!e.dismissible||o.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},n=()=>{let o=e.shadowRoot?.querySelector(".panel");o?.matches(":popover-open")&&Lt(e,o)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",n,!0),globalThis.addEventListener("resize",n),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",n,!0),globalThis.removeEventListener("resize",n)},Tt(e)},unmount(){this._popoverCleanup?.()}}));function Tt(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let n=e.open,o=typeof r.showPopover=="function";if(n&&!r.matches(":popover-open")){if(o)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";Lt(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!n&&r.matches(":popover-open"))if(o)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function Lt(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let n=t.getBoundingClientRect(),o=globalThis.innerWidth,a=globalThis.innerHeight,s=e.offset,i=e.placement||"bottom",l=u=>u==="top"?r.top-n.height-s>=4:u==="bottom"?r.bottom+n.height+s<=a-4:u==="left"?r.left-n.width-s>=4:u==="right"?r.right+n.width+s<=o-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"bottom")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-n.height-s,d=r.left+r.width/2-n.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-n.width/2):i==="left"?(c=r.top+r.height/2-n.height/2,d=r.left-n.width-s):i==="right"&&(c=r.top+r.height/2-n.height/2,d=r.right+s),c=Math.max(4,Math.min(a-n.height-4,c)),d=Math.max(4,Math.min(o-n.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var cn="tc-drawer";var le=new WeakMap;function Pe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(cn,m({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Pe(e.size??"min(420px, 92vw)");return`
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Ht(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let n=t.refs.dialog;n&&e.target===n&&Ht(r,"backdrop")}},afterRender(){dn(this)},unmount(){let e=le.get(this);e&&(e.cleanup(),le.delete(this))}}));function dn(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let n=e.open,o=le.get(e);if(o&&o.dialog!==r&&(o.cleanup(),le.delete(e)),n&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!le.has(e)){let a=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",a),le.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",a)})}}else if(!n&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Ht(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var pn="tc-progress";function ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function un(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}h(pn,m({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),n=!!e.indeterminate,o=Number(e.value??0),a=Number(e.max??100),s=un(o,a),i=e.label||(n?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,p=(d-u)/2,g=2*Math.PI*p,f=n?g*.25:s/100*g,b=n?`role="progressbar" aria-valuetext="${ce(i)}"`:`role="progressbar" aria-valuenow="${o}" aria-valuemin="0" aria-valuemax="${a}"`;return`
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,c=n?`role="progressbar" aria-valuetext="${ce(i)}"`:`role="progressbar" aria-valuenow="${o}" aria-valuemin="0" aria-valuemax="${a}"`;return`
...
`;h(Hn,m({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Start writing\u2026"},toolbar:{type:"string",default:qt},readonly:{type:"boolean",default:!1,reflect:!0},minHeight:{type:"string",default:"180px"},maxHeight:{type:"string",default:""},pasteAs:{type:"string",default:"text"}},theme:{"tc-editor-bg":"var(--tc-color-surface, #ffffff)","tc-editor-fg":"var(--tc-color-ink, #14171f)","tc-editor-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-editor-toolbar-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-fg":"var(--tc-color-ink-soft, #4a5061)","tc-editor-toolbar-active-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-editor-toolbar-hover-bg":"rgba(20, 23, 31, 0.06)","tc-editor-placeholder":"var(--tc-color-ink-muted, #6b7280)","tc-editor-radius":"var(--tc-radius-md, 8px)","tc-editor-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-editor-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, 'SF Mono', monospace)","tc-editor-line-height":"1.6"},styles:{display:"block"},template:({props:e})=>{let t=String(e.toolbar??qt),r=!!e.readonly,n=G(String(e.minHeight??"180px")),o=String(e.maxHeight??"").trim(),a=t.split(",").map(c=>c.trim()).filter(Boolean),s=a.map(c=>{if(c==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let d=Cn[c];if(!d)return"";let u=d.shortcut?` (${G(d.shortcut)})`:"";return`<button type="button" class="tb-btn" data-cmd="${G(d.command)}"${d.value?` data-val="${G(d.value)}"`:""} data-key="${G(d.key)}" title="${G(d.label)}${u}" aria-label="${G(d.label)}">${d.icon}</button>`}).join(""),i=a.length===0?"toolbar empty":r?"toolbar readonly":"toolbar";return`
        ...
        ${zn}
      `},afterMount(){Bt(this),Ot(this)},afterRender(){let e=this,r=e.shadowRoot?.querySelector(".surface");if(r){let n=r.innerHTML,o=String(e.value??"");o&&n!==o&&document.activeElement!==e&&(r.innerHTML=o),Ke(r)}Bt(e),Ot(e)},unmount(){this._editorCleanup?.()}}));function Ke(e){let t=e.textContent?.trim()===""&&e.querySelector("img, hr, br")===null;e.dataset.empty=t?"true":"false"}function Bt(e){let t=e;t._editorCleanup?.();let r=t.shadowRoot;if(!r)return;let n=r.querySelector(".surface");if(!n)return;n.dataset.bootstrapped||(t.value&&(n.innerHTML=String(t.value)),n.dataset.bootstrapped="1"),Ke(n);let o=(p,g)=>{if(!t.readonly){if(n.focus(),p==="code"){let b=r.getSelection?.()??globalThis.getSelection();if(!b||b.rangeCount===0)return;let v=b.getRangeAt(0),x=v.extractContents(),y=document.createElement("code");y.className="tc-code-inline",y.appendChild(x),v.insertNode(y),v.selectNodeContents(y),b.removeAllRanges(),b.addRange(v)}else if(p==="link"){let f=globalThis.prompt("URL")?.trim();if(!f)return;document.execCommand("createLink",!1,f)}else if(p==="math"){let f=globalThis.prompt("LaTeX (e.g. E = mc^2). Wrap with $$ for display.")?.trim();if(!f)return;let b=f.startsWith("$$")&&f.endsWith("$$"),v=b?f.replace(/^\$\$|\$\$$/g,"").trim():f;An(t,v,b)}else if(p==="codeblock"){let f=r.getSelection?.()??globalThis.getSelection();if(!f||f.rangeCount===0)return;let b=f.getRangeAt(0),v=b.toString()||"// code",x=document.createElement("pre"),y=document.createElement("code");y.textContent=v,x.appendChild(y),b.deleteContents(),b.insertNode(x);let w=document.createRange();w.selectNodeContents(y),w.collapse(!1),f.removeAllRanges(),f.addRange(w)}else p==="formatBlock"?document.execCommand("formatBlock",!1,`<${g??"p"}>`):document.execCommand(p,!1,g);_t(t,n),Ft(r,n)}},a=p=>{let g=p.target?.closest?.(".tb-btn");if(!g)return;p.preventDefault();let f=g.dataset.cmd;f&&o(f,g.dataset.val)},s=()=>{Ke(n),_t(t,n)},i=()=>{let p=n.innerHTML;t._lastEmitted!==p&&(t._lastEmitted=p,t.dispatchEvent(new CustomEvent("tc-change",{detail:{html:p},bubbles:!0,composed:!0})))},l=p=>{if(t.readonly||t.pasteAs!=="text")return;p.preventDefault();let g=p.clipboardData?.getData("text/plain")??"";document.execCommand("insertText",!1,g)},c=p=>{if(t.readonly||!(p.metaKey||p.ctrlKey))return;let g=p.key.toLowerCase();g==="b"?(p.preventDefault(),o("bold")):g==="i"?(p.preventDefault(),o("italic")):g==="u"?(p.preventDefault(),o("underline")):g==="k"&&(p.preventDefault(),o("link"))},d=()=>{let p=globalThis.getSelection();!p||!p.anchorNode||n.contains(p.anchorNode)&&Ft(r,n)},u=r.querySelector(".toolbar");u?.addEventListener("click",a),n.addEventListener("input",s),n.addEventListener("blur",i),n.addEventListener("paste",l),n.addEventListener("keydown",c),document.addEventListener("selectionchange",d),t._editorCleanup=()=>{u?.removeEventListener("click",a),n.removeEventListener("input",s),n.removeEventListener("blur",i),n.removeEventListener("paste",l),n.removeEventListener("keydown",c),document.removeEventListener("selectionchange",d)}}function _t(e,t){let r=t.innerHTML;e.value=r,e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:r},bubbles:!0,composed:!0}))}function An(e,t,r){let n=e.shadowRoot;if(!n)return;let o=n.querySelector(".surface");if(!o)return;let a=n.getSelection?.()??globalThis.getSelection();if(!a||a.rangeCount===0)return;let s=a.getRangeAt(0),i=document.createElement(r?"div":"span");i.className=r?"tc-math display":"tc-math inline",i.setAttribute("contenteditable","false"),i.dataset.latex=t,i.innerHTML=Pt(e,t,r),s.deleteContents(),s.insertNode(i);let l=document.createTextNode("\u200B");i.parentNode?.insertBefore(l,i.nextSibling);let c=document.createRange();c.setStartAfter(l),c.collapse(!0),a.removeAllRanges(),a.addRange(c),e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:o.innerHTML},bubbles:!0,composed:!0}))}function Pt(e,t,r){if(e.mathRenderer)try{return e.mathRenderer(t,r)}catch{}return`<code class="tc-math-src">${t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code>`}function Ot(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".surface");if(!r)return;r.querySelectorAll(".tc-math").forEach(o=>{let a=o,s=a.dataset.latex??"",i=a.classList.contains("display"),l=`${i?"d":"i"}:${s}`;a.dataset.stamp!==l&&(a.innerHTML=Pt(e,s,i),a.dataset.stamp=l)})}function Ft(e,t){e.querySelectorAll(".tb-btn").forEach(n=>{let o=n,a=o.dataset.cmd??"",s=o.dataset.val,i=!1;try{a==="formatBlock"&&s?i=(document.queryCommandValue("formatBlock")||"").toLowerCase().replace(/^[<]|[>]$/g,"")===s:(a==="bold"||a==="italic"||a==="underline"||a==="strikeThrough"||a==="insertOrderedList"||a==="insertUnorderedList")&&(i=document.queryCommandState(a))}catch{i=!1}o.classList.toggle("is-active",i)})}var Rn="tc-markdown";function E(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Re="\0M\0";function Nn(e,t){let r=[],n=(s,i)=>{let l=r.length;return r.push({latex:s,display:i}),`${Re}${l}${Re}`},o=e;o=o.replace(/\$\$([\s\S]+?)\$\$/g,(s,i)=>n(i.trim(),!0)),o=o.replace(/(^|[\s(])\$([^\$\n][^\$\n]*?)\$(?=[\s.,;:!?)\]]|$)/g,(s,i,l)=>`${i}${n(l.trim(),!1)}`);let a=E(o);return a=a.replace(/`([^`]+)`/g,"<code>$1</code>"),a=a.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),a=a.replace(/(?<!\*)\*([^*\n]+?)\*(?!\*)/g,"<em>$1</em>"),a=a.replace(/\b_(.+?)_\b/g,"<em>$1</em>"),a=a.replace(/~~(.+?)~~/g,"<del>$1</del>"),a=a.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(s,i,l)=>`<img src="${E(l)}" alt="${E(i)}" loading="lazy"/>`),a=a.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(s,i,l)=>`<a href="${E(l)}" target="_blank" rel="noopener">${i}</a>`),a=a.replace(new RegExp(`${Re}(\\d+)${Re}`,"g"),(s,i)=>{let l=r[Number(i)];if(!l)return"";let c=l.latex;if(t)try{let d=t(c,l.display);return l.display?`<div class="tc-md-math display" data-latex="${E(c)}">${d}</div>`:`<span class="tc-md-math inline" data-latex="${E(c)}">${d}</span>`}catch(d){return l.display?`<div class="tc-md-math error" title="${E(String(d))}">${E(c)}</div>`:`<span class="tc-md-math error" title="${E(String(d))}">${E(c)}</span>`}return l.display?`<div class="tc-md-math fallback display" data-latex="${E(c)}"><code>${E(c)}</code></div>`:`<span class="tc-md-math fallback inline" data-latex="${E(c)}"><code>${E(c)}</code></span>`}),a}function In(e){let t=e.match(/^\[([ xX])\]\s+(.*)$/);return t?`<li class="tc-md-task"><input type="checkbox" disabled${t[1].toLowerCase()==="x"?" checked":""}/><span>${t[2]}</span></li>`:""}function Dn(e,t){let r=(a,s,i)=>{let l=i&&i!=="left"?` style="text-align:${i}"`:"";return`<${s}${l}>${a}</${s}>`},n=e[0]?.map((a,s)=>r(a,"th",t[s])).join("")??"",o=e.slice(1).map(a=>`<tr>${a.map((s,i)=>r(s,"td",t[i])).join("")}</tr>`).join("");return`<table class="tc-md-table"><thead><tr>${n}</tr></thead><tbody>${o}</tbody></table>`}function Ye(e,t){let r=t?.mathRenderer,n=t?.highlight,o=e.replace(/\r\n?/g,`
`).split(`
`),a=[],s=0,i=l=>Nn(l,r);for(;s<o.length;){let l=o[s],c=l.match(/^:::\s*([a-zA-Z][\w-]*)(?:\s+(.+))?\s*$/);if(c){let f=c[1].toLowerCase(),b=(c[2]??"").trim(),v=[];for(s++;s<o.length&&!/^:::\s*$/.test(o[s]);)v.push(o[s]),s++;s<o.length&&s++;let x=Ye(v.join(`
`),t);a.push(`<div class="tc-md-callout v-${E(f)}" role="${f==="danger"?"alert":"note"}">${b?`<div class="callout-title">${i(b)}</div>`:""}<div class="callout-body">${x}</div></div>`);continue}let d=l.match(/^```(\S*)\s*$/);if(d){let f=d[1]??"",b=[];for(s++;s<o.length&&!/^```\s*$/.test(o[s]);)b.push(o[s]),s++;s<o.length&&s++;let v=b.join(`
`),x=n&&f?(()=>{try{return n(v,f)}catch{return E(v)}})():E(v),y=f?` class="lang-${E(f)}"`:"";a.push(`<pre><code${y}>${x}</code></pre>`);continue}let u=l.match(/^(#{1,6})\s+(.*)$/);if(u){let f=u[1].length;a.push(`<h${f}>${i(u[2])}</h${f}>`),s++;continue}if(/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(l.trim())){a.push("<hr/>"),s++;continue}if(/^\s*\|.+\|\s*$/.test(l)&&s+1<o.length&&/^\s*\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?\s*$/.test(o[s+1])){let f=l.trim().replace(/^\||\|$/g,"").split("|").map(y=>y.trim()),b=o[s+1].trim().replace(/^\||\|$/g,"").split("|").map(y=>{let w=y.trim(),C=w.startsWith(":"),H=w.endsWith(":");return C&&H?"center":H?"right":C?"left":""}),v=[];for(s+=2;s<o.length&&/^\s*\|.+\|\s*$/.test(o[s]);)v.push(o[s].trim().replace(/^\||\|$/g,"").split("|").map(y=>i(y.trim()))),s++;let x=[f.map(y=>i(y)),...v];a.push(Dn(x,b));continue}if(/^>\s?/.test(l)){let f=[];for(;s<o.length&&/^>\s?/.test(o[s]);)f.push(o[s].replace(/^>\s?/,"")),s++;a.push(`<blockquote>${i(f.join(" "))}</blockquote>`);continue}let p=l.match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(p){let f=!!p[3],b=f?"ol":"ul",v=[],x=!1;for(;s<o.length;){let w=o[s].match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(!w||!!w[3]!==f)break;let H=w[4],j=In(H);j?(x=!0,v.push(j)):v.push(`<li>${i(H)}</li>`),s++}let y=x?' class="tc-md-tasks"':"";a.push(`<${b}${y}>${v.join("")}</${b}>`);continue}if(l.trim()===""){s++;continue}let g=[l];for(s++;s<o.length;){let f=o[s];if(f.trim()===""||/^#{1,6}\s+/.test(f)||/^```/.test(f)||/^>\s?/.test(f)||/^:::/.test(f)||/^(\s*)(?:[-*+]|\d+\.)\s+/.test(f)||/^\s*\|.+\|\s*$/.test(f)||/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(f.trim()))break;g.push(f),s++}a.push(`<p>${i(g.join(" "))}</p>`)}return a.join(`
...
`).map(l=>n+l).join(`
`);return{text:e.slice(0,o)+i+e.slice(a),selStart:o,selEnd:o+i.length}}var Ut={bold:{key:"bold",label:"Bold",shortcut:"\u2318B",apply:(e,t,r)=>Ue(e,t,r,"**","**","bold text")},italic:{key:"italic",label:"Italic",shortcut:"\u2318I",apply:(e,t,r)=>Ue(e,t,r,"*","*","italic text")},heading:{key:"heading",label:"Heading",apply:(e,t,r)=>Ne(e,t,r,"## ")},code:{key:"code",label:"Code",apply:(e,t,r)=>Ue(e,t,r,"`","`","code")},link:{key:"link",label:"Link",shortcut:"\u2318K",apply:(e,t,r)=>{let n=globalThis.prompt?.("URL")?.trim();if(!n)return{text:e,selStart:t,selEnd:r};let o=e.slice(t,r)||"link text";return{text:e.slice(0,t)+`[${o}](${n})`+e.slice(r),selStart:t+1,selEnd:t+1+o.length}}},bullet:{key:"bullet",label:"Bulleted list",apply:(e,t,r)=>Ne(e,t,r,"- ")},ordered:{key:"ordered",label:"Numbered list",apply:(e,t,r)=>Ne(e,t,r,"1. ")},quote:{key:"quote",label:"Quote",apply:(e,t,r)=>Ne(e,t,r,"> ")}},Gt="bold,italic,heading,|,bullet,ordered,quote,|,link,code",jn=`
  <style>
    :host {
      display: block;
...
`;h(Rn,m({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Write some markdown\u2026"},mode:{type:"string",default:"split"},readonly:{type:"boolean",default:!1},minHeight:{type:"string",default:"240px"},toolbar:{type:"string",default:Gt}},theme:{"tc-md-bg":"var(--tc-color-surface, #ffffff)","tc-md-fg":"var(--tc-color-ink, #14171f)","tc-md-rule":"var(--tc-color-rule, #ece5d3)","tc-md-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-md-preview-bg":"var(--tc-color-bg, #faf8f3)","tc-md-radius":"var(--tc-radius-md, 8px)","tc-md-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-md-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)"},styles:{display:"block"},refs:{source:"textarea",preview:".preview"},template:({props:e,state:t})=>{let r=String(t.mode??e.mode??"split"),n=String(e.value??""),o=String(e.toolbar??Gt).split(",").map(p=>p.trim()).filter(Boolean),a=o.map(p=>{if(p==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let g=Ut[p];if(!g||!Vt[g.key])return"";let f=g.shortcut?` (${E(g.shortcut)})`:"";return`<button type="button" class="tb-btn" data-op="${E(g.key)}" title="${E(g.label)}${f}" aria-label="${E(g.label)}">${Vt[g.key]}</button>`}).join(""),s=(p,g)=>`<button type="button" data-mode="${p}" class="${r===p?"is-active":""}" aria-pressed="${r===p?"true":"false"}">${g}</button>`,i=e,c=(i.render??(p=>Ye(p,{mathRenderer:i.mathRenderer,highlight:i.highlight})))(n),d=r==="source"?"panes source-only":r==="preview"?"panes preview-only":"panes";return`
      ...
      `},afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".nav-toggle"),n=t.querySelector(".nav-menu"),o=Array.from(t.querySelectorAll(".nav-group")),a=(p,g)=>{p.classList.toggle("open",g),p.querySelector(".nav-group-trigger")?.setAttribute("aria-expanded",g?"true":"false")},s=p=>{for(let g of o)g!==p&&a(g,!1)},i=()=>{n?.classList.remove("open"),r?.setAttribute("aria-expanded","false"),r?.setAttribute("aria-label","Open menu")},l=p=>{p.preventDefault();let g=!n?.classList.contains("open");n?.classList.toggle("open",g),r?.setAttribute("aria-expanded",g?"true":"false"),r?.setAttribute("aria-label",g?"Close menu":"Open menu")};r?.addEventListener("click",l);let c=[];for(let p of o){let g=p.querySelector(".nav-group-trigger");if(!g)continue;let f=b=>{b.preventDefault();let v=!p.classList.contains("open");s(p),a(p,v)};g.addEventListener("click",f),c.push([g,f])}let d=p=>{let g=p.composedPath();for(let f of o)g.includes(f)||a(f,!1);n&&!g.includes(n)&&!(r&&g.includes(r))&&i()},u=p=>{p.key==="Escape"&&(s(),n?.classList.contains("open")&&(i(),r?.focus()))};document.addEventListener("click",d),document.addEventListener("keydown",u),e._navCleanup=()=>{r?.removeEventListener("click",l);for(let[p,g]of c)p.removeEventListener("click",g);document.removeEventListener("click",d),document.removeEventListener("keydown",u)}},unmount(){this._navCleanup?.()}}));function ke(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Fn="site-footer";h(Fn,m({props:{base:{type:"string",default:""},year:{type:"string",default:"2026"}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??"");return`
        <footer class="foot">
          <div class="inner">
      ...
      `}}));function de(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Pn="site-search";var Y=null,De=null;function je(e){if(Y)return Promise.resolve(Y);if(De)return De;let t=`${e}search.json`;return De=fetch(t).then(r=>r.json()).then(r=>(Y=r.docs??[],Y)).catch(r=>(console.warn("[site-search] failed to load index:",r),Y=[],Y)),De}function Wt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Yt(e,t){let r=e.trim().toLowerCase();if(!r)return[];let n=r.split(/\s+/).filter(Boolean).map(a=>({raw:a,re:new RegExp(Wt(a),"i")})),o=[];for(let a of t){let s=a.title.toLowerCase(),i=(a.description??"").toLowerCase(),l=(a.text??"").toLowerCase(),c=0;for(let u of n){let p=u.raw;s===p&&(c+=50),s.startsWith(p)&&(c+=20),s.includes(p)&&(c+=10),i.includes(p)&&(c+=5),l.includes(p)&&(c+=1)}n.every(u=>u.re.test(a.title)||u.re.test(i)||u.re.test(l))&&c!==0&&(a.category==="blog"&&a.date&&(Date.now()-new Date(a.date).getTime())/864e5<30&&(c+=3),o.push({doc:a,score:c}))}return o.sort((a,s)=>s.score-a.score),o.slice(0,12)}function Vn(e,t,r=140){let n=e.trim().toLowerCase().split(/\s+/)[0];if(!n)return t.slice(0,r);let a=t.toLowerCase().indexOf(n);if(a===-1)return t.slice(0,r);let s=Math.max(0,a-40),i=Math.min(t.length,s+r),l=s>0?"\u2026 ":"",c=i<t.length?" \u2026":"";return l+t.slice(s,i)+c}function W(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Xe(e,t){let r=t.trim();if(!r)return W(e);let n=r.split(/\s+/).filter(Boolean),o=W(e);for(let a of n){let s=new RegExp(`(${Wt(W(a))})`,"gi");o=o.replace(s,"<mark>$1</mark>")}return o}function Gn(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var Kn=`
        <style>
          :host { display: inline-block; }
...
`;h(Pn,m({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),n=String(t.query??""),o=Number(t.focusIdx??0),a=t.results??[],s=`
      ...
      `,i=n.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':a.length===0?`<div class="empty">No results for "${W(n)}". Try a shorter query.</div>`:a.map((c,d)=>{let u=d===o?"row focused":"row",p=r+c.doc.url.replace(/^\//,""),g=Vn(n,c.doc.text);return`
