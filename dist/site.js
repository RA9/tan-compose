...
`,je=!1;function Yt(){if(typeof document>"u"||je)return;if(document.querySelector("style[data-tc-tokens]")){je=!0;return}let e=document.createElement("style");e.setAttribute("data-tc-tokens",""),e.textContent=Ut,document.head.insertBefore(e,document.head.firstChild),je=!0}Yt();var Wt=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],Xt=new Set(["string","number","boolean","json"]);function f(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Wt){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,o]of Object.entries(t)){if(o===null||typeof o!="object"||Array.isArray(o))throw new TypeError(`describe(): props.${r} must be a record`);if(!Xt.has(o.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Je=new Map,Jt=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,Zt=/^(\S+)(?:\s+(.+))?$/;function g(e,t){if(typeof e!="string"||!Jt.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Je.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),o=t.props??{},n=t.refs??{},a=tr(t);class s extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let l=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),rr(l,a),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",l.appendChild(this.container),t.attributes&&rt(this,t.attributes),this.ctx=er(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[l,c]of Object.entries(o)){let d=this.getAttribute(l),u=d!==null?Ze(d,c.type):c.default;this.propValues.set(l,u),this.maybeSyncFormValue(l,u),Object.defineProperty(this,l,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(l),set:p=>{let m=ar(p,c.type),b=this.propValues.get(l);Object.is(b,m)||(this.propValues.set(l,m),c.reflect&&sr(this,l,m,c.type),this.maybeSyncFormValue(l,m),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(l,c){if(!this.internals||l!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(l){console.error(`[tan-compose] beforeMount threw for <${e}>:`,l)}if(this.renderInternal(),t.action){let l=t.action;this.addEventListener("click",l),this.mountCleanups.push(()=>this.removeEventListener("click",l))}if(t.emit)for(let l of t.emit)this.addEventListener(l.name,l.handler),this.mountCleanups.push(()=>this.removeEventListener(l.name,l.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(l){console.error(`[tan-compose] afterMount threw for <${e}>:`,l)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(l){console.error(`[tan-compose] unmount threw for <${e}>:`,l)}ee(this.mountCleanups),ee(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){tt(t,l=>{let c=this.listSlots.get(l);if(c){for(let d of c.cache.values())ee(d.cleanups);c.cache.clear()}})}attributeChangedCallback(l,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(o,l)){let u=o[l],p=d!==null?Ze(d,u.type):u.default,m=this.propValues.get(l);Object.is(m,p)||(this.propValues.set(l,p),this.isMounted&&this.scheduleRender());return}this.state.set(l,d),this.isMounted&&this.scheduleRender()}}setState(l,c){let d=this.state.get(l);Object.is(d,c)||(this.state.set(l,c),this.isMounted&&this.scheduleRender())}getState(l){return this.state.get(l)}render(){this.renderInternal()}emitEvent(l,c){this.dispatchEvent(new CustomEvent(l,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(l){let c=this.listSlots.get(l);return c||(c={cache:new Map},this.listSlots.set(l,c)),c}renderInternal(){this.rendering=!0;let l=this.captureFocusInShadow();try{ee(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let u=Qe(d,c,p=>this.getOrCreateSlot(p));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(l&&this.restoreFocusInShadow(l),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let l=this.shadowRoot;if(!l)return null;let c=l.activeElement;if(!c)return null;let d=[],u=c;for(;u&&u!==l;){let b=u.parentNode;if(!b)break;let h=u.tagName,w=Array.from(b.children).filter(x=>x.tagName===h).indexOf(u);if(d.unshift({tag:h,idx:w}),u=b instanceof Element?b:null,!u&&b===l)break}let p=null,m=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{p=c.selectionStart,m=c.selectionEnd}catch{}return{path:d,selectionStart:p,selectionEnd:m}}restoreFocusInShadow(l){let c=this.shadowRoot;if(!c)return;let d=c;for(let p of l.path){let m=Array.from(d.children??[]),v=(m.length>0?m:Array.from(d.children??[])).filter(w=>w.tagName===p.tag)[p.idx];if(!v)return;d=v}let u=d;if(!(!u||typeof u.focus!="function")&&c.activeElement!==u&&(u.focus(),l.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(l.selectionStart,l.selectionEnd??l.selectionStart)}catch{}}refreshRefs(){let l={},c=this.shadowRoot;for(let[d,u]of Object.entries(n))l[d]=c?c.querySelector(u):null;this.currentRefs=l}formAssociatedCallback(l){try{t.formAssociatedCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(l){try{t.formDisabledCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(l){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,l)}}formStateRestoreCallback(l,c){try{t.formStateRestoreCallback?.call(this,l,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(l){let c=new Map;for(let[d,u]of Object.entries(l)){let p=Zt.exec(d.trim());if(!p)continue;let[,m,b]=p;c.has(m)||c.set(m,[]),c.get(m).push({selector:b??null,handler:u})}for(let[d,u]of c){let p=m=>{for(let{selector:b,handler:h}of u){if(!b){h(m,this.ctx);continue}let v=m.composedPath();for(let w of v){if(w===this.shadowRoot||w===this)break;if(w instanceof Element&&this.shadowRoot?.contains(w)&&w.matches(b)){h(m,this.ctx);break}}}};this.shadowRoot.addEventListener(d,p),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,p))}}}return Je.set(e,s),customElements.define(e,s),e}function Qe(e,t,r){return e.if&&!e.if(t.ctx)?null:et(e,t,r)}function et(e,t,r){let o=document.createElement(e.tag||"div");if(e.styles&&(o.style.cssText=Object.entries(e.styles).map(([n,a])=>`${n}: ${a}`).join("; ")),e.className&&(o.className=e.className),e.attributes&&rt(o,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(o.innerHTML=n)}if(e.children)for(let n of e.children){let a=Qe(n,t,r);a&&o.appendChild(a)}if(e.for&&Qt(o,e,t,r),e.action){let n=e.action;o.addEventListener("click",n),t.cleanups.push(()=>o.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)o.addEventListener(n.name,n.handler),t.cleanups.push(()=>o.removeEventListener(n.name,n.handler));return o}function Qt(e,t,r,o){let n=t.for,a=o(t),s=n.items(r.ctx),i=new Map;for(let l=0;l<s.length;l++){let c=s[l],d=n.key(c,l),u,p=a.cache.get(d);if(p&&Object.is(p.lastItem,c))u=p;else{let m=[],b=n.render(c,l,r.ctx),h=et(b,{...r,cleanups:m},o);p&&ee(p.cleanups),u={element:h,lastItem:c,cleanups:m}}i.set(d,u),e.appendChild(u.element)}for(let[l,c]of a.cache)i.has(l)||ee(c.cleanups);a.cache=i}function tt(e,t){if(e.for&&t(e),e.children)for(let r of e.children)tt(r,t)}function er(e,t,r,o){return{host:e,get props(){let n={};for(let[a,s]of t)n[a]=s;return n},get state(){let n={};for(let[a,s]of r)n[a]=s;return n},get refs(){return o()},setState:(n,a)=>e.setState(n,a),getState:n=>e.getState(n),emit:(n,a)=>e.emitEvent(n,a)}}function tr(e){let t=e.theme?or(e.theme):void 0,r=e.styles?nr(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let a=new CSSStyleSheet;a.replaceSync(t),n.push(a)}if(r){let a=new CSSStyleSheet;a.replaceSync(r),n.push(a)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function rr(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function rt(e,t){for(let[r,o]of Object.entries(t))e.setAttribute(r,o)}function or(e){return`:host { ${Object.entries(e).map(([r,o])=>`--${r}: ${o};`).join(" ")} }`}function nr(e){return`.container { ${Object.entries(e).map(([r,o])=>`${r}: ${o};`).join(" ")} }`}function ee(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function Ze(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function ar(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function sr(e,t,r,o){if(o!=="json"){if(o==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var ir="tc-button";var ot=`
      <style>
        .root {
...
`;g(ir,f({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${fe(e.variant)} s-${fe(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
        <span class="content"><slot></slot></span>`,o=String(e.href??""),n=o.length>0,a=!!(e.disabled||e.loading);if(n){let s=e.target?` target="${fe(e.target)}"`:"",i=e.rel?String(e.rel):String(e.target)==="_blank"?"noopener":"",l=i?` rel="${fe(i)}"`:"",c=a?"":` href="${fe(o)}"`;return`
      <a
        part="button"
        class="${t}"${c}${s}${l}${a?' aria-disabled="true"':""}${a?' tabindex="-1"':""}
        role="button"
      >
        ${r}
      </a>${ot}`}return`
      ...
      `},events:{"input textarea":(e,t)=>{let r=e.target.value,o=t.host;o.internals?.setFormValue(r),o.value=r,t.emit("tc-input",{value:r})}},formResetCallback(){this.value=""}}));function J(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var dr="tc-select";g(dr,f({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.options??[],r=!!e.error;return`
        ...
        <div class="wrap">
          ...
          >
            ...
            ${t.map(o=>`<option value="${re(o.value)}"${o.disabled?" disabled":""}${o.value===e.value?" selected":""}>${re(o.label)}</option>`).join("")}
          </select>
      ...
      `},refs:{input:".cb"},events:{"change .cb":(e,t)=>{let r=e.target.checked,o=t.host;o.checked=r,o.internals?.setFormValue(r?o.value:null),t.emit("tc-change",{checked:r})}},afterMount(){let e=this,r=e.shadowRoot?.querySelector(".cb");r&&(r.indeterminate=e.indeterminate),e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function $e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var pr="tc-switch";g(pr,f({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-switch-track-off":"var(--tc-color-rule-strong, #d9cfb8)","tc-switch-track-on":"var(--tc-color-accent, #a16939)","tc-switch-thumb":"var(--tc-color-surface, #ffffff)","tc-switch-fg":"var(--tc-color-ink, #14171f)","tc-switch-helper":"var(--tc-color-ink-muted, #6b7280)","tc-switch-error":"var(--tc-color-danger, #b3261e)","tc-switch-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.error;return`
        <label class="row ${e.disabled?"is-disabled":""}">
          ...
          ${e.label?`<span class="label">${nt(e.label)}</span>`:""}
        </label>
        ${e.error||e.helper?`<div class="${t?"error":"helper"}">${nt(e.error||e.helper)}</div>`:""}
        <style>
      ...
      `},events:{"click .track":(e,t)=>{let r=t.host;r.disabled||(r.checked=!r.checked,r.internals?.setFormValue(r.checked?r.value:null),t.emit("tc-change",{checked:r.checked}))},"keydown .track":(e,t)=>{let r=e;if(r.key!==" "&&r.key!=="Enter")return;r.preventDefault();let o=t.host;o.disabled||(o.checked=!o.checked,o.internals?.setFormValue(o.checked?o.value:null),t.emit("tc-change",{checked:o.checked}))}},afterMount(){let e=this;e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function nt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var fr="tc-file";g(fr,f({formAssociated:!0,props:{name:{type:"string",default:""},accept:{type:"string",default:""},multiple:{type:"boolean",default:!1,reflect:!0},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},buttonText:{type:"string",default:"Choose file"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-file-zone-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-file-zone-fg":"var(--tc-color-ink-soft, #4a5061)"},styles:{display:"block"},refs:{input:"input[type='file']"},template:({props:e,state:t})=>{let r=!!e.error,o=t.files??[],n=o.length===0?"No file selected":o.length===1?oe(o[0].name):`${o.length} files selected`;return`
      ...
      `},events:{"click .btn":(e,t)=>{t.refs.input?.click()},"change input[type='file']":(e,t)=>{let r=e.target,o=Array.from(r.files??[]);t.setState("files",o);let n=t.host;if(n.internals)if(o.length===0)n.internals.setFormValue(null);else if(o.length===1)n.internals.setFormValue(o[0]);else{let a=new FormData,s=n.name;for(let i of o)a.append(s,i);n.internals.setFormValue(a)}t.emit("tc-files",{files:o})}},formResetCallback(){let t=this.shadowRoot?.querySelector(".native");t&&(t.value=""),this.setState("files",[])}}));function oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var gr="tc-radio-group";g(gr,f({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},layout:{type:"string",default:"vertical"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-radio-accent":"var(--tc-color-accent, #a16939)"},styles:{display:"block"},template:({props:e})=>{let t=e.options??[],r=!!e.error,o=String(e.layout??"vertical");return`
        <fieldset class="group" ${e.disabled?"disabled":""}>
          ...
          <div class="opts l-${ne(o)}" role="radiogroup" aria-invalid="${r?"true":"false"}">
            ${t.map((n,a)=>`<label class="opt ${n.disabled?"is-disabled":""}">
                  <input
                    type="radio"
                    class="r"
                    name="${ne(e.name)||`__rg_${a}__`}"
                    value="${ne(n.value)}"
      ...
      `},events:{"change input.r":(e,t)=>{let r=e.target.value,o=t.host;o.value=r,o.internals?.setFormValue(r),t.emit("tc-change",{value:r})}},afterMount(){let e=this;e.value&&e.internals?.setFormValue(e.value)},formResetCallback(){this.value=""}}));function ne(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var mr="tc-table";var br=`
...
`,Be=new WeakMap;g(mr,f({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[f({tag:"style",template:br}),f({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),f({tag:"div",className:"wrap",children:[f({tag:"table",children:[f({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],o=t;return`<tr>${r.map(n=>{let a=o.sortKey===n.key,s=n.sortable!==!1,i=a?o.sortDir==="asc"?"\u25B2":"\u25BC":"",l=a?o.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${Ee(n.key)}"
                        class="${s?"sortable":""}"
                        aria-sort="${l}"
                      >${Ee(n.label)}<span class="sort">${i}</span></th>`}).join("")}</tr>`}}),f({tag:"tbody",children:[f({tag:"tr",className:"empty",if:({props:e,state:t})=>at(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${Ee(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>at(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],a=e;return f({tag:"tr",attributes:{"data-row-id":String(a.id??t)},template:n.map(s=>`<td>${typeof s.render=="function"?s.render(a):Ee(a[s.key]??"")}</td>`).join("")})}}})]})]}),f({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,o=Se(e,r),n=e.pageSize??10,a=Math.max(1,Math.ceil(o.length/n)),s=Math.min(r.page??0,a-1),i=(e.rows??[]).length;return`
            <span class="count">${o.length} of ${i} rows</span>
          ...
          `}})],refs:{filter:".filter"},afterRender(){let e=this,t=e.refs.filter;if(!t)return;let r=e.getState("q")??"";t.value!==r&&(t.value=r);let o=Be.get(e);if(o){Be.delete(e),t.focus();let n=Math.min(o.caret,t.value.length);try{t.setSelectionRange(n,n)}catch{}}},events:{"input .filter":(e,t)=>{let r=e.target;Be.set(t.host,{caret:r.selectionStart??r.value.length}),t.setState("q",r.value),t.setState("page",0)},"click .prev":(e,t)=>{let r=(t.state.page??0)-1;t.setState("page",Math.max(0,r))},"click .next":(e,t)=>{let r=t.state,o=Se(t.props,r).length,n=t.props.pageSize??10,a=Math.max(0,Math.ceil(o/n)-1),s=(r.page??0)+1;t.setState("page",Math.min(a,s))},"click th.sortable":(e,t)=>{let r=e.target.closest("th");if(!r)return;let o=r.dataset.col;if(!o)return;let n=t.state,a;n.sortKey!==o?a="asc":a=n.sortDir==="asc"?"desc":n.sortDir==="desc"?null:"asc",t.setState("sortKey",a?o:null),t.setState("sortDir",a),t.emit("tc-sort-change",{key:a?o:null,direction:a})},"click tr[data-row-id]":(e,t)=>{let r=e.target.closest("tr[data-row-id]");if(!r)return;let o=r.dataset.rowId;if(o===void 0)return;let n=Se(t.props,t.state),a=n.find(s=>String(s.id)===o)??n[Number(o)];a&&t.emit("tc-row-click",{row:a})}}}));function Se(e,t){let r=e.rows??[],o=e.columns??[],n=(t.q??"").trim().toLowerCase(),a=n.length===0?r.slice():r.filter(s=>o.some(i=>String(s[i.key]??"").toLowerCase().includes(n)));if(t.sortKey&&t.sortDir){let s=t.sortKey,i=t.sortDir==="asc"?1:-1;a=a.slice().sort((l,c)=>{let d=l[s],u=c[s];return d===u?0:d==null?1:u==null?-1:typeof d=="number"&&typeof u=="number"?(d-u)*i:String(d).localeCompare(String(u))*i})}return a}function at(e,t){let r=e.pageSize??10,o=Se(e,t),n=Math.max(1,Math.ceil(o.length/r)),a=Math.min(t.page??0,n-1);return o.slice(a*r,a*r+r)}function Ee(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var hr="tc-tabs";g(hr,f({props:{tabs:{type:"json",default:[]},active:{type:"string",default:"",reflect:!0}},theme:{"tc-tabs-fg":"var(--tc-color-ink, #14171f)","tc-tabs-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-tabs-rule":"var(--tc-color-rule, #ece5d3)","tc-tabs-accent":"var(--tc-color-accent, #a16939)","tc-tabs-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block","font-family":"var(--tc-tabs-font)"},template:({props:e})=>{let t=e.tabs??[],r=e.active||t[0]?.id||"";return`
        <div role="tablist" class="strip">
          ${t.map(o=>`<button
              role="tab"
              type="button"
              class="tab ${o.id===r?"active":""}"
              data-tab="${ge(o.id)}"
              aria-selected="${o.id===r?"true":"false"}"
              aria-controls="panel-${ge(o.id)}"
              tabindex="${o.id===r?"0":"-1"}"
            >${ge(o.label)}</button>`).join("")}
        </div>
        <div class="panels">
          ${t.map(o=>`<section
              role="tabpanel"
              ...
              aria-labelledby=""
              ${o.id===r?"":"hidden"}
            ><slot name="${ge(o.id)}"></slot></section>`).join("")}
        </div>
        <style>
          .strip {
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{st(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let o=t.refs.dialog;o&&e.target===o&&st(r,"backdrop")}},afterRender(){yr(this)},unmount(){let e=ae.get(this);e&&(e.cleanup(),ae.delete(this))}}));function yr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let o=e.open,n=ae.get(e);if(n&&n.dialog!==r&&(n.cleanup(),ae.delete(e)),o&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!ae.has(e)){let a=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",a),ae.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",a)})}}else if(!o&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function st(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function it(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var xr="tc-toast";var me=new WeakMap;g(xr,f({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
        <div class="toast v-${lt(t)} ${e.open?"open":"closed"}" role="status" aria-live="polite">
          <span class="icon" aria-hidden="true">${r}</span>
          <span class="msg">${e.message?lt(e.message):"<slot></slot>"}</span>
      ...
      `}}));function se(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var $r="tc-card";g($r,f({props:{title:{type:"string",default:""},subtitle:{type:"string",default:""},padded:{type:"boolean",default:!0},bordered:{type:"boolean",default:!0},elevated:{type:"boolean",default:!1},size:{type:"string",default:"md"}},theme:{"tc-card-surface":"var(--tc-color-surface, #ffffff)","tc-card-ink":"var(--tc-color-ink, #14171f)","tc-card-soft":"var(--tc-color-ink-soft, #5a6072)","tc-card-rule":"var(--tc-color-rule, #ece5d3)","tc-card-radius":"var(--tc-radius-lg, 12px)","tc-card-shadow":"var(--tc-shadow-md, 0 8px 24px rgba(20, 23, 31, 0.06))","tc-card-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-card-padding-x":"var(--tc-space-5, 20px)","tc-card-padding-y":"var(--tc-space-5, 20px)","tc-card-gap":"var(--tc-space-3, 12px)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.title||!!e.subtitle,r=String(e.size??"md").toLowerCase();return`
        <div class="${["card",`size-${["sm","md","lg"].includes(r)?r:"md"}`,e.bordered?"bordered":"",e.elevated?"elevated":"",e.padded===!1?"nopad":"",t?"has-header":""].filter(Boolean).join(" ")}">
          ...
          <div class="head">
            <slot name="header">
              ${e.title?`<div class="title">${dt(e.title)}</div>`:""}
              ${e.subtitle?`<div class="subtitle">${dt(e.subtitle)}</div>`:""}
            </slot>
          </div>
          <div class="body"><slot></slot></div>
    ...
    `}));function pt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mr="tc-stack";g(Mr,f({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${Tr(e.gap)}; --tc-stack-align: ${Hr(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function Tr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Lr(t)})`:t}function Lr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Hr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Cr="tc-cluster";g(Cr,f({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${Ar(e.gap)};
        --tc-cluster-justify: ${zr(e.justify)};
        --tc-cluster-align: ${Nr(e.align)};
    ...
    `}));function zr(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Ar(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Rr(t)})`:t}function Rr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function Nr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ir="tc-grid";g(Ir,f({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${ft(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${ft(e.min)}, 1fr))`};
          --tc-grid-gap: ${Dr(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `}}));function Dr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${qr(t)})`:t}function qr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function ft(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var jr="tc-code";var Br='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>',Or='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>';g(jr,f({props:{language:{type:"string",default:""},copy:{type:"boolean",default:!1},filename:{type:"string",default:""}},theme:{"tc-code-bg":"var(--tc-code-bg-base, #14171f)","tc-code-ink":"var(--tc-code-ink-base, #efe6d4)","tc-code-rule":"var(--tc-code-rule-base, rgba(255,255,255,0.08))","tc-code-label":"var(--tc-code-label-base, #8a8678)","tc-code-radius":"var(--tc-radius-md, 10px)","tc-code-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)","tc-code-padding":"var(--tc-space-5, 20px) var(--tc-space-5, 20px)","tc-code-kw":"var(--tc-code-kw-base, #f0a878)","tc-code-str":"var(--tc-code-str-base, #d9b380)","tc-code-com":"var(--tc-code-com-base, #8a8678)","tc-code-num":"var(--tc-code-num-base, #c4d3b8)","tc-code-tag":"var(--tc-code-tag-base, #d49a68)"},styles:{display:"block"},template:({props:e,state:t})=>{let r=e.filename||e.language||"",o=t.copied===!0;return`
        <div class="block">
          ${r||e.copy?`
            <header class="bar">
              <span class="label">${gt(r)}</span>
              ${e.copy?`<button type="button" class="copy" aria-label="Copy code">
                    <span class="copy-icon" aria-hidden="true">${o?Or:Br}</span>
                    <span class="copy-text">${o?"Copied":"Copy"}</span>
                  </button>`:""}
            </header>
          `:""}
          <pre><code class="code lang-${gt(String(e.language||"txt"))}"><slot></slot></code></pre>
        </div>
        <style>
          :host { display: block; }
          .block {
      ...
      `},events:{"click .copy":(e,t)=>{let r=t.host,o=r.shadowRoot?.querySelector("slot"),a=(o?o.assignedNodes({flatten:!0}):Array.from(r.childNodes)).map(i=>i.textContent??"").join(""),s=()=>{t.setState("copied",!0),t.emit("tc-copy",{text:a}),setTimeout(()=>t.setState("copied",!1),1600)};navigator.clipboard?.writeText?navigator.clipboard.writeText(a).then(s,s):s()}}}));function gt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var _r="tc-callout";var mt={note:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>'};g(_r,f({props:{variant:{type:"string",default:"note"},title:{type:"string",default:""},compact:{type:"boolean",default:!1}},theme:{"tc-callout-radius":"var(--tc-radius-md, 8px)","tc-callout-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-callout-note-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-callout-note-fg":"var(--tc-color-ink-soft, #4a5061)","tc-callout-note-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-callout-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-callout-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-callout-info-border":"var(--tc-color-info, #3a5b8c)","tc-callout-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-callout-success-fg":"var(--tc-color-success-fg, #155b40)","tc-callout-success-border":"var(--tc-color-success, #207a5b)","tc-callout-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-callout-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-callout-warning-border":"var(--tc-color-warning, #a87326)","tc-callout-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-callout-danger-fg":"var(--tc-color-danger-fg, #7a1a14)","tc-callout-danger-border":"var(--tc-color-danger, #b3261e)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"note"),r=mt[t]??mt.note;return`
        <aside
      ...
      `}}));function bt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Fr="tc-toc";var Me=new WeakMap;g(Fr,f({props:{target:{type:"string",default:"main"},levels:{type:"string",default:"h2,h3"},sticky:{type:"boolean",default:!0},label:{type:"string",default:"On this page"}},theme:{"tc-toc-fg":"var(--tc-color-ink, #14171f)","tc-toc-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-toc-active":"var(--tc-color-accent, #a16939)","tc-toc-rule":"var(--tc-color-rule, #ece5d3)","tc-toc-label":"var(--tc-color-ink-soft, #4a5061)","tc-toc-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-toc-top":"80px"},styles:{display:"block"},template:({props:e,state:t})=>{let r=t.items??[],o=t.activeId??"";return`
        <nav
          class="toc${e.sticky?" sticky":""}"
          aria-label="Table of contents"
        >
          ${e.label?`<div class="label">${Oe(e.label)}</div>`:""}
          ${r.length===0?'<p class="empty">No sections yet.</p>':`<ol class="list">${r.map(n=>`<li class="lvl-${n.level}${n.id===o?" active":""}"><a href="#${Oe(n.id)}">${Oe(n.text)}</a></li>`).join("")}</ol>`}
        </nav>
        <style>
      ...
      `},afterMount(){Pr(this)},unmount(){Me.get(this)?.observer?.disconnect(),Me.delete(this)}}));function Pr(e){Me.get(e)?.observer?.disconnect();let r=e,o=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),a=document.querySelector(o);if(!a)return;let s=Array.from(a.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),i=s.map(c=>(c.id||(c.id=Vr(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",i),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(c=>{let u=c.filter(m=>m.isIntersecting).sort((m,b)=>m.boundingClientRect.top-b.boundingClientRect.top)[0];if(!u)return;let p=u.target.id;p&&e.setState("activeId",p)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of s)l.observe(c);Me.set(e,{observer:l,activeId:""})}function Vr(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Gr="tc-pagination";g(Gr,f({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=Kr(Number(e.current)|0,1,t),o=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let a=Ur(r,t,o,n),s=Te(String(e.size??"sm")),i=r<=1?" disabled":"",l=r>=t?" disabled":"",c=a.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${s}"
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let o=r.getAttribute("data-page");if(o==null)return;let n=Number(o),a=t.host,s=Math.max(1,Number(a.total)|0),i=Number(a.current)|0;!Number.isFinite(n)||n<1||n>s||n!==i&&t.emit("tc-page-change",{page:n})}}}));function Kr(e,t,r){return Math.min(r,Math.max(t,e))}function Ur(e,t,r,o){let n=new Set;for(let i=1;i<=Math.min(o,t);i++)n.add(i);for(let i=Math.max(1,t-o+1);i<=t;i++)n.add(i);for(let i=Math.max(1,e-r);i<=Math.min(t,e+r);i++)n.add(i);let a=[...n].sort((i,l)=>i-l),s=[];for(let i=0;i<a.length;i++)i>0&&a[i]-a[i-1]>1&&s.push("\u2026"),s.push(a[i]);return s}function Te(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Yr="tc-combobox";function be(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function he(e){return e.join(",")}function Wr(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var Xr=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;g(Yr,f({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],o=!!e.multiple,n=e.searchable!==!1,a=!!e.disabled,s=!!e.error,i=be(e.value),l=String(t.query??""),c=!!t.open&&!a,d=Number(t.focusedIndex??-1),u=ht(r,l),p=new Set(i),m=i.map(k=>r.find(_=>_.value===k)).filter(k=>!!k),b=n&&(c||o&&i.length===0),h=!o&&i.length===1&&(!c||!n),v=i.length===0&&!b&&!h,w=o?m.map(k=>`<span class="chip" data-value="${H(k.value)}">
              ${k.icon?`<span class="chip-icon">${H(k.icon)}</span>`:""}
              <span class="chip-label">${H(k.label)}</span>
              <button
                type="button"
                class="chip-remove"
                data-remove="${H(k.value)}"
                aria-label="Remove ${H(k.label)}"
                ${a?"disabled":""}
              >&times;</button>
            </span>`).join(""):"",x=h&&m[0]?`<span class="single">
            ${m[0].icon?`<span class="single-icon">${H(m[0].icon)}</span>`:""}
            <span class="single-label">${H(m[0].label)}</span>
          </span>`:"",T=v?`<span class="placeholder">${H(e.placeholder??"")}</span>`:"",R=b?`<input
            type="text"
            class="search"
            part="search"
            value="${H(l)}"
            ...
            role="combobox"
          />`:"",I=u.length===0?`<div class="empty">${H(e["empty-text"]??"No results")}</div>`:u.map((k,_)=>{let C=p.has(k.value);return`<div
              class="${["option",C?"selected":"",_===d?"focused":"",k.disabled?"disabled":""].filter(Boolean).join(" ")}"
              role="option"
              data-value="${H(k.value)}"
              data-index="${_}"
              aria-selected="${C?"true":"false"}"
              ${k.disabled?'aria-disabled="true"':""}
            >
              ${o?`<span class="check" aria-hidden="true">${C?"\u2713":""}</span>`:""}
              ${k.icon?`<span class="opt-icon">${H(k.icon)}</span>`:""}
              <span class="opt-label">${H(k.label)}</span>
            </div>`}).join(""),B=e.label?`<label class="label">${H(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",de=s?`<div class="helper error">${H(e.error)}</div>`:e.helper?`<div class="helper">${H(e.helper)}</div>`:"";return`
        ${B}
        <div
          class="control ${s?"invalid":""} ${c?"open":""} ${a?"disabled":""}"
          part="control"
          tabindex="${a?"-1":"0"}"
        ...
        ${de}
        ${Xr}
      `},events:{"click .control":(e,t)=>{if(e.target.closest(".chip-remove")||t.host.disabled)return;let n=!!t.getState("open");t.setState("open",!0),n||t.emit("tc-open"),t.refs.search?.focus()},"keydown .control":(e,t)=>{let r=e;if(r.key==="Enter"||r.key===" "){if(r.preventDefault(),t.host.disabled)return;t.setState("open",!0),t.emit("tc-open"),t.refs.search?.focus()}},"input .search":(e,t)=>{let r=e.target.value;t.setState("query",r),t.setState("open",!0),t.setState("focusedIndex",0),t.emit("tc-search",{query:r})},"keydown .search":(e,t)=>{let r=e,o=e.target,n=t.host,a=!!n.multiple,s=n.options??[],i=ht(s,String(t.getState("query")??""));if(r.key==="Backspace"&&o.value===""&&a){let l=be(n.value);l.length>0&&(l.pop(),n.value=he(l),Le(t,l,n),t.emit("tc-change",{value:l.slice()}),r.preventDefault());return}if(r.key==="ArrowDown"){r.preventDefault(),t.setState("open",!0);let l=Number(t.getState("focusedIndex")??-1),c=Math.min(i.length-1,l+1);t.setState("focusedIndex",c);return}if(r.key==="ArrowUp"){r.preventDefault();let l=Number(t.getState("focusedIndex")??0),c=Math.max(0,l-1);t.setState("focusedIndex",c);return}if(r.key==="Enter"){r.preventDefault();let l=Number(t.getState("focusedIndex")??-1);l>=0&&l<i.length&&vt(t,i[l],n);return}if(r.key==="Escape"){r.preventDefault(),t.setState("open",!1),t.setState("query",""),t.emit("tc-close");return}},"mousedown .option":(e,t)=>{e.preventDefault();let r=e.target.closest(".option");if(!r||r.classList.contains("disabled"))return;let o=r.dataset.value;if(o==null)return;let n=t.host,s=(n.options??[]).find(i=>i.value===o);s&&vt(t,s,n)},"click .chip-remove":(e,t)=>{e.stopPropagation();let o=e.target.dataset.remove;if(o==null)return;let n=t.host,a=be(n.value).filter(s=>s!==o);n.value=he(a),Le(t,a,n),t.emit("tc-change",{value:a.slice()})},"focusout .control":(e,t)=>{queueMicrotask(()=>{t.host.matches(":focus-within")||(t.setState("open",!1),t.setState("query",""),t.emit("tc-close"))})}},afterMount(){let e=this;if(!e.multiple||!e.internals)return;let t=be(e.value),r=String(e.name??"");if(!r){e.internals.setFormValue(he(t));return}let o=new FormData;for(let n of t)o.append(r,n);e.internals.setFormValue(o)},afterRender(){let e=this;if(!(e.getState?!!e.getState("open"):!1))return;let r=e.refs?.search??null;if(!r||e.shadowRoot?.activeElement===r)return;r.focus();let n=r.value.length;try{r.setSelectionRange(n,n)}catch{}}}));function ht(e,t){if(!t)return e;let r=new RegExp(Wr(t),"i");return e.filter(o=>r.test(o.label)||r.test(o.value))}function vt(e,t,r){let o=!!r.multiple,n=Number(r.max??0),a=be(r.value);if(o){let s;if(a.includes(t.value))s=a.filter(i=>i!==t.value);else{if(n>0&&a.length>=n)return;s=a.concat(t.value)}r.value=he(s),Le(e,s,r),e.setState("query",""),e.emit("tc-change",{value:s.slice()}),queueMicrotask(()=>{e.refs.search?.focus()})}else r.value=t.value,Le(e,[t.value],r),e.setState("query",""),e.setState("open",!1),e.emit("tc-change",{value:t.value}),e.emit("tc-close")}function Le(e,t,r){let o=r.internals;if(!o)return;let n=String(r.name??"");if(!r.multiple){o.setFormValue(t[0]??"");return}if(!n){o.setFormValue(he(t));return}let a=new FormData;for(let s of t)a.append(n,s);o.setFormValue(a)}function H(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Jr="tc-carousel";function yt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function He(e){let t=0;for(let r of Array.from(e.children))r instanceof Element&&!r.hasAttribute("slot")&&t++;return t}function wt(e,t,r){return t<=0?0:r?(e%t+t)%t:Math.max(0,Math.min(t-1,e))}function P(e,t){let r=He(e);if(r===0)return;let o=e.value,n=wt(t,r,e.loop);n!==o&&(e.value=n,e.dispatchEvent(new CustomEvent("tc-change",{detail:{index:n,previous:o},bubbles:!0,composed:!0})))}function xt(e){_e(e),!(e.autoplay<=0)&&(He(e)<=1||(e._carouselTimer=globalThis.setInterval(()=>{P(e,e.value+1)},e.autoplay)))}function _e(e){e._carouselTimer!==void 0&&(globalThis.clearInterval(e._carouselTimer),e._carouselTimer=void 0)}g(Jr,f({props:{value:{type:"number",default:0,reflect:!0},autoplay:{type:"number",default:0},loop:{type:"boolean",default:!0},orientation:{type:"string",default:"horizontal"},transition:{type:"string",default:"slide"},indicators:{type:"boolean",default:!0},controls:{type:"boolean",default:!0},swipe:{type:"boolean",default:!0},pauseOnHover:{type:"boolean",default:!0},ariaLabel:{type:"string",default:"Carousel"},height:{type:"string",default:""}},theme:{"tc-carousel-radius":"var(--tc-radius-lg, 12px)","tc-carousel-bg":"var(--tc-color-bg, #faf8f3)","tc-carousel-control-bg":"rgba(255, 255, 255, 0.85)","tc-carousel-control-bg-hover":"rgba(255, 255, 255, 1)","tc-carousel-control-fg":"var(--tc-color-ink, #14171f)","tc-carousel-control-size":"36px","tc-carousel-indicator":"rgba(20, 23, 31, 0.25)","tc-carousel-indicator-active":"var(--tc-color-accent, #a16939)","tc-carousel-duration":"320ms"},styles:{display:"block",position:"relative"},template:({props:e})=>{let t=Number(e.value??0),r=String(e.orientation)==="vertical",o=String(e.transition)==="fade",n=String(e.height??""),a=!!e.controls,s=!!e.indicators,i=yt(e.ariaLabel??"Carousel");return`
        <div
          class="root ${r?"v":"h"} ${o?"fade":"slide"}"
          role="region"
          aria-roledescription="carousel"
          aria-label="${i}"
          style="${n?`--tc-carousel-height: ${yt(n)};`:""}--tc-carousel-index: ${t};"
        >
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;P(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;P(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let o=Number(r.dataset.index);if(!Number.isFinite(o))return;let n=t.host;P(n,o)},"keydown .root":(e,t)=>{let r=e,o=t.host,n=o.orientation==="vertical",a=He(o),s=n?"ArrowUp":"ArrowLeft",i=n?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),P(o,o.value-1)):r.key===i?(r.preventDefault(),P(o,o.value+1)):r.key==="Home"?(r.preventDefault(),P(o,0)):r.key==="End"&&(r.preventDefault(),P(o,a-1))}},afterMount(){let e=this,t=()=>kt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let o=e.shadowRoot,n=o?.querySelector("slot"),a=()=>t();n?.addEventListener("slotchange",a),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",a)};let s=()=>_e(e),i=()=>{e.pauseOnHover&&xt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",i),e.addEventListener("focusin",s),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",s),e.removeEventListener("focusout",i)},Zr(e),o?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&xt(e)},afterRender(){kt(this)},unmount(){let e=this;_e(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function kt(e){let t=He(e),r=e.shadowRoot;if(!r)return;let o=r.querySelector(".root");if(o&&t>0){let i=wt(e.value,t,e.loop);i!==e.value&&(e.value=i),o.style.setProperty("--tc-carousel-index",String(i))}let n=r.querySelector(".indicators");if(n){let i=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===i?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function Zr(e){let t=0,r=0,o=!1,n=40,a=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,o=!0))},s=l=>{if(!o)return;o=!1;let c=l.clientX-t,d=l.clientY-r,p=e.orientation==="vertical"?d:c;Math.abs(p)<n||P(e,e.value+(p<0?1:-1))},i=()=>{o=!1};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",i)}}var Qr="tc-accordion";g(Qr,f({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this,t=a=>{let s=a.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let i of Ce(e))i!==s&&i.open&&(i.open=!1);eo(e)}},r=a=>{let s=a.target;if(!s||s.tagName!=="SUMMARY")return;let i=Ce(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=i.indexOf(s);if(l===-1)return;let c=-1;a.key==="ArrowDown"?c=(l+1)%i.length:a.key==="ArrowUp"?c=(l-1+i.length)%i.length:a.key==="Home"?c=0:a.key==="End"&&(c=i.length-1),c!==-1&&(a.preventDefault(),i[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let o=()=>{for(let a of Ce(e)){let s=a.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",s.appendChild(i);let l=()=>{i.style.transform=a.open?"rotate(90deg)":"rotate(0)"};l(),a.addEventListener("toggle",l)}}};o();let n=new MutationObserver(o);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));function Ce(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function eo(e){let t=[];for(let r of Ce(e))if(r.open){let o=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(o)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var to="tc-tooltip";function ro(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}g(to,f({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${ro(e.text)}</span>`:""}
    ...
    `,afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".tip");if(!r)return;let o=()=>{e.disabled||(clearTimeout(e._tooltipTimer),e._tooltipTimer=globalThis.setTimeout(()=>{if(typeof r.showPopover=="function")try{r.showPopover()}catch{r.style.visibility="visible",r.style.opacity="1"}else r.style.visibility="visible",r.style.opacity="1";$t(e,r)},Math.max(0,e.delay)))},n=()=>{clearTimeout(e._tooltipTimer);try{typeof r.hidePopover=="function"&&r.hidePopover()}catch{}r.style.opacity="",r.style.visibility=""},a=i=>{i.key==="Escape"&&n()};e.addEventListener("pointerenter",o),e.addEventListener("pointerleave",n),e.addEventListener("focusin",o),e.addEventListener("focusout",n),e.addEventListener("keydown",a);let s=()=>{r.matches(":popover-open")&&$t(e,r)};globalThis.addEventListener("scroll",s,!0),globalThis.addEventListener("resize",s),e._tooltipCleanup=()=>{clearTimeout(e._tooltipTimer),e.removeEventListener("pointerenter",o),e.removeEventListener("pointerleave",n),e.removeEventListener("focusin",o),e.removeEventListener("focusout",n),e.removeEventListener("keydown",a),globalThis.removeEventListener("scroll",s,!0),globalThis.removeEventListener("resize",s),n()}},unmount(){this._tooltipCleanup?.()}}));function $t(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let o=t.getBoundingClientRect(),n=globalThis.innerWidth,a=globalThis.innerHeight,s=e.offset,i=e.placement||"top",l=u=>u==="top"?r.top-o.height-s>=4:u==="bottom"?r.bottom+o.height+s<=a-4:u==="left"?r.left-o.width-s>=4:u==="right"?r.right+o.width+s<=n-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"top")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-o.height-s,d=r.left+r.width/2-o.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-o.width/2):i==="left"?(c=r.top+r.height/2-o.height/2,d=r.left-o.width-s):i==="right"&&(c=r.top+r.height/2-o.height/2,d=r.right+s),c=Math.max(4,Math.min(a-o.height-4,c)),d=Math.max(4,Math.min(n-o.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`,t.dataset.placement=i}var oo="tc-popover";g(oo,f({props:{open:{type:"boolean",default:!1,reflect:!0},placement:{type:"string",default:"bottom"},offset:{type:"number",default:8},dismissible:{type:"boolean",default:!0}},theme:{"tc-popover-bg":"var(--tc-color-surface, #ffffff)","tc-popover-fg":"var(--tc-color-ink, #14171f)","tc-popover-rule":"var(--tc-color-rule, #ece5d3)","tc-popover-radius":"var(--tc-radius-md, 8px)","tc-popover-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.18))","tc-popover-padding":"12px 14px","tc-popover-min-width":"200px","tc-popover-max-width":"340px","tc-popover-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative"},template:()=>`
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){Et(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},o=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&St(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",o,!0),globalThis.addEventListener("resize",o),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",o,!0),globalThis.removeEventListener("resize",o)},Et(e)},unmount(){this._popoverCleanup?.()}}));function Et(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let o=e.open,n=typeof r.showPopover=="function";if(o&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";St(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!o&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function St(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let o=t.getBoundingClientRect(),n=globalThis.innerWidth,a=globalThis.innerHeight,s=e.offset,i=e.placement||"bottom",l=u=>u==="top"?r.top-o.height-s>=4:u==="bottom"?r.bottom+o.height+s<=a-4:u==="left"?r.left-o.width-s>=4:u==="right"?r.right+o.width+s<=n-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"bottom")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-o.height-s,d=r.left+r.width/2-o.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-o.width/2):i==="left"?(c=r.top+r.height/2-o.height/2,d=r.left-o.width-s):i==="right"&&(c=r.top+r.height/2-o.height/2,d=r.right+s),c=Math.max(4,Math.min(a-o.height-4,c)),d=Math.max(4,Math.min(n-o.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var no="tc-drawer";var ie=new WeakMap;function Fe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}g(no,f({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Fe(e.size??"min(420px, 92vw)");return`
        <dialog
          class="dlg side-${Fe(t)}"
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Mt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let o=t.refs.dialog;o&&e.target===o&&Mt(r,"backdrop")}},afterRender(){ao(this)},unmount(){let e=ie.get(this);e&&(e.cleanup(),ie.delete(this))}}));function ao(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let o=e.open,n=ie.get(e);if(n&&n.dialog!==r&&(n.cleanup(),ie.delete(e)),o&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!ie.has(e)){let a=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",a),ie.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",a)})}}else if(!o&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Mt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var so="tc-progress";function le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function io(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}g(so,f({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),o=!!e.indeterminate,n=Number(e.value??0),a=Number(e.max??100),s=io(n,a),i=e.label||(o?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,p=(d-u)/2,m=2*Math.PI*p,b=o?m*.25:s/100*m,h=o?`role="progressbar" aria-valuetext="${le(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${a}"`;return`
          <div class="circ size-${le(r)} ${o?"indet":""}" ${h}>
            <svg viewBox="0 0 ${d} ${d}" width="${d}" height="${d}" aria-hidden="true">
              <circle class="track" cx="${d/2}" cy="${d/2}" r="${p}" stroke-width="${u}" fill="none" />
              <circle
                class="fill"
                cx="${d/2}" cy="${d/2}" r="${p}"
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,c=o?`role="progressbar" aria-valuetext="${le(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${a}"`;return`
        <div class="bar size-${le(r)} ${o?"indet":""}" ${c}>
          <div class="track">
      ...
      `}}));var lo="tc-stepper";function Tt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}g(lo,f({props:{steps:{type:"json",default:[]},active:{type:"number",default:0,reflect:!0},orientation:{type:"string",default:"horizontal"},clickable:{type:"boolean",default:!1}},theme:{"tc-stepper-bg":"transparent","tc-stepper-ink":"var(--tc-color-ink, #14171f)","tc-stepper-soft":"var(--tc-color-ink-soft, #4a5061)","tc-stepper-rule":"var(--tc-color-rule, #ece5d3)","tc-stepper-accent":"var(--tc-color-accent, #a16939)","tc-stepper-done":"var(--tc-color-success, #2f7a52)","tc-stepper-radius":"999px","tc-stepper-marker-size":"28px","tc-stepper-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.steps??[],r=Number(e.active??0),o=String(e.orientation)==="vertical",n=!!e.clickable,a=t.map((s,i)=>{let l=i<r?"done":i===r?"current":"upcoming",c=l==="done"?'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>':`${i+1}`;return`
          <li class="step state-${l}" data-index="${i}">
            <${n?"button":"div"} class="row" ${n?`type="button" aria-current="${l==="current"?"step":"false"}"`:`aria-current="${l==="current"?"step":"false"}"`}>
              ...
              <span class="text">
                <span class="title">${Tt(s.title)}</span>
                ${s.description?`<span class="desc">${Tt(s.description)}</span>`:""}
              </span>
            </${n?"button":"div"}>
            ${i<t.length-1?`<span class="line ${i<r?"done":""}" aria-hidden="true"></span>`:""}
          </li>
        `}).join("");return`
        <ol class="root ${o?"v":"h"} ${n?"clickable":""}" aria-label="Progress">
          ${a}
        </ol>
        <style>
      ...
      `},events:{"click .row":(e,t)=>{let r=t.host;if(!r.clickable)return;let o=e.target.closest(".step");if(!o)return;let n=Number(o.dataset.index);if(!Number.isFinite(n)||n===r.active)return;let a=r.active;r.active=n,t.emit("tc-step-change",{active:n,previous:a})}}}));var co="tc-avatar";function V(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Lt(e){let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?"":t.length===1?t[0].slice(0,2).toUpperCase():(t[0][0]+t[t.length-1][0]).toUpperCase()}var Pe=[["#dde6f4","#1f3a66"],["#dbece2","#155b40"],["#efe2cf","#8a572d"],["#f4dad7","#7a1a14"],["#e3dcf1","#3d2a73"],["#d5e8e5","#0d4f49"],["#fbe3c5","#7a4f0a"]];function uo(e){if(!e)return Pe[0];let t=0;for(let o=0;o<e.length;o++)t=t*31+e.charCodeAt(o)|0;let r=Math.abs(t)%Pe.length;return Pe[r]}g(co,f({props:{src:{type:"string",default:""},alt:{type:"string",default:""},name:{type:"string",default:""},size:{type:"string",default:"md"},shape:{type:"string",default:"circle"},status:{type:"string",default:""},ring:{type:"boolean",default:!1}},theme:{"tc-avatar-bg":"var(--tc-color-rule, #ece5d3)","tc-avatar-fg":"var(--tc-color-ink, #14171f)","tc-avatar-ring":"var(--tc-color-surface, #ffffff)","tc-avatar-status-online":"#2f7a52","tc-avatar-status-away":"#d7a52f","tc-avatar-status-busy":"#b3261e","tc-avatar-status-offline":"#9aa0a6","tc-avatar-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative","vertical-align":"middle"},template:({props:e})=>{let t=String(e.name??""),r=String(e.src??""),o=String(e.alt??"")||t||"avatar",n=String(e.size??"md"),a=String(e.shape??"circle"),s=String(e.status??""),i=!!e.ring,[l,c]=uo(t);return`
        <span class="root size-${V(n)} shape-${V(a)} ${i?"ringed":""}"
              style="--tc-avatar-tint-bg: ${l}; --tc-avatar-tint-fg: ${c};">
          ${r?`<img src="${V(r)}" alt="${V(o)}" loading="lazy" onerror="this.replaceWith(Object.assign(document.createElement('span'),{className:'fallback',textContent:'${V(Lt(t))}'}))">`:`<span class="fallback" aria-label="${V(o)}">${V(Lt(t))}</span>`}
    ...
    `,afterMount(){let e=this,t=()=>Ht(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){Ht(this)},unmount(){this._agroupCleanup?.()}}));function Ht(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),o=Array.from(e.children).filter(l=>l instanceof HTMLElement),n=0;for(let l of o)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),n<t||t===0?(l.hidden=!1,n++):l.hidden=!0);let a=o.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,s=Math.max(0,a-n),i=e.shadowRoot?.querySelector(".overflow");i&&(s>0?(i.hidden=!1,i.textContent=`+${s}`):i.hidden=!0)}var fo="tc-rating";function Ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var zt="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";g(fo,f({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),o=Number(e.value??0),n=Number(t.hover??-1),a=n>=0?n:o,s=String(e.size??"md"),i=!!e.readonly,l=!!e.allowHalf,c=Ct(e.ariaLabel??"Rating"),d=s==="sm"?18:s==="lg"?32:24,u=[];for(let p=1;p<=r;p++){let m=a-(p-1),b=m>=1?100:m>=.5&&l?50:m>0&&!l?100:0,h=b===50;u.push(`
          <span class="star ${h?"half":b===100?"full":"empty"}" data-index="${p}">
            <svg viewBox="0 0 24 24" width="${d}" height="${d}" aria-hidden="true">
              <path class="track" d="${zt}" fill="var(--tc-rating-track)" />
              ${b>0?`<path class="fill" d="${zt}" fill="var(--tc-rating-fill)" clip-path="${h?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
            ${l&&!i?`<span class="hit-left" data-index="${p}" data-half="1"></span>
                 <span class="hit-right" data-index="${p}" data-half="0"></span>`:""}
          </span>
        `)}return`
        <div
          class="root size-${Ct(s)} ${i?"readonly":""}"
          role="${i?"img":"slider"}"
          tabindex="${i?"-1":"0"}"
          aria-label="${c}"
          aria-valuenow="${o}"
      ...
      `},events:{"click .star":(e,t)=>{let r=t.host;if(r.readonly)return;let o=e.target,n=o.closest(".hit-left, .hit-right"),a=o.closest(".star");if(!a)return;let s=Number(a.dataset.index);if(!Number.isFinite(s))return;let i=s;n?.dataset.half==="1"&&r.allowHalf&&(i=s-.5),i===r.value&&(i=0);let l=r.value;r.value=i,t.emit("tc-change",{value:i,previous:l})},"mouseover .star":(e,t)=>{let r=t.host;if(r.readonly)return;let o=e.target,n=o.closest(".hit-left, .hit-right"),a=o.closest(".star");if(!a)return;let s=Number(a.dataset.index);if(!Number.isFinite(s))return;let i=s;n?.dataset.half==="1"&&r.allowHalf&&(i=s-.5),t.setState("hover",i)},"mouseleave .root":(e,t)=>{t.setState("hover",-1)},"keydown .root":(e,t)=>{let r=e,o=t.host;if(o.readonly)return;let n=o.allowHalf?.5:1,a=o.value,s=a;if(r.key==="ArrowRight"||r.key==="ArrowUp")s=Math.min(o.max,a+n);else if(r.key==="ArrowLeft"||r.key==="ArrowDown")s=Math.max(0,a-n);else if(r.key==="Home")s=0;else if(r.key==="End")s=o.max;else return;r.preventDefault(),s!==a&&(o.value=s,t.emit("tc-change",{value:s,previous:a}))}}}));var go="tc-slider";function ze(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}g(go,f({props:{value:{type:"number",default:0,reflect:!0},min:{type:"number",default:0},max:{type:"number",default:100},step:{type:"number",default:1},disabled:{type:"boolean",default:!1,reflect:!0},showValue:{type:"boolean",default:!1},showTicks:{type:"boolean",default:!1},label:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-slider-track":"var(--tc-color-rule, #ece5d3)","tc-slider-fill":"var(--tc-color-accent, #a16939)","tc-slider-thumb":"var(--tc-color-surface, #ffffff)","tc-slider-thumb-ring":"var(--tc-color-accent, #a16939)","tc-slider-radius":"999px","tc-slider-thumb-size":"20px","tc-slider-track-size":"6px","tc-slider-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-slider-fg":"var(--tc-color-ink, #14171f)","tc-slider-fg-muted":"var(--tc-color-ink-muted, #6b7280)"},styles:{display:"block"},template:({props:e})=>{let t=Number(e.value??0),r=Number(e.min??0),o=Number(e.max??100),n=Number(e.step??1),a=!!e.disabled,s=o>r?(t-r)/(o-r)*100:0,i=String(e.label??""),l=String(e.suffix??""),c=!!e.showValue,d=!!e.showTicks,u="";if(d&&n>0){let p=Math.floor((o-r)/n)+1;if(p<=50){let m=[];for(let b=0;b<p;b++){let v=(r+b*n-r)/(o-r)*100;m.push(`<span class="tick" style="left:${v.toFixed(2)}%"></span>`)}u=m.join("")}}return`
        ${i||c?`<div class="head">
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,o=t.host,n=Number(r.value);o.value!==n&&(o.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,o=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:o.value})}}}));var mo="tc-chart";function At(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),o=e/Math.pow(10,r),n;return t?o<1.5?n=1:o<3?n=2:o<7?n=5:n=10:o<=1?n=1:o<=2?n=2:o<=5?n=5:n=10,n*Math.pow(10,r)}function bo(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let o=At(t-e,!1),n=At(o/(r-1),!0),a=Math.floor(e/n)*n,s=Math.ceil(t/n)*n,i=[];for(let l=a;l<=s+n*.5;l+=n)i.push(Number(l.toFixed(10)));return{min:a,max:s,ticks:i}}function Ve(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(o=>`${o.x} ${o.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let o=0;o<e.length-1;o++){let n=e[o-1]??e[o],a=e[o],s=e[o+1],i=e[o+2]??s,l=a.x+(s.x-n.x)/6,c=a.y+(s.y-n.y)/6,d=s.x-(i.x-a.x)/6,u=s.y-(i.y-a.y)/6;r+=` C ${l},${c} ${d},${u} ${s.x},${s.y}`}return r}function ve(e,t,r,o){return{x:e+r*Math.sin(o),y:t-r*Math.cos(o)}}function ho(e,t,r,o,n,a){let s=a-n>Math.PI?1:0,i=ve(e,t,r,n),l=ve(e,t,r,a);if(o<=0)return`M ${e} ${t} L ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} Z`;let c=ve(e,t,o,a),d=ve(e,t,o,n);return`M ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} L ${c.x} ${c.y} A ${o} ${o} 0 ${s} 0 ${d.x} ${d.y} Z`}function $(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Z(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function ye(e,t){return t[e%t.length]}function vo(e,t){let{data:r,smooth:o,stacked:n,showAxes:a,showGrid:s,showLabels:i,showValues:l}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",p=u?4:16,m=u?4:a&&i?28:8,b=u?4:a?44:8,h=u?4:12,v=e.W-b-h,w=e.H-p-m,x=1/0,T=-1/0;if(n&&d.length>0){let E=c.length>0?c.map((y,M)=>d.reduce((L,D)=>L+(D.values?.[M]??0),0)):[];for(let y of E)y<x&&(x=y),y>T&&(T=y);x>0&&(x=0)}else for(let E of d)for(let y of E.values??[])y<x&&(x=y),y>T&&(T=y);(!Number.isFinite(x)||!Number.isFinite(T))&&(x=0,T=1),x===T&&(x-=1,T+=1);let R=bo(e.yMin??x,e.yMax??T,5),I=e.yMin??R.min,B=e.yMax??R.max,de=B-I||1,k=c.length||d[0]?.values?.length||0,_=E=>k===1?b+v/2:t==="bar"?b+(E+.5)*(v/k):b+E/(k-1)*v,C=E=>p+w-(E-I)/de*w,Q=[];if(!u){if(s)for(let E of R.ticks){let y=C(E);Q.push(`<line class="grid" x1="${b}" x2="${e.W-h}" y1="${y}" y2="${y}"/>`)}if(a){for(let y of R.ticks){let M=C(y);Q.push(`<text class="axis-label y" x="${b-8}" y="${M}" text-anchor="end" dominant-baseline="middle">${$(Z(y))}</text>`)}if(i&&c.length>0){let y=Math.max(1,Math.ceil(c.length/8));c.forEach((M,L)=>{L%y!==0&&L!==c.length-1||Q.push(`<text class="axis-label x" x="${_(L)}" y="${e.H-m+16}" text-anchor="middle">${$(M)}</text>`)})}let E=I<=0&&B>=0?C(0):C(I);Q.push(`<line class="axis" x1="${b}" x2="${e.W-h}" y1="${E}" y2="${E}"/>`)}}let O=[];if(t==="bar"){let E=v/k,y=E*.18,M=E-y*2;d.forEach((L,D)=>{let W=`series series-${D}`,z=ye(D,e.palette),N=0;L.values?.forEach((S,q)=>{if(!Number.isFinite(S))return;let F=_(q),X,ke,we,qe;if(n){X=F-M/2,ke=M;let ue=C(N+S),pe=C(N);we=Math.min(ue,pe),qe=Math.abs(ue-pe),N+=S}else{let ue=M/d.length;X=F-M/2+D*ue,ke=ue*.86;let pe=C(S),Xe=C(I<0&&B>0?0:I);we=Math.min(pe,Xe),qe=Math.abs(pe-Xe)}let We=`${$(L.name)}${c[q]?` \xB7 ${$(c[q])}`:""}: ${$(Z(S))}`,Kt=(q*.04).toFixed(3);O.push(`<g class="${W}"><rect class="hit" x="${X}" y="${we}" width="${ke}" height="${qe}" rx="2" fill="${z}" data-tip="${We}" data-color="${z}" style="animation-delay: ${Kt}s"><title>${We}</title></rect>`+(l?`<text class="value-label" x="${X+ke/2}" y="${we-4}" text-anchor="middle">${$(Z(S))}</text>`:"")+"</g>")})})}else if(n&&t==="area"){let E=new Array(k).fill(0);d.forEach((y,M)=>{let L=ye(M,e.palette),D=[],W=[];for(let S=0;S<k;S++){let q=y.values?.[S]??0,F=E[S]+q;D.push({x:_(S),y:C(F)}),W.push({x:_(S),y:C(E[S])}),E[S]=F}let z=Ve(D,o)+" L "+W.slice().reverse().map(S=>`${S.x} ${S.y}`).join(" L ")+" Z",N=(M*.15).toFixed(3);O.push(`<path class="series-fill series-${M}" d="${z}" fill="${L}" fill-opacity="0.25" pointer-events="none" style="animation-delay: ${N}s"/>`),O.push(`<path class="series-line series-${M}" d="${Ve(D,o)}" stroke="${L}" fill="none" pointer-events="none" style="animation-delay: ${N}s"/>`),D.forEach((S,q)=>{let F=y.values?.[q]??0,X=`${$(y.name)}${c[q]?` \xB7 ${$(c[q])}`:""}: ${$(Z(F))}`;O.push(`<circle class="hit series-${M}" cx="${S.x}" cy="${S.y}" r="12" fill="transparent" data-tip="${X}" data-color="${L}"><title>${X}</title></circle>`)})})}else d.forEach((E,y)=>{let M=ye(y,e.palette),L=(E.values??[]).map((z,N)=>({x:_(N),y:C(z)})),D=Ve(L,o),W=(y*.15).toFixed(3);if(t==="area"){let z=C(I<0&&B>0?0:I),N=D+` L ${L[L.length-1].x} ${z} L ${L[0].x} ${z} Z`;O.push(`<path class="series-fill series-${y}" d="${N}" fill="${M}" fill-opacity="0.25" style="animation-delay: ${W}s"/>`)}O.push(`<path class="series-line series-${y}" d="${D}" stroke="${M}" fill="none" style="animation-delay: ${W}s"/>`),u||L.forEach((z,N)=>{let S=E.values?.[N],q=`${$(E.name)}${c[N]?` \xB7 ${$(c[N])}`:""}: ${$(Z(S??0))}`,F=(y*.15+N*.025+.55).toFixed(3);O.push(`<circle class="series-point series-${y}" cx="${z.x}" cy="${z.y}" r="3.5" fill="${M}" pointer-events="none" style="animation-delay: ${F}s"/>`),O.push(`<circle class="hit series-${y}" cx="${z.x}" cy="${z.y}" r="12" fill="transparent" data-tip="${q}" data-color="${M}"><title>${q}</title></circle>`),l&&O.push(`<text class="value-label" x="${z.x}" y="${z.y-8}" text-anchor="middle" pointer-events="none">${$(Z(S??0))}</text>`)})});return Q.join("")+O.join("")}function yo(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let o=e.W/2,n=e.H/2,a=Math.min(e.W,e.H)/2-4,s=Math.max(0,Math.min(.9,e.innerRadius))*a,i=0,l=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let p=u/r*Math.PI*2,m=i,b=i+p,h=ho(o,n,a,s,m,b-.01),v=ye(d,e.palette),w=(u/r*100).toFixed(1).replace(/\.0$/,""),x=`${$(c.name)}: ${$(Z(u))} (${w}%)`,T=(d*.08).toFixed(3);if(l.push(`<path class="series-segment hit series-${d}" d="${h}" fill="${v}" data-tip="${x}" data-color="${v}" style="animation-delay: ${T}s"><title>${x}</title></path>`),e.showValues){let R=(m+b)/2,I=(a+s)/2,B=ve(o,n,I,R);l.push(`<text class="value-label donut" x="${B.x}" y="${B.y}" text-anchor="middle" dominant-baseline="middle">${$(w)}%</text>`)}i=b}),l.join("")}function xo(e,t,r){return e.length===0?"":'<div class="legend" part="legend">'+e.map((o,n)=>{let a=ye(n,t),s=r.includes(o.name);return`<button class="${s?"legend-item is-hidden":"legend-item"}" type="button" data-series="${$(o.name)}" aria-pressed="${s?"true":"false"}" title="${s?"Show":"Hide"} series '${$(o.name)}'"><span class="swatch" style="background:${a}"></span>${$(o.name)}</button>`}).join("")+"</div>"}function ko(e,t){if(e==="donut"){let n=(t.series??[]).reduce((s,i)=>s+(i.value??0),0);return`Donut chart: ${(t.series??[]).filter(s=>(s.value??0)>0).map(s=>{let i=n>0?(s.value??0)/n*100:0;return`${s.name} ${i.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(n=>n.name).join(", "),o=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${o} data point${o===1?"":"s"}.`}var wo=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],$o=`
  <style>
...
`;g(mo,f({props:{type:{type:"string",default:"line"},data:{type:"json",default:{series:[]}},height:{type:"string",default:"240px"},smooth:{type:"boolean",default:!0},stacked:{type:"boolean",default:!1},showLegend:{type:"boolean",default:!0},showAxes:{type:"boolean",default:!0},showGrid:{type:"boolean",default:!0},showLabels:{type:"boolean",default:!0},showValues:{type:"boolean",default:!1},innerRadius:{type:"number",default:.6},yMin:{type:"json",default:null},yMax:{type:"json",default:null},ariaLabel:{type:"string",default:"Chart"},colors:{type:"json",default:null},src:{type:"string",default:""},srcKey:{type:"string",default:""},loadingText:{type:"string",default:"Loading chart\u2026"},errorText:{type:"string",default:"Couldn't load chart data"}},theme:{"tc-chart-bg":"transparent","tc-chart-fg":"var(--tc-color-ink, #14171f)","tc-chart-axis":"var(--tc-color-rule-strong, #d9cfb8)","tc-chart-grid":"var(--tc-color-rule, #ece5d3)","tc-chart-label":"var(--tc-color-ink-muted, #6b7280)","tc-chart-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e,state:t})=>{let r=String(e.type??"line").toLowerCase(),o=["line","area","bar","sparkline","donut"].includes(r)?r:"line",n=e.data,a=t.fetched,s=!!n&&Array.isArray(n.series)&&n.series.length>0,i=s?n:a??{series:[]},l=Array.isArray(t.hiddenSeries)?t.hiddenSeries:[],c={labels:i.labels,series:(i.series??[]).filter(k=>!l.includes(k.name))},d=String(e.src??""),u=!!t.loading&&!s&&!a,p=d&&t.error?String(t.error):"",m=u?`<div class="overlay loading">${$(String(e.loadingText??"Loading chart\u2026"))}</div>`:p?`<div class="overlay error" role="alert">${$(String(e.errorText??"Couldn't load chart data"))}<small>${$(p)}</small></div>`:"",b=o==="sparkline",h=o==="donut",v=e.colors,w=Array.isArray(v)&&v.length>0?v:wo,x=h?320:800,T=h?320:400,R={data:c,smooth:!!e.smooth,stacked:!!e.stacked,showAxes:!!e.showAxes,showGrid:!!e.showGrid,showLabels:!!e.showLabels,showValues:!!e.showValues,innerRadius:Number(e.innerRadius??.6),yMin:e.yMin==null?null:Number(e.yMin),yMax:e.yMax==null?null:Number(e.yMax),palette:w,W:x,H:T},I=h?yo(R):vo(R,o),B=ko(o,c),de=$(String(e.height??"240px"));return`
...
`;g(So,f({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Start writing\u2026"},toolbar:{type:"string",default:It},readonly:{type:"boolean",default:!1,reflect:!0},minHeight:{type:"string",default:"180px"},maxHeight:{type:"string",default:""},pasteAs:{type:"string",default:"text"}},theme:{"tc-editor-bg":"var(--tc-color-surface, #ffffff)","tc-editor-fg":"var(--tc-color-ink, #14171f)","tc-editor-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-editor-toolbar-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-fg":"var(--tc-color-ink-soft, #4a5061)","tc-editor-toolbar-active-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-editor-toolbar-hover-bg":"rgba(20, 23, 31, 0.06)","tc-editor-placeholder":"var(--tc-color-ink-muted, #6b7280)","tc-editor-radius":"var(--tc-radius-md, 8px)","tc-editor-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-editor-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, 'SF Mono', monospace)","tc-editor-line-height":"1.6"},styles:{display:"block"},template:({props:e})=>{let t=String(e.toolbar??It),r=!!e.readonly,o=G(String(e.minHeight??"180px")),n=String(e.maxHeight??"").trim(),a=t.split(",").map(c=>c.trim()).filter(Boolean),s=a.map(c=>{if(c==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let d=Mo[c];if(!d)return"";let u=d.shortcut?` (${G(d.shortcut)})`:"";return`<button type="button" class="tb-btn" data-cmd="${G(d.command)}"${d.value?` data-val="${G(d.value)}"`:""} data-key="${G(d.key)}" title="${G(d.label)}${u}" aria-label="${G(d.label)}">${d.icon}</button>`}).join(""),i=a.length===0?"toolbar empty":r?"toolbar readonly":"toolbar";return`
        ...
        ${To}
      `},afterMount(){Dt(this)},afterRender(){let e=this,r=e.shadowRoot?.querySelector(".surface");if(r){let o=r.innerHTML,n=String(e.value??"");n&&o!==n&&document.activeElement!==e&&(r.innerHTML=n),Ge(r)}Dt(e)},unmount(){this._editorCleanup?.()}}));function Ge(e){let t=e.textContent?.trim()===""&&e.querySelector("img, hr, br")===null;e.dataset.empty=t?"true":"false"}function Dt(e){let t=e;t._editorCleanup?.();let r=t.shadowRoot;if(!r)return;let o=r.querySelector(".surface");if(!o)return;o.dataset.bootstrapped||(t.value&&(o.innerHTML=String(t.value)),o.dataset.bootstrapped="1"),Ge(o);let n=(p,m)=>{if(!t.readonly){if(o.focus(),p==="code"){let h=r.getSelection?.()??globalThis.getSelection();if(!h||h.rangeCount===0)return;let v=h.getRangeAt(0),w=v.extractContents(),x=document.createElement("code");x.className="tc-code-inline",x.appendChild(w),v.insertNode(x),v.selectNodeContents(x),h.removeAllRanges(),h.addRange(v)}else if(p==="link"){let b=globalThis.prompt("URL")?.trim();if(!b)return;document.execCommand("createLink",!1,b)}else p==="formatBlock"?document.execCommand("formatBlock",!1,`<${m??"p"}>`):document.execCommand(p,!1,m);qt(t,o),jt(r,o)}},a=p=>{let m=p.target?.closest?.(".tb-btn");if(!m)return;p.preventDefault();let b=m.dataset.cmd;b&&n(b,m.dataset.val)},s=()=>{Ge(o),qt(t,o)},i=()=>{let p=o.innerHTML;t._lastEmitted!==p&&(t._lastEmitted=p,t.dispatchEvent(new CustomEvent("tc-change",{detail:{html:p},bubbles:!0,composed:!0})))},l=p=>{if(t.readonly||t.pasteAs!=="text")return;p.preventDefault();let m=p.clipboardData?.getData("text/plain")??"";document.execCommand("insertText",!1,m)},c=p=>{if(t.readonly||!(p.metaKey||p.ctrlKey))return;let m=p.key.toLowerCase();m==="b"?(p.preventDefault(),n("bold")):m==="i"?(p.preventDefault(),n("italic")):m==="u"?(p.preventDefault(),n("underline")):m==="k"&&(p.preventDefault(),n("link"))},d=()=>{let p=globalThis.getSelection();!p||!p.anchorNode||o.contains(p.anchorNode)&&jt(r,o)},u=r.querySelector(".toolbar");u?.addEventListener("click",a),o.addEventListener("input",s),o.addEventListener("blur",i),o.addEventListener("paste",l),o.addEventListener("keydown",c),document.addEventListener("selectionchange",d),t._editorCleanup=()=>{u?.removeEventListener("click",a),o.removeEventListener("input",s),o.removeEventListener("blur",i),o.removeEventListener("paste",l),o.removeEventListener("keydown",c),document.removeEventListener("selectionchange",d)}}function qt(e,t){let r=t.innerHTML;e.value=r,e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:r},bubbles:!0,composed:!0}))}function jt(e,t){e.querySelectorAll(".tb-btn").forEach(o=>{let n=o,a=n.dataset.cmd??"",s=n.dataset.val,i=!1;try{a==="formatBlock"&&s?i=(document.queryCommandValue("formatBlock")||"").toLowerCase().replace(/^[<]|[>]$/g,"")===s:(a==="bold"||a==="italic"||a==="underline"||a==="strikeThrough"||a==="insertOrderedList"||a==="insertUnorderedList")&&(i=document.queryCommandState(a))}catch{i=!1}n.classList.toggle("is-active",i)})}var Lo="tc-markdown";function j(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ae(e){let t=j(e);return t=t.replace(/`([^`]+)`/g,"<code>$1</code>"),t=t.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/(?<!\*)\*([^*\n]+?)\*(?!\*)/g,"<em>$1</em>"),t=t.replace(/\b_(.+?)_\b/g,"<em>$1</em>"),t=t.replace(/~~(.+?)~~/g,"<del>$1</del>"),t=t.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(r,o,n)=>`<img src="${j(n)}" alt="${j(o)}" loading="lazy"/>`),t=t.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(r,o,n)=>`<a href="${j(n)}" target="_blank" rel="noopener">${o}</a>`),t}function Ft(e){let t=e.replace(/\r\n?/g,`
`).split(`
`),r=[],o=0;for(;o<t.length;){let n=t[o],a=n.match(/^```(\S*)\s*$/);if(a){let c=a[1]??"",d=[];for(o++;o<t.length&&!/^```\s*$/.test(t[o]);)d.push(t[o]),o++;o<t.length&&o++;let u=c?` class="lang-${j(c)}"`:"";r.push(`<pre><code${u}>${j(d.join(`
`))}</code></pre>`);continue}let s=n.match(/^(#{1,6})\s+(.*)$/);if(s){let c=s[1].length;r.push(`<h${c}>${Ae(s[2])}</h${c}>`),o++;continue}if(/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(n.trim())){r.push("<hr/>"),o++;continue}if(/^>\s?/.test(n)){let c=[];for(;o<t.length&&/^>\s?/.test(t[o]);)c.push(t[o].replace(/^>\s?/,"")),o++;r.push(`<blockquote>${Ae(c.join(" "))}</blockquote>`);continue}let i=n.match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(i){let c=!!i[3],d=c?"ol":"ul",u=[];for(;o<t.length;){let p=t[o].match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(!p||!!p[3]!==c)break;u.push(`<li>${Ae(p[4])}</li>`),o++}r.push(`<${d}>${u.join("")}</${d}>`);continue}if(n.trim()===""){o++;continue}let l=[n];for(o++;o<t.length;){let c=t[o];if(c.trim()===""||/^#{1,6}\s+/.test(c)||/^```/.test(c)||/^>\s?/.test(c)||/^(\s*)(?:[-*+]|\d+\.)\s+/.test(c)||/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(c.trim()))break;l.push(c),o++}r.push(`<p>${Ae(l.join(" "))}</p>`)}return r.join(`
`)}var Bt={bold:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4h7a4 4 0 0 1 0 8H6z"/><path d="M6 12h8a4 4 0 0 1 0 8H6z"/></svg>',italic:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>',heading:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6v12"/><path d="M12 6v12"/><path d="M4 12h8"/><path d="M16 18l4-12"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',link:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',bullet:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><circle cx="4" cy="6" r="1.2" fill="currentColor"/><circle cx="4" cy="12" r="1.2" fill="currentColor"/><circle cx="4" cy="18" r="1.2" fill="currentColor"/></svg>',ordered:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><path d="M4 8V4l-1 1"/><path d="M3 14h2l-2 3h2"/></svg>',quote:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h3v6H4v-3a3 3 0 0 1 3-3z"/><path d="M16 7h3v6h-6v-3a3 3 0 0 1 3-3z"/></svg>',preview:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'};function Ke(e,t,r,o,n,a="text"){let s=e.slice(t,r)||a;return{text:e.slice(0,t)+o+s+n+e.slice(r),selStart:t+o.length,selEnd:t+o.length+s.length}}function Re(e,t,r,o){let n=e.lastIndexOf(`
`,t-1)+1,a=(()=>{let l=e.indexOf(`
`,r);return l===-1?e.length:l})(),i=e.slice(n,a).split(`
`).map(l=>o+l).join(`
`);return{text:e.slice(0,n)+i+e.slice(a),selStart:n,selEnd:n+i.length}}var Pt={bold:{key:"bold",label:"Bold",shortcut:"\u2318B",apply:(e,t,r)=>Ke(e,t,r,"**","**","bold text")},italic:{key:"italic",label:"Italic",shortcut:"\u2318I",apply:(e,t,r)=>Ke(e,t,r,"*","*","italic text")},heading:{key:"heading",label:"Heading",apply:(e,t,r)=>Re(e,t,r,"## ")},code:{key:"code",label:"Code",apply:(e,t,r)=>Ke(e,t,r,"`","`","code")},link:{key:"link",label:"Link",shortcut:"\u2318K",apply:(e,t,r)=>{let o=globalThis.prompt?.("URL")?.trim();if(!o)return{text:e,selStart:t,selEnd:r};let n=e.slice(t,r)||"link text";return{text:e.slice(0,t)+`[${n}](${o})`+e.slice(r),selStart:t+1,selEnd:t+1+n.length}}},bullet:{key:"bullet",label:"Bulleted list",apply:(e,t,r)=>Re(e,t,r,"- ")},ordered:{key:"ordered",label:"Numbered list",apply:(e,t,r)=>Re(e,t,r,"1. ")},quote:{key:"quote",label:"Quote",apply:(e,t,r)=>Re(e,t,r,"> ")}},Ot="bold,italic,heading,|,bullet,ordered,quote,|,link,code",Ho=`
  <style>
    :host {
      display: block;
...
`;g(Lo,f({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Write some markdown\u2026"},mode:{type:"string",default:"split"},readonly:{type:"boolean",default:!1},minHeight:{type:"string",default:"240px"},toolbar:{type:"string",default:Ot}},theme:{"tc-md-bg":"var(--tc-color-surface, #ffffff)","tc-md-fg":"var(--tc-color-ink, #14171f)","tc-md-rule":"var(--tc-color-rule, #ece5d3)","tc-md-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-md-preview-bg":"var(--tc-color-bg, #faf8f3)","tc-md-radius":"var(--tc-radius-md, 8px)","tc-md-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-md-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)"},styles:{display:"block"},refs:{source:"textarea",preview:".preview"},template:({props:e,state:t})=>{let r=String(t.mode??e.mode??"split"),o=String(e.value??""),n=String(e.toolbar??Ot).split(",").map(d=>d.trim()).filter(Boolean),a=n.map(d=>{if(d==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let u=Pt[d];if(!u||!Bt[u.key])return"";let p=u.shortcut?` (${j(u.shortcut)})`:"";return`<button type="button" class="tb-btn" data-op="${j(u.key)}" title="${j(u.label)}${p}" aria-label="${j(u.label)}">${Bt[u.key]}</button>`}).join(""),s=(d,u)=>`<button type="button" data-mode="${d}" class="${r===d?"is-active":""}" aria-pressed="${r===d?"true":"false"}">${u}</button>`,i=Ft(o),l=r==="source"?"panes source-only":r==="preview"?"panes preview-only":"panes";return`
        <div class="root" style="${`--tc-md-min-height: ${j(e.minHeight??"240px")};`}">
        ...
        <header class="topbar">
          <div class="inner">
            ...
            <nav aria-label="Primary">
              ${r.map(n=>{let a=n.id===o,s=[n.hideOnSmall?"nav-hide-sm":"",a?"active":""].filter(Boolean).join(" "),i=a?' aria-current="page"':"",l=n.external?' target="_blank" rel="noopener"':"";return`<a href="${xe(n.href)}"${i}${l}${s?` class="${s}"`:""}>${xe(n.label)}</a>`}).join(`
              `)}
            </nav>
          </div>
        </header>
      ...
      `}}));function xe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ro="site-footer";g(Ro,f({props:{base:{type:"string",default:""},year:{type:"string",default:"2026"}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??"");return`
        <footer class="foot">
          <div class="inner">
      ...
      `}}));function ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var No="site-search";var U=null,Ie=null;function De(e){if(U)return Promise.resolve(U);if(Ie)return Ie;let t=`${e}search.json`;return Ie=fetch(t).then(r=>r.json()).then(r=>(U=r.docs??[],U)).catch(r=>(console.warn("[site-search] failed to load index:",r),U=[],U)),Ie}function Gt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Vt(e,t){let r=e.trim().toLowerCase();if(!r)return[];let o=r.split(/\s+/).filter(Boolean).map(a=>({raw:a,re:new RegExp(Gt(a),"i")})),n=[];for(let a of t){let s=a.title.toLowerCase(),i=(a.description??"").toLowerCase(),l=(a.text??"").toLowerCase(),c=0;for(let u of o){let p=u.raw;s===p&&(c+=50),s.startsWith(p)&&(c+=20),s.includes(p)&&(c+=10),i.includes(p)&&(c+=5),l.includes(p)&&(c+=1)}o.every(u=>u.re.test(a.title)||u.re.test(i)||u.re.test(l))&&c!==0&&(a.category==="blog"&&a.date&&(Date.now()-new Date(a.date).getTime())/864e5<30&&(c+=3),n.push({doc:a,score:c}))}return n.sort((a,s)=>s.score-a.score),n.slice(0,12)}function Io(e,t,r=140){let o=e.trim().toLowerCase().split(/\s+/)[0];if(!o)return t.slice(0,r);let a=t.toLowerCase().indexOf(o);if(a===-1)return t.slice(0,r);let s=Math.max(0,a-40),i=Math.min(t.length,s+r),l=s>0?"\u2026 ":"",c=i<t.length?" \u2026":"";return l+t.slice(s,i)+c}function Y(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ye(e,t){let r=t.trim();if(!r)return Y(e);let o=r.split(/\s+/).filter(Boolean),n=Y(e);for(let a of o){let s=new RegExp(`(${Gt(Y(a))})`,"gi");n=n.replace(s,"<mark>$1</mark>")}return n}function Do(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var qo=`
        <style>
          :host { display: inline-block; }
...
`;g(No,f({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),o=String(t.query??""),n=Number(t.focusIdx??0),a=t.results??[],s=`
      ...
      `,i=o.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':a.length===0?`<div class="empty">No results for "${Y(o)}". Try a shorter query.</div>`:a.map((c,d)=>{let u=d===n?"row focused":"row",p=r+c.doc.url.replace(/^\//,""),m=Io(o,c.doc.text);return`
              <a class="${u}" data-index="${d}" href="${Y(p)}">
                <span class="row-cat ${Y(c.doc.category)}">${Y(c.doc.category)}</span>
                <div class="row-main">
                  <div class="row-title">${Ye(c.doc.title,o)}</div>
                  <div class="row-desc">${Ye(c.doc.description,o)}</div>
                  <div class="row-snippet">${Ye(m,o)}</div>
                </div>
              </a>
            `}).join(""),l=`
      ...
      `;return s+l+qo},events:{"click .trigger":(e,t)=>{let r=t.host,o=String(r.base??"");t.setState("open",!0),t.setState("query",""),t.setState("focusIdx",0),t.setState("results",[]),De(o)},"click .close":(e,t)=>Do(t),"input .search-input":(e,t)=>{let r=e.target.value,o=t.host,n=String(o.base??"");t.setState("query",r),t.setState("focusIdx",0),U?t.setState("results",Vt(r,U)):De(n).then(a=>{t.setState("results",Vt(r,a))})},"keydown .search-input":(e,t)=>{let r=e,o=t.getState("results")??[],n=Number(t.getState("focusIdx")??0);if(r.key==="ArrowDown"){if(r.preventDefault(),o.length===0)return;t.setState("focusIdx",Math.min(o.length-1,n+1));return}if(r.key==="ArrowUp"){if(r.preventDefault(),o.length===0)return;t.setState("focusIdx",Math.max(0,n-1));return}if(r.key==="Enter"){if(o.length===0)return;r.preventDefault();let a=o[n];if(a){let s=t.host,l=String(s.base??"")+a.doc.url.replace(/^\//,"");globalThis.location.href=l}return}},"mouseover .row":(e,t)=>{let r=e.target.closest(".row");if(!r)return;let o=Number(r.dataset.index);Number.isNaN(o)||t.setState("focusIdx",o)}},afterMount(){let e=this,t=r=>{if(r.key.toLowerCase()==="k"&&(r.metaKey||r.ctrlKey)&&!r.altKey){if(r.preventDefault(),!e.setState)return;e.setState("open",!0),e.setState("query",""),e.setState("focusIdx",0),e.setState("results",[]),De(String(e.base??""));return}if(r.key==="/"&&!r.metaKey&&!r.ctrlKey&&!r.altKey){let o=document.activeElement,n=o?.tagName.toLowerCase();if(n==="input"||n==="textarea"||o?.isContentEditable===!0||(r.preventDefault(),!e.setState))return;e.setState("open",!0),e.setState("query",""),e.setState("focusIdx",0),e.setState("results",[]),De(String(e.base??""))}};document.addEventListener("keydown",t),e._searchKeyHandler=t},unmount(){let e=this;e._searchKeyHandler&&document.removeEventListener("keydown",e._searchKeyHandler)},afterRender(){let e=this,t=e.refs?.dialog??null;if(!t)return;let r=e.getState?!!e.getState("open"):!1;if(r&&!t.open){t.showModal(),(e.refs?.input??null)?.focus(),t.addEventListener("close",()=>{e.getState?.("open")&&(e.setState?.("open",!1),e.setState?.("query",""),e.setState?.("results",[]),e.setState?.("focusIdx",0))}),t.addEventListener("click",n=>{n.target===t&&t.close()});return}if(!r&&t.open){t.close();return}if(r){let o=e.refs?.input??null;o&&e.shadowRoot?.activeElement!==o&&o.focus()}}}));
