...
`,je=!1;function Zt(){if(typeof document>"u"||je)return;if(document.querySelector("style[data-tc-tokens]")){je=!0;return}let e=document.createElement("style");e.setAttribute("data-tc-tokens",""),e.textContent=Xt,document.head.insertBefore(e,document.head.firstChild),je=!0}Zt();var Jt=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],Qt=new Set(["string","number","boolean","json"]);function b(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.stylesheet!==void 0&&!(typeof e.stylesheet=="string"||Array.isArray(e.stylesheet)&&e.stylesheet.every(r=>typeof r=="string")))throw new TypeError("describe(): `stylesheet` must be a string or array of strings");if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Jt){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,n]of Object.entries(t)){if(n===null||typeof n!="object"||Array.isArray(n))throw new TypeError(`describe(): props.${r} must be a record`);if(!Qt.has(n.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Ze=Symbol.for("tan-compose.SafeHtml"),ce=class{value;[Ze]=!0;constructor(t){this.value=t}toString(){return this.value}};function Ee(e){return typeof e=="object"&&e!==null&&e[Ze]===!0}function de(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(e){return new ce(String(e??""))}function Je(e){return e==null||e===!1||e===!0?e===!0?"true":"":Ee(e)?e.value:Array.isArray(e)?e.map(Je).join(""):de(e)}function v(e,...t){let r=e[0];for(let n=0;n<t.length;n++)r+=Je(t[n])+e[n+1];return new ce(r)}var Qe=new Map,er=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,tr=/^(\S+)(?:\s+(.+))?$/,rr=new Set(["focus","blur","mouseenter","mouseleave","pointerenter","pointerleave","load","error","scroll"]),et=50;function nr(e){return e.replace(/[A-Z]/g,t=>"-"+t.toLowerCase())}function nt(e){return Ee(e)?e.value:e}function tt(e){return e.replace(/(["\\])/g,"\\$1")}function y(e,t){let r=t;if(typeof e!="string"||!er.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Qe.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let n=r.props??{},o=new Map,a=new Map,s=new Set(r.observedAttributes??[]);for(let m of Object.keys(n)){let c=nr(m);o.set(c,m),o.set(m.toLowerCase(),m),s.add(c),s.add(m.toLowerCase()),a.set(m,c)}let i=Array.from(s),l=r.refs??{},d=sr(r);class g extends HTMLElement{static get observedAttributes(){return i}static get formAssociated(){return r.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;allSlots=new Set;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;renderTick=0;renderTickScheduled=!1;internals;constructor(){super();let c=this.attachShadow({mode:"open"});r.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),ir(c,d),this.container=document.createElement("div"),this.container.className=r.className?`container ${r.className}`:"container",c.appendChild(this.container),r.attributes&&st(this,r.attributes),this.ctx=ar(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[c,u]of Object.entries(n)){let p=this.getAttribute(a.get(c)??c)??this.getAttribute(c),h=p!==null?rt(p,u.type):u.default;this.propValues.set(c,h),this.maybeSyncFormValue(c,h),Object.defineProperty(this,c,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(c),set:x=>{let w=dr(x,u.type),k=this.propValues.get(c);Object.is(k,w)||(this.propValues.set(c,w),u.reflect&&ur(this,a.get(c)??c,w,u.type),this.maybeSyncFormValue(c,w),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(c,u){if(!this.internals||c!=="value")return;let p=u==null?null:String(u);this.internals.setFormValue(p)}connectedCallback(){if(!this.isMounted){try{r.beforeMount?.call(this)}catch(c){console.error(`[tan-compose] beforeMount threw for <${e}>:`,c)}if(this.renderInternal(),r.action){let c=r.action;this.addEventListener("click",c),this.mountCleanups.push(()=>this.removeEventListener("click",c))}if(r.emit)for(let c of r.emit)this.addEventListener(c.name,c.handler),this.mountCleanups.push(()=>this.removeEventListener(c.name,c.handler));r.events&&this.attachDelegatedEvents(r.events),this.isMounted=!0;try{r.afterMount?.call(this)}catch(c){console.error(`[tan-compose] afterMount threw for <${e}>:`,c)}}}disconnectedCallback(){try{r.unmount?.call(this)}catch(c){console.error(`[tan-compose] unmount threw for <${e}>:`,c)}re(this.mountCleanups),re(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){for(let c of this.allSlots){for(let u of c.cache.values())re(u.cleanups);c.cache.clear()}this.allSlots.clear()}attributeChangedCallback(c,u,p){if(u===p)return;let h=o.get(c);if(h){let x=n[h],w=p!==null?rt(p,x.type):x.default,k=this.propValues.get(h);Object.is(k,w)||(this.propValues.set(h,w),this.maybeSyncFormValue(h,w),this.isMounted&&this.scheduleRender());return}this.state.set(c,p),this.isMounted&&this.scheduleRender()}setState(c,u){let p=this.state.get(c);Object.is(p,u)||(this.state.set(c,u),this.isMounted&&this.scheduleRender())}getState(c){return this.state.get(c)}render(){this.renderInternal()}emitEvent(c,u){this.dispatchEvent(new CustomEvent(c,{detail:u,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(c){let u=this.listSlots.get(c);return u||(u={cache:new Map},this.listSlots.set(c,u),this.allSlots.add(u)),u}renderInternal(){if(++this.renderTick>et){console.error(`[tan-compose] <${e}> exceeded ${et} renders in one turn \u2014 aborting to break a render loop (check afterRender / setState).`),this.renderTick=0,this.renderQueued=!1;return}if(!this.renderTickScheduled){this.renderTickScheduled=!0;let u=()=>{this.renderTick=0,this.renderTickScheduled=!1};typeof queueMicrotask=="function"?queueMicrotask(u):Promise.resolve().then(u)}this.rendering=!0;let c=this.captureFocusInShadow();try{re(this.renderCleanups),this.container.replaceChildren();let u={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(r.template!==void 0){let p=typeof r.template=="function"?r.template(this.ctx):r.template,h=nt(p);h&&(this.container.innerHTML=h)}if(r.children)for(let p of r.children){let h=ot(p,u,x=>this.getOrCreateSlot(x));h&&this.container.appendChild(h)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(c&&this.restoreFocusInShadow(c),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{r.afterRender?.call(this)}catch(u){console.error(`[tan-compose] afterRender threw for <${e}>:`,u)}}captureFocusInShadow(){let c=this.shadowRoot;if(!c)return null;let u=c.activeElement;if(!u)return null;let p=[],h=u;for(;h&&h!==c;){let k=h.parentNode;if(!k)break;let $=h.tagName,T=Array.from(k.children).filter(z=>z.tagName===$).indexOf(h);if(p.unshift({tag:$,idx:T}),h=k instanceof Element?k:null,!h&&k===c)break}let x=null,w=null;if(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)try{x=u.selectionStart,w=u.selectionEnd}catch{}return{id:u.id||null,name:u.getAttribute("name"),path:p,selectionStart:x,selectionEnd:w}}restoreFocusInShadow(c){let u=this.shadowRoot;if(!u)return;let p=null;if(c.id&&(p=u.getElementById?.(c.id)??u.querySelector(`[id="${tt(c.id)}"]`)),!p&&c.name&&(p=u.querySelector(`[name="${tt(c.name)}"]`)),!p){let h=u;for(let x of c.path){let w=Array.from(h.children??[]),S=(w.length>0?w:Array.from(h.children??[])).filter(T=>T.tagName===x.tag)[x.idx];if(!S)return;h=S}p=h}if(!(!p||typeof p.focus!="function")&&u.activeElement!==p&&(p.focus(),c.selectionStart!=null&&(p instanceof HTMLInputElement||p instanceof HTMLTextAreaElement)))try{p.setSelectionRange(c.selectionStart,c.selectionEnd??c.selectionStart)}catch{}}refreshRefs(){let c={},u=this.shadowRoot;for(let[p,h]of Object.entries(l))c[p]=u?u.querySelector(h):null;this.currentRefs=c}formAssociatedCallback(c){try{r.formAssociatedCallback?.call(this,c)}catch(u){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,u)}}formDisabledCallback(c){try{r.formDisabledCallback?.call(this,c)}catch(u){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,u)}}formResetCallback(){try{r.formResetCallback?.call(this)}catch(c){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,c)}}formStateRestoreCallback(c,u){try{r.formStateRestoreCallback?.call(this,c,u)}catch(p){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,p)}}attachDelegatedEvents(c){let u=new Map;for(let[p,h]of Object.entries(c)){let x=tr.exec(p.trim());if(!x)continue;let[,w,k]=x;u.has(w)||u.set(w,[]),u.get(w).push({selector:k??null,handler:h})}for(let[p,h]of u){let x=k=>{for(let{selector:$,handler:S}of h){if(!$){S(k,this.ctx);continue}let T=k.composedPath();for(let z of T){if(z===this.shadowRoot||z===this)break;if(z instanceof Element&&this.shadowRoot?.contains(z)&&z.matches($)){S(k,this.ctx);break}}}},w=rr.has(p);this.shadowRoot.addEventListener(p,x,w),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(p,x,w))}}}return Qe.set(e,g),customElements.define(e,g),e}function ot(e,t,r){return e.if&&!e.if(t.ctx)?null:at(e,t,r)}function at(e,t,r){let n=document.createElement(e.tag||"div");if(e.styles&&(n.style.cssText=Object.entries(e.styles).map(([o,a])=>`${o}: ${a}`).join("; ")),e.className&&(n.className=e.className),e.attributes&&st(n,e.attributes),e.template!==void 0){let o=typeof e.template=="function"?e.template(t.ctx):e.template,a=nt(o);a&&(n.innerHTML=a)}if(e.children)for(let o of e.children){let a=ot(o,t,r);a&&n.appendChild(a)}if(e.for&&or(n,e,t,r),e.action){let o=e.action;n.addEventListener("click",o),t.cleanups.push(()=>n.removeEventListener("click",o))}if(e.emit)for(let o of e.emit)n.addEventListener(o.name,o.handler),t.cleanups.push(()=>n.removeEventListener(o.name,o.handler));return n}function or(e,t,r,n){let o=t.for,a=n(t),s=o.items(r.ctx),i=new Map;for(let l=0;l<s.length;l++){let d=s[l],g=o.key(d,l),m,c=a.cache.get(g);if(c&&Object.is(c.lastItem,d))m=c;else{let u=[],p=o.render(d,l,r.ctx),h=at(p,{...r,cleanups:u},n);c&&re(c.cleanups),m={element:h,lastItem:d,cleanups:u}}i.set(g,m),e.appendChild(m.element)}for(let[l,d]of a.cache)i.has(l)||re(d.cleanups);a.cache=i}function ar(e,t,r,n){return{host:e,get props(){let o={};for(let[a,s]of t)o[a]=s;return o},get state(){let o={};for(let[a,s]of r)o[a]=s;return o},get refs(){return n()},setState:(o,a)=>e.setState(o,a),getState:o=>e.getState(o),emit:(o,a)=>e.emitEvent(o,a)}}function sr(e){let t=[];if(e.theme&&t.push(lr(e.theme)),e.stylesheet){let n=Array.isArray(e.stylesheet)?e.stylesheet:[e.stylesheet];for(let o of n)o&&t.push(o)}if(e.styles&&t.push(cr(e.styles)),t.length===0)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];for(let o of t){let a=new CSSStyleSheet;a.replaceSync(o),n.push(a)}return{kind:"adopted",sheets:n}}return{kind:"fallback",cssList:t}}function ir(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}for(let r of t.cssList){let n=document.createElement("style");n.textContent=r,e.appendChild(n)}}function st(e,t){for(let[r,n]of Object.entries(t))e.setAttribute(r,n)}function lr(e){return`:host { ${Object.entries(e).map(([r,n])=>`--${r}: ${n};`).join(" ")} }`}function cr(e){return`.container { ${Object.entries(e).map(([r,n])=>`${r}: ${n};`).join(" ")} }`}function re(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function rt(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function dr(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function ur(e,t,r,n){if(n!=="json"){if(n==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var pr="tc-button";var fr=`
        .root {
...
`;y(pr,b({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""},type:{type:"string",default:"button"}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-btn-padding-x":"initial","tc-btn-padding-y":"initial"},styles:{display:"inline-block","vertical-align":"middle"},stylesheet:fr,template:({props:e})=>{let t=`root v-${ue(e.variant)} s-${ue(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
        <span class="content"><slot></slot></span>`,n=String(e.href??""),o=n.length>0,a=!!(e.disabled||e.loading);if(o){let l=e.target?` target="${ue(e.target)}"`:"",d=e.rel?String(e.rel):String(e.target)==="_blank"?"noopener":"",g=d?` rel="${ue(d)}"`:"",m=a?"":` href="${ue(n)}"`,c=a?' aria-disabled="true"':"",u=a?' tabindex="-1"':"";return v`
          <a
            part="button"
            class="${f(t)}"
            ${f(m)}${f(l)}${f(g)}${f(c)}${f(u)}
...
`;y(gr,b({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},type:{type:"string",default:"text"},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},stylesheet:mr,refs:{input:"input"},template:({props:e})=>{let t=!!e.error;return v`
        ${f(e.label?`<label class="label">${it(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"")}
        <input
        ...
        />
        ${f(e.error||e.helper?`<div class="${t?"error":"helper"}">${it(e.error||e.helper)}</div>`:"")}
      `},events:{"input input":(e,t)=>{let r=e.target.value,n=t.host;n.internals?.setFormValue(r),n.value=r,t.emit("tc-input",{value:r})}},formResetCallback(){this.value=""}}));function it(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var hr="tc-textarea";var br=`
          :host { font-family: var(--tc-input-font); }
          .label {
            display: block; font-size: 0.82rem; font-weight: 600;
            color: var(--tc-input-fg); margin-bottom: 6px;
...
`;y(hr,b({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},rows:{type:"number",default:4},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},resize:{type:"string",default:"vertical"}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},stylesheet:br,refs:{input:"textarea"},template:({props:e})=>{let t=!!e.error;return v`
        ${f(e.label?`<label class="label">${lt(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"")}
        <textarea
          class="input ${t?"invalid":""}"
          part="textarea"
          name="${e.name}"
        ...
        >${e.value}</textarea>
        ${f(e.error||e.helper?`<div class="${t?"error":"helper"}">${lt(e.error||e.helper)}</div>`:"")}
      `},events:{"input textarea":(e,t)=>{let r=e.target.value,n=t.host;n.internals?.setFormValue(r),n.value=r,t.emit("tc-input",{value:r})}},formResetCallback(){this.value=""}}));function lt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var vr="tc-select";var yr=`
          :host { font-family: var(--tc-input-font); }
          .label {
            display: block; font-size: 0.82rem; font-weight: 600;
            color: var(--tc-input-fg); margin-bottom: 6px;
...
`;y(vr,b({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},stylesheet:yr,template:({props:e})=>{let t=e.options??[],r=!!e.error;return v`
        ${f(e.label?`<label class="label">${pe(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"")}
        <div class="wrap">
          <select
          ...
          >
            ${f(e.placeholder?`<option value="" disabled ${e.value===""?"selected":""}>${pe(e.placeholder)}</option>`:"")} ${f(t.map(n=>`<option value="${pe(n.value)}"${n.disabled?" disabled":""}${n.value===e.value?" selected":""}>${pe(n.label)}</option>`).join(""))}
          </select>
          <span class="caret" aria-hidden="true">▾</span>
        </div>
        ${f(e.error||e.helper?`<div class="${r?"error":"helper"}">${pe(e.error||e.helper)}</div>`:"")}
      `},events:{"change select":(e,t)=>{let r=e.target.value,n=t.host;n.internals?.setFormValue(r),n.value=r,t.emit("tc-change",{value:r})}},formResetCallback(){this.value=""}}));function pe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var xr="tc-checkbox";var kr=`
...
`;y(xr,b({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},indeterminate:{type:"boolean",default:!1}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-sm, 4px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-checkbox-accent":"var(--tc-color-accent, #a16939)"},styles:{display:"block"},stylesheet:kr,template:({props:e})=>{let t=!!e.error;return v`
        <label class="row ${e.disabled?"is-disabled":""} ${t?"is-invalid":""}">
          <input
            ...
            aria-invalid="${t?"true":"false"}"
          />
          ${f(e.label?`<span class="label">${ct(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</span>`:"<span></span>")}
        </label>
        ${f(e.error||e.helper?`<div class="${t?"error":"helper"}">${ct(e.error||e.helper)}</div>`:"")}
      `},refs:{input:".cb"},events:{"change .cb":(e,t)=>{let r=e.target.checked,n=t.host;n.checked=r,n.internals?.setFormValue(r?n.value:null),t.emit("tc-change",{checked:r})}},afterMount(){let e=this,r=e.shadowRoot?.querySelector(".cb");r&&(r.indeterminate=e.indeterminate),e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var wr="tc-switch";var $r=`
...
`;y(wr,b({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-switch-track-off":"var(--tc-color-rule-strong, #d9cfb8)","tc-switch-track-on":"var(--tc-color-accent, #a16939)","tc-switch-thumb":"var(--tc-color-surface, #ffffff)","tc-switch-fg":"var(--tc-color-ink, #14171f)","tc-switch-helper":"var(--tc-color-ink-muted, #6b7280)","tc-switch-error":"var(--tc-color-danger, #b3261e)","tc-switch-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},stylesheet:$r,template:({props:e})=>{let t=!!e.error;return v`
        <label class="row ${e.disabled?"is-disabled":""}">
          ...
          ${f(e.label?`<span class="label">${dt(e.label)}</span>`:"")}
        </label>
        ${f(e.error||e.helper?`<div class="${t?"error":"helper"}">${dt(e.error||e.helper)}</div>`:"")}
      `},events:{"click .track":(e,t)=>{let r=t.host;r.disabled||(r.checked=!r.checked,r.internals?.setFormValue(r.checked?r.value:null),t.emit("tc-change",{checked:r.checked}))},"keydown .track":(e,t)=>{let r=e;if(r.key!==" "&&r.key!=="Enter")return;r.preventDefault();let n=t.host;n.disabled||(n.checked=!n.checked,n.internals?.setFormValue(n.checked?n.value:null),t.emit("tc-change",{checked:n.checked}))}},afterMount(){let e=this;e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function dt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Er="tc-file";var Mr=`
          :host { font-family: var(--tc-input-font); color: var(--tc-input-fg); }
          .label {
            display: block; font-size: 0.82rem; font-weight: 600;
            color: var(--tc-input-fg); margin-bottom: 6px;
...
`;y(Er,b({formAssociated:!0,props:{name:{type:"string",default:""},accept:{type:"string",default:""},multiple:{type:"boolean",default:!1,reflect:!0},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},buttonText:{type:"string",default:"Choose file"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-file-zone-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-file-zone-fg":"var(--tc-color-ink-soft, #4a5061)"},styles:{display:"block"},stylesheet:Mr,refs:{input:"input[type='file']"},template:({props:e,state:t})=>{let r=!!e.error,n=t.files??[],o=n.length===0?"No file selected":n.length===1?qe(n[0].name):`${n.length} files selected`;return v`
        ${f(e.label?`<label class="label">${qe(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"")}
...
`,Be=new WeakMap;y(Lr,b({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[b({tag:"style",template:Hr}),b({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),b({tag:"div",className:"wrap",children:[b({tag:"table",children:[b({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],n=t,o=r.map(a=>{let s=n.sortKey===a.key,i=a.sortable!==!1,l=s?n.sortDir==="asc"?"\u25B2":"\u25BC":"",d=s?n.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${pt(a.key)}"
                        class="${i?"sortable":""}"
                        aria-sort="${d}"
                      >${pt(a.label)}<span class="sort">${l}</span></th>`}).join("");return v`
                    <tr>${f(o)}</tr>
                  `}}),b({tag:"tbody",children:[b({tag:"tr",className:"empty",if:({props:e,state:t})=>ut(e,t).length===0,template:({props:e})=>{let r=(e.columns??[]).length||1;return v`
                        <td colspan="${r}">${e.emptyText}</td>
                      `}})],for:{items:({props:e,state:t})=>ut(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let o=r.props.columns??[],a=e;return b({tag:"tr",attributes:{"data-row-id":String(a.id??t)},template:o.map(s=>{let i=typeof s.render=="function"?f(s.render(a)):a[s.key]??"";return v`
                          <td>${i}</td>
                        `.value}).join("")})}}})]})]}),b({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,n=Me(e,r),o=e.pageSize??10,a=Math.max(1,Math.ceil(n.length/o)),s=Math.min(r.page??0,a-1),i=(e.rows??[]).length;return v`
          ...
          `}})],refs:{filter:".filter"},afterRender(){let e=this,t=e.refs.filter;if(!t)return;let r=e.getState("q")??"";t.value!==r&&(t.value=r);let n=Be.get(e);if(n){Be.delete(e),t.focus();let o=Math.min(n.caret,t.value.length);try{t.setSelectionRange(o,o)}catch{}}},events:{"input .filter":(e,t)=>{let r=e.target;Be.set(t.host,{caret:r.selectionStart??r.value.length}),t.setState("q",r.value),t.setState("page",0)},"click .prev":(e,t)=>{let r=(t.state.page??0)-1;t.setState("page",Math.max(0,r))},"click .next":(e,t)=>{let r=t.state,n=Me(t.props,r).length,o=t.props.pageSize??10,a=Math.max(0,Math.ceil(n/o)-1),s=(r.page??0)+1;t.setState("page",Math.min(a,s))},"click th.sortable":(e,t)=>{let r=e.target.closest("th");if(!r)return;let n=r.dataset.col;if(!n)return;let o=t.state,a;o.sortKey!==n?a="asc":a=o.sortDir==="asc"?"desc":o.sortDir==="desc"?null:"asc",t.setState("sortKey",a?n:null),t.setState("sortDir",a),t.emit("tc-sort-change",{key:a?n:null,direction:a})},"click tr[data-row-id]":(e,t)=>{let r=e.target.closest("tr[data-row-id]");if(!r)return;let n=r.dataset.rowId;if(n===void 0)return;let o=Me(t.props,t.state),a=o.find(s=>String(s.id)===n)??o[Number(n)];a&&t.emit("tc-row-click",{row:a})}}}));function Me(e,t){let r=e.rows??[],n=e.columns??[],o=(t.q??"").trim().toLowerCase(),a=o.length===0?r.slice():r.filter(s=>n.some(i=>String(s[i.key]??"").toLowerCase().includes(o)));if(t.sortKey&&t.sortDir){let s=t.sortKey,i=t.sortDir==="asc"?1:-1;a=a.slice().sort((l,d)=>{let g=l[s],m=d[s];return g===m?0:g==null?1:m==null?-1:typeof g=="number"&&typeof m=="number"?(g-m)*i:String(g).localeCompare(String(m))*i})}return a}function ut(e,t){let r=e.pageSize??10,n=Me(e,t),o=Math.max(1,Math.ceil(n.length/r)),a=Math.min(t.page??0,o-1);return n.slice(a*r,a*r+r)}function pt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Cr="tc-tabs";var zr=`
          .strip {
...
`;y(Cr,b({props:{tabs:{type:"json",default:[]},active:{type:"string",default:"",reflect:!0}},theme:{"tc-tabs-fg":"var(--tc-color-ink, #14171f)","tc-tabs-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-tabs-rule":"var(--tc-color-rule, #ece5d3)","tc-tabs-accent":"var(--tc-color-accent, #a16939)","tc-tabs-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block","font-family":"var(--tc-tabs-font)"},stylesheet:zr,template:({props:e})=>{let t=e.tabs??[],r=e.active||t[0]?.id||"";return v`
        <div role="tablist" class="strip">
          ${f(t.map(n=>`<button
              ...
              aria-controls="panel-${ge(n.id)}"
              tabindex="${n.id===r?"0":"-1"}"
            >${ge(n.label)}</button>`).join(""))}
        </div>
        <div class="panels">
          ${f(t.map(n=>`<section
              role="tabpanel"
      ...
      `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{ft(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let n=t.refs.dialog;n&&e.target===n&&ft(r,"backdrop")}},afterRender(){Rr(this)},unmount(){let e=ne.get(this);e&&(e.cleanup(),ne.delete(this))}}));function Rr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let n=e.open,o=ne.get(e);if(o&&o.dialog!==r&&(o.cleanup(),ne.delete(e)),n&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!ne.has(e)){let a=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",a),ne.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",a)})}}else if(!n&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function ft(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function gt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Nr="tc-toast";var me=new WeakMap,Ir=`
          :host { display: block; }
          .toast {
            display: inline-flex; align-items: center; gap: 12px;
            padding: 11px 14px;
...
`;y(Nr,b({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},stylesheet:Ir,template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return v`
        <div class="toast v-${t} ${e.open?"open":"closed"}" role="status" aria-live="polite">
          <span class="icon" aria-hidden="true">${f(r)}</span>
          <span class="msg">${f(e.message?jr(e.message):"<slot></slot>")}</span>
          ${f(e.dismissible?'<button type="button" class="x" aria-label="Close">\xD7</button>':"")}
        </div>
      `},events:{"click .x":(e,t)=>mt(t.host,"button")},afterMount(){Dr(this)},unmount(){let e=me.get(this);e!==void 0&&(clearTimeout(e),me.delete(this))}}));function Dr(e){let t=e,r=me.get(e);if(r!==void 0&&clearTimeout(r),me.delete(e),!t.open||!t.duration||t.duration<=0)return;let n=setTimeout(()=>{t.open&&mt(e,"timeout")},t.duration);me.set(e,n)}function mt(e,t){let r=e;r.open&&(r.open=!1,e.dispatchEvent(new CustomEvent("tc-toast-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function jr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var qr="tc-stat";var Br=`
...
`;y(qr,b({props:{label:{type:"string",default:""},value:{type:"string",default:""},delta:{type:"string",default:""},trend:{type:"string",default:"neutral"},prefix:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-stat-surface":"var(--tc-color-surface, #ffffff)","tc-stat-rule":"var(--tc-color-rule, #ece5d3)","tc-stat-label":"var(--tc-color-ink-muted, #6b7280)","tc-stat-value":"var(--tc-color-ink, #14171f)","tc-stat-up":"var(--tc-color-success, #207a5b)","tc-stat-down":"var(--tc-color-danger, #b3261e)","tc-stat-neutral":"var(--tc-color-ink-muted, #6b7280)","tc-stat-radius":"var(--tc-radius-lg, 12px)","tc-stat-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block",height:"100%"},stylesheet:Br,template:({props:e})=>{let t=String(e.trend??"neutral"),r=t==="up"?"\u25B2":t==="down"?"\u25BC":"\u2022";return v`
        <div class="card">
          ${e.label?f(`<div class="label">${he(e.label)}</div>`):""}
          <div class="value">
            ${e.prefix?f(`<span class="prefix">${he(e.prefix)}</span>`):""}
            <span class="num">${e.value}</span>
            ${e.suffix?f(`<span class="suffix">${he(e.suffix)}</span>`):""}
          </div>
          ${e.delta?f(`<div class="delta t-${he(t)}">
                  <span class="arrow" aria-hidden="true">${r}</span>
                  <span>${he(e.delta)}</span>
                </div>`):""}
        </div>
      `}}));function he(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var _r="tc-card";var Or=`
  :host { display: block; }
  .card {
...
`;y(Fr,b({props:{variant:{type:"string",default:"neutral"},size:{type:"string",default:"md"},pill:{type:"boolean",default:!1}},theme:{"tc-badge-radius":"var(--tc-radius-sm, 6px)","tc-badge-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-badge-neutral-bg":"var(--tc-color-rule, #ece5d3)","tc-badge-neutral-fg":"var(--tc-color-ink, #14171f)","tc-badge-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-badge-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-badge-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-badge-success-fg":"var(--tc-color-success-fg, #155b40)","tc-badge-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-badge-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-badge-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-badge-danger-fg":"var(--tc-color-danger-fg, #7a1a14)"},styles:{display:"inline-block"},stylesheet:Pr,template:({props:e})=>v`
        <span class="badge v-${e.variant} s-${e.size} ${e.pill?"pill":""}">
          <slot></slot>
        </span>
      `}));var Vr="tc-skeleton";var Yr=`
  .bone {
...
`;y(Gr,b({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},stylesheet:Kr,template:({props:e})=>v`
        <div
          class="stack"
          style="--tc-stack-gap: ${Ur(e.gap)}; --tc-stack-align: ${e.align};"
        >
          <slot></slot>
        </div>
      `}));function Ur(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Wr(t)})`:t}function Wr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}var Xr="tc-cluster";var Zr=`
  .cluster {
    display: flex;
    flex-direction: row;
...
`;y(Xr,b({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},stylesheet:Zr,template:({props:e})=>v`
        <div
          class="cluster"
          style="--tc-cluster-gap: ${Qr(e.gap)};
            --tc-cluster-justify: ${Jr(e.justify)};
            --tc-cluster-align: ${e.align};
            --tc-cluster-wrap: ${e.wrap?"wrap":"nowrap"};"
          >
            <slot></slot>
          </div>
        `}));function Jr(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Qr(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${en(t)})`:t}function en(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}var tn="tc-grid";var rn=`
  .grid {
    display: grid;
    grid-template-columns: var(--tc-grid-template);
    gap: var(--tc-grid-gap);
  }
`;y(tn,b({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},stylesheet:rn,template:({props:e})=>{let t=String(e.columns??"").trim(),r=t?`repeat(${de(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${de(e.min)}, 1fr))`;return v`
        <div
          class="grid"
          style="--tc-grid-template: ${f(r)};
            --tc-grid-gap: ${nn(e.gap)};"
          >
            <slot></slot>
          </div>
        `}}));function nn(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${on(t)})`:t}function on(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}var an="tc-code";var sn='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>',ln='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',cn=`
  :host { display: block; }
  .block {
...
`;y(un,b({props:{variant:{type:"string",default:"note"},title:{type:"string",default:""},compact:{type:"boolean",default:!1}},theme:{"tc-callout-radius":"var(--tc-radius-md, 8px)","tc-callout-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-callout-note-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-callout-note-fg":"var(--tc-color-ink-soft, #4a5061)","tc-callout-note-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-callout-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-callout-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-callout-info-border":"var(--tc-color-info, #3a5b8c)","tc-callout-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-callout-success-fg":"var(--tc-color-success-fg, #155b40)","tc-callout-success-border":"var(--tc-color-success, #207a5b)","tc-callout-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-callout-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-callout-warning-border":"var(--tc-color-warning, #a87326)","tc-callout-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-callout-danger-fg":"var(--tc-color-danger-fg, #7a1a14)","tc-callout-danger-border":"var(--tc-color-danger, #b3261e)"},styles:{display:"block"},stylesheet:pn,template:({props:e})=>{let t=String(e.variant??"note"),r=ht[t]??ht.note;return v`
        <aside
      ...
      `}}));var fn="tc-toc";var Se=new WeakMap,gn=`
...
`;y(fn,b({props:{target:{type:"string",default:"main"},levels:{type:"string",default:"h2,h3"},sticky:{type:"boolean",default:!0},label:{type:"string",default:"On this page"}},theme:{"tc-toc-fg":"var(--tc-color-ink, #14171f)","tc-toc-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-toc-active":"var(--tc-color-accent, #a16939)","tc-toc-rule":"var(--tc-color-rule, #ece5d3)","tc-toc-label":"var(--tc-color-ink-soft, #4a5061)","tc-toc-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-toc-top":"80px"},styles:{display:"block"},stylesheet:gn,template:({props:e,state:t})=>{let r=t.items??[],n=t.activeId??"";return v`
        <nav
        ...
        >
          ${e.label?v`
            ...
            `:""} ${r.length===0?f('<p class="empty">No sections yet.</p>'):f(`<ol class="list">${r.map(o=>`<li class="lvl-${o.level}${o.id===n?" active":""}"><a href="#${bt(o.id)}">${bt(o.text)}</a></li>`).join("")}</ol>`)}
        </nav>
      `},afterMount(){mn(this)},unmount(){Se.get(this)?.observer?.disconnect(),Se.delete(this)}}));function mn(e){Se.get(e)?.observer?.disconnect();let r=e,n=r.target||"main",o=(r.levels||"h2,h3").split(",").map(d=>d.trim().toLowerCase()).filter(Boolean),a=document.querySelector(n);if(!a)return;let s=Array.from(a.querySelectorAll(o.join(","))).filter(d=>d instanceof HTMLElement),i=s.map(d=>(d.id||(d.id=hn(d.textContent??"")),{id:d.id,level:parseInt(d.tagName.slice(1),10),text:(d.textContent??"").trim()}));if(e.setState("items",i),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(d=>{let m=d.filter(u=>u.isIntersecting).sort((u,p)=>u.boundingClientRect.top-p.boundingClientRect.top)[0];if(!m)return;let c=m.target.id;c&&e.setState("activeId",c)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let d of s)l.observe(d);Se.set(e,{observer:l,activeId:""})}function hn(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function bt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var bn="tc-pagination";var vn=`
          :host { display: block; }
          nav {
            display: inline-flex;
            align-items: center;
...
`;y(bn,b({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},stylesheet:vn,template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=yn(Number(e.current)|0,1,t),n=Math.max(0,Number(e.siblings)|0),o=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let a=xn(r,t,n,o),s=kn(String(e.size??"sm")),i=r<=1?" disabled":"",l=r>=t?" disabled":"",d=a.map(g=>{if(g==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let m=g===r;return`<tc-button
            class="num"
            size="${s}"
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let n=r.getAttribute("data-page");if(n==null)return;let o=Number(n),a=t.host,s=Math.max(1,Number(a.total)|0),i=Number(a.current)|0;!Number.isFinite(o)||o<1||o>s||o!==i&&t.emit("tc-page-change",{page:o})}}}));function yn(e,t,r){return Math.min(r,Math.max(t,e))}function xn(e,t,r,n){let o=new Set;for(let i=1;i<=Math.min(n,t);i++)o.add(i);for(let i=Math.max(1,t-n+1);i<=t;i++)o.add(i);for(let i=Math.max(1,e-r);i<=Math.min(t,e+r);i++)o.add(i);let a=[...o].sort((i,l)=>i-l),s=[];for(let i=0;i<a.length;i++)i>0&&a[i]-a[i-1]>1&&s.push("\u2026"),s.push(a[i]);return s}function kn(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var wn="tc-combobox";function be(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function ve(e){return e.join(",")}function $n(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var En=`
          :host {
            display: block;
            position: relative;
          }
...
`;y(wn,b({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},stylesheet:En,refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],n=!!e.multiple,o=e.searchable!==!1,a=!!e.disabled,s=!!e.error,i=be(e.value),l=String(t.query??""),d=!!t.open&&!a,g=Number(t.focusedIndex??-1),m=vt(r,l),c=new Set(i),u=i.map(M=>r.find(P=>P.value===M)).filter(M=>!!M),p=o&&(d||n&&i.length===0),h=!n&&i.length===1&&(!d||!o),x=i.length===0&&!p&&!h,w=n?u.map(M=>`<span class="chip" data-value="${D(M.value)}">
              ${M.icon?`<span class="chip-icon">${D(M.icon)}</span>`:""}
              <span class="chip-label">${D(M.label)}</span>
              <button
                type="button"
                class="chip-remove"
                data-remove="${D(M.value)}"
                aria-label="Remove ${D(M.label)}"
                ${a?"disabled":""}
              >&times;</button>
            </span>`).join(""):"",k=h&&u[0]?`<span class="single">
            ${u[0].icon?`<span class="single-icon">${D(u[0].icon)}</span>`:""}
            <span class="single-label">${D(u[0].label)}</span>
          </span>`:"",$=x?`<span class="placeholder">${D(e.placeholder??"")}</span>`:"",S=p?`<input
            type="text"
            class="search"
            part="search"
            value="${D(l)}"
            placeholder="${D(i.length===0?e.placeholder??"":"")}"
            ${a?"disabled":""}
            autocomplete="off"
            aria-autocomplete="list"
            aria-expanded="${d?"true":"false"}"
            role="combobox"
          />`:"",T=m.length===0?`<div class="empty">${D(e["empty-text"]??"No results")}</div>`:m.map((M,P)=>{let j=c.has(M.value);return`<div
              class="${["option",j?"selected":"",P===g?"focused":"",M.disabled?"disabled":""].filter(Boolean).join(" ")}"
              role="option"
              data-value="${D(M.value)}"
              data-index="${P}"
              aria-selected="${j?"true":"false"}"
              ${M.disabled?'aria-disabled="true"':""}
            >
              ${n?`<span class="check" aria-hidden="true">${j?"\u2713":""}</span>`:""}
              ${M.icon?`<span class="opt-icon">${D(M.icon)}</span>`:""}
              <span class="opt-label">${D(M.label)}</span>
            </div>`}).join(""),z=e.label?`<label class="label">${D(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",se=s?`<div class="helper error">${D(e.error)}</div>`:e.helper?`<div class="helper">${D(e.helper)}</div>`:"";return v`
        ${f(z)}
        <div
        ...
        ${f(se)}
      `},events:{"click .control":(e,t)=>{if(e.target.closest(".chip-remove")||t.host.disabled)return;let o=!!t.getState("open");t.setState("open",!0),o||t.emit("tc-open"),t.refs.search?.focus()},"keydown .control":(e,t)=>{let r=e;if(r.key==="Enter"||r.key===" "){if(r.preventDefault(),t.host.disabled)return;t.setState("open",!0),t.emit("tc-open"),t.refs.search?.focus()}},"input .search":(e,t)=>{let r=e.target.value;t.setState("query",r),t.setState("open",!0),t.setState("focusedIndex",0),t.emit("tc-search",{query:r})},"keydown .search":(e,t)=>{let r=e,n=e.target,o=t.host,a=!!o.multiple,s=o.options??[],i=vt(s,String(t.getState("query")??""));if(r.key==="Backspace"&&n.value===""&&a){let l=be(o.value);l.length>0&&(l.pop(),o.value=ve(l),Te(t,l,o),t.emit("tc-change",{value:l.slice()}),r.preventDefault());return}if(r.key==="ArrowDown"){r.preventDefault(),t.setState("open",!0);let l=Number(t.getState("focusedIndex")??-1),d=Math.min(i.length-1,l+1);t.setState("focusedIndex",d);return}if(r.key==="ArrowUp"){r.preventDefault();let l=Number(t.getState("focusedIndex")??0),d=Math.max(0,l-1);t.setState("focusedIndex",d);return}if(r.key==="Enter"){r.preventDefault();let l=Number(t.getState("focusedIndex")??-1);l>=0&&l<i.length&&yt(t,i[l],o);return}if(r.key==="Escape"){r.preventDefault(),t.setState("open",!1),t.setState("query",""),t.emit("tc-close");return}},"mousedown .option":(e,t)=>{e.preventDefault();let r=e.target.closest(".option");if(!r||r.classList.contains("disabled"))return;let n=r.dataset.value;if(n==null)return;let o=t.host,s=(o.options??[]).find(i=>i.value===n);s&&yt(t,s,o)},"click .chip-remove":(e,t)=>{e.stopPropagation();let n=e.target.dataset.remove;if(n==null)return;let o=t.host,a=be(o.value).filter(s=>s!==n);o.value=ve(a),Te(t,a,o),t.emit("tc-change",{value:a.slice()})},"focusout .control":(e,t)=>{queueMicrotask(()=>{t.host.matches(":focus-within")||(t.setState("open",!1),t.setState("query",""),t.emit("tc-close"))})}},afterMount(){let e=this;if(!e.multiple||!e.internals)return;let t=be(e.value),r=String(e.name??"");if(!r){e.internals.setFormValue(ve(t));return}let n=new FormData;for(let o of t)n.append(r,o);e.internals.setFormValue(n)},afterRender(){let e=this;if(!(e.getState?!!e.getState("open"):!1))return;let r=e.refs?.search??null;if(!r||e.shadowRoot?.activeElement===r)return;r.focus();let o=r.value.length;try{r.setSelectionRange(o,o)}catch{}}}));function vt(e,t){if(!t)return e;let r=new RegExp($n(t),"i");return e.filter(n=>r.test(n.label)||r.test(n.value))}function yt(e,t,r){let n=!!r.multiple,o=Number(r.max??0),a=be(r.value);if(n){let s;if(a.includes(t.value))s=a.filter(i=>i!==t.value);else{if(o>0&&a.length>=o)return;s=a.concat(t.value)}r.value=ve(s),Te(e,s,r),e.setState("query",""),e.emit("tc-change",{value:s.slice()}),queueMicrotask(()=>{e.refs.search?.focus()})}else r.value=t.value,Te(e,[t.value],r),e.setState("query",""),e.setState("open",!1),e.emit("tc-change",{value:t.value}),e.emit("tc-close")}function Te(e,t,r){let n=r.internals;if(!n)return;let o=String(r.name??"");if(!r.multiple){n.setFormValue(t[0]??"");return}if(!o){n.setFormValue(ve(t));return}let a=new FormData;for(let s of t)a.append(o,s);n.setFormValue(a)}function D(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mn="tc-carousel";var Sn=`
...
`;function xt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Le(e){let t=0;for(let r of Array.from(e.children))r instanceof Element&&!r.hasAttribute("slot")&&t++;return t}function $t(e,t,r){return t<=0?0:r?(e%t+t)%t:Math.max(0,Math.min(t-1,e))}function Y(e,t){let r=Le(e);if(r===0)return;let n=e.value,o=$t(t,r,e.loop);o!==n&&(e.value=o,e.dispatchEvent(new CustomEvent("tc-change",{detail:{index:o,previous:n},bubbles:!0,composed:!0})))}function kt(e){_e(e),!(e.autoplay<=0)&&(Le(e)<=1||(e._carouselTimer=globalThis.setInterval(()=>{Y(e,e.value+1)},e.autoplay)))}function _e(e){e._carouselTimer!==void 0&&(globalThis.clearInterval(e._carouselTimer),e._carouselTimer=void 0)}y(Mn,b({props:{value:{type:"number",default:0,reflect:!0},autoplay:{type:"number",default:0},loop:{type:"boolean",default:!0},orientation:{type:"string",default:"horizontal"},transition:{type:"string",default:"slide"},indicators:{type:"boolean",default:!0},controls:{type:"boolean",default:!0},swipe:{type:"boolean",default:!0},pauseOnHover:{type:"boolean",default:!0},ariaLabel:{type:"string",default:"Carousel"},height:{type:"string",default:""}},theme:{"tc-carousel-radius":"var(--tc-radius-lg, 12px)","tc-carousel-bg":"var(--tc-color-bg, #faf8f3)","tc-carousel-control-bg":"rgba(255, 255, 255, 0.85)","tc-carousel-control-bg-hover":"rgba(255, 255, 255, 1)","tc-carousel-control-fg":"var(--tc-color-ink, #14171f)","tc-carousel-control-size":"36px","tc-carousel-indicator":"rgba(20, 23, 31, 0.25)","tc-carousel-indicator-active":"var(--tc-color-accent, #a16939)","tc-carousel-duration":"320ms"},styles:{display:"block",position:"relative"},stylesheet:Sn,template:({props:e})=>{let t=Number(e.value??0),r=String(e.orientation)==="vertical",n=String(e.transition)==="fade",o=String(e.height??""),a=!!e.controls,s=!!e.indicators,i=xt(e.ariaLabel??"Carousel");return v`
        <div
          class="root ${r?"v":"h"} ${n?"fade":"slide"}"
          role="region"
          aria-roledescription="carousel"
          aria-label="${f(i)}"
          style="${f(o?`--tc-carousel-height: ${xt(o)};`:"")}--tc-carousel-index: ${t};"
        >
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;Y(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;Y(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let n=Number(r.dataset.index);if(!Number.isFinite(n))return;let o=t.host;Y(o,n)},"keydown .root":(e,t)=>{let r=e,n=t.host,o=n.orientation==="vertical",a=Le(n),s=o?"ArrowUp":"ArrowLeft",i=o?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),Y(n,n.value-1)):r.key===i?(r.preventDefault(),Y(n,n.value+1)):r.key==="Home"?(r.preventDefault(),Y(n,0)):r.key==="End"&&(r.preventDefault(),Y(n,a-1))}},afterMount(){let e=this,t=()=>wt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let n=e.shadowRoot,o=n?.querySelector("slot"),a=()=>t();o?.addEventListener("slotchange",a),e._carouselSlotObs=()=>{r.disconnect(),o?.removeEventListener("slotchange",a)};let s=()=>_e(e),i=()=>{e.pauseOnHover&&kt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",i),e.addEventListener("focusin",s),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",s),e.removeEventListener("focusout",i)},Tn(e),n?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&kt(e)},afterRender(){wt(this)},unmount(){let e=this;_e(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function wt(e){let t=Le(e),r=e.shadowRoot;if(!r)return;let n=r.querySelector(".root");if(n&&t>0){let i=$t(e.value,t,e.loop);i!==e.value&&(e.value=i),n.style.setProperty("--tc-carousel-index",String(i))}let o=r.querySelector(".indicators");if(o){let i=e.value,l="";for(let d=0;d<t;d++)l+=`<button type="button" class="dot" role="tab" data-index="${d}"
        aria-current="${d===i?"true":"false"}"
        aria-label="Go to slide ${d+1}"></button>`;o.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function Tn(e){let t=0,r=0,n=!1,o=40,a=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,n=!0))},s=l=>{if(!n)return;n=!1;let d=l.clientX-t,g=l.clientY-r,c=e.orientation==="vertical"?g:d;Math.abs(c)<o||Y(e,e.value+(c<0?1:-1))},i=()=>{n=!1};e.addEventListener("pointerdown",a),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",a),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",i)}}var G="tc-accordion";var Ln=`
...
`;y(G,b({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},stylesheet:Ln,template:({props:e})=>v`
        <div class="root ${e.bordered?"bordered":""}">
          <slot></slot>
        </div>
      `,afterMount(){let e=this;Hn();let t=a=>{let s=a.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let i of He(e))i!==s&&i.open&&(i.open=!1);Cn(e)}},r=a=>{let s=a.target;if(!s||s.tagName!=="SUMMARY")return;let i=He(e).map(g=>g.querySelector("summary")).filter(g=>!!g),l=i.indexOf(s);if(l===-1)return;let d=-1;a.key==="ArrowDown"?d=(l+1)%i.length:a.key==="ArrowUp"?d=(l-1+i.length)%i.length:a.key==="Home"?d=0:a.key==="End"&&(d=i.length-1),d!==-1&&(a.preventDefault(),i[d]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let n=()=>{for(let a of He(e)){let s=a.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",s.appendChild(i);let l=()=>{i.style.transform=a.open?"rotate(90deg)":"rotate(0)"};l(),a.addEventListener("toggle",l)}}};n();let o=new MutationObserver(n);o.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),o.disconnect()}},unmount(){this._accordionCleanup?.()}}));var Et="tc-accordion-light-styles";function Hn(){if(typeof document>"u"||document.getElementById(Et))return;let e=document.createElement("style");e.id=Et,e.textContent=`
    ${G} details { background: transparent; }
    ${G} details + details {
    ...
    ${G} details > summary::marker { content: ""; }
    ${G} details > summary:hover { background: rgba(20, 23, 31, 0.03); }
    ${G} details > summary:focus-visible {
      outline: 2px solid var(--tc-accordion-accent, #a16939);
      outline-offset: -2px;
    }
  `,(document.head||document.documentElement).appendChild(e)}function He(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function Cn(e){let t=[];for(let r of He(e))if(r.open){let n=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(n)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var zn="tc-tooltip";var An=`
...
`;y(Nn,b({props:{open:{type:"boolean",default:!1,reflect:!0},placement:{type:"string",default:"bottom"},offset:{type:"number",default:8},dismissible:{type:"boolean",default:!0}},theme:{"tc-popover-bg":"var(--tc-color-surface, #ffffff)","tc-popover-fg":"var(--tc-color-ink, #14171f)","tc-popover-rule":"var(--tc-color-rule, #ece5d3)","tc-popover-radius":"var(--tc-radius-md, 8px)","tc-popover-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.18))","tc-popover-padding":"12px 14px","tc-popover-min-width":"200px","tc-popover-max-width":"340px","tc-popover-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative"},stylesheet:In,template:()=>v`
...
`,oe=new WeakMap;function Lt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}y(Dn,b({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},stylesheet:jn,template:({props:e})=>{let t=String(e.side??"right"),r=Lt(e.size??"min(420px, 92vw)");return v`
        <dialog
          class="dlg side-${t}"
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Ht(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let n=t.refs.dialog;n&&e.target===n&&Ht(r,"backdrop")}},afterRender(){qn(this)},unmount(){let e=oe.get(this);e&&(e.cleanup(),oe.delete(this))}}));function qn(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let n=e.open,o=oe.get(e);if(o&&o.dialog!==r&&(o.cleanup(),oe.delete(e)),n&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!oe.has(e)){let a=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",a),oe.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",a)})}}else if(!n&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Ht(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var Bn="tc-progress";function Ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function _n(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}y(Bn,b({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),n=!!e.indeterminate,o=Number(e.value??0),a=Number(e.max??100),s=_n(o,a),i=e.label||(n?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let g=r==="sm"?28:r==="lg"?72:48,m=r==="sm"?3:r==="lg"?6:4,c=(g-m)/2,u=2*Math.PI*c,p=n?u*.25:s/100*u,h=n?`role="progressbar" aria-valuetext="${Ce(i)}"`:`role="progressbar" aria-valuenow="${o}" aria-valuemin="0" aria-valuemax="${a}"`;return v`
          <div class="circ size-${r} ${n?"indet":""}" ${f(h)}>
            ...
            ${f(e.showLabel?`<span class="label" aria-hidden="true">${Ce(i)}</span>`:"")}
          </div>
          <style>
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,d=n?`role="progressbar" aria-valuetext="${Ce(i)}"`:`role="progressbar" aria-valuenow="${o}" aria-valuemin="0" aria-valuemax="${a}"`;return v`
      ...
      `}}));var On="tc-stepper";function Ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}y(On,b({props:{steps:{type:"json",default:[]},active:{type:"number",default:0,reflect:!0},orientation:{type:"string",default:"horizontal"},clickable:{type:"boolean",default:!1}},theme:{"tc-stepper-bg":"transparent","tc-stepper-ink":"var(--tc-color-ink, #14171f)","tc-stepper-soft":"var(--tc-color-ink-soft, #4a5061)","tc-stepper-rule":"var(--tc-color-rule, #ece5d3)","tc-stepper-accent":"var(--tc-color-accent, #a16939)","tc-stepper-done":"var(--tc-color-success, #2f7a52)","tc-stepper-radius":"999px","tc-stepper-marker-size":"28px","tc-stepper-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.steps??[],r=Number(e.active??0),n=String(e.orientation)==="vertical",o=!!e.clickable,a=t.map((s,i)=>{let l=i<r?"done":i===r?"current":"upcoming",d=l==="done"?'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>':`${i+1}`;return`
          <li class="step state-${l}" data-index="${i}">
            <${o?"button":"div"} class="row" ${o?`type="button" aria-current="${l==="current"?"step":"false"}"`:`aria-current="${l==="current"?"step":"false"}"`}>
              ...
              <span class="text">
                <span class="title">${Ct(s.title)}</span>
                ${s.description?`<span class="desc">${Ct(s.description)}</span>`:""}
              </span>
            </${o?"button":"div"}>
      ...
      `},events:{"click .row":(e,t)=>{let r=t.host;if(!r.clickable)return;let n=e.target.closest(".step");if(!n)return;let o=Number(n.dataset.index);if(!Number.isFinite(o)||o===r.active)return;let a=r.active;r.active=o,t.emit("tc-step-change",{active:o,previous:a})}}}));var Fn="tc-avatar";var Pn=`
...
`;function Q(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function zt(e){let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?"":t.length===1?t[0].slice(0,2).toUpperCase():(t[0][0]+t[t.length-1][0]).toUpperCase()}var Oe=[["#dde6f4","#1f3a66"],["#dbece2","#155b40"],["#efe2cf","#8a572d"],["#f4dad7","#7a1a14"],["#e3dcf1","#3d2a73"],["#d5e8e5","#0d4f49"],["#fbe3c5","#7a4f0a"]];function Vn(e){if(!e)return Oe[0];let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;let r=Math.abs(t)%Oe.length;return Oe[r]}y(Fn,b({props:{src:{type:"string",default:""},alt:{type:"string",default:""},name:{type:"string",default:""},size:{type:"string",default:"md"},shape:{type:"string",default:"circle"},status:{type:"string",default:""},ring:{type:"boolean",default:!1}},theme:{"tc-avatar-bg":"var(--tc-color-rule, #ece5d3)","tc-avatar-fg":"var(--tc-color-ink, #14171f)","tc-avatar-ring":"var(--tc-color-surface, #ffffff)","tc-avatar-status-online":"#2f7a52","tc-avatar-status-away":"#d7a52f","tc-avatar-status-busy":"#b3261e","tc-avatar-status-offline":"#9aa0a6","tc-avatar-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative","vertical-align":"middle"},stylesheet:Pn,template:({props:e})=>{let t=String(e.name??""),r=String(e.src??""),n=String(e.alt??"")||t||"avatar",o=String(e.size??"md"),a=String(e.shape??"circle"),s=String(e.status??""),i=!!e.ring,[l,d]=Vn(t);return v`
        <span
          class="root size-${o} shape-${a} ${i?"ringed":""}"
          style="--tc-avatar-tint-bg: ${l}; --tc-avatar-tint-fg: ${d};"
        >
          ${r?f(`<img src="${Q(r)}" alt="${Q(n)}" loading="lazy" onerror="this.replaceWith(Object.assign(document.createElement('span'),{className:'fallback',textContent:'${Q(zt(t))}'}))">`):f(`<span class="fallback" aria-label="${Q(n)}">${Q(zt(t))}</span>`)} ${s?f(`<span class="status status-${Q(s)}" aria-label="${Q(s)}"></span>`):""}
        </span>
      `}}));var Yn="tc-avatar-group";var Gn=`
  :host {
    display: inline-flex;
...
`;y(Yn,b({props:{max:{type:"number",default:4},spacing:{type:"string",default:"normal"},size:{type:"string",default:"md"}},theme:{"tc-avatar-group-ring":"var(--tc-color-surface, #ffffff)","tc-avatar-group-overflow-bg":"var(--tc-color-rule, #ece5d3)","tc-avatar-group-overflow-fg":"var(--tc-color-ink, #14171f)"},styles:{display:"inline-flex"},stylesheet:Gn,template:()=>v`
        <span class="row"><slot></slot><span class="overflow" hidden></span></span>
      `,afterMount(){let e=this,t=()=>At(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){At(this)},unmount(){this._agroupCleanup?.()}}));function At(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),n=Array.from(e.children).filter(l=>l instanceof HTMLElement),o=0;for(let l of n)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),o<t||t===0?(l.hidden=!1,o++):l.hidden=!0);let a=n.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,s=Math.max(0,a-o),i=e.shadowRoot?.querySelector(".overflow");i&&(s>0?(i.hidden=!1,i.textContent=`+${s}`):i.hidden=!0)}var Kn="tc-rating";var Rt="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";y(Kn,b({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),n=Number(e.value??0),o=Number(t.hover??-1),a=o>=0?o:n,s=String(e.size??"md"),i=!!e.readonly,l=!!e.allowHalf,d=String(e.ariaLabel??"Rating"),g=s==="sm"?18:s==="lg"?32:24,m=[];for(let c=1;c<=r;c++){let u=a-(c-1),p=u>=1?100:u>=.5&&l?50:u>0&&!l?100:0,h=p===50;m.push(`
          <span class="star ${h?"half":p===100?"full":"empty"}" data-index="${c}">
            <svg viewBox="0 0 24 24" width="${g}" height="${g}" aria-hidden="true">
              <path class="track" d="${Rt}" fill="var(--tc-rating-track)" />
              ${p>0?`<path class="fill" d="${Rt}" fill="var(--tc-rating-fill)" clip-path="${h?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
...
`;function Fe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}y(Un,b({props:{value:{type:"number",default:0,reflect:!0},min:{type:"number",default:0},max:{type:"number",default:100},step:{type:"number",default:1},disabled:{type:"boolean",default:!1,reflect:!0},showValue:{type:"boolean",default:!1},showTicks:{type:"boolean",default:!1},label:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-slider-track":"var(--tc-color-rule, #ece5d3)","tc-slider-fill":"var(--tc-color-accent, #a16939)","tc-slider-thumb":"var(--tc-color-surface, #ffffff)","tc-slider-thumb-ring":"var(--tc-color-accent, #a16939)","tc-slider-radius":"999px","tc-slider-thumb-size":"20px","tc-slider-track-size":"6px","tc-slider-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-slider-fg":"var(--tc-color-ink, #14171f)","tc-slider-fg-muted":"var(--tc-color-ink-muted, #6b7280)"},styles:{display:"block"},stylesheet:Wn,template:({props:e})=>{let t=Number(e.value??0),r=Number(e.min??0),n=Number(e.max??100),o=Number(e.step??1),a=!!e.disabled,s=n>r?(t-r)/(n-r)*100:0,i=String(e.label??""),l=String(e.suffix??""),d=!!e.showValue,g=!!e.showTicks,m="";if(g&&o>0){let c=Math.floor((n-r)/o)+1;if(c<=50){let u=[];for(let p=0;p<c;p++){let x=(r+p*o-r)/(n-r)*100;u.push(`<span class="tick" style="left:${x.toFixed(2)}%"></span>`)}m=u.join("")}}return v`
        ${f(i||d?`<div class="head">
              ${i?`<label for="r" class="lbl">${Fe(i)}</label>`:"<span></span>"}
              ${d?`<span class="val">${Fe(String(t))}${Fe(l)}</span>`:""}
            </div>`:"")}
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,n=t.host,o=Number(r.value);n.value!==o&&(n.value=o,t.emit("tc-input",{value:o}))},"change .range":(e,t)=>{let r=e.target,n=t.host,o=Number(r.value);t.emit("tc-change",{value:o,previous:n.value})}}}));var Xn="tc-chart";function Nt(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),n=e/Math.pow(10,r),o;return t?n<1.5?o=1:n<3?o=2:n<7?o=5:o=10:n<=1?o=1:n<=2?o=2:n<=5?o=5:o=10,o*Math.pow(10,r)}function Zn(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let n=Nt(t-e,!1),o=Nt(n/(r-1),!0),a=Math.floor(e/o)*o,s=Math.ceil(t/o)*o,i=[];for(let l=a;l<=s+o*.5;l+=o)i.push(Number(l.toFixed(10)));return{min:a,max:s,ticks:i}}function Pe(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(n=>`${n.x} ${n.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let n=0;n<e.length-1;n++){let o=e[n-1]??e[n],a=e[n],s=e[n+1],i=e[n+2]??s,l=a.x+(s.x-o.x)/6,d=a.y+(s.y-o.y)/6,g=s.x-(i.x-a.x)/6,m=s.y-(i.y-a.y)/6;r+=` C ${l},${d} ${g},${m} ${s.x},${s.y}`}return r}function ye(e,t,r,n){return{x:e+r*Math.sin(n),y:t-r*Math.cos(n)}}function Jn(e,t,r,n,o,a){let s=a-o>Math.PI?1:0,i=ye(e,t,r,o),l=ye(e,t,r,a);if(n<=0)return`M ${e} ${t} L ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} Z`;let d=ye(e,t,n,a),g=ye(e,t,n,o);return`M ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} L ${d.x} ${d.y} A ${n} ${n} 0 ${s} 0 ${g.x} ${g.y} Z`}function C(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ee(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function xe(e,t){return t[e%t.length]}function Qn(e,t){let{data:r,smooth:n,stacked:o,showAxes:a,showGrid:s,showLabels:i,showValues:l}=e,d=r.labels??[],g=r.series??[],m=t==="sparkline",c=m?4:16,u=m?4:a&&i?28:8,p=m?4:a?44:8,h=m?4:12,x=e.W-p-h,w=e.H-c-u,k=1/0,$=-1/0;if(o&&g.length>0){let L=d.length>0?d.map((E,R)=>g.reduce((N,_)=>N+(_.values?.[R]??0),0)):[];for(let E of L)E<k&&(k=E),E>$&&($=E);k>0&&(k=0)}else for(let L of g)for(let E of L.values??[])E<k&&(k=E),E>$&&($=E);(!Number.isFinite(k)||!Number.isFinite($))&&(k=0,$=1),k===$&&(k-=1,$+=1);let S=Zn(e.yMin??k,e.yMax??$,5),T=e.yMin??S.min,z=e.yMax??S.max,se=z-T||1,M=d.length||g[0]?.values?.length||0,P=L=>M===1?p+x/2:t==="bar"?p+(L+.5)*(x/M):p+L/(M-1)*x,j=L=>c+w-(L-T)/se*w,te=[];if(!m){if(s)for(let L of S.ticks){let E=j(L);te.push(`<line class="grid" x1="${p}" x2="${e.W-h}" y1="${E}" y2="${E}"/>`)}if(a){for(let E of S.ticks){let R=j(E);te.push(`<text class="axis-label y" x="${p-8}" y="${R}" text-anchor="end" dominant-baseline="middle">${C(ee(E))}</text>`)}if(i&&d.length>0){let E=Math.max(1,Math.ceil(d.length/8));d.forEach((R,N)=>{N%E!==0&&N!==d.length-1||te.push(`<text class="axis-label x" x="${P(N)}" y="${e.H-u+16}" text-anchor="middle">${C(R)}</text>`)})}let L=T<=0&&z>=0?j(0):j(T);te.push(`<line class="axis" x1="${p}" x2="${e.W-h}" y1="${L}" y2="${L}"/>`)}}let F=[];if(t==="bar"){let L=x/M,E=L*.18,R=L-E*2;g.forEach((N,_)=>{let Z=`series series-${_}`,q=xe(_,e.palette),B=0;N.values?.forEach((H,O)=>{if(!Number.isFinite(H))return;let V=P(O),J,we,$e,De;if(o){J=V-R/2,we=R;let ie=j(B+H),le=j(B);$e=Math.min(ie,le),De=Math.abs(ie-le),B+=H}else{let ie=R/g.length;J=V-R/2+_*ie,we=ie*.86;let le=j(H),Xe=j(T<0&&z>0?0:T);$e=Math.min(le,Xe),De=Math.abs(le-Xe)}let We=`${C(N.name)}${d[O]?` \xB7 ${C(d[O])}`:""}: ${C(ee(H))}`,Wt=(O*.04).toFixed(3);F.push(`<g class="${Z}"><rect class="hit" x="${J}" y="${$e}" width="${we}" height="${De}" rx="2" fill="${q}" data-tip="${We}" data-color="${q}" style="animation-delay: ${Wt}s"><title>${We}</title></rect>`+(l?`<text class="value-label" x="${J+we/2}" y="${$e-4}" text-anchor="middle">${C(ee(H))}</text>`:"")+"</g>")})})}else if(o&&t==="area"){let L=new Array(M).fill(0);g.forEach((E,R)=>{let N=xe(R,e.palette),_=[],Z=[];for(let H=0;H<M;H++){let O=E.values?.[H]??0,V=L[H]+O;_.push({x:P(H),y:j(V)}),Z.push({x:P(H),y:j(L[H])}),L[H]=V}let q=Pe(_,n)+" L "+Z.slice().reverse().map(H=>`${H.x} ${H.y}`).join(" L ")+" Z",B=(R*.15).toFixed(3);F.push(`<path class="series-fill series-${R}" d="${q}" fill="${N}" fill-opacity="0.25" pointer-events="none" style="animation-delay: ${B}s"/>`),F.push(`<path class="series-line series-${R}" d="${Pe(_,n)}" stroke="${N}" fill="none" pointer-events="none" style="animation-delay: ${B}s"/>`),_.forEach((H,O)=>{let V=E.values?.[O]??0,J=`${C(E.name)}${d[O]?` \xB7 ${C(d[O])}`:""}: ${C(ee(V))}`;F.push(`<circle class="hit series-${R}" cx="${H.x}" cy="${H.y}" r="12" fill="transparent" data-tip="${J}" data-color="${N}"><title>${J}</title></circle>`)})})}else g.forEach((L,E)=>{let R=xe(E,e.palette),N=(L.values??[]).map((q,B)=>({x:P(B),y:j(q)})),_=Pe(N,n),Z=(E*.15).toFixed(3);if(t==="area"){let q=j(T<0&&z>0?0:T),B=_+` L ${N[N.length-1].x} ${q} L ${N[0].x} ${q} Z`;F.push(`<path class="series-fill series-${E}" d="${B}" fill="${R}" fill-opacity="0.25" style="animation-delay: ${Z}s"/>`)}F.push(`<path class="series-line series-${E}" d="${_}" stroke="${R}" fill="none" style="animation-delay: ${Z}s"/>`),m||N.forEach((q,B)=>{let H=L.values?.[B],O=`${C(L.name)}${d[B]?` \xB7 ${C(d[B])}`:""}: ${C(ee(H??0))}`,V=(E*.15+B*.025+.55).toFixed(3);F.push(`<circle class="series-point series-${E}" cx="${q.x}" cy="${q.y}" r="3.5" fill="${R}" pointer-events="none" style="animation-delay: ${V}s"/>`),F.push(`<circle class="hit series-${E}" cx="${q.x}" cy="${q.y}" r="12" fill="transparent" data-tip="${O}" data-color="${R}"><title>${O}</title></circle>`),l&&F.push(`<text class="value-label" x="${q.x}" y="${q.y-8}" text-anchor="middle" pointer-events="none">${C(ee(H??0))}</text>`)})});return te.join("")+F.join("")}function eo(e){let t=e.data.series??[],r=t.reduce((d,g)=>d+(g.value??0),0);if(r<=0)return"";let n=e.W/2,o=e.H/2,a=Math.min(e.W,e.H)/2-4,s=Math.max(0,Math.min(.9,e.innerRadius))*a,i=0,l=[];return t.forEach((d,g)=>{let m=d.value??0;if(m<=0)return;let c=m/r*Math.PI*2,u=i,p=i+c,h=Jn(n,o,a,s,u,p-.01),x=xe(g,e.palette),w=(m/r*100).toFixed(1).replace(/\.0$/,""),k=`${C(d.name)}: ${C(ee(m))} (${w}%)`,$=(g*.08).toFixed(3);if(l.push(`<path class="series-segment hit series-${g}" d="${h}" fill="${x}" data-tip="${k}" data-color="${x}" style="animation-delay: ${$}s"><title>${k}</title></path>`),e.showValues){let S=(u+p)/2,T=(a+s)/2,z=ye(n,o,T,S);l.push(`<text class="value-label donut" x="${z.x}" y="${z.y}" text-anchor="middle" dominant-baseline="middle">${C(w)}%</text>`)}i=p}),l.join("")}function to(e,t,r){return e.length===0?"":'<div class="legend" part="legend">'+e.map((n,o)=>{let a=xe(o,t),s=r.includes(n.name);return`<button class="${s?"legend-item is-hidden":"legend-item"}" type="button" data-series="${C(n.name)}" aria-pressed="${s?"true":"false"}" title="${s?"Show":"Hide"} series '${C(n.name)}'"><span class="swatch" style="background:${a}"></span>${C(n.name)}</button>`}).join("")+"</div>"}function ro(e,t){if(e==="donut"){let o=(t.series??[]).reduce((s,i)=>s+(i.value??0),0);return`Donut chart: ${(t.series??[]).filter(s=>(s.value??0)>0).map(s=>{let i=o>0?(s.value??0)/o*100:0;return`${s.name} ${i.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(o=>o.name).join(", "),n=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${n} data point${n===1?"":"s"}.`}var no=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],oo=`
...
`;y(so,b({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Start writing\u2026"},toolbar:{type:"string",default:jt},readonly:{type:"boolean",default:!1,reflect:!0},minHeight:{type:"string",default:"180px"},maxHeight:{type:"string",default:""},pasteAs:{type:"string",default:"text"}},theme:{"tc-editor-bg":"var(--tc-color-surface, #ffffff)","tc-editor-fg":"var(--tc-color-ink, #14171f)","tc-editor-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-editor-toolbar-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-fg":"var(--tc-color-ink-soft, #4a5061)","tc-editor-toolbar-active-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-editor-toolbar-hover-bg":"rgba(20, 23, 31, 0.06)","tc-editor-placeholder":"var(--tc-color-ink-muted, #6b7280)","tc-editor-radius":"var(--tc-radius-md, 8px)","tc-editor-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-editor-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, 'SF Mono', monospace)","tc-editor-line-height":"1.6"},styles:{display:"block"},stylesheet:lo,template:({props:e})=>{let t=String(e.toolbar??jt),r=!!e.readonly,n=K(String(e.minHeight??"180px")),o=String(e.maxHeight??"").trim(),a=t.split(",").map(d=>d.trim()).filter(Boolean),s=a.map(d=>{if(d==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let g=io[d];if(!g)return"";let m=g.shortcut?` (${K(g.shortcut)})`:"";return`<button type="button" class="tb-btn" data-cmd="${K(g.command)}"${g.value?` data-val="${K(g.value)}"`:""} data-key="${K(g.key)}" title="${K(g.label)}${m}" aria-label="${K(g.label)}">${g.icon}</button>`}).join(""),i=a.length===0?"toolbar empty":r?"toolbar readonly":"toolbar",l=`--tc-editor-min-height: ${n};${o?`--tc-editor-max-height: ${K(o)};`:""}`;return v`
      ...
      `},afterMount(){qt(this),_t(this)},afterRender(){let e=this,r=e.shadowRoot?.querySelector(".surface");if(r){let n=r.innerHTML,o=String(e.value??"");o&&n!==o&&document.activeElement!==e&&(r.innerHTML=o),Ve(r)}qt(e),_t(e)},unmount(){this._editorCleanup?.()}}));function Ve(e){let t=e.textContent?.trim()===""&&e.querySelector("img, hr, br")===null;e.dataset.empty=t?"true":"false"}function qt(e){let t=e;t._editorCleanup?.();let r=t.shadowRoot;if(!r)return;let n=r.querySelector(".surface");if(!n)return;n.dataset.bootstrapped||(t.value&&(n.innerHTML=String(t.value)),n.dataset.bootstrapped="1"),Ve(n);let o=(c,u)=>{if(!t.readonly){if(n.focus(),c==="code"){let h=r.getSelection?.()??globalThis.getSelection();if(!h||h.rangeCount===0)return;let x=h.getRangeAt(0),w=x.extractContents(),k=document.createElement("code");k.className="tc-code-inline",k.appendChild(w),x.insertNode(k),x.selectNodeContents(k),h.removeAllRanges(),h.addRange(x)}else if(c==="link"){let p=globalThis.prompt("URL")?.trim();if(!p)return;document.execCommand("createLink",!1,p)}else if(c==="math"){let p=globalThis.prompt("LaTeX (e.g. E = mc^2). Wrap with $$ for display.")?.trim();if(!p)return;let h=p.startsWith("$$")&&p.endsWith("$$"),x=h?p.replace(/^\$\$|\$\$$/g,"").trim():p;co(t,x,h)}else if(c==="codeblock"){let p=r.getSelection?.()??globalThis.getSelection();if(!p||p.rangeCount===0)return;let h=p.getRangeAt(0),x=h.toString()||"// code",w=document.createElement("pre"),k=document.createElement("code");k.textContent=x,w.appendChild(k),h.deleteContents(),h.insertNode(w);let $=document.createRange();$.selectNodeContents(k),$.collapse(!1),p.removeAllRanges(),p.addRange($)}else c==="formatBlock"?document.execCommand("formatBlock",!1,`<${u??"p"}>`):document.execCommand(c,!1,u);Bt(t,n),Ot(r,n)}},a=c=>{let u=c.target?.closest?.(".tb-btn");if(!u)return;c.preventDefault();let p=u.dataset.cmd;p&&o(p,u.dataset.val)},s=()=>{Ve(n),Bt(t,n)},i=()=>{let c=n.innerHTML;t._lastEmitted!==c&&(t._lastEmitted=c,t.dispatchEvent(new CustomEvent("tc-change",{detail:{html:c},bubbles:!0,composed:!0})))},l=c=>{if(t.readonly||t.pasteAs!=="text")return;c.preventDefault();let u=c.clipboardData?.getData("text/plain")??"";document.execCommand("insertText",!1,u)},d=c=>{if(t.readonly||!(c.metaKey||c.ctrlKey))return;let u=c.key.toLowerCase();u==="b"?(c.preventDefault(),o("bold")):u==="i"?(c.preventDefault(),o("italic")):u==="u"?(c.preventDefault(),o("underline")):u==="k"&&(c.preventDefault(),o("link"))},g=()=>{let c=globalThis.getSelection();!c||!c.anchorNode||n.contains(c.anchorNode)&&Ot(r,n)},m=r.querySelector(".toolbar");m?.addEventListener("click",a),n.addEventListener("input",s),n.addEventListener("blur",i),n.addEventListener("paste",l),n.addEventListener("keydown",d),document.addEventListener("selectionchange",g),t._editorCleanup=()=>{m?.removeEventListener("click",a),n.removeEventListener("input",s),n.removeEventListener("blur",i),n.removeEventListener("paste",l),n.removeEventListener("keydown",d),document.removeEventListener("selectionchange",g)}}function Bt(e,t){let r=t.innerHTML;e.value=r,e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:r},bubbles:!0,composed:!0}))}function co(e,t,r){let n=e.shadowRoot;if(!n)return;let o=n.querySelector(".surface");if(!o)return;let a=n.getSelection?.()??globalThis.getSelection();if(!a||a.rangeCount===0)return;let s=a.getRangeAt(0),i=document.createElement(r?"div":"span");i.className=r?"tc-math display":"tc-math inline",i.setAttribute("contenteditable","false"),i.dataset.latex=t,i.innerHTML=Ft(e,t,r),s.deleteContents(),s.insertNode(i);let l=document.createTextNode("\u200B");i.parentNode?.insertBefore(l,i.nextSibling);let d=document.createRange();d.setStartAfter(l),d.collapse(!0),a.removeAllRanges(),a.addRange(d),e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:o.innerHTML},bubbles:!0,composed:!0}))}function Ft(e,t,r){if(e.mathRenderer)try{return e.mathRenderer(t,r)}catch{}return`<code class="tc-math-src">${t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code>`}function _t(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".surface");if(!r)return;r.querySelectorAll(".tc-math").forEach(o=>{let a=o,s=a.dataset.latex??"",i=a.classList.contains("display"),l=`${i?"d":"i"}:${s}`;a.dataset.stamp!==l&&(a.innerHTML=Ft(e,s,i),a.dataset.stamp=l)})}function Ot(e,t){e.querySelectorAll(".tb-btn").forEach(n=>{let o=n,a=o.dataset.cmd??"",s=o.dataset.val,i=!1;try{a==="formatBlock"&&s?i=(document.queryCommandValue("formatBlock")||"").toLowerCase().replace(/^[<]|[>]$/g,"")===s:(a==="bold"||a==="italic"||a==="underline"||a==="strikeThrough"||a==="insertOrderedList"||a==="insertUnorderedList")&&(i=document.queryCommandState(a))}catch{i=!1}o.classList.toggle("is-active",i)})}var uo="tc-markdown";function A(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ze="\0M\0";function po(e,t){let r=[],n=(s,i)=>{let l=r.length;return r.push({latex:s,display:i}),`${ze}${l}${ze}`},o=e;o=o.replace(/\$\$([\s\S]+?)\$\$/g,(s,i)=>n(i.trim(),!0)),o=o.replace(/(^|[\s(])\$([^\$\n][^\$\n]*?)\$(?=[\s.,;:!?)\]]|$)/g,(s,i,l)=>`${i}${n(l.trim(),!1)}`);let a=A(o);return a=a.replace(/`([^`]+)`/g,"<code>$1</code>"),a=a.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),a=a.replace(/(?<!\*)\*([^*\n]+?)\*(?!\*)/g,"<em>$1</em>"),a=a.replace(/\b_(.+?)_\b/g,"<em>$1</em>"),a=a.replace(/~~(.+?)~~/g,"<del>$1</del>"),a=a.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(s,i,l)=>`<img src="${A(l)}" alt="${A(i)}" loading="lazy"/>`),a=a.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(s,i,l)=>`<a href="${A(l)}" target="_blank" rel="noopener">${i}</a>`),a=a.replace(new RegExp(`${ze}(\\d+)${ze}`,"g"),(s,i)=>{let l=r[Number(i)];if(!l)return"";let d=l.latex;if(t)try{let g=t(d,l.display);return l.display?`<div class="tc-md-math display" data-latex="${A(d)}">${g}</div>`:`<span class="tc-md-math inline" data-latex="${A(d)}">${g}</span>`}catch(g){return l.display?`<div class="tc-md-math error" title="${A(String(g))}">${A(d)}</div>`:`<span class="tc-md-math error" title="${A(String(g))}">${A(d)}</span>`}return l.display?`<div class="tc-md-math fallback display" data-latex="${A(d)}"><code>${A(d)}</code></div>`:`<span class="tc-md-math fallback inline" data-latex="${A(d)}"><code>${A(d)}</code></span>`}),a}function fo(e){let t=e.match(/^\[([ xX])\]\s+(.*)$/);return t?`<li class="tc-md-task"><input type="checkbox" disabled${t[1].toLowerCase()==="x"?" checked":""}/><span>${t[2]}</span></li>`:""}function go(e,t){let r=(a,s,i)=>{let l=i&&i!=="left"?` style="text-align:${i}"`:"";return`<${s}${l}>${a}</${s}>`},n=e[0]?.map((a,s)=>r(a,"th",t[s])).join("")??"",o=e.slice(1).map(a=>`<tr>${a.map((s,i)=>r(s,"td",t[i])).join("")}</tr>`).join("");return`<table class="tc-md-table"><thead><tr>${n}</tr></thead><tbody>${o}</tbody></table>`}function Ge(e,t){let r=t?.mathRenderer,n=t?.highlight,o=e.replace(/\r\n?/g,`
`).split(`
`),a=[],s=0,i=l=>po(l,r);for(;s<o.length;){let l=o[s],d=l.match(/^:::\s*([a-zA-Z][\w-]*)(?:\s+(.+))?\s*$/);if(d){let p=d[1].toLowerCase(),h=(d[2]??"").trim(),x=[];for(s++;s<o.length&&!/^:::\s*$/.test(o[s]);)x.push(o[s]),s++;s<o.length&&s++;let w=Ge(x.join(`
`),t);a.push(`<div class="tc-md-callout v-${A(p)}" role="${p==="danger"?"alert":"note"}">${h?`<div class="callout-title">${i(h)}</div>`:""}<div class="callout-body">${w}</div></div>`);continue}let g=l.match(/^```(\S*)\s*$/);if(g){let p=g[1]??"",h=[];for(s++;s<o.length&&!/^```\s*$/.test(o[s]);)h.push(o[s]),s++;s<o.length&&s++;let x=h.join(`
`),w=n&&p?(()=>{try{return n(x,p)}catch{return A(x)}})():A(x),k=p?` class="lang-${A(p)}"`:"";a.push(`<pre><code${k}>${w}</code></pre>`);continue}let m=l.match(/^(#{1,6})\s+(.*)$/);if(m){let p=m[1].length;a.push(`<h${p}>${i(m[2])}</h${p}>`),s++;continue}if(/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(l.trim())){a.push("<hr/>"),s++;continue}if(/^\s*\|.+\|\s*$/.test(l)&&s+1<o.length&&/^\s*\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?\s*$/.test(o[s+1])){let p=l.trim().replace(/^\||\|$/g,"").split("|").map(k=>k.trim()),h=o[s+1].trim().replace(/^\||\|$/g,"").split("|").map(k=>{let $=k.trim(),S=$.startsWith(":"),T=$.endsWith(":");return S&&T?"center":T?"right":S?"left":""}),x=[];for(s+=2;s<o.length&&/^\s*\|.+\|\s*$/.test(o[s]);)x.push(o[s].trim().replace(/^\||\|$/g,"").split("|").map(k=>i(k.trim()))),s++;let w=[p.map(k=>i(k)),...x];a.push(go(w,h));continue}if(/^>\s?/.test(l)){let p=[];for(;s<o.length&&/^>\s?/.test(o[s]);)p.push(o[s].replace(/^>\s?/,"")),s++;a.push(`<blockquote>${i(p.join(" "))}</blockquote>`);continue}let c=l.match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(c){let p=!!c[3],h=p?"ol":"ul",x=[],w=!1;for(;s<o.length;){let $=o[s].match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(!$||!!$[3]!==p)break;let T=$[4],z=fo(T);z?(w=!0,x.push(z)):x.push(`<li>${i(T)}</li>`),s++}let k=w?' class="tc-md-tasks"':"";a.push(`<${h}${k}>${x.join("")}</${h}>`);continue}if(l.trim()===""){s++;continue}let u=[l];for(s++;s<o.length;){let p=o[s];if(p.trim()===""||/^#{1,6}\s+/.test(p)||/^```/.test(p)||/^>\s?/.test(p)||/^:::/.test(p)||/^(\s*)(?:[-*+]|\d+\.)\s+/.test(p)||/^\s*\|.+\|\s*$/.test(p)||/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(p.trim()))break;u.push(p),s++}a.push(`<p>${i(u.join(" "))}</p>`)}return a.join(`
`)}var Pt={bold:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4h7a4 4 0 0 1 0 8H6z"/><path d="M6 12h8a4 4 0 0 1 0 8H6z"/></svg>',italic:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>',heading:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6v12"/><path d="M12 6v12"/><path d="M4 12h8"/><path d="M16 18l4-12"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',link:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',bullet:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><circle cx="4" cy="6" r="1.2" fill="currentColor"/><circle cx="4" cy="12" r="1.2" fill="currentColor"/><circle cx="4" cy="18" r="1.2" fill="currentColor"/></svg>',ordered:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><path d="M4 8V4l-1 1"/><path d="M3 14h2l-2 3h2"/></svg>',quote:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h3v6H4v-3a3 3 0 0 1 3-3z"/><path d="M16 7h3v6h-6v-3a3 3 0 0 1 3-3z"/></svg>',preview:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'};function Ye(e,t,r,n,o,a="text"){let s=e.slice(t,r)||a;return{text:e.slice(0,t)+n+s+o+e.slice(r),selStart:t+n.length,selEnd:t+n.length+s.length}}function Ae(e,t,r,n){let o=e.lastIndexOf(`
`,t-1)+1,a=(()=>{let l=e.indexOf(`
`,r);return l===-1?e.length:l})(),i=e.slice(o,a).split(`
`).map(l=>n+l).join(`
`);return{text:e.slice(0,o)+i+e.slice(a),selStart:o,selEnd:o+i.length}}var Gt={bold:{key:"bold",label:"Bold",shortcut:"\u2318B",apply:(e,t,r)=>Ye(e,t,r,"**","**","bold text")},italic:{key:"italic",label:"Italic",shortcut:"\u2318I",apply:(e,t,r)=>Ye(e,t,r,"*","*","italic text")},heading:{key:"heading",label:"Heading",apply:(e,t,r)=>Ae(e,t,r,"## ")},code:{key:"code",label:"Code",apply:(e,t,r)=>Ye(e,t,r,"`","`","code")},link:{key:"link",label:"Link",shortcut:"\u2318K",apply:(e,t,r)=>{let n=globalThis.prompt?.("URL")?.trim();if(!n)return{text:e,selStart:t,selEnd:r};let o=e.slice(t,r)||"link text";return{text:e.slice(0,t)+`[${o}](${n})`+e.slice(r),selStart:t+1,selEnd:t+1+o.length}}},bullet:{key:"bullet",label:"Bulleted list",apply:(e,t,r)=>Ae(e,t,r,"- ")},ordered:{key:"ordered",label:"Numbered list",apply:(e,t,r)=>Ae(e,t,r,"1. ")},quote:{key:"quote",label:"Quote",apply:(e,t,r)=>Ae(e,t,r,"> ")}},Vt="bold,italic,heading,|,bullet,ordered,quote,|,link,code",mo=`
    :host {
      display: block;
...
`;y(uo,b({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Write some markdown\u2026"},mode:{type:"string",default:"split"},readonly:{type:"boolean",default:!1},minHeight:{type:"string",default:"240px"},toolbar:{type:"string",default:Vt}},theme:{"tc-md-bg":"var(--tc-color-surface, #ffffff)","tc-md-fg":"var(--tc-color-ink, #14171f)","tc-md-rule":"var(--tc-color-rule, #ece5d3)","tc-md-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-md-preview-bg":"var(--tc-color-bg, #faf8f3)","tc-md-radius":"var(--tc-radius-md, 8px)","tc-md-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-md-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)"},styles:{display:"block"},stylesheet:mo,refs:{source:"textarea",preview:".preview"},template:({props:e,state:t})=>{let r=String(t.mode??e.mode??"split"),n=String(e.value??""),o=String(e.toolbar??Vt).split(",").map(c=>c.trim()).filter(Boolean),a=o.map(c=>{if(c==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let u=Gt[c];if(!u||!Pt[u.key])return"";let p=u.shortcut?` (${A(u.shortcut)})`:"";return`<button type="button" class="tb-btn" data-op="${A(u.key)}" title="${A(u.label)}${p}" aria-label="${A(u.label)}">${Pt[u.key]}</button>`}).join(""),s=(c,u)=>`<button type="button" data-mode="${c}" class="${r===c?"is-active":""}" aria-pressed="${r===c?"true":"false"}">${u}</button>`,i=e,d=(i.render??(c=>Ge(c,{mathRenderer:i.mathRenderer,highlight:i.highlight})))(n),g=r==="source"?"panes source-only":r==="preview"?"panes preview-only":"panes",m=`--tc-md-min-height: ${e.minHeight??"240px"};`;return v`
      ...
      `}}));function ae(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ko="site-search";var W=null,Ne=null;function Ie(e){if(W)return Promise.resolve(W);if(Ne)return Ne;let t=`${e}search.json`;return Ne=fetch(t).then(r=>r.json()).then(r=>(W=r.docs??[],W)).catch(r=>(console.warn("[site-search] failed to load index:",r),W=[],W)),Ne}function Ut(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Kt(e,t){let r=e.trim().toLowerCase();if(!r)return[];let n=r.split(/\s+/).filter(Boolean).map(a=>({raw:a,re:new RegExp(Ut(a),"i")})),o=[];for(let a of t){let s=a.title.toLowerCase(),i=(a.description??"").toLowerCase(),l=(a.text??"").toLowerCase(),d=0;for(let m of n){let c=m.raw;s===c&&(d+=50),s.startsWith(c)&&(d+=20),s.includes(c)&&(d+=10),i.includes(c)&&(d+=5),l.includes(c)&&(d+=1)}n.every(m=>m.re.test(a.title)||m.re.test(i)||m.re.test(l))&&d!==0&&(a.category==="blog"&&a.date&&(Date.now()-new Date(a.date).getTime())/864e5<30&&(d+=3),o.push({doc:a,score:d}))}return o.sort((a,s)=>s.score-a.score),o.slice(0,12)}function wo(e,t,r=140){let n=e.trim().toLowerCase().split(/\s+/)[0];if(!n)return t.slice(0,r);let a=t.toLowerCase().indexOf(n);if(a===-1)return t.slice(0,r);let s=Math.max(0,a-40),i=Math.min(t.length,s+r),l=s>0?"\u2026 ":"",d=i<t.length?" \u2026":"";return l+t.slice(s,i)+d}function X(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ue(e,t){let r=t.trim();if(!r)return X(e);let n=r.split(/\s+/).filter(Boolean),o=X(e);for(let a of n){let s=new RegExp(`(${Ut(X(a))})`,"gi");o=o.replace(s,"<mark>$1</mark>")}return o}function $o(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var Eo=`
        <style>
          :host { display: inline-block; }
...
`;y(ko,b({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),n=String(t.query??""),o=Number(t.focusIdx??0),a=t.results??[],s=`
      ...
      `,i=n.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':a.length===0?`<div class="empty">No results for "${X(n)}". Try a shorter query.</div>`:a.map((d,g)=>{let m=g===o?"row focused":"row",c=r+d.doc.url.replace(/^\//,""),u=wo(n,d.doc.text);return`
              <a class="${m}" data-index="${g}" href="${X(c)}">
                <span class="row-cat ${X(d.doc.category)}">${X(d.doc.category)}</span>
                <div class="row-main">
                  <div class="row-title">${Ue(d.doc.title,n)}</div>
                  <div class="row-desc">${Ue(d.doc.description,n)}</div>
                  <div class="row-snippet">${Ue(u,n)}</div>
                </div>
              </a>
            `}).join(""),l=`
      ...
      `;return s+l+Eo},events:{"click .trigger":(e,t)=>{let r=t.host,n=String(r.base??"");t.setState("open",!0),t.setState("query",""),t.setState("focusIdx",0),t.setState("results",[]),Ie(n)},"click .close":(e,t)=>$o(t),"input .search-input":(e,t)=>{let r=e.target.value,n=t.host,o=String(n.base??"");t.setState("query",r),t.setState("focusIdx",0),W?t.setState("results",Kt(r,W)):Ie(o).then(a=>{t.setState("results",Kt(r,a))})},"keydown .search-input":(e,t)=>{let r=e,n=t.getState("results")??[],o=Number(t.getState("focusIdx")??0);if(r.key==="ArrowDown"){if(r.preventDefault(),n.length===0)return;t.setState("focusIdx",Math.min(n.length-1,o+1));return}if(r.key==="ArrowUp"){if(r.preventDefault(),n.length===0)return;t.setState("focusIdx",Math.max(0,o-1));return}if(r.key==="Enter"){if(n.length===0)return;r.preventDefault();let a=n[o];if(a){let s=t.host,l=String(s.base??"")+a.doc.url.replace(/^\//,"");globalThis.location.href=l}return}},"mouseover .row":(e,t)=>{let r=e.target.closest(".row");if(!r)return;let n=Number(r.dataset.index);Number.isNaN(n)||t.setState("focusIdx",n)}},afterMount(){let e=this,t=r=>{if(r.key.toLowerCase()==="k"&&(r.metaKey||r.ctrlKey)&&!r.altKey){if(r.preventDefault(),!e.setState)return;e.setState("open",!0),e.setState("query",""),e.setState("focusIdx",0),e.setState("results",[]),Ie(String(e.base??""));return}if(r.key==="/"&&!r.metaKey&&!r.ctrlKey&&!r.altKey){let n=document.activeElement,o=n?.tagName.toLowerCase();if(o==="input"||o==="textarea"||n?.isContentEditable===!0||(r.preventDefault(),!e.setState))return;e.setState("open",!0),e.setState("query",""),e.setState("focusIdx",0),e.setState("results",[]),Ie(String(e.base??""))}};document.addEventListener("keydown",t),e._searchKeyHandler=t},unmount(){let e=this;e._searchKeyHandler&&document.removeEventListener("keydown",e._searchKeyHandler)},afterRender(){let e=this,t=e.refs?.dialog??null;if(!t)return;let r=e.getState?!!e.getState("open"):!1;if(r&&!t.open){t.showModal(),(e.refs?.input??null)?.focus(),t.addEventListener("close",()=>{e.getState?.("open")&&(e.setState?.("open",!1),e.setState?.("query",""),e.setState?.("results",[]),e.setState?.("focusIdx",0))}),t.addEventListener("click",o=>{o.target===t&&t.close()});return}if(!r&&t.open){t.close();return}if(r){let n=e.refs?.input??null;n&&e.shadowRoot?.activeElement!==n&&n.focus()}}}));
