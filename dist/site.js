...
`,Be=!1;function Zt(){if(typeof document>"u"||Be)return;if(document.querySelector("style[data-tc-tokens]")){Be=!0;return}let e=document.createElement("style");e.setAttribute("data-tc-tokens",""),e.textContent=Jt,document.head.insertBefore(e,document.head.firstChild),Be=!0}Zt();var Qt=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],er=new Set(["string","number","boolean","json"]);function m(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Qt){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,n]of Object.entries(t)){if(n===null||typeof n!="object"||Array.isArray(n))throw new TypeError(`describe(): props.${r} must be a record`);if(!er.has(n.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Qe=new Map,tr=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,rr=/^(\S+)(?:\s+(.+))?$/;function h(e,t){if(typeof e!="string"||!tr.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Qe.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),n=t.props??{},a=t.refs??{},o=or(t);class s extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let l=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),sr(l,o),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",l.appendChild(this.container),t.attributes&&at(this,t.attributes),this.ctx=ar(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[l,c]of Object.entries(n)){let d=this.getAttribute(l),u=d!==null?et(d,c.type):c.default;this.propValues.set(l,u),this.maybeSyncFormValue(l,u),Object.defineProperty(this,l,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(l),set:p=>{let g=cr(p,c.type),f=this.propValues.get(l);Object.is(f,g)||(this.propValues.set(l,g),c.reflect&&dr(this,l,g,c.type),this.maybeSyncFormValue(l,g),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(l,c){if(!this.internals||l!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(l){console.error(`[tan-compose] beforeMount threw for <${e}>:`,l)}if(this.renderInternal(),t.action){let l=t.action;this.addEventListener("click",l),this.mountCleanups.push(()=>this.removeEventListener("click",l))}if(t.emit)for(let l of t.emit)this.addEventListener(l.name,l.handler),this.mountCleanups.push(()=>this.removeEventListener(l.name,l.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(l){console.error(`[tan-compose] afterMount threw for <${e}>:`,l)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(l){console.error(`[tan-compose] unmount threw for <${e}>:`,l)}te(this.mountCleanups),te(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){nt(t,l=>{let c=this.listSlots.get(l);if(c){for(let d of c.cache.values())te(d.cleanups);c.cache.clear()}})}attributeChangedCallback(l,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(n,l)){let u=n[l],p=d!==null?et(d,u.type):u.default,g=this.propValues.get(l);Object.is(g,p)||(this.propValues.set(l,p),this.isMounted&&this.scheduleRender());return}this.state.set(l,d),this.isMounted&&this.scheduleRender()}}setState(l,c){let d=this.state.get(l);Object.is(d,c)||(this.state.set(l,c),this.isMounted&&this.scheduleRender())}getState(l){return this.state.get(l)}render(){this.renderInternal()}emitEvent(l,c){this.dispatchEvent(new CustomEvent(l,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(l){let c=this.listSlots.get(l);return c||(c={cache:new Map},this.listSlots.set(l,c)),c}renderInternal(){this.rendering=!0;let l=this.captureFocusInShadow();try{te(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let u=tt(d,c,p=>this.getOrCreateSlot(p));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(l&&this.restoreFocusInShadow(l),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let l=this.shadowRoot;if(!l)return null;let c=l.activeElement;if(!c)return null;let d=[],u=c;for(;u&&u!==l;){let f=u.parentNode;if(!f)break;let b=u.tagName,x=Array.from(f.children).filter(y=>y.tagName===b).indexOf(u);if(d.unshift({tag:b,idx:x}),u=f instanceof Element?f:null,!u&&f===l)break}let p=null,g=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{p=c.selectionStart,g=c.selectionEnd}catch{}return{path:d,selectionStart:p,selectionEnd:g}}restoreFocusInShadow(l){let c=this.shadowRoot;if(!c)return;let d=c;for(let p of l.path){let g=Array.from(d.children??[]),v=(g.length>0?g:Array.from(d.children??[])).filter(x=>x.tagName===p.tag)[p.idx];if(!v)return;d=v}let u=d;if(!(!u||typeof u.focus!="function")&&c.activeElement!==u&&(u.focus(),l.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(l.selectionStart,l.selectionEnd??l.selectionStart)}catch{}}refreshRefs(){let l={},c=this.shadowRoot;for(let[d,u]of Object.entries(a))l[d]=c?c.querySelector(u):null;this.currentRefs=l}formAssociatedCallback(l){try{t.formAssociatedCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(l){try{t.formDisabledCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(l){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,l)}}formStateRestoreCallback(l,c){try{t.formStateRestoreCallback?.call(this,l,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(l){let c=new Map;for(let[d,u]of Object.entries(l)){let p=rr.exec(d.trim());if(!p)continue;let[,g,f]=p;c.has(g)||c.set(g,[]),c.get(g).push({selector:f??null,handler:u})}for(let[d,u]of c){let p=g=>{for(let{selector:f,handler:b}of u){if(!f){b(g,this.ctx);continue}let v=g.composedPath();for(let x of v){if(x===this.shadowRoot||x===this)break;if(x instanceof Element&&this.shadowRoot?.contains(x)&&x.matches(f)){b(g,this.ctx);break}}}};this.shadowRoot.addEventListener(d,p),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,p))}}}return Qe.set(e,s),customElements.define(e,s),e}function tt(e,t,r){return e.if&&!e.if(t.ctx)?null:rt(e,t,r)}function rt(e,t,r){let n=document.createElement(e.tag||"div");if(e.styles&&(n.style.cssText=Object.entries(e.styles).map(([a,o])=>`${a}: ${o}`).join("; ")),e.className&&(n.className=e.className),e.attributes&&at(n,e.attributes),e.template!==void 0){let a=typeof e.template=="function"?e.template(t.ctx):e.template;a&&(n.innerHTML=a)}if(e.children)for(let a of e.children){let o=tt(a,t,r);o&&n.appendChild(o)}if(e.for&&nr(n,e,t,r),e.action){let a=e.action;n.addEventListener("click",a),t.cleanups.push(()=>n.removeEventListener("click",a))}if(e.emit)for(let a of e.emit)n.addEventListener(a.name,a.handler),t.cleanups.push(()=>n.removeEventListener(a.name,a.handler));return n}function nr(e,t,r,n){let a=t.for,o=n(t),s=a.items(r.ctx),i=new Map;for(let l=0;l<s.length;l++){let c=s[l],d=a.key(c,l),u,p=o.cache.get(d);if(p&&Object.is(p.lastItem,c))u=p;else{let g=[],f=a.render(c,l,r.ctx),b=rt(f,{...r,cleanups:g},n);p&&te(p.cleanups),u={element:b,lastItem:c,cleanups:g}}i.set(d,u),e.appendChild(u.element)}for(let[l,c]of o.cache)i.has(l)||te(c.cleanups);o.cache=i}function nt(e,t){if(e.for&&t(e),e.children)for(let r of e.children)nt(r,t)}function ar(e,t,r,n){return{host:e,get props(){let a={};for(let[o,s]of t)a[o]=s;return a},get state(){let a={};for(let[o,s]of r)a[o]=s;return a},get refs(){return n()},setState:(a,o)=>e.setState(a,o),getState:a=>e.getState(a),emit:(a,o)=>e.emitEvent(a,o)}}function or(e){let t=e.theme?ir(e.theme):void 0,r=e.styles?lr(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let a=[];if(t){let o=new CSSStyleSheet;o.replaceSync(t),a.push(o)}if(r){let o=new CSSStyleSheet;o.replaceSync(r),a.push(o)}return{kind:"adopted",sheets:a}}return{kind:"fallback",theme:t,styles:r}}function sr(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function at(e,t){for(let[r,n]of Object.entries(t))e.setAttribute(r,n)}function ir(e){return`:host { ${Object.entries(e).map(([r,n])=>`--${r}: ${n};`).join(" ")} }`}function lr(e){return`.container { ${Object.entries(e).map(([r,n])=>`${r}: ${n};`).join(" ")} }`}function te(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function et(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function cr(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function dr(e,t,r,n){if(n!=="json"){if(n==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var pr="tc-button";var ot=`
      <style>
        .root {
...
`;h(pr,m({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""},type:{type:"string",default:"button"}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-btn-padding-x":"initial","tc-btn-padding-y":"initial"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${ge(e.variant)} s-${ge(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
      ...
      >
        ${r}
      </a>${ot}`}let s=String(e.type??"button");return`
      <button
        part="button"
        class="${t}"
        ${o?"disabled":""}
      ...
      `},refs:{input:".cb"},events:{"change .cb":(e,t)=>{let r=e.target.checked,n=t.host;n.checked=r,n.internals?.setFormValue(r?n.value:null),t.emit("tc-change",{checked:r})}},afterMount(){let e=this,r=e.shadowRoot?.querySelector(".cb");r&&(r.indeterminate=e.indeterminate),e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function Me(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var hr="tc-switch";h(hr,m({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-switch-track-off":"var(--tc-color-rule-strong, #d9cfb8)","tc-switch-track-on":"var(--tc-color-accent, #a16939)","tc-switch-thumb":"var(--tc-color-surface, #ffffff)","tc-switch-fg":"var(--tc-color-ink, #14171f)","tc-switch-helper":"var(--tc-color-ink-muted, #6b7280)","tc-switch-error":"var(--tc-color-danger, #b3261e)","tc-switch-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.error;return`
        <label class="row ${e.disabled?"is-disabled":""}">
          ...
          ${e.label?`<span class="label">${st(e.label)}</span>`:""}
        </label>
        ${e.error||e.helper?`<div class="${t?"error":"helper"}">${st(e.error||e.helper)}</div>`:""}
        <style>
      ...
      `},events:{"change input.r":(e,t)=>{let r=e.target.value,n=t.host;n.value=r,n.internals?.setFormValue(r),t.emit("tc-change",{value:r})}},afterMount(){let e=this;e.value&&e.internals?.setFormValue(e.value)},formResetCallback(){this.value=""}}));function oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var yr="tc-table";var xr=`
...
`,_e=new WeakMap;h(yr,m({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[m({tag:"style",template:xr}),m({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),m({tag:"div",className:"wrap",children:[m({tag:"table",children:[m({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],n=t;return`<tr>${r.map(a=>{let o=n.sortKey===a.key,s=a.sortable!==!1,i=o?n.sortDir==="asc"?"\u25B2":"\u25BC":"",l=o?n.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${Ee(a.key)}"
                        class="${s?"sortable":""}"
                        aria-sort="${l}"
                      >${Ee(a.label)}<span class="sort">${i}</span></th>`}).join("")}</tr>`}}),m({tag:"tbody",children:[m({tag:"tr",className:"empty",if:({props:e,state:t})=>it(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${Ee(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>it(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let a=r.props.columns??[],o=e;return m({tag:"tr",attributes:{"data-row-id":String(o.id??t)},template:a.map(s=>`<td>${typeof s.render=="function"?s.render(o):Ee(o[s.key]??"")}</td>`).join("")})}}})]})]}),m({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,n=Se(e,r),a=e.pageSize??10,o=Math.max(1,Math.ceil(n.length/a)),s=Math.min(r.page??0,o-1),i=(e.rows??[]).length;return`
          ...
          `}})],refs:{filter:".filter"},afterRender(){let e=this,t=e.refs.filter;if(!t)return;let r=e.getState("q")??"";t.value!==r&&(t.value=r);let n=_e.get(e);if(n){_e.delete(e),t.focus();let a=Math.min(n.caret,t.value.length);try{t.setSelectionRange(a,a)}catch{}}},events:{"input .filter":(e,t)=>{let r=e.target;_e.set(t.host,{caret:r.selectionStart??r.value.length}),t.setState("q",r.value),t.setState("page",0)},"click .prev":(e,t)=>{let r=(t.state.page??0)-1;t.setState("page",Math.max(0,r))},"click .next":(e,t)=>{let r=t.state,n=Se(t.props,r).length,a=t.props.pageSize??10,o=Math.max(0,Math.ceil(n/a)-1),s=(r.page??0)+1;t.setState("page",Math.min(o,s))},"click th.sortable":(e,t)=>{let r=e.target.closest("th");if(!r)return;let n=r.dataset.col;if(!n)return;let a=t.state,o;a.sortKey!==n?o="asc":o=a.sortDir==="asc"?"desc":a.sortDir==="desc"?null:"asc",t.setState("sortKey",o?n:null),t.setState("sortDir",o),t.emit("tc-sort-change",{key:o?n:null,direction:o})},"click tr[data-row-id]":(e,t)=>{let r=e.target.closest("tr[data-row-id]");if(!r)return;let n=r.dataset.rowId;if(n===void 0)return;let a=Se(t.props,t.state),o=a.find(s=>String(s.id)===n)??a[Number(n)];o&&t.emit("tc-row-click",{row:o})}}}));function Se(e,t){let r=e.rows??[],n=e.columns??[],a=(t.q??"").trim().toLowerCase(),o=a.length===0?r.slice():r.filter(s=>n.some(i=>String(s[i.key]??"").toLowerCase().includes(a)));if(t.sortKey&&t.sortDir){let s=t.sortKey,i=t.sortDir==="asc"?1:-1;o=o.slice().sort((l,c)=>{let d=l[s],u=c[s];return d===u?0:d==null?1:u==null?-1:typeof d=="number"&&typeof u=="number"?(d-u)*i:String(d).localeCompare(String(u))*i})}return o}function it(e,t){let r=e.pageSize??10,n=Se(e,t),a=Math.max(1,Math.ceil(n.length/r)),o=Math.min(t.page??0,a-1);return n.slice(o*r,o*r+r)}function Ee(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var kr="tc-tabs";h(kr,m({props:{tabs:{type:"json",default:[]},active:{type:"string",default:"",reflect:!0}},theme:{"tc-tabs-fg":"var(--tc-color-ink, #14171f)","tc-tabs-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-tabs-rule":"var(--tc-color-rule, #ece5d3)","tc-tabs-accent":"var(--tc-color-accent, #a16939)","tc-tabs-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block","font-family":"var(--tc-tabs-font)"},template:({props:e})=>{let t=e.tabs??[],r=e.active||t[0]?.id||"";return`
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{lt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let n=t.refs.dialog;n&&e.target===n&&lt(r,"backdrop")}},afterRender(){$r(this)},unmount(){let e=se.get(this);e&&(e.cleanup(),se.delete(this))}}));function $r(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let n=e.open,a=se.get(e);if(a&&a.dialog!==r&&(a.cleanup(),se.delete(e)),n&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!se.has(e)){let o=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),se.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!n&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function lt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mr="tc-toast";var he=new WeakMap;h(Mr,m({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
        <div class="toast v-${dt(t)} ${e.open?"open":"closed"}" role="status" aria-live="polite">
          <span class="icon" aria-hidden="true">${r}</span>
          <span class="msg">${e.message?dt(e.message):"<slot></slot>"}</span>
    ...
    `}));function gt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Cr="tc-stack";h(Cr,m({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${zr(e.gap)}; --tc-stack-align: ${Rr(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function zr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Ar(t)})`:t}function Ar(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Rr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Nr="tc-cluster";h(Nr,m({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${Dr(e.gap)};
        --tc-cluster-justify: ${Ir(e.justify)};
        --tc-cluster-align: ${qr(e.align)};
    ...
    `}));function Ir(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Dr(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${jr(t)})`:t}function jr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function qr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Br="tc-grid";h(Br,m({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${mt(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${mt(e.min)}, 1fr))`};
          --tc-grid-gap: ${_r(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `},events:{"click .copy":(e,t)=>{let r=t.host,n=r.shadowRoot?.querySelector("slot"),o=(n?n.assignedNodes({flatten:!0}):Array.from(r.childNodes)).map(i=>i.textContent??"").join(""),s=()=>{t.setState("copied",!0),t.emit("tc-copy",{text:o}),setTimeout(()=>t.setState("copied",!1),1600)};navigator.clipboard?.writeText?navigator.clipboard.writeText(o).then(s,s):s()}}}));function ht(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Gr="tc-callout";var bt={note:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>'};h(Gr,m({props:{variant:{type:"string",default:"note"},title:{type:"string",default:""},compact:{type:"boolean",default:!1}},theme:{"tc-callout-radius":"var(--tc-radius-md, 8px)","tc-callout-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-callout-note-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-callout-note-fg":"var(--tc-color-ink-soft, #4a5061)","tc-callout-note-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-callout-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-callout-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-callout-info-border":"var(--tc-color-info, #3a5b8c)","tc-callout-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-callout-success-fg":"var(--tc-color-success-fg, #155b40)","tc-callout-success-border":"var(--tc-color-success, #207a5b)","tc-callout-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-callout-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-callout-warning-border":"var(--tc-color-warning, #a87326)","tc-callout-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-callout-danger-fg":"var(--tc-color-danger-fg, #7a1a14)","tc-callout-danger-border":"var(--tc-color-danger, #b3261e)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"note"),r=bt[t]??bt.note;return`
        <aside
          class="callout v-${vt(t)} ${e.compact?"compact":""}"
          role="${t==="danger"?"alert":"note"}"
        >
          <span class="icon" aria-hidden="true">${r}</span>
          <div class="body">
            ${e.title?`<div class="title">${vt(e.title)}</div>`:""}
      ...
      `},afterMount(){Ur(this)},unmount(){Te.get(this)?.observer?.disconnect(),Te.delete(this)}}));function Ur(e){Te.get(e)?.observer?.disconnect();let r=e,n=r.target||"main",a=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),o=document.querySelector(n);if(!o)return;let s=Array.from(o.querySelectorAll(a.join(","))).filter(c=>c instanceof HTMLElement),i=s.map(c=>(c.id||(c.id=Yr(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",i),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(c=>{let u=c.filter(g=>g.isIntersecting).sort((g,f)=>g.boundingClientRect.top-f.boundingClientRect.top)[0];if(!u)return;let p=u.target.id;p&&e.setState("activeId",p)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of s)l.observe(c);Te.set(e,{observer:l,activeId:""})}function Yr(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Wr="tc-pagination";h(Wr,m({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=Xr(Number(e.current)|0,1,t),n=Math.max(0,Number(e.siblings)|0),a=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let o=Jr(r,t,n,a),s=Le(String(e.size??"sm")),i=r<=1?" disabled":"",l=r>=t?" disabled":"",c=o.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${s}"
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let n=r.getAttribute("data-page");if(n==null)return;let a=Number(n),o=t.host,s=Math.max(1,Number(o.total)|0),i=Number(o.current)|0;!Number.isFinite(a)||a<1||a>s||a!==i&&t.emit("tc-page-change",{page:a})}}}));function Xr(e,t,r){return Math.min(r,Math.max(t,e))}function Jr(e,t,r,n){let a=new Set;for(let i=1;i<=Math.min(n,t);i++)a.add(i);for(let i=Math.max(1,t-n+1);i<=t;i++)a.add(i);for(let i=Math.max(1,e-r);i<=Math.min(t,e+r);i++)a.add(i);let o=[...a].sort((i,l)=>i-l),s=[];for(let i=0;i<o.length;i++)i>0&&o[i]-o[i-1]>1&&s.push("\u2026"),s.push(o[i]);return s}function Le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Zr="tc-combobox";function be(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function ve(e){return e.join(",")}function Qr(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var en=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;h(Zr,m({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],n=!!e.multiple,a=e.searchable!==!1,o=!!e.disabled,s=!!e.error,i=be(e.value),l=String(t.query??""),c=!!t.open&&!o,d=Number(t.focusedIndex??-1),u=yt(r,l),p=new Set(i),g=i.map($=>r.find(O=>O.value===$)).filter($=>!!$),f=a&&(c||n&&i.length===0),b=!n&&i.length===1&&(!c||!a),v=i.length===0&&!f&&!b,x=n?g.map($=>`<span class="chip" data-value="${R($.value)}">
              ...
              <button
                ...
                ${o?"disabled":""}
              >&times;</button>
            </span>`).join(""):"",y=b&&g[0]?`<span class="single">
            ${g[0].icon?`<span class="single-icon">${R(g[0].icon)}</span>`:""}
            <span class="single-label">${R(g[0].label)}</span>
          </span>`:"",w=v?`<span class="placeholder">${R(e.placeholder??"")}</span>`:"",C=f?`<input
            type="text"
            class="search"
            part="search"
            value="${R(l)}"
            ...
            role="combobox"
          />`:"",H=u.length===0?`<div class="empty">${R(e["empty-text"]??"No results")}</div>`:u.map(($,O)=>{let N=p.has($.value);return`<div
            ...
            </div>`}).join(""),j=e.label?`<label class="label">${R(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",pe=s?`<div class="helper error">${R(e.error)}</div>`:e.helper?`<div class="helper">${R(e.helper)}</div>`:"";return`
        ${j}
        <div
        ...
        ${pe}
        ${en}
      `},events:{"click .control":(e,t)=>{if(e.target.closest(".chip-remove")||t.host.disabled)return;let a=!!t.getState("open");t.setState("open",!0),a||t.emit("tc-open"),t.refs.search?.focus()},"keydown .control":(e,t)=>{let r=e;if(r.key==="Enter"||r.key===" "){if(r.preventDefault(),t.host.disabled)return;t.setState("open",!0),t.emit("tc-open"),t.refs.search?.focus()}},"input .search":(e,t)=>{let r=e.target.value;t.setState("query",r),t.setState("open",!0),t.setState("focusedIndex",0),t.emit("tc-search",{query:r})},"keydown .search":(e,t)=>{let r=e,n=e.target,a=t.host,o=!!a.multiple,s=a.options??[],i=yt(s,String(t.getState("query")??""));if(r.key==="Backspace"&&n.value===""&&o){let l=be(a.value);l.length>0&&(l.pop(),a.value=ve(l),He(t,l,a),t.emit("tc-change",{value:l.slice()}),r.preventDefault());return}if(r.key==="ArrowDown"){r.preventDefault(),t.setState("open",!0);let l=Number(t.getState("focusedIndex")??-1),c=Math.min(i.length-1,l+1);t.setState("focusedIndex",c);return}if(r.key==="ArrowUp"){r.preventDefault();let l=Number(t.getState("focusedIndex")??0),c=Math.max(0,l-1);t.setState("focusedIndex",c);return}if(r.key==="Enter"){r.preventDefault();let l=Number(t.getState("focusedIndex")??-1);l>=0&&l<i.length&&xt(t,i[l],a);return}if(r.key==="Escape"){r.preventDefault(),t.setState("open",!1),t.setState("query",""),t.emit("tc-close");return}},"mousedown .option":(e,t)=>{e.preventDefault();let r=e.target.closest(".option");if(!r||r.classList.contains("disabled"))return;let n=r.dataset.value;if(n==null)return;let a=t.host,s=(a.options??[]).find(i=>i.value===n);s&&xt(t,s,a)},"click .chip-remove":(e,t)=>{e.stopPropagation();let n=e.target.dataset.remove;if(n==null)return;let a=t.host,o=be(a.value).filter(s=>s!==n);a.value=ve(o),He(t,o,a),t.emit("tc-change",{value:o.slice()})},"focusout .control":(e,t)=>{queueMicrotask(()=>{t.host.matches(":focus-within")||(t.setState("open",!1),t.setState("query",""),t.emit("tc-close"))})}},afterMount(){let e=this;if(!e.multiple||!e.internals)return;let t=be(e.value),r=String(e.name??"");if(!r){e.internals.setFormValue(ve(t));return}let n=new FormData;for(let a of t)n.append(r,a);e.internals.setFormValue(n)},afterRender(){let e=this;if(!(e.getState?!!e.getState("open"):!1))return;let r=e.refs?.search??null;if(!r||e.shadowRoot?.activeElement===r)return;r.focus();let a=r.value.length;try{r.setSelectionRange(a,a)}catch{}}}));function yt(e,t){if(!t)return e;let r=new RegExp(Qr(t),"i");return e.filter(n=>r.test(n.label)||r.test(n.value))}function xt(e,t,r){let n=!!r.multiple,a=Number(r.max??0),o=be(r.value);if(n){let s;if(o.includes(t.value))s=o.filter(i=>i!==t.value);else{if(a>0&&o.length>=a)return;s=o.concat(t.value)}r.value=ve(s),He(e,s,r),e.setState("query",""),e.emit("tc-change",{value:s.slice()}),queueMicrotask(()=>{e.refs.search?.focus()})}else r.value=t.value,He(e,[t.value],r),e.setState("query",""),e.setState("open",!1),e.emit("tc-change",{value:t.value}),e.emit("tc-close")}function He(e,t,r){let n=r.internals;if(!n)return;let a=String(r.name??"");if(!r.multiple){n.setFormValue(t[0]??"");return}if(!a){n.setFormValue(ve(t));return}let o=new FormData;for(let s of t)o.append(a,s);n.setFormValue(o)}function R(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var tn="tc-carousel";function kt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ce(e){let t=0;for(let r of Array.from(e.children))r instanceof Element&&!r.hasAttribute("slot")&&t++;return t}function Mt(e,t,r){return t<=0?0:r?(e%t+t)%t:Math.max(0,Math.min(t-1,e))}function P(e,t){let r=Ce(e);if(r===0)return;let n=e.value,a=Mt(t,r,e.loop);a!==n&&(e.value=a,e.dispatchEvent(new CustomEvent("tc-change",{detail:{index:a,previous:n},bubbles:!0,composed:!0})))}function wt(e){Fe(e),!(e.autoplay<=0)&&(Ce(e)<=1||(e._carouselTimer=globalThis.setInterval(()=>{P(e,e.value+1)},e.autoplay)))}function Fe(e){e._carouselTimer!==void 0&&(globalThis.clearInterval(e._carouselTimer),e._carouselTimer=void 0)}h(tn,m({props:{value:{type:"number",default:0,reflect:!0},autoplay:{type:"number",default:0},loop:{type:"boolean",default:!0},orientation:{type:"string",default:"horizontal"},transition:{type:"string",default:"slide"},indicators:{type:"boolean",default:!0},controls:{type:"boolean",default:!0},swipe:{type:"boolean",default:!0},pauseOnHover:{type:"boolean",default:!0},ariaLabel:{type:"string",default:"Carousel"},height:{type:"string",default:""}},theme:{"tc-carousel-radius":"var(--tc-radius-lg, 12px)","tc-carousel-bg":"var(--tc-color-bg, #faf8f3)","tc-carousel-control-bg":"rgba(255, 255, 255, 0.85)","tc-carousel-control-bg-hover":"rgba(255, 255, 255, 1)","tc-carousel-control-fg":"var(--tc-color-ink, #14171f)","tc-carousel-control-size":"36px","tc-carousel-indicator":"rgba(20, 23, 31, 0.25)","tc-carousel-indicator-active":"var(--tc-color-accent, #a16939)","tc-carousel-duration":"320ms"},styles:{display:"block",position:"relative"},template:({props:e})=>{let t=Number(e.value??0),r=String(e.orientation)==="vertical",n=String(e.transition)==="fade",a=String(e.height??""),o=!!e.controls,s=!!e.indicators,i=kt(e.ariaLabel??"Carousel");return`
        <div
          class="root ${r?"v":"h"} ${n?"fade":"slide"}"
          role="region"
          aria-roledescription="carousel"
          aria-label="${i}"
          style="${a?`--tc-carousel-height: ${kt(a)};`:""}--tc-carousel-index: ${t};"
        >
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;P(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;P(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let n=Number(r.dataset.index);if(!Number.isFinite(n))return;let a=t.host;P(a,n)},"keydown .root":(e,t)=>{let r=e,n=t.host,a=n.orientation==="vertical",o=Ce(n),s=a?"ArrowUp":"ArrowLeft",i=a?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),P(n,n.value-1)):r.key===i?(r.preventDefault(),P(n,n.value+1)):r.key==="Home"?(r.preventDefault(),P(n,0)):r.key==="End"&&(r.preventDefault(),P(n,o-1))}},afterMount(){let e=this,t=()=>$t(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let n=e.shadowRoot,a=n?.querySelector("slot"),o=()=>t();a?.addEventListener("slotchange",o),e._carouselSlotObs=()=>{r.disconnect(),a?.removeEventListener("slotchange",o)};let s=()=>Fe(e),i=()=>{e.pauseOnHover&&wt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",i),e.addEventListener("focusin",s),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",s),e.removeEventListener("focusout",i)},rn(e),n?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&wt(e)},afterRender(){$t(this)},unmount(){let e=this;Fe(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function $t(e){let t=Ce(e),r=e.shadowRoot;if(!r)return;let n=r.querySelector(".root");if(n&&t>0){let i=Mt(e.value,t,e.loop);i!==e.value&&(e.value=i),n.style.setProperty("--tc-carousel-index",String(i))}let a=r.querySelector(".indicators");if(a){let i=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===i?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;a.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function rn(e){let t=0,r=0,n=!1,a=40,o=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,n=!0))},s=l=>{if(!n)return;n=!1;let c=l.clientX-t,d=l.clientY-r,p=e.orientation==="vertical"?d:c;Math.abs(p)<a||P(e,e.value+(p<0?1:-1))},i=()=>{n=!1};e.addEventListener("pointerdown",o),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",o),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",i)}}var K="tc-accordion";h(K,m({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this;nn();let t=o=>{let s=o.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let i of ze(e))i!==s&&i.open&&(i.open=!1);an(e)}},r=o=>{let s=o.target;if(!s||s.tagName!=="SUMMARY")return;let i=ze(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=i.indexOf(s);if(l===-1)return;let c=-1;o.key==="ArrowDown"?c=(l+1)%i.length:o.key==="ArrowUp"?c=(l-1+i.length)%i.length:o.key==="Home"?c=0:o.key==="End"&&(c=i.length-1),c!==-1&&(o.preventDefault(),i[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let n=()=>{for(let o of ze(e)){let s=o.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",s.appendChild(i);let l=()=>{i.style.transform=o.open?"rotate(90deg)":"rotate(0)"};l(),o.addEventListener("toggle",l)}}};n();let a=new MutationObserver(n);a.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),a.disconnect()}},unmount(){this._accordionCleanup?.()}}));var Et="tc-accordion-light-styles";function nn(){if(typeof document>"u"||document.getElementById(Et))return;let e=document.createElement("style");e.id=Et,e.textContent=`
  ...
  `,(document.head||document.documentElement).appendChild(e)}function ze(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function an(e){let t=[];for(let r of ze(e))if(r.open){let n=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(n)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var on="tc-tooltip";function sn(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(on,m({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${sn(e.text)}</span>`:""}
    ...
    `,afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".tip");if(!r)return;let n=()=>{e.disabled||(clearTimeout(e._tooltipTimer),e._tooltipTimer=globalThis.setTimeout(()=>{if(typeof r.showPopover=="function")try{r.showPopover()}catch{r.style.visibility="visible",r.style.opacity="1"}else r.style.visibility="visible",r.style.opacity="1";St(e,r)},Math.max(0,e.delay)))},a=()=>{clearTimeout(e._tooltipTimer);try{typeof r.hidePopover=="function"&&r.hidePopover()}catch{}r.style.opacity="",r.style.visibility=""},o=i=>{i.key==="Escape"&&a()};e.addEventListener("pointerenter",n),e.addEventListener("pointerleave",a),e.addEventListener("focusin",n),e.addEventListener("focusout",a),e.addEventListener("keydown",o);let s=()=>{r.matches(":popover-open")&&St(e,r)};globalThis.addEventListener("scroll",s,!0),globalThis.addEventListener("resize",s),e._tooltipCleanup=()=>{clearTimeout(e._tooltipTimer),e.removeEventListener("pointerenter",n),e.removeEventListener("pointerleave",a),e.removeEventListener("focusin",n),e.removeEventListener("focusout",a),e.removeEventListener("keydown",o),globalThis.removeEventListener("scroll",s,!0),globalThis.removeEventListener("resize",s),a()}},unmount(){this._tooltipCleanup?.()}}));function St(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let n=t.getBoundingClientRect(),a=globalThis.innerWidth,o=globalThis.innerHeight,s=e.offset,i=e.placement||"top",l=u=>u==="top"?r.top-n.height-s>=4:u==="bottom"?r.bottom+n.height+s<=o-4:u==="left"?r.left-n.width-s>=4:u==="right"?r.right+n.width+s<=a-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"top")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-n.height-s,d=r.left+r.width/2-n.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-n.width/2):i==="left"?(c=r.top+r.height/2-n.height/2,d=r.left-n.width-s):i==="right"&&(c=r.top+r.height/2-n.height/2,d=r.right+s),c=Math.max(4,Math.min(o-n.height-4,c)),d=Math.max(4,Math.min(a-n.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`,t.dataset.placement=i}var ln="tc-popover";h(ln,m({props:{open:{type:"boolean",default:!1,reflect:!0},placement:{type:"string",default:"bottom"},offset:{type:"number",default:8},dismissible:{type:"boolean",default:!0}},theme:{"tc-popover-bg":"var(--tc-color-surface, #ffffff)","tc-popover-fg":"var(--tc-color-ink, #14171f)","tc-popover-rule":"var(--tc-color-rule, #ece5d3)","tc-popover-radius":"var(--tc-radius-md, 8px)","tc-popover-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.18))","tc-popover-padding":"12px 14px","tc-popover-min-width":"200px","tc-popover-max-width":"340px","tc-popover-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative"},template:()=>`
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){Tt(this)},afterMount(){let e=this,t=a=>{!e.open||!e.dismissible||a.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=a=>{!e.open||!e.dismissible||a.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},n=()=>{let a=e.shadowRoot?.querySelector(".panel");a?.matches(":popover-open")&&Lt(e,a)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",n,!0),globalThis.addEventListener("resize",n),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",n,!0),globalThis.removeEventListener("resize",n)},Tt(e)},unmount(){this._popoverCleanup?.()}}));function Tt(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let n=e.open,a=typeof r.showPopover=="function";if(n&&!r.matches(":popover-open")){if(a)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";Lt(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!n&&r.matches(":popover-open"))if(a)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function Lt(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let n=t.getBoundingClientRect(),a=globalThis.innerWidth,o=globalThis.innerHeight,s=e.offset,i=e.placement||"bottom",l=u=>u==="top"?r.top-n.height-s>=4:u==="bottom"?r.bottom+n.height+s<=o-4:u==="left"?r.left-n.width-s>=4:u==="right"?r.right+n.width+s<=a-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"bottom")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-n.height-s,d=r.left+r.width/2-n.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-n.width/2):i==="left"?(c=r.top+r.height/2-n.height/2,d=r.left-n.width-s):i==="right"&&(c=r.top+r.height/2-n.height/2,d=r.right+s),c=Math.max(4,Math.min(o-n.height-4,c)),d=Math.max(4,Math.min(a-n.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var cn="tc-drawer";var le=new WeakMap;function Pe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(cn,m({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Pe(e.size??"min(420px, 92vw)");return`
        <dialog
          class="dlg side-${Pe(t)}"
        ...
        >
          ${e.title||e.dismissible?`<header class="head">
                ${e.title?`<h2 id="title" class="title">${Pe(e.title)}</h2>`:"<span></span>"}
                ${e.dismissible?'<button class="x" type="button" aria-label="Close">\xD7</button>':""}
              </header>`:""}
          <div class="body"><slot></slot></div>
          <footer class="foot"><slot name="footer"></slot></footer>
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Ht(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let n=t.refs.dialog;n&&e.target===n&&Ht(r,"backdrop")}},afterRender(){dn(this)},unmount(){let e=le.get(this);e&&(e.cleanup(),le.delete(this))}}));function dn(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let n=e.open,a=le.get(e);if(a&&a.dialog!==r&&(a.cleanup(),le.delete(e)),n&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!le.has(e)){let o=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),le.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!n&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Ht(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var pn="tc-progress";function ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function un(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}h(pn,m({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),n=!!e.indeterminate,a=Number(e.value??0),o=Number(e.max??100),s=un(a,o),i=e.label||(n?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,p=(d-u)/2,g=2*Math.PI*p,f=n?g*.25:s/100*g,b=n?`role="progressbar" aria-valuetext="${ce(i)}"`:`role="progressbar" aria-valuenow="${a}" aria-valuemin="0" aria-valuemax="${o}"`;return`
          <div class="circ size-${ce(r)} ${n?"indet":""}" ${b}>
            <svg viewBox="0 0 ${d} ${d}" width="${d}" height="${d}" aria-hidden="true">
              ...
              <circle
                ...
                stroke-dasharray="${f.toFixed(3)} ${(g-f).toFixed(3)}"
                stroke-dashoffset="${(g/4).toFixed(3)}"
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,c=n?`role="progressbar" aria-valuetext="${ce(i)}"`:`role="progressbar" aria-valuenow="${a}" aria-valuemin="0" aria-valuemax="${o}"`;return`
        <div class="bar size-${ce(r)} ${n?"indet":""}" ${c}>
          <div class="track">
      ...
      `}}));var fn="tc-stepper";function Ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(fn,m({props:{steps:{type:"json",default:[]},active:{type:"number",default:0,reflect:!0},orientation:{type:"string",default:"horizontal"},clickable:{type:"boolean",default:!1}},theme:{"tc-stepper-bg":"transparent","tc-stepper-ink":"var(--tc-color-ink, #14171f)","tc-stepper-soft":"var(--tc-color-ink-soft, #4a5061)","tc-stepper-rule":"var(--tc-color-rule, #ece5d3)","tc-stepper-accent":"var(--tc-color-accent, #a16939)","tc-stepper-done":"var(--tc-color-success, #2f7a52)","tc-stepper-radius":"999px","tc-stepper-marker-size":"28px","tc-stepper-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.steps??[],r=Number(e.active??0),n=String(e.orientation)==="vertical",a=!!e.clickable,o=t.map((s,i)=>{let l=i<r?"done":i===r?"current":"upcoming",c=l==="done"?'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>':`${i+1}`;return`
        ...
        `}).join("");return`
        <ol class="root ${n?"v":"h"} ${a?"clickable":""}" aria-label="Progress">
          ${o}
        </ol>
        <style>
    ...
    `,afterMount(){let e=this,t=()=>At(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){At(this)},unmount(){this._agroupCleanup?.()}}));function At(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),n=Array.from(e.children).filter(l=>l instanceof HTMLElement),a=0;for(let l of n)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),a<t||t===0?(l.hidden=!1,a++):l.hidden=!0);let o=n.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,s=Math.max(0,o-a),i=e.shadowRoot?.querySelector(".overflow");i&&(s>0?(i.hidden=!1,i.textContent=`+${s}`):i.hidden=!0)}var bn="tc-rating";function Rt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Nt="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";h(bn,m({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),n=Number(e.value??0),a=Number(t.hover??-1),o=a>=0?a:n,s=String(e.size??"md"),i=!!e.readonly,l=!!e.allowHalf,c=Rt(e.ariaLabel??"Rating"),d=s==="sm"?18:s==="lg"?32:24,u=[];for(let p=1;p<=r;p++){let g=o-(p-1),f=g>=1?100:g>=.5&&l?50:g>0&&!l?100:0,b=f===50;u.push(`
          <span class="star ${b?"half":f===100?"full":"empty"}" data-index="${p}">
            <svg viewBox="0 0 24 24" width="${d}" height="${d}" aria-hidden="true">
              <path class="track" d="${Nt}" fill="var(--tc-rating-track)" />
              ${f>0?`<path class="fill" d="${Nt}" fill="var(--tc-rating-fill)" clip-path="${b?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
        ...
        `)}return`
        <div
          class="root size-${Rt(s)} ${i?"readonly":""}"
          role="${i?"img":"slider"}"
          tabindex="${i?"-1":"0"}"
          aria-label="${c}"
          aria-valuenow="${n}"
      ...
      `},events:{"click .star":(e,t)=>{let r=t.host;if(r.readonly)return;let n=e.target,a=n.closest(".hit-left, .hit-right"),o=n.closest(".star");if(!o)return;let s=Number(o.dataset.index);if(!Number.isFinite(s))return;let i=s;a?.dataset.half==="1"&&r.allowHalf&&(i=s-.5),i===r.value&&(i=0);let l=r.value;r.value=i,t.emit("tc-change",{value:i,previous:l})},"mouseover .star":(e,t)=>{let r=t.host;if(r.readonly)return;let n=e.target,a=n.closest(".hit-left, .hit-right"),o=n.closest(".star");if(!o)return;let s=Number(o.dataset.index);if(!Number.isFinite(s))return;let i=s;a?.dataset.half==="1"&&r.allowHalf&&(i=s-.5),t.setState("hover",i)},"mouseleave .root":(e,t)=>{t.setState("hover",-1)},"keydown .root":(e,t)=>{let r=e,n=t.host;if(n.readonly)return;let a=n.allowHalf?.5:1,o=n.value,s=o;if(r.key==="ArrowRight"||r.key==="ArrowUp")s=Math.min(n.max,o+a);else if(r.key==="ArrowLeft"||r.key==="ArrowDown")s=Math.max(0,o-a);else if(r.key==="Home")s=0;else if(r.key==="End")s=n.max;else return;r.preventDefault(),s!==o&&(n.value=s,t.emit("tc-change",{value:s,previous:o}))}}}));var vn="tc-slider";function Ae(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(vn,m({props:{value:{type:"number",default:0,reflect:!0},min:{type:"number",default:0},max:{type:"number",default:100},step:{type:"number",default:1},disabled:{type:"boolean",default:!1,reflect:!0},showValue:{type:"boolean",default:!1},showTicks:{type:"boolean",default:!1},label:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-slider-track":"var(--tc-color-rule, #ece5d3)","tc-slider-fill":"var(--tc-color-accent, #a16939)","tc-slider-thumb":"var(--tc-color-surface, #ffffff)","tc-slider-thumb-ring":"var(--tc-color-accent, #a16939)","tc-slider-radius":"999px","tc-slider-thumb-size":"20px","tc-slider-track-size":"6px","tc-slider-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-slider-fg":"var(--tc-color-ink, #14171f)","tc-slider-fg-muted":"var(--tc-color-ink-muted, #6b7280)"},styles:{display:"block"},template:({props:e})=>{let t=Number(e.value??0),r=Number(e.min??0),n=Number(e.max??100),a=Number(e.step??1),o=!!e.disabled,s=n>r?(t-r)/(n-r)*100:0,i=String(e.label??""),l=String(e.suffix??""),c=!!e.showValue,d=!!e.showTicks,u="";if(d&&a>0){let p=Math.floor((n-r)/a)+1;if(p<=50){let g=[];for(let f=0;f<p;f++){let v=(r+f*a-r)/(n-r)*100;g.push(`<span class="tick" style="left:${v.toFixed(2)}%"></span>`)}u=g.join("")}}return`
        ${i||c?`<div class="head">
              ${i?`<label for="r" class="lbl">${Ae(i)}</label>`:"<span></span>"}
              ${c?`<span class="val">${Ae(String(t))}${Ae(l)}</span>`:""}
            </div>`:""}
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,n=t.host,a=Number(r.value);n.value!==a&&(n.value=a,t.emit("tc-input",{value:a}))},"change .range":(e,t)=>{let r=e.target,n=t.host,a=Number(r.value);t.emit("tc-change",{value:a,previous:n.value})}}}));var yn="tc-chart";function It(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),n=e/Math.pow(10,r),a;return t?n<1.5?a=1:n<3?a=2:n<7?a=5:a=10:n<=1?a=1:n<=2?a=2:n<=5?a=5:a=10,a*Math.pow(10,r)}function xn(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let n=It(t-e,!1),a=It(n/(r-1),!0),o=Math.floor(e/a)*a,s=Math.ceil(t/a)*a,i=[];for(let l=o;l<=s+a*.5;l+=a)i.push(Number(l.toFixed(10)));return{min:o,max:s,ticks:i}}function Ge(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(n=>`${n.x} ${n.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let n=0;n<e.length-1;n++){let a=e[n-1]??e[n],o=e[n],s=e[n+1],i=e[n+2]??s,l=o.x+(s.x-a.x)/6,c=o.y+(s.y-a.y)/6,d=s.x-(i.x-o.x)/6,u=s.y-(i.y-o.y)/6;r+=` C ${l},${c} ${d},${u} ${s.x},${s.y}`}return r}function ye(e,t,r,n){return{x:e+r*Math.sin(n),y:t-r*Math.cos(n)}}function kn(e,t,r,n,a,o){let s=o-a>Math.PI?1:0,i=ye(e,t,r,a),l=ye(e,t,r,o);if(n<=0)return`M ${e} ${t} L ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} Z`;let c=ye(e,t,n,o),d=ye(e,t,n,a);return`M ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} L ${c.x} ${c.y} A ${n} ${n} 0 ${s} 0 ${d.x} ${d.y} Z`}function M(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Q(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function xe(e,t){return t[e%t.length]}function wn(e,t){let{data:r,smooth:n,stacked:a,showAxes:o,showGrid:s,showLabels:i,showValues:l}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",p=u?4:16,g=u?4:o&&i?28:8,f=u?4:o?44:8,b=u?4:12,v=e.W-f-b,x=e.H-p-g,y=1/0,w=-1/0;if(a&&d.length>0){let S=c.length>0?c.map((k,L)=>d.reduce((z,q)=>z+(q.values?.[L]??0),0)):[];for(let k of S)k<y&&(y=k),k>w&&(w=k);y>0&&(y=0)}else for(let S of d)for(let k of S.values??[])k<y&&(y=k),k>w&&(w=k);(!Number.isFinite(y)||!Number.isFinite(w))&&(y=0,w=1),y===w&&(y-=1,w+=1);let C=xn(e.yMin??y,e.yMax??w,5),H=e.yMin??C.min,j=e.yMax??C.max,pe=j-H||1,$=c.length||d[0]?.values?.length||0,O=S=>$===1?f+v/2:t==="bar"?f+(S+.5)*(v/$):f+S/($-1)*v,N=S=>p+x-(S-H)/pe*x,ee=[];if(!u){if(s)for(let S of C.ticks){let k=N(S);ee.push(`<line class="grid" x1="${f}" x2="${e.W-b}" y1="${k}" y2="${k}"/>`)}if(o){for(let k of C.ticks){let L=N(k);ee.push(`<text class="axis-label y" x="${f-8}" y="${L}" text-anchor="end" dominant-baseline="middle">${M(Q(k))}</text>`)}if(i&&c.length>0){let k=Math.max(1,Math.ceil(c.length/8));c.forEach((L,z)=>{z%k!==0&&z!==c.length-1||ee.push(`<text class="axis-label x" x="${O(z)}" y="${e.H-g+16}" text-anchor="middle">${M(L)}</text>`)})}let S=H<=0&&j>=0?N(0):N(H);ee.push(`<line class="axis" x1="${f}" x2="${e.W-b}" y1="${S}" y2="${S}"/>`)}}let _=[];if(t==="bar"){let S=v/$,k=S*.18,L=S-k*2;d.forEach((z,q)=>{let X=`series series-${q}`,I=xe(q,e.palette),D=0;z.values?.forEach((T,B)=>{if(!Number.isFinite(T))return;let F=O(B),J,we,$e,qe;if(a){J=F-L/2,we=L;let ue=N(D+T),fe=N(D);$e=Math.min(ue,fe),qe=Math.abs(ue-fe),D+=T}else{let ue=L/d.length;J=F-L/2+q*ue,we=ue*.86;let fe=N(T),Ze=N(H<0&&j>0?0:H);$e=Math.min(fe,Ze),qe=Math.abs(fe-Ze)}let Je=`${M(z.name)}${c[B]?` \xB7 ${M(c[B])}`:""}: ${M(Q(T))}`,Xt=(B*.04).toFixed(3);_.push(`<g class="${X}"><rect class="hit" x="${J}" y="${$e}" width="${we}" height="${qe}" rx="2" fill="${I}" data-tip="${Je}" data-color="${I}" style="animation-delay: ${Xt}s"><title>${Je}</title></rect>`+(l?`<text class="value-label" x="${J+we/2}" y="${$e-4}" text-anchor="middle">${M(Q(T))}</text>`:"")+"</g>")})})}else if(a&&t==="area"){let S=new Array($).fill(0);d.forEach((k,L)=>{let z=xe(L,e.palette),q=[],X=[];for(let T=0;T<$;T++){let B=k.values?.[T]??0,F=S[T]+B;q.push({x:O(T),y:N(F)}),X.push({x:O(T),y:N(S[T])}),S[T]=F}let I=Ge(q,n)+" L "+X.slice().reverse().map(T=>`${T.x} ${T.y}`).join(" L ")+" Z",D=(L*.15).toFixed(3);_.push(`<path class="series-fill series-${L}" d="${I}" fill="${z}" fill-opacity="0.25" pointer-events="none" style="animation-delay: ${D}s"/>`),_.push(`<path class="series-line series-${L}" d="${Ge(q,n)}" stroke="${z}" fill="none" pointer-events="none" style="animation-delay: ${D}s"/>`),q.forEach((T,B)=>{let F=k.values?.[B]??0,J=`${M(k.name)}${c[B]?` \xB7 ${M(c[B])}`:""}: ${M(Q(F))}`;_.push(`<circle class="hit series-${L}" cx="${T.x}" cy="${T.y}" r="12" fill="transparent" data-tip="${J}" data-color="${z}"><title>${J}</title></circle>`)})})}else d.forEach((S,k)=>{let L=xe(k,e.palette),z=(S.values??[]).map((I,D)=>({x:O(D),y:N(I)})),q=Ge(z,n),X=(k*.15).toFixed(3);if(t==="area"){let I=N(H<0&&j>0?0:H),D=q+` L ${z[z.length-1].x} ${I} L ${z[0].x} ${I} Z`;_.push(`<path class="series-fill series-${k}" d="${D}" fill="${L}" fill-opacity="0.25" style="animation-delay: ${X}s"/>`)}_.push(`<path class="series-line series-${k}" d="${q}" stroke="${L}" fill="none" style="animation-delay: ${X}s"/>`),u||z.forEach((I,D)=>{let T=S.values?.[D],B=`${M(S.name)}${c[D]?` \xB7 ${M(c[D])}`:""}: ${M(Q(T??0))}`,F=(k*.15+D*.025+.55).toFixed(3);_.push(`<circle class="series-point series-${k}" cx="${I.x}" cy="${I.y}" r="3.5" fill="${L}" pointer-events="none" style="animation-delay: ${F}s"/>`),_.push(`<circle class="hit series-${k}" cx="${I.x}" cy="${I.y}" r="12" fill="transparent" data-tip="${B}" data-color="${L}"><title>${B}</title></circle>`),l&&_.push(`<text class="value-label" x="${I.x}" y="${I.y-8}" text-anchor="middle" pointer-events="none">${M(Q(T??0))}</text>`)})});return ee.join("")+_.join("")}function $n(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let n=e.W/2,a=e.H/2,o=Math.min(e.W,e.H)/2-4,s=Math.max(0,Math.min(.9,e.innerRadius))*o,i=0,l=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let p=u/r*Math.PI*2,g=i,f=i+p,b=kn(n,a,o,s,g,f-.01),v=xe(d,e.palette),x=(u/r*100).toFixed(1).replace(/\.0$/,""),y=`${M(c.name)}: ${M(Q(u))} (${x}%)`,w=(d*.08).toFixed(3);if(l.push(`<path class="series-segment hit series-${d}" d="${b}" fill="${v}" data-tip="${y}" data-color="${v}" style="animation-delay: ${w}s"><title>${y}</title></path>`),e.showValues){let C=(g+f)/2,H=(o+s)/2,j=ye(n,a,H,C);l.push(`<text class="value-label donut" x="${j.x}" y="${j.y}" text-anchor="middle" dominant-baseline="middle">${M(x)}%</text>`)}i=f}),l.join("")}function Mn(e,t,r){return e.length===0?"":'<div class="legend" part="legend">'+e.map((n,a)=>{let o=xe(a,t),s=r.includes(n.name);return`<button class="${s?"legend-item is-hidden":"legend-item"}" type="button" data-series="${M(n.name)}" aria-pressed="${s?"true":"false"}" title="${s?"Show":"Hide"} series '${M(n.name)}'"><span class="swatch" style="background:${o}"></span>${M(n.name)}</button>`}).join("")+"</div>"}function En(e,t){if(e==="donut"){let a=(t.series??[]).reduce((s,i)=>s+(i.value??0),0);return`Donut chart: ${(t.series??[]).filter(s=>(s.value??0)>0).map(s=>{let i=a>0?(s.value??0)/a*100:0;return`${s.name} ${i.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(a=>a.name).join(", "),n=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${n} data point${n===1?"":"s"}.`}var Sn=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],Tn=`
  <style>
...
`;h(yn,m({props:{type:{type:"string",default:"line"},data:{type:"json",default:{series:[]}},height:{type:"string",default:"240px"},smooth:{type:"boolean",default:!0},stacked:{type:"boolean",default:!1},showLegend:{type:"boolean",default:!0},showAxes:{type:"boolean",default:!0},showGrid:{type:"boolean",default:!0},showLabels:{type:"boolean",default:!0},showValues:{type:"boolean",default:!1},innerRadius:{type:"number",default:.6},yMin:{type:"json",default:null},yMax:{type:"json",default:null},ariaLabel:{type:"string",default:"Chart"},colors:{type:"json",default:null},src:{type:"string",default:""},srcKey:{type:"string",default:""},loadingText:{type:"string",default:"Loading chart\u2026"},errorText:{type:"string",default:"Couldn't load chart data"}},theme:{"tc-chart-bg":"transparent","tc-chart-fg":"var(--tc-color-ink, #14171f)","tc-chart-axis":"var(--tc-color-rule-strong, #d9cfb8)","tc-chart-grid":"var(--tc-color-rule, #ece5d3)","tc-chart-label":"var(--tc-color-ink-muted, #6b7280)","tc-chart-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e,state:t})=>{let r=String(e.type??"line").toLowerCase(),n=["line","area","bar","sparkline","donut"].includes(r)?r:"line",a=e.data,o=t.fetched,s=!!a&&Array.isArray(a.series)&&a.series.length>0,i=s?a:o??{series:[]},l=Array.isArray(t.hiddenSeries)?t.hiddenSeries:[],c={labels:i.labels,series:(i.series??[]).filter($=>!l.includes($.name))},d=String(e.src??""),u=!!t.loading&&!s&&!o,p=d&&t.error?String(t.error):"",g=u?`<div class="overlay loading">${M(String(e.loadingText??"Loading chart\u2026"))}</div>`:p?`<div class="overlay error" role="alert">${M(String(e.errorText??"Couldn't load chart data"))}<small>${M(p)}</small></div>`:"",f=n==="sparkline",b=n==="donut",v=e.colors,x=Array.isArray(v)&&v.length>0?v:Sn,y=b?320:800,w=b?320:400,C={data:c,smooth:!!e.smooth,stacked:!!e.stacked,showAxes:!!e.showAxes,showGrid:!!e.showGrid,showLabels:!!e.showLabels,showValues:!!e.showValues,innerRadius:Number(e.innerRadius??.6),yMin:e.yMin==null?null:Number(e.yMin),yMax:e.yMax==null?null:Number(e.yMax),palette:x,W:y,H:w},H=b?$n(C):wn(C,n),j=En(n,c),pe=M(String(e.height??"240px"));return`
        <div class="root" role="img" aria-label="${M(e.ariaLabel??"Chart")}">
          ...
          ${e.showLegend&&!f&&i.series&&i.series.length>0?Mn(i.series,x,l):""}
...
`;h(Hn,m({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Start writing\u2026"},toolbar:{type:"string",default:qt},readonly:{type:"boolean",default:!1,reflect:!0},minHeight:{type:"string",default:"180px"},maxHeight:{type:"string",default:""},pasteAs:{type:"string",default:"text"}},theme:{"tc-editor-bg":"var(--tc-color-surface, #ffffff)","tc-editor-fg":"var(--tc-color-ink, #14171f)","tc-editor-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-editor-toolbar-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-fg":"var(--tc-color-ink-soft, #4a5061)","tc-editor-toolbar-active-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-editor-toolbar-hover-bg":"rgba(20, 23, 31, 0.06)","tc-editor-placeholder":"var(--tc-color-ink-muted, #6b7280)","tc-editor-radius":"var(--tc-radius-md, 8px)","tc-editor-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-editor-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, 'SF Mono', monospace)","tc-editor-line-height":"1.6"},styles:{display:"block"},template:({props:e})=>{let t=String(e.toolbar??qt),r=!!e.readonly,n=G(String(e.minHeight??"180px")),a=String(e.maxHeight??"").trim(),o=t.split(",").map(c=>c.trim()).filter(Boolean),s=o.map(c=>{if(c==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let d=Cn[c];if(!d)return"";let u=d.shortcut?` (${G(d.shortcut)})`:"";return`<button type="button" class="tb-btn" data-cmd="${G(d.command)}"${d.value?` data-val="${G(d.value)}"`:""} data-key="${G(d.key)}" title="${G(d.label)}${u}" aria-label="${G(d.label)}">${d.icon}</button>`}).join(""),i=o.length===0?"toolbar empty":r?"toolbar readonly":"toolbar";return`
        ...
        ${zn}
      `},afterMount(){Bt(this),Ot(this)},afterRender(){let e=this,r=e.shadowRoot?.querySelector(".surface");if(r){let n=r.innerHTML,a=String(e.value??"");a&&n!==a&&document.activeElement!==e&&(r.innerHTML=a),Ke(r)}Bt(e),Ot(e)},unmount(){this._editorCleanup?.()}}));function Ke(e){let t=e.textContent?.trim()===""&&e.querySelector("img, hr, br")===null;e.dataset.empty=t?"true":"false"}function Bt(e){let t=e;t._editorCleanup?.();let r=t.shadowRoot;if(!r)return;let n=r.querySelector(".surface");if(!n)return;n.dataset.bootstrapped||(t.value&&(n.innerHTML=String(t.value)),n.dataset.bootstrapped="1"),Ke(n);let a=(p,g)=>{if(!t.readonly){if(n.focus(),p==="code"){let b=r.getSelection?.()??globalThis.getSelection();if(!b||b.rangeCount===0)return;let v=b.getRangeAt(0),x=v.extractContents(),y=document.createElement("code");y.className="tc-code-inline",y.appendChild(x),v.insertNode(y),v.selectNodeContents(y),b.removeAllRanges(),b.addRange(v)}else if(p==="link"){let f=globalThis.prompt("URL")?.trim();if(!f)return;document.execCommand("createLink",!1,f)}else if(p==="math"){let f=globalThis.prompt("LaTeX (e.g. E = mc^2). Wrap with $$ for display.")?.trim();if(!f)return;let b=f.startsWith("$$")&&f.endsWith("$$"),v=b?f.replace(/^\$\$|\$\$$/g,"").trim():f;An(t,v,b)}else if(p==="codeblock"){let f=r.getSelection?.()??globalThis.getSelection();if(!f||f.rangeCount===0)return;let b=f.getRangeAt(0),v=b.toString()||"// code",x=document.createElement("pre"),y=document.createElement("code");y.textContent=v,x.appendChild(y),b.deleteContents(),b.insertNode(x);let w=document.createRange();w.selectNodeContents(y),w.collapse(!1),f.removeAllRanges(),f.addRange(w)}else p==="formatBlock"?document.execCommand("formatBlock",!1,`<${g??"p"}>`):document.execCommand(p,!1,g);_t(t,n),Ft(r,n)}},o=p=>{let g=p.target?.closest?.(".tb-btn");if(!g)return;p.preventDefault();let f=g.dataset.cmd;f&&a(f,g.dataset.val)},s=()=>{Ke(n),_t(t,n)},i=()=>{let p=n.innerHTML;t._lastEmitted!==p&&(t._lastEmitted=p,t.dispatchEvent(new CustomEvent("tc-change",{detail:{html:p},bubbles:!0,composed:!0})))},l=p=>{if(t.readonly||t.pasteAs!=="text")return;p.preventDefault();let g=p.clipboardData?.getData("text/plain")??"";document.execCommand("insertText",!1,g)},c=p=>{if(t.readonly||!(p.metaKey||p.ctrlKey))return;let g=p.key.toLowerCase();g==="b"?(p.preventDefault(),a("bold")):g==="i"?(p.preventDefault(),a("italic")):g==="u"?(p.preventDefault(),a("underline")):g==="k"&&(p.preventDefault(),a("link"))},d=()=>{let p=globalThis.getSelection();!p||!p.anchorNode||n.contains(p.anchorNode)&&Ft(r,n)},u=r.querySelector(".toolbar");u?.addEventListener("click",o),n.addEventListener("input",s),n.addEventListener("blur",i),n.addEventListener("paste",l),n.addEventListener("keydown",c),document.addEventListener("selectionchange",d),t._editorCleanup=()=>{u?.removeEventListener("click",o),n.removeEventListener("input",s),n.removeEventListener("blur",i),n.removeEventListener("paste",l),n.removeEventListener("keydown",c),document.removeEventListener("selectionchange",d)}}function _t(e,t){let r=t.innerHTML;e.value=r,e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:r},bubbles:!0,composed:!0}))}function An(e,t,r){let n=e.shadowRoot;if(!n)return;let a=n.querySelector(".surface");if(!a)return;let o=n.getSelection?.()??globalThis.getSelection();if(!o||o.rangeCount===0)return;let s=o.getRangeAt(0),i=document.createElement(r?"div":"span");i.className=r?"tc-math display":"tc-math inline",i.setAttribute("contenteditable","false"),i.dataset.latex=t,i.innerHTML=Pt(e,t,r),s.deleteContents(),s.insertNode(i);let l=document.createTextNode("\u200B");i.parentNode?.insertBefore(l,i.nextSibling);let c=document.createRange();c.setStartAfter(l),c.collapse(!0),o.removeAllRanges(),o.addRange(c),e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:a.innerHTML},bubbles:!0,composed:!0}))}function Pt(e,t,r){if(e.mathRenderer)try{return e.mathRenderer(t,r)}catch{}return`<code class="tc-math-src">${t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code>`}function Ot(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".surface");if(!r)return;r.querySelectorAll(".tc-math").forEach(a=>{let o=a,s=o.dataset.latex??"",i=o.classList.contains("display"),l=`${i?"d":"i"}:${s}`;o.dataset.stamp!==l&&(o.innerHTML=Pt(e,s,i),o.dataset.stamp=l)})}function Ft(e,t){e.querySelectorAll(".tb-btn").forEach(n=>{let a=n,o=a.dataset.cmd??"",s=a.dataset.val,i=!1;try{o==="formatBlock"&&s?i=(document.queryCommandValue("formatBlock")||"").toLowerCase().replace(/^[<]|[>]$/g,"")===s:(o==="bold"||o==="italic"||o==="underline"||o==="strikeThrough"||o==="insertOrderedList"||o==="insertUnorderedList")&&(i=document.queryCommandState(o))}catch{i=!1}a.classList.toggle("is-active",i)})}var Rn="tc-markdown";function E(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Re="\0M\0";function Nn(e,t){let r=[],n=(s,i)=>{let l=r.length;return r.push({latex:s,display:i}),`${Re}${l}${Re}`},a=e;a=a.replace(/\$\$([\s\S]+?)\$\$/g,(s,i)=>n(i.trim(),!0)),a=a.replace(/(^|[\s(])\$([^\$\n][^\$\n]*?)\$(?=[\s.,;:!?)\]]|$)/g,(s,i,l)=>`${i}${n(l.trim(),!1)}`);let o=E(a);return o=o.replace(/`([^`]+)`/g,"<code>$1</code>"),o=o.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),o=o.replace(/(?<!\*)\*([^*\n]+?)\*(?!\*)/g,"<em>$1</em>"),o=o.replace(/\b_(.+?)_\b/g,"<em>$1</em>"),o=o.replace(/~~(.+?)~~/g,"<del>$1</del>"),o=o.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(s,i,l)=>`<img src="${E(l)}" alt="${E(i)}" loading="lazy"/>`),o=o.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(s,i,l)=>`<a href="${E(l)}" target="_blank" rel="noopener">${i}</a>`),o=o.replace(new RegExp(`${Re}(\\d+)${Re}`,"g"),(s,i)=>{let l=r[Number(i)];if(!l)return"";let c=l.latex;if(t)try{let d=t(c,l.display);return l.display?`<div class="tc-md-math display" data-latex="${E(c)}">${d}</div>`:`<span class="tc-md-math inline" data-latex="${E(c)}">${d}</span>`}catch(d){return l.display?`<div class="tc-md-math error" title="${E(String(d))}">${E(c)}</div>`:`<span class="tc-md-math error" title="${E(String(d))}">${E(c)}</span>`}return l.display?`<div class="tc-md-math fallback display" data-latex="${E(c)}"><code>${E(c)}</code></div>`:`<span class="tc-md-math fallback inline" data-latex="${E(c)}"><code>${E(c)}</code></span>`}),o}function In(e){let t=e.match(/^\[([ xX])\]\s+(.*)$/);return t?`<li class="tc-md-task"><input type="checkbox" disabled${t[1].toLowerCase()==="x"?" checked":""}/><span>${t[2]}</span></li>`:""}function Dn(e,t){let r=(o,s,i)=>{let l=i&&i!=="left"?` style="text-align:${i}"`:"";return`<${s}${l}>${o}</${s}>`},n=e[0]?.map((o,s)=>r(o,"th",t[s])).join("")??"",a=e.slice(1).map(o=>`<tr>${o.map((s,i)=>r(s,"td",t[i])).join("")}</tr>`).join("");return`<table class="tc-md-table"><thead><tr>${n}</tr></thead><tbody>${a}</tbody></table>`}function Ye(e,t){let r=t?.mathRenderer,n=t?.highlight,a=e.replace(/\r\n?/g,`
`).split(`
`),o=[],s=0,i=l=>Nn(l,r);for(;s<a.length;){let l=a[s],c=l.match(/^:::\s*([a-zA-Z][\w-]*)(?:\s+(.+))?\s*$/);if(c){let f=c[1].toLowerCase(),b=(c[2]??"").trim(),v=[];for(s++;s<a.length&&!/^:::\s*$/.test(a[s]);)v.push(a[s]),s++;s<a.length&&s++;let x=Ye(v.join(`
`),t);o.push(`<div class="tc-md-callout v-${E(f)}" role="${f==="danger"?"alert":"note"}">${b?`<div class="callout-title">${i(b)}</div>`:""}<div class="callout-body">${x}</div></div>`);continue}let d=l.match(/^```(\S*)\s*$/);if(d){let f=d[1]??"",b=[];for(s++;s<a.length&&!/^```\s*$/.test(a[s]);)b.push(a[s]),s++;s<a.length&&s++;let v=b.join(`
`),x=n&&f?(()=>{try{return n(v,f)}catch{return E(v)}})():E(v),y=f?` class="lang-${E(f)}"`:"";o.push(`<pre><code${y}>${x}</code></pre>`);continue}let u=l.match(/^(#{1,6})\s+(.*)$/);if(u){let f=u[1].length;o.push(`<h${f}>${i(u[2])}</h${f}>`),s++;continue}if(/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(l.trim())){o.push("<hr/>"),s++;continue}if(/^\s*\|.+\|\s*$/.test(l)&&s+1<a.length&&/^\s*\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?\s*$/.test(a[s+1])){let f=l.trim().replace(/^\||\|$/g,"").split("|").map(y=>y.trim()),b=a[s+1].trim().replace(/^\||\|$/g,"").split("|").map(y=>{let w=y.trim(),C=w.startsWith(":"),H=w.endsWith(":");return C&&H?"center":H?"right":C?"left":""}),v=[];for(s+=2;s<a.length&&/^\s*\|.+\|\s*$/.test(a[s]);)v.push(a[s].trim().replace(/^\||\|$/g,"").split("|").map(y=>i(y.trim()))),s++;let x=[f.map(y=>i(y)),...v];o.push(Dn(x,b));continue}if(/^>\s?/.test(l)){let f=[];for(;s<a.length&&/^>\s?/.test(a[s]);)f.push(a[s].replace(/^>\s?/,"")),s++;o.push(`<blockquote>${i(f.join(" "))}</blockquote>`);continue}let p=l.match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(p){let f=!!p[3],b=f?"ol":"ul",v=[],x=!1;for(;s<a.length;){let w=a[s].match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(!w||!!w[3]!==f)break;let H=w[4],j=In(H);j?(x=!0,v.push(j)):v.push(`<li>${i(H)}</li>`),s++}let y=x?' class="tc-md-tasks"':"";o.push(`<${b}${y}>${v.join("")}</${b}>`);continue}if(l.trim()===""){s++;continue}let g=[l];for(s++;s<a.length;){let f=a[s];if(f.trim()===""||/^#{1,6}\s+/.test(f)||/^```/.test(f)||/^>\s?/.test(f)||/^:::/.test(f)||/^(\s*)(?:[-*+]|\d+\.)\s+/.test(f)||/^\s*\|.+\|\s*$/.test(f)||/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(f.trim()))break;g.push(f),s++}o.push(`<p>${i(g.join(" "))}</p>`)}return o.join(`
`)}var Vt={bold:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4h7a4 4 0 0 1 0 8H6z"/><path d="M6 12h8a4 4 0 0 1 0 8H6z"/></svg>',italic:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>',heading:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6v12"/><path d="M12 6v12"/><path d="M4 12h8"/><path d="M16 18l4-12"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',link:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',bullet:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><circle cx="4" cy="6" r="1.2" fill="currentColor"/><circle cx="4" cy="12" r="1.2" fill="currentColor"/><circle cx="4" cy="18" r="1.2" fill="currentColor"/></svg>',ordered:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><path d="M4 8V4l-1 1"/><path d="M3 14h2l-2 3h2"/></svg>',quote:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h3v6H4v-3a3 3 0 0 1 3-3z"/><path d="M16 7h3v6h-6v-3a3 3 0 0 1 3-3z"/></svg>',preview:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'};function Ue(e,t,r,n,a,o="text"){let s=e.slice(t,r)||o;return{text:e.slice(0,t)+n+s+a+e.slice(r),selStart:t+n.length,selEnd:t+n.length+s.length}}function Ne(e,t,r,n){let a=e.lastIndexOf(`
`,t-1)+1,o=(()=>{let l=e.indexOf(`
`,r);return l===-1?e.length:l})(),i=e.slice(a,o).split(`
`).map(l=>n+l).join(`
`);return{text:e.slice(0,a)+i+e.slice(o),selStart:a,selEnd:a+i.length}}var Ut={bold:{key:"bold",label:"Bold",shortcut:"\u2318B",apply:(e,t,r)=>Ue(e,t,r,"**","**","bold text")},italic:{key:"italic",label:"Italic",shortcut:"\u2318I",apply:(e,t,r)=>Ue(e,t,r,"*","*","italic text")},heading:{key:"heading",label:"Heading",apply:(e,t,r)=>Ne(e,t,r,"## ")},code:{key:"code",label:"Code",apply:(e,t,r)=>Ue(e,t,r,"`","`","code")},link:{key:"link",label:"Link",shortcut:"\u2318K",apply:(e,t,r)=>{let n=globalThis.prompt?.("URL")?.trim();if(!n)return{text:e,selStart:t,selEnd:r};let a=e.slice(t,r)||"link text";return{text:e.slice(0,t)+`[${a}](${n})`+e.slice(r),selStart:t+1,selEnd:t+1+a.length}}},bullet:{key:"bullet",label:"Bulleted list",apply:(e,t,r)=>Ne(e,t,r,"- ")},ordered:{key:"ordered",label:"Numbered list",apply:(e,t,r)=>Ne(e,t,r,"1. ")},quote:{key:"quote",label:"Quote",apply:(e,t,r)=>Ne(e,t,r,"> ")}},Gt="bold,italic,heading,|,bullet,ordered,quote,|,link,code",jn=`
  <style>
    :host {
      display: block;
...
`;h(Rn,m({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Write some markdown\u2026"},mode:{type:"string",default:"split"},readonly:{type:"boolean",default:!1},minHeight:{type:"string",default:"240px"},toolbar:{type:"string",default:Gt}},theme:{"tc-md-bg":"var(--tc-color-surface, #ffffff)","tc-md-fg":"var(--tc-color-ink, #14171f)","tc-md-rule":"var(--tc-color-rule, #ece5d3)","tc-md-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-md-preview-bg":"var(--tc-color-bg, #faf8f3)","tc-md-radius":"var(--tc-radius-md, 8px)","tc-md-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-md-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)"},styles:{display:"block"},refs:{source:"textarea",preview:".preview"},template:({props:e,state:t})=>{let r=String(t.mode??e.mode??"split"),n=String(e.value??""),a=String(e.toolbar??Gt).split(",").map(p=>p.trim()).filter(Boolean),o=a.map(p=>{if(p==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let g=Ut[p];if(!g||!Vt[g.key])return"";let f=g.shortcut?` (${E(g.shortcut)})`:"";return`<button type="button" class="tb-btn" data-op="${E(g.key)}" title="${E(g.label)}${f}" aria-label="${E(g.label)}">${Vt[g.key]}</button>`}).join(""),s=(p,g)=>`<button type="button" data-mode="${p}" class="${r===p?"is-active":""}" aria-pressed="${r===p?"true":"false"}">${g}</button>`,i=e,c=(i.render??(p=>Ye(p,{mathRenderer:i.mathRenderer,highlight:i.highlight})))(n),d=r==="source"?"panes source-only":r==="preview"?"panes preview-only":"panes";return`
        <div class="root" style="${`--tc-md-min-height: ${E(e.minHeight??"240px")};`}">
          <div class="${a.length===0?"toolbar empty":"toolbar"}" role="toolbar" aria-label="Markdown formatting">
            ${o}
      ...
      `}}));function U(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var _n="site-nav";var On='<svg class="nav-caret" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg>';h(_n,m({props:{active:{type:"string",default:""},version:{type:"string",default:"v1.1.0"},base:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??""),r=String(e.active??""),n=[{id:"docs",label:"Docs",href:`${t}docs.html`},{id:"components",label:"Components",href:`${t}components.html`}],a=[{id:"icons",label:"Icons",href:`${t}icons.html`},{id:"themes",label:"Themes",href:`${t}themes.html`},{id:"examples",label:"Examples",href:`${t}examples.html`},{id:"playground",label:"Playground",href:`${t}playground.html`}],o=[{id:"blog",label:"Blog",href:`${t}blog/`},{id:"github",label:"GitHub",href:"https://github.com/ra9/tan-compose",external:!0}],s=(l,c="")=>{let d=l.id===r,u=[c,d?"active":""].filter(Boolean).join(" "),p=d?' aria-current="page"':"",g=l.external?' target="_blank" rel="noopener"':"";return`<a href="${ke(l.href)}"${p}${g}${u?` class="${u}"`:""}>${ke(l.label)}</a>`},i=a.some(l=>l.id===r);return`
        <header class="topbar">
          <div class="inner">
            ...
            <nav id="primary-nav" class="nav-menu" aria-label="Primary">
              ...
              <div class="nav-group${i?" group-active":""}">
                ...
                <div class="nav-dropdown" role="menu">
                  ...
                  ${a.map(l=>s(l,"nav-dropdown-link")).join(`
                  `)}
                </div>
              </div>
      ...
      `},afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".nav-toggle"),n=t.querySelector(".nav-menu"),a=Array.from(t.querySelectorAll(".nav-group")),o=(p,g)=>{p.classList.toggle("open",g),p.querySelector(".nav-group-trigger")?.setAttribute("aria-expanded",g?"true":"false")},s=p=>{for(let g of a)g!==p&&o(g,!1)},i=()=>{n?.classList.remove("open"),r?.setAttribute("aria-expanded","false"),r?.setAttribute("aria-label","Open menu")},l=p=>{p.preventDefault();let g=!n?.classList.contains("open");n?.classList.toggle("open",g),r?.setAttribute("aria-expanded",g?"true":"false"),r?.setAttribute("aria-label",g?"Close menu":"Open menu")};r?.addEventListener("click",l);let c=[];for(let p of a){let g=p.querySelector(".nav-group-trigger");if(!g)continue;let f=b=>{b.preventDefault();let v=!p.classList.contains("open");s(p),o(p,v)};g.addEventListener("click",f),c.push([g,f])}let d=p=>{let g=p.composedPath();for(let f of a)g.includes(f)||o(f,!1);n&&!g.includes(n)&&!(r&&g.includes(r))&&i()},u=p=>{p.key==="Escape"&&(s(),n?.classList.contains("open")&&(i(),r?.focus()))};document.addEventListener("click",d),document.addEventListener("keydown",u),e._navCleanup=()=>{r?.removeEventListener("click",l);for(let[p,g]of c)p.removeEventListener("click",g);document.removeEventListener("click",d),document.removeEventListener("keydown",u)}},unmount(){this._navCleanup?.()}}));function ke(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Fn="site-footer";h(Fn,m({props:{base:{type:"string",default:""},year:{type:"string",default:"2026"}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??"");return`
        <footer class="foot">
          <div class="inner">
      ...
      `}}));function de(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Pn="site-search";var Y=null,De=null;function je(e){if(Y)return Promise.resolve(Y);if(De)return De;let t=`${e}search.json`;return De=fetch(t).then(r=>r.json()).then(r=>(Y=r.docs??[],Y)).catch(r=>(console.warn("[site-search] failed to load index:",r),Y=[],Y)),De}function Wt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Yt(e,t){let r=e.trim().toLowerCase();if(!r)return[];let n=r.split(/\s+/).filter(Boolean).map(o=>({raw:o,re:new RegExp(Wt(o),"i")})),a=[];for(let o of t){let s=o.title.toLowerCase(),i=(o.description??"").toLowerCase(),l=(o.text??"").toLowerCase(),c=0;for(let u of n){let p=u.raw;s===p&&(c+=50),s.startsWith(p)&&(c+=20),s.includes(p)&&(c+=10),i.includes(p)&&(c+=5),l.includes(p)&&(c+=1)}n.every(u=>u.re.test(o.title)||u.re.test(i)||u.re.test(l))&&c!==0&&(o.category==="blog"&&o.date&&(Date.now()-new Date(o.date).getTime())/864e5<30&&(c+=3),a.push({doc:o,score:c}))}return a.sort((o,s)=>s.score-o.score),a.slice(0,12)}function Vn(e,t,r=140){let n=e.trim().toLowerCase().split(/\s+/)[0];if(!n)return t.slice(0,r);let o=t.toLowerCase().indexOf(n);if(o===-1)return t.slice(0,r);let s=Math.max(0,o-40),i=Math.min(t.length,s+r),l=s>0?"\u2026 ":"",c=i<t.length?" \u2026":"";return l+t.slice(s,i)+c}function W(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Xe(e,t){let r=t.trim();if(!r)return W(e);let n=r.split(/\s+/).filter(Boolean),a=W(e);for(let o of n){let s=new RegExp(`(${Wt(W(o))})`,"gi");a=a.replace(s,"<mark>$1</mark>")}return a}function Gn(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var Kn=`
        <style>
          :host { display: inline-block; }
...
`;h(Pn,m({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),n=String(t.query??""),a=Number(t.focusIdx??0),o=t.results??[],s=`
      ...
      `,i=n.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':o.length===0?`<div class="empty">No results for "${W(n)}". Try a shorter query.</div>`:o.map((c,d)=>{let u=d===a?"row focused":"row",p=r+c.doc.url.replace(/^\//,""),g=Vn(n,c.doc.text);return`
              <a class="${u}" data-index="${d}" href="${W(p)}">
                <span class="row-cat ${W(c.doc.category)}">${W(c.doc.category)}</span>
                <div class="row-main">
                  <div class="row-title">${Xe(c.doc.title,n)}</div>
                  <div class="row-desc">${Xe(c.doc.description,n)}</div>
                  <div class="row-snippet">${Xe(g,n)}</div>
                </div>
              </a>
            `}).join(""),l=`
