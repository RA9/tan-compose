...
`,Be=!1;function Zt(){if(typeof document>"u"||Be)return;if(document.querySelector("style[data-tc-tokens]")){Be=!0;return}let e=document.createElement("style");e.setAttribute("data-tc-tokens",""),e.textContent=Jt,document.head.insertBefore(e,document.head.firstChild),Be=!0}Zt();var Qt=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],er=new Set(["string","number","boolean","json"]);function g(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Qt){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,a]of Object.entries(t)){if(a===null||typeof a!="object"||Array.isArray(a))throw new TypeError(`describe(): props.${r} must be a record`);if(!er.has(a.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Qe=new Map,tr=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,rr=/^(\S+)(?:\s+(.+))?$/;function h(e,t){if(typeof e!="string"||!tr.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Qe.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),a=t.props??{},n=t.refs??{},o=or(t);class s extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let l=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),sr(l,o),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",l.appendChild(this.container),t.attributes&&nt(this,t.attributes),this.ctx=nr(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[l,c]of Object.entries(a)){let d=this.getAttribute(l),u=d!==null?et(d,c.type):c.default;this.propValues.set(l,u),this.maybeSyncFormValue(l,u),Object.defineProperty(this,l,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(l),set:f=>{let m=cr(f,c.type),p=this.propValues.get(l);Object.is(p,m)||(this.propValues.set(l,m),c.reflect&&dr(this,l,m,c.type),this.maybeSyncFormValue(l,m),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(l,c){if(!this.internals||l!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(l){console.error(`[tan-compose] beforeMount threw for <${e}>:`,l)}if(this.renderInternal(),t.action){let l=t.action;this.addEventListener("click",l),this.mountCleanups.push(()=>this.removeEventListener("click",l))}if(t.emit)for(let l of t.emit)this.addEventListener(l.name,l.handler),this.mountCleanups.push(()=>this.removeEventListener(l.name,l.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(l){console.error(`[tan-compose] afterMount threw for <${e}>:`,l)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(l){console.error(`[tan-compose] unmount threw for <${e}>:`,l)}te(this.mountCleanups),te(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){at(t,l=>{let c=this.listSlots.get(l);if(c){for(let d of c.cache.values())te(d.cleanups);c.cache.clear()}})}attributeChangedCallback(l,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(a,l)){let u=a[l],f=d!==null?et(d,u.type):u.default,m=this.propValues.get(l);Object.is(m,f)||(this.propValues.set(l,f),this.isMounted&&this.scheduleRender());return}this.state.set(l,d),this.isMounted&&this.scheduleRender()}}setState(l,c){let d=this.state.get(l);Object.is(d,c)||(this.state.set(l,c),this.isMounted&&this.scheduleRender())}getState(l){return this.state.get(l)}render(){this.renderInternal()}emitEvent(l,c){this.dispatchEvent(new CustomEvent(l,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(l){let c=this.listSlots.get(l);return c||(c={cache:new Map},this.listSlots.set(l,c)),c}renderInternal(){this.rendering=!0;let l=this.captureFocusInShadow();try{te(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let u=tt(d,c,f=>this.getOrCreateSlot(f));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(l&&this.restoreFocusInShadow(l),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let l=this.shadowRoot;if(!l)return null;let c=l.activeElement;if(!c)return null;let d=[],u=c;for(;u&&u!==l;){let p=u.parentNode;if(!p)break;let b=u.tagName,x=Array.from(p.children).filter(y=>y.tagName===b).indexOf(u);if(d.unshift({tag:b,idx:x}),u=p instanceof Element?p:null,!u&&p===l)break}let f=null,m=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{f=c.selectionStart,m=c.selectionEnd}catch{}return{path:d,selectionStart:f,selectionEnd:m}}restoreFocusInShadow(l){let c=this.shadowRoot;if(!c)return;let d=c;for(let f of l.path){let m=Array.from(d.children??[]),v=(m.length>0?m:Array.from(d.children??[])).filter(x=>x.tagName===f.tag)[f.idx];if(!v)return;d=v}let u=d;if(!(!u||typeof u.focus!="function")&&c.activeElement!==u&&(u.focus(),l.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(l.selectionStart,l.selectionEnd??l.selectionStart)}catch{}}refreshRefs(){let l={},c=this.shadowRoot;for(let[d,u]of Object.entries(n))l[d]=c?c.querySelector(u):null;this.currentRefs=l}formAssociatedCallback(l){try{t.formAssociatedCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(l){try{t.formDisabledCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(l){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,l)}}formStateRestoreCallback(l,c){try{t.formStateRestoreCallback?.call(this,l,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(l){let c=new Map;for(let[d,u]of Object.entries(l)){let f=rr.exec(d.trim());if(!f)continue;let[,m,p]=f;c.has(m)||c.set(m,[]),c.get(m).push({selector:p??null,handler:u})}for(let[d,u]of c){let f=m=>{for(let{selector:p,handler:b}of u){if(!p){b(m,this.ctx);continue}let v=m.composedPath();for(let x of v){if(x===this.shadowRoot||x===this)break;if(x instanceof Element&&this.shadowRoot?.contains(x)&&x.matches(p)){b(m,this.ctx);break}}}};this.shadowRoot.addEventListener(d,f),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,f))}}}return Qe.set(e,s),customElements.define(e,s),e}function tt(e,t,r){return e.if&&!e.if(t.ctx)?null:rt(e,t,r)}function rt(e,t,r){let a=document.createElement(e.tag||"div");if(e.styles&&(a.style.cssText=Object.entries(e.styles).map(([n,o])=>`${n}: ${o}`).join("; ")),e.className&&(a.className=e.className),e.attributes&&nt(a,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(a.innerHTML=n)}if(e.children)for(let n of e.children){let o=tt(n,t,r);o&&a.appendChild(o)}if(e.for&&ar(a,e,t,r),e.action){let n=e.action;a.addEventListener("click",n),t.cleanups.push(()=>a.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)a.addEventListener(n.name,n.handler),t.cleanups.push(()=>a.removeEventListener(n.name,n.handler));return a}function ar(e,t,r,a){let n=t.for,o=a(t),s=n.items(r.ctx),i=new Map;for(let l=0;l<s.length;l++){let c=s[l],d=n.key(c,l),u,f=o.cache.get(d);if(f&&Object.is(f.lastItem,c))u=f;else{let m=[],p=n.render(c,l,r.ctx),b=rt(p,{...r,cleanups:m},a);f&&te(f.cleanups),u={element:b,lastItem:c,cleanups:m}}i.set(d,u),e.appendChild(u.element)}for(let[l,c]of o.cache)i.has(l)||te(c.cleanups);o.cache=i}function at(e,t){if(e.for&&t(e),e.children)for(let r of e.children)at(r,t)}function nr(e,t,r,a){return{host:e,get props(){let n={};for(let[o,s]of t)n[o]=s;return n},get state(){let n={};for(let[o,s]of r)n[o]=s;return n},get refs(){return a()},setState:(n,o)=>e.setState(n,o),getState:n=>e.getState(n),emit:(n,o)=>e.emitEvent(n,o)}}function or(e){let t=e.theme?ir(e.theme):void 0,r=e.styles?lr(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let o=new CSSStyleSheet;o.replaceSync(t),n.push(o)}if(r){let o=new CSSStyleSheet;o.replaceSync(r),n.push(o)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function sr(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function nt(e,t){for(let[r,a]of Object.entries(t))e.setAttribute(r,a)}function ir(e){return`:host { ${Object.entries(e).map(([r,a])=>`--${r}: ${a};`).join(" ")} }`}function lr(e){return`.container { ${Object.entries(e).map(([r,a])=>`${r}: ${a};`).join(" ")} }`}function te(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function et(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function cr(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function dr(e,t,r,a){if(a!=="json"){if(a==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var ur="tc-button";var ot=`
      <style>
        .root {
...
`;h(ur,g({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""},type:{type:"string",default:"button"}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-btn-padding-x":"initial","tc-btn-padding-y":"initial"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${ge(e.variant)} s-${ge(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
      ...
      `},events:{"input textarea":(e,t)=>{let r=e.target.value,a=t.host;a.internals?.setFormValue(r),a.value=r,t.emit("tc-input",{value:r})}},formResetCallback(){this.value=""}}));function Z(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var gr="tc-select";h(gr,g({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.options??[],r=!!e.error;return`
        ...
        <div class="wrap">
          ...
          >
            ${e.placeholder?`<option value="" disabled ${e.value===""?"selected":""}>${ae(e.placeholder)}</option>`:""}
            ${t.map(a=>`<option value="${ae(a.value)}"${a.disabled?" disabled":""}${a.value===e.value?" selected":""}>${ae(a.label)}</option>`).join("")}
          </select>
      ...
      `},events:{"click .track":(e,t)=>{let r=t.host;r.disabled||(r.checked=!r.checked,r.internals?.setFormValue(r.checked?r.value:null),t.emit("tc-change",{checked:r.checked}))},"keydown .track":(e,t)=>{let r=e;if(r.key!==" "&&r.key!=="Enter")return;r.preventDefault();let a=t.host;a.disabled||(a.checked=!a.checked,a.internals?.setFormValue(a.checked?a.value:null),t.emit("tc-change",{checked:a.checked}))}},afterMount(){let e=this;e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function st(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var br="tc-file";h(br,g({formAssociated:!0,props:{name:{type:"string",default:""},accept:{type:"string",default:""},multiple:{type:"boolean",default:!1,reflect:!0},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},buttonText:{type:"string",default:"Choose file"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-file-zone-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-file-zone-fg":"var(--tc-color-ink-soft, #4a5061)"},styles:{display:"block"},refs:{input:"input[type='file']"},template:({props:e,state:t})=>{let r=!!e.error,a=t.files??[],n=a.length===0?"No file selected":a.length===1?ne(a[0].name):`${a.length} files selected`;return`
      ...
      `},events:{"click .btn":(e,t)=>{t.refs.input?.click()},"change input[type='file']":(e,t)=>{let r=e.target,a=Array.from(r.files??[]);t.setState("files",a);let n=t.host;if(n.internals)if(a.length===0)n.internals.setFormValue(null);else if(a.length===1)n.internals.setFormValue(a[0]);else{let o=new FormData,s=n.name;for(let i of a)o.append(s,i);n.internals.setFormValue(o)}t.emit("tc-files",{files:a})}},formResetCallback(){let t=this.shadowRoot?.querySelector(".native");t&&(t.value=""),this.setState("files",[])}}));function ne(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var vr="tc-radio-group";h(vr,g({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},layout:{type:"string",default:"vertical"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-radio-accent":"var(--tc-color-accent, #a16939)"},styles:{display:"block"},template:({props:e})=>{let t=e.options??[],r=!!e.error,a=String(e.layout??"vertical");return`
        <fieldset class="group" ${e.disabled?"disabled":""}>
          ...
          <div class="opts l-${oe(a)}" role="radiogroup" aria-invalid="${r?"true":"false"}">
      ...
      `},events:{"change input.r":(e,t)=>{let r=e.target.value,a=t.host;a.value=r,a.internals?.setFormValue(r),t.emit("tc-change",{value:r})}},afterMount(){let e=this;e.value&&e.internals?.setFormValue(e.value)},formResetCallback(){this.value=""}}));function oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var yr="tc-table";var xr=`
...
`,_e=new WeakMap;h(yr,g({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[g({tag:"style",template:xr}),g({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),g({tag:"div",className:"wrap",children:[g({tag:"table",children:[g({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let o=a.sortKey===n.key,s=n.sortable!==!1,i=o?a.sortDir==="asc"?"\u25B2":"\u25BC":"",l=o?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${Ee(n.key)}"
                        class="${s?"sortable":""}"
                        aria-sort="${l}"
                      >${Ee(n.label)}<span class="sort">${i}</span></th>`}).join("")}</tr>`}}),g({tag:"tbody",children:[g({tag:"tr",className:"empty",if:({props:e,state:t})=>it(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${Ee(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>it(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],o=e;return g({tag:"tr",attributes:{"data-row-id":String(o.id??t)},template:n.map(s=>`<td>${typeof s.render=="function"?s.render(o):Ee(o[s.key]??"")}</td>`).join("")})}}})]})]}),g({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=Se(e,r),n=e.pageSize??10,o=Math.max(1,Math.ceil(a.length/n)),s=Math.min(r.page??0,o-1),i=(e.rows??[]).length;return`
        ...
        <div role="tablist" class="strip">
          ${t.map(a=>`<button
              ...
              aria-controls="panel-${me(a.id)}"
              tabindex="${a.id===r?"0":"-1"}"
            >${me(a.label)}</button>`).join("")}
        </div>
        <div class="panels">
          ${t.map(a=>`<section
              role="tabpanel"
              ...
              aria-labelledby=""
              ${a.id===r?"":"hidden"}
            ><slot name="${me(a.id)}"></slot></section>`).join("")}
        </div>
        <style>
          .strip {
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{lt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&lt(r,"backdrop")}},afterRender(){$r(this)},unmount(){let e=se.get(this);e&&(e.cleanup(),se.delete(this))}}));function $r(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=se.get(e);if(n&&n.dialog!==r&&(n.cleanup(),se.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!se.has(e)){let o=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),se.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function lt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mr="tc-toast";var he=new WeakMap;h(Mr,g({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
      ...
      `}}));function ie(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Tr="tc-card";h(Tr,g({props:{title:{type:"string",default:""},subtitle:{type:"string",default:""},padded:{type:"boolean",default:!0},bordered:{type:"boolean",default:!0},elevated:{type:"boolean",default:!1},size:{type:"string",default:"md"}},theme:{"tc-card-surface":"var(--tc-color-surface, #ffffff)","tc-card-ink":"var(--tc-color-ink, #14171f)","tc-card-soft":"var(--tc-color-ink-soft, #5a6072)","tc-card-rule":"var(--tc-color-rule, #ece5d3)","tc-card-radius":"var(--tc-radius-lg, 12px)","tc-card-shadow":"var(--tc-shadow-md, 0 8px 24px rgba(20, 23, 31, 0.06))","tc-card-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-card-padding-x":"var(--tc-space-5, 20px)","tc-card-padding-y":"var(--tc-space-5, 20px)","tc-card-gap":"var(--tc-space-3, 12px)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.title||!!e.subtitle,r=String(e.size??"md").toLowerCase();return`
        <div class="${["card",`size-${["sm","md","lg"].includes(r)?r:"md"}`,e.bordered?"bordered":"",e.elevated?"elevated":"",e.padded===!1?"nopad":"",t?"has-header":""].filter(Boolean).join(" ")}">
          ...
          <div class="head">
            <slot name="header">
              ${e.title?`<div class="title">${pt(e.title)}</div>`:""}
              ${e.subtitle?`<div class="subtitle">${pt(e.subtitle)}</div>`:""}
            </slot>
          </div>
          <div class="body"><slot></slot></div>
    ...
    `}));function gt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Cr="tc-stack";h(Cr,g({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
    ...
    `}));function Ir(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Dr(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${jr(t)})`:t}function jr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function qr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Br="tc-grid";h(Br,g({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
      ...
      `},afterMount(){Ur(this)},unmount(){Te.get(this)?.observer?.disconnect(),Te.delete(this)}}));function Ur(e){Te.get(e)?.observer?.disconnect();let r=e,a=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),o=document.querySelector(a);if(!o)return;let s=Array.from(o.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),i=s.map(c=>(c.id||(c.id=Yr(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",i),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(c=>{let u=c.filter(m=>m.isIntersecting).sort((m,p)=>m.boundingClientRect.top-p.boundingClientRect.top)[0];if(!u)return;let f=u.target.id;f&&e.setState("activeId",f)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of s)l.observe(c);Te.set(e,{observer:l,activeId:""})}function Yr(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Wr="tc-pagination";h(Wr,g({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=Xr(Number(e.current)|0,1,t),a=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let o=Jr(r,t,a,n),s=Le(String(e.size??"sm")),i=r<=1?" disabled":"",l=r>=t?" disabled":"",c=o.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${s}"
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let a=r.getAttribute("data-page");if(a==null)return;let n=Number(a),o=t.host,s=Math.max(1,Number(o.total)|0),i=Number(o.current)|0;!Number.isFinite(n)||n<1||n>s||n!==i&&t.emit("tc-page-change",{page:n})}}}));function Xr(e,t,r){return Math.min(r,Math.max(t,e))}function Jr(e,t,r,a){let n=new Set;for(let i=1;i<=Math.min(a,t);i++)n.add(i);for(let i=Math.max(1,t-a+1);i<=t;i++)n.add(i);for(let i=Math.max(1,e-r);i<=Math.min(t,e+r);i++)n.add(i);let o=[...n].sort((i,l)=>i-l),s=[];for(let i=0;i<o.length;i++)i>0&&o[i]-o[i-1]>1&&s.push("\u2026"),s.push(o[i]);return s}function Le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Zr="tc-combobox";function be(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function ve(e){return e.join(",")}function Qr(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var ea=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;h(Zr,g({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],a=!!e.multiple,n=e.searchable!==!1,o=!!e.disabled,s=!!e.error,i=be(e.value),l=String(t.query??""),c=!!t.open&&!o,d=Number(t.focusedIndex??-1),u=yt(r,l),f=new Set(i),m=i.map($=>r.find(O=>O.value===$)).filter($=>!!$),p=n&&(c||a&&i.length===0),b=!a&&i.length===1&&(!c||!n),v=i.length===0&&!p&&!b,x=a?m.map($=>`<span class="chip" data-value="${R($.value)}">
          ...
          />`:"",H=u.length===0?`<div class="empty">${R(e["empty-text"]??"No results")}</div>`:u.map(($,O)=>{let N=f.has($.value);return`<div
            ...
            </div>`}).join(""),j=e.label?`<label class="label">${R(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",ue=s?`<div class="helper error">${R(e.error)}</div>`:e.helper?`<div class="helper">${R(e.helper)}</div>`:"";return`
        ${j}
        <div
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;P(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;P(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let a=Number(r.dataset.index);if(!Number.isFinite(a))return;let n=t.host;P(n,a)},"keydown .root":(e,t)=>{let r=e,a=t.host,n=a.orientation==="vertical",o=Ce(a),s=n?"ArrowUp":"ArrowLeft",i=n?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),P(a,a.value-1)):r.key===i?(r.preventDefault(),P(a,a.value+1)):r.key==="Home"?(r.preventDefault(),P(a,0)):r.key==="End"&&(r.preventDefault(),P(a,o-1))}},afterMount(){let e=this,t=()=>$t(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let a=e.shadowRoot,n=a?.querySelector("slot"),o=()=>t();n?.addEventListener("slotchange",o),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",o)};let s=()=>Fe(e),i=()=>{e.pauseOnHover&&wt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",i),e.addEventListener("focusin",s),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",s),e.removeEventListener("focusout",i)},ra(e),a?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&wt(e)},afterRender(){$t(this)},unmount(){let e=this;Fe(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function $t(e){let t=Ce(e),r=e.shadowRoot;if(!r)return;let a=r.querySelector(".root");if(a&&t>0){let i=Mt(e.value,t,e.loop);i!==e.value&&(e.value=i),a.style.setProperty("--tc-carousel-index",String(i))}let n=r.querySelector(".indicators");if(n){let i=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===i?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function ra(e){let t=0,r=0,a=!1,n=40,o=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,a=!0))},s=l=>{if(!a)return;a=!1;let c=l.clientX-t,d=l.clientY-r,f=e.orientation==="vertical"?d:c;Math.abs(f)<n||P(e,e.value+(f<0?1:-1))},i=()=>{a=!1};e.addEventListener("pointerdown",o),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",o),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",i)}}var K="tc-accordion";h(K,g({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this;aa();let t=o=>{let s=o.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let i of ze(e))i!==s&&i.open&&(i.open=!1);na(e)}},r=o=>{let s=o.target;if(!s||s.tagName!=="SUMMARY")return;let i=ze(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=i.indexOf(s);if(l===-1)return;let c=-1;o.key==="ArrowDown"?c=(l+1)%i.length:o.key==="ArrowUp"?c=(l-1+i.length)%i.length:o.key==="Home"?c=0:o.key==="End"&&(c=i.length-1),c!==-1&&(o.preventDefault(),i[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let a=()=>{for(let o of ze(e)){let s=o.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",s.appendChild(i);let l=()=>{i.style.transform=o.open?"rotate(90deg)":"rotate(0)"};l(),o.addEventListener("toggle",l)}}};a();let n=new MutationObserver(a);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));var Et="tc-accordion-light-styles";function aa(){if(typeof document>"u"||document.getElementById(Et))return;let e=document.createElement("style");e.id=Et,e.textContent=`
  ...
  `,(document.head||document.documentElement).appendChild(e)}function ze(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function na(e){let t=[];for(let r of ze(e))if(r.open){let a=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(a)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var oa="tc-tooltip";function sa(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(oa,g({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${sa(e.text)}</span>`:""}
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){Tt(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},a=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&Lt(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",a,!0),globalThis.addEventListener("resize",a),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",a,!0),globalThis.removeEventListener("resize",a)},Tt(e)},unmount(){this._popoverCleanup?.()}}));function Tt(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let a=e.open,n=typeof r.showPopover=="function";if(a&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";Lt(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!a&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function Lt(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,o=globalThis.innerHeight,s=e.offset,i=e.placement||"bottom",l=u=>u==="top"?r.top-a.height-s>=4:u==="bottom"?r.bottom+a.height+s<=o-4:u==="left"?r.left-a.width-s>=4:u==="right"?r.right+a.width+s<=n-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"bottom")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-a.height-s,d=r.left+r.width/2-a.width/2):i==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-a.width/2):i==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-s):i==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+s),c=Math.max(4,Math.min(o-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var la="tc-drawer";var le=new WeakMap;function Pe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}h(la,g({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Pe(e.size??"min(420px, 92vw)");return`
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Ht(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&Ht(r,"backdrop")}},afterRender(){ca(this)},unmount(){let e=le.get(this);e&&(e.cleanup(),le.delete(this))}}));function ca(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=le.get(e);if(n&&n.dialog!==r&&(n.cleanup(),le.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!le.has(e)){let o=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),le.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Ht(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var da="tc-progress";function ce(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ua(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}h(da,g({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),a=!!e.indeterminate,n=Number(e.value??0),o=Number(e.max??100),s=ua(n,o),i=e.label||(a?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,f=(d-u)/2,m=2*Math.PI*f,p=a?m*.25:s/100*m,b=a?`role="progressbar" aria-valuetext="${ce(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${o}"`;return`
          <div class="circ size-${ce(r)} ${a?"indet":""}" ${b}>
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,c=a?`role="progressbar" aria-valuetext="${ce(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${o}"`;return`
        <div class="bar size-${ce(r)} ${a?"indet":""}" ${c}>
          <div class="track">
    ...
    `,afterMount(){let e=this,t=()=>At(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){At(this)},unmount(){this._agroupCleanup?.()}}));function At(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),a=Array.from(e.children).filter(l=>l instanceof HTMLElement),n=0;for(let l of a)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),n<t||t===0?(l.hidden=!1,n++):l.hidden=!0);let o=a.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,s=Math.max(0,o-n),i=e.shadowRoot?.querySelector(".overflow");i&&(s>0?(i.hidden=!1,i.textContent=`+${s}`):i.hidden=!0)}var ha="tc-rating";function Rt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Nt="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";h(ha,g({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),a=Number(e.value??0),n=Number(t.hover??-1),o=n>=0?n:a,s=String(e.size??"md"),i=!!e.readonly,l=!!e.allowHalf,c=Rt(e.ariaLabel??"Rating"),d=s==="sm"?18:s==="lg"?32:24,u=[];for(let f=1;f<=r;f++){let m=o-(f-1),p=m>=1?100:m>=.5&&l?50:m>0&&!l?100:0,b=p===50;u.push(`
          <span class="star ${b?"half":p===100?"full":"empty"}" data-index="${f}">
            <svg viewBox="0 0 24 24" width="${d}" height="${d}" aria-hidden="true">
              ...
              ${p>0?`<path class="fill" d="${Nt}" fill="var(--tc-rating-fill)" clip-path="${b?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);a.value!==n&&(a.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:a.value})}}}));var va="tc-chart";function It(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),a=e/Math.pow(10,r),n;return t?a<1.5?n=1:a<3?n=2:a<7?n=5:n=10:a<=1?n=1:a<=2?n=2:a<=5?n=5:n=10,n*Math.pow(10,r)}function ya(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let a=It(t-e,!1),n=It(a/(r-1),!0),o=Math.floor(e/n)*n,s=Math.ceil(t/n)*n,i=[];for(let l=o;l<=s+n*.5;l+=n)i.push(Number(l.toFixed(10)));return{min:o,max:s,ticks:i}}function Ge(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(a=>`${a.x} ${a.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let a=0;a<e.length-1;a++){let n=e[a-1]??e[a],o=e[a],s=e[a+1],i=e[a+2]??s,l=o.x+(s.x-n.x)/6,c=o.y+(s.y-n.y)/6,d=s.x-(i.x-o.x)/6,u=s.y-(i.y-o.y)/6;r+=` C ${l},${c} ${d},${u} ${s.x},${s.y}`}return r}function ye(e,t,r,a){return{x:e+r*Math.sin(a),y:t-r*Math.cos(a)}}function xa(e,t,r,a,n,o){let s=o-n>Math.PI?1:0,i=ye(e,t,r,n),l=ye(e,t,r,o);if(a<=0)return`M ${e} ${t} L ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} Z`;let c=ye(e,t,a,o),d=ye(e,t,a,n);return`M ${i.x} ${i.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} L ${c.x} ${c.y} A ${a} ${a} 0 ${s} 0 ${d.x} ${d.y} Z`}function M(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Q(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function xe(e,t){return t[e%t.length]}function ka(e,t){let{data:r,smooth:a,stacked:n,showAxes:o,showGrid:s,showLabels:i,showValues:l}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",f=u?4:16,m=u?4:o&&i?28:8,p=u?4:o?44:8,b=u?4:12,v=e.W-p-b,x=e.H-f-m,y=1/0,w=-1/0;if(n&&d.length>0){let S=c.length>0?c.map((k,L)=>d.reduce((z,q)=>z+(q.values?.[L]??0),0)):[];for(let k of S)k<y&&(y=k),k>w&&(w=k);y>0&&(y=0)}else for(let S of d)for(let k of S.values??[])k<y&&(y=k),k>w&&(w=k);(!Number.isFinite(y)||!Number.isFinite(w))&&(y=0,w=1),y===w&&(y-=1,w+=1);let C=ya(e.yMin??y,e.yMax??w,5),H=e.yMin??C.min,j=e.yMax??C.max,ue=j-H||1,$=c.length||d[0]?.values?.length||0,O=S=>$===1?p+v/2:t==="bar"?p+(S+.5)*(v/$):p+S/($-1)*v,N=S=>f+x-(S-H)/ue*x,ee=[];if(!u){if(s)for(let S of C.ticks){let k=N(S);ee.push(`<line class="grid" x1="${p}" x2="${e.W-b}" y1="${k}" y2="${k}"/>`)}if(o){for(let k of C.ticks){let L=N(k);ee.push(`<text class="axis-label y" x="${p-8}" y="${L}" text-anchor="end" dominant-baseline="middle">${M(Q(k))}</text>`)}if(i&&c.length>0){let k=Math.max(1,Math.ceil(c.length/8));c.forEach((L,z)=>{z%k!==0&&z!==c.length-1||ee.push(`<text class="axis-label x" x="${O(z)}" y="${e.H-m+16}" text-anchor="middle">${M(L)}</text>`)})}let S=H<=0&&j>=0?N(0):N(H);ee.push(`<line class="axis" x1="${p}" x2="${e.W-b}" y1="${S}" y2="${S}"/>`)}}let _=[];if(t==="bar"){let S=v/$,k=S*.18,L=S-k*2;d.forEach((z,q)=>{let X=`series series-${q}`,I=xe(q,e.palette),D=0;z.values?.forEach((T,B)=>{if(!Number.isFinite(T))return;let F=O(B),J,we,$e,qe;if(n){J=F-L/2,we=L;let pe=N(D+T),fe=N(D);$e=Math.min(pe,fe),qe=Math.abs(pe-fe),D+=T}else{let pe=L/d.length;J=F-L/2+q*pe,we=pe*.86;let fe=N(T),Ze=N(H<0&&j>0?0:H);$e=Math.min(fe,Ze),qe=Math.abs(fe-Ze)}let Je=`${M(z.name)}${c[B]?` \xB7 ${M(c[B])}`:""}: ${M(Q(T))}`,Xt=(B*.04).toFixed(3);_.push(`<g class="${X}"><rect class="hit" x="${J}" y="${$e}" width="${we}" height="${qe}" rx="2" fill="${I}" data-tip="${Je}" data-color="${I}" style="animation-delay: ${Xt}s"><title>${Je}</title></rect>`+(l?`<text class="value-label" x="${J+we/2}" y="${$e-4}" text-anchor="middle">${M(Q(T))}</text>`:"")+"</g>")})})}else if(n&&t==="area"){let S=new Array($).fill(0);d.forEach((k,L)=>{let z=xe(L,e.palette),q=[],X=[];for(let T=0;T<$;T++){let B=k.values?.[T]??0,F=S[T]+B;q.push({x:O(T),y:N(F)}),X.push({x:O(T),y:N(S[T])}),S[T]=F}let I=Ge(q,a)+" L "+X.slice().reverse().map(T=>`${T.x} ${T.y}`).join(" L ")+" Z",D=(L*.15).toFixed(3);_.push(`<path class="series-fill series-${L}" d="${I}" fill="${z}" fill-opacity="0.25" pointer-events="none" style="animation-delay: ${D}s"/>`),_.push(`<path class="series-line series-${L}" d="${Ge(q,a)}" stroke="${z}" fill="none" pointer-events="none" style="animation-delay: ${D}s"/>`),q.forEach((T,B)=>{let F=k.values?.[B]??0,J=`${M(k.name)}${c[B]?` \xB7 ${M(c[B])}`:""}: ${M(Q(F))}`;_.push(`<circle class="hit series-${L}" cx="${T.x}" cy="${T.y}" r="12" fill="transparent" data-tip="${J}" data-color="${z}"><title>${J}</title></circle>`)})})}else d.forEach((S,k)=>{let L=xe(k,e.palette),z=(S.values??[]).map((I,D)=>({x:O(D),y:N(I)})),q=Ge(z,a),X=(k*.15).toFixed(3);if(t==="area"){let I=N(H<0&&j>0?0:H),D=q+` L ${z[z.length-1].x} ${I} L ${z[0].x} ${I} Z`;_.push(`<path class="series-fill series-${k}" d="${D}" fill="${L}" fill-opacity="0.25" style="animation-delay: ${X}s"/>`)}_.push(`<path class="series-line series-${k}" d="${q}" stroke="${L}" fill="none" style="animation-delay: ${X}s"/>`),u||z.forEach((I,D)=>{let T=S.values?.[D],B=`${M(S.name)}${c[D]?` \xB7 ${M(c[D])}`:""}: ${M(Q(T??0))}`,F=(k*.15+D*.025+.55).toFixed(3);_.push(`<circle class="series-point series-${k}" cx="${I.x}" cy="${I.y}" r="3.5" fill="${L}" pointer-events="none" style="animation-delay: ${F}s"/>`),_.push(`<circle class="hit series-${k}" cx="${I.x}" cy="${I.y}" r="12" fill="transparent" data-tip="${B}" data-color="${L}"><title>${B}</title></circle>`),l&&_.push(`<text class="value-label" x="${I.x}" y="${I.y-8}" text-anchor="middle" pointer-events="none">${M(Q(T??0))}</text>`)})});return ee.join("")+_.join("")}function wa(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let a=e.W/2,n=e.H/2,o=Math.min(e.W,e.H)/2-4,s=Math.max(0,Math.min(.9,e.innerRadius))*o,i=0,l=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let f=u/r*Math.PI*2,m=i,p=i+f,b=xa(a,n,o,s,m,p-.01),v=xe(d,e.palette),x=(u/r*100).toFixed(1).replace(/\.0$/,""),y=`${M(c.name)}: ${M(Q(u))} (${x}%)`,w=(d*.08).toFixed(3);if(l.push(`<path class="series-segment hit series-${d}" d="${b}" fill="${v}" data-tip="${y}" data-color="${v}" style="animation-delay: ${w}s"><title>${y}</title></path>`),e.showValues){let C=(m+p)/2,H=(o+s)/2,j=ye(a,n,H,C);l.push(`<text class="value-label donut" x="${j.x}" y="${j.y}" text-anchor="middle" dominant-baseline="middle">${M(x)}%</text>`)}i=p}),l.join("")}function $a(e,t,r){return e.length===0?"":'<div class="legend" part="legend">'+e.map((a,n)=>{let o=xe(n,t),s=r.includes(a.name);return`<button class="${s?"legend-item is-hidden":"legend-item"}" type="button" data-series="${M(a.name)}" aria-pressed="${s?"true":"false"}" title="${s?"Show":"Hide"} series '${M(a.name)}'"><span class="swatch" style="background:${o}"></span>${M(a.name)}</button>`}).join("")+"</div>"}function Ma(e,t){if(e==="donut"){let n=(t.series??[]).reduce((s,i)=>s+(i.value??0),0);return`Donut chart: ${(t.series??[]).filter(s=>(s.value??0)>0).map(s=>{let i=n>0?(s.value??0)/n*100:0;return`${s.name} ${i.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(n=>n.name).join(", "),a=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${a} data point${a===1?"":"s"}.`}var Ea=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],Sa=`
  <style>
...
`;h(va,g({props:{type:{type:"string",default:"line"},data:{type:"json",default:{series:[]}},height:{type:"string",default:"240px"},smooth:{type:"boolean",default:!0},stacked:{type:"boolean",default:!1},showLegend:{type:"boolean",default:!0},showAxes:{type:"boolean",default:!0},showGrid:{type:"boolean",default:!0},showLabels:{type:"boolean",default:!0},showValues:{type:"boolean",default:!1},innerRadius:{type:"number",default:.6},yMin:{type:"json",default:null},yMax:{type:"json",default:null},ariaLabel:{type:"string",default:"Chart"},colors:{type:"json",default:null},src:{type:"string",default:""},srcKey:{type:"string",default:""},loadingText:{type:"string",default:"Loading chart\u2026"},errorText:{type:"string",default:"Couldn't load chart data"}},theme:{"tc-chart-bg":"transparent","tc-chart-fg":"var(--tc-color-ink, #14171f)","tc-chart-axis":"var(--tc-color-rule-strong, #d9cfb8)","tc-chart-grid":"var(--tc-color-rule, #ece5d3)","tc-chart-label":"var(--tc-color-ink-muted, #6b7280)","tc-chart-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e,state:t})=>{let r=String(e.type??"line").toLowerCase(),a=["line","area","bar","sparkline","donut"].includes(r)?r:"line",n=e.data,o=t.fetched,s=!!n&&Array.isArray(n.series)&&n.series.length>0,i=s?n:o??{series:[]},l=Array.isArray(t.hiddenSeries)?t.hiddenSeries:[],c={labels:i.labels,series:(i.series??[]).filter($=>!l.includes($.name))},d=String(e.src??""),u=!!t.loading&&!s&&!o,f=d&&t.error?String(t.error):"",m=u?`<div class="overlay loading">${M(String(e.loadingText??"Loading chart\u2026"))}</div>`:f?`<div class="overlay error" role="alert">${M(String(e.errorText??"Couldn't load chart data"))}<small>${M(f)}</small></div>`:"",p=a==="sparkline",b=a==="donut",v=e.colors,x=Array.isArray(v)&&v.length>0?v:Ea,y=b?320:800,w=b?320:400,C={data:c,smooth:!!e.smooth,stacked:!!e.stacked,showAxes:!!e.showAxes,showGrid:!!e.showGrid,showLabels:!!e.showLabels,showValues:!!e.showValues,innerRadius:Number(e.innerRadius??.6),yMin:e.yMin==null?null:Number(e.yMin),yMax:e.yMax==null?null:Number(e.yMax),palette:x,W:y,H:w},H=b?wa(C):ka(C,a),j=Ma(a,c),ue=M(String(e.height??"240px"));return`
        <div class="root" role="img" aria-label="${M(e.ariaLabel??"Chart")}">
          ...
          ${e.showLegend&&!p&&i.series&&i.series.length>0?$a(i.series,x,l):""}
...
`;h(La,g({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Start writing\u2026"},toolbar:{type:"string",default:qt},readonly:{type:"boolean",default:!1,reflect:!0},minHeight:{type:"string",default:"180px"},maxHeight:{type:"string",default:""},pasteAs:{type:"string",default:"text"}},theme:{"tc-editor-bg":"var(--tc-color-surface, #ffffff)","tc-editor-fg":"var(--tc-color-ink, #14171f)","tc-editor-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-editor-toolbar-rule":"var(--tc-color-rule, #ece5d3)","tc-editor-toolbar-fg":"var(--tc-color-ink-soft, #4a5061)","tc-editor-toolbar-active-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-editor-toolbar-hover-bg":"rgba(20, 23, 31, 0.06)","tc-editor-placeholder":"var(--tc-color-ink-muted, #6b7280)","tc-editor-radius":"var(--tc-radius-md, 8px)","tc-editor-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-editor-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, 'SF Mono', monospace)","tc-editor-line-height":"1.6"},styles:{display:"block"},template:({props:e})=>{let t=String(e.toolbar??qt),r=!!e.readonly,a=G(String(e.minHeight??"180px")),n=String(e.maxHeight??"").trim(),o=t.split(",").map(c=>c.trim()).filter(Boolean),s=o.map(c=>{if(c==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let d=Ha[c];if(!d)return"";let u=d.shortcut?` (${G(d.shortcut)})`:"";return`<button type="button" class="tb-btn" data-cmd="${G(d.command)}"${d.value?` data-val="${G(d.value)}"`:""} data-key="${G(d.key)}" title="${G(d.label)}${u}" aria-label="${G(d.label)}">${d.icon}</button>`}).join(""),i=o.length===0?"toolbar empty":r?"toolbar readonly":"toolbar";return`
        ...
        ${Ca}
      `},afterMount(){Bt(this),Ot(this)},afterRender(){let e=this,r=e.shadowRoot?.querySelector(".surface");if(r){let a=r.innerHTML,n=String(e.value??"");n&&a!==n&&document.activeElement!==e&&(r.innerHTML=n),Ke(r)}Bt(e),Ot(e)},unmount(){this._editorCleanup?.()}}));function Ke(e){let t=e.textContent?.trim()===""&&e.querySelector("img, hr, br")===null;e.dataset.empty=t?"true":"false"}function Bt(e){let t=e;t._editorCleanup?.();let r=t.shadowRoot;if(!r)return;let a=r.querySelector(".surface");if(!a)return;a.dataset.bootstrapped||(t.value&&(a.innerHTML=String(t.value)),a.dataset.bootstrapped="1"),Ke(a);let n=(f,m)=>{if(!t.readonly){if(a.focus(),f==="code"){let b=r.getSelection?.()??globalThis.getSelection();if(!b||b.rangeCount===0)return;let v=b.getRangeAt(0),x=v.extractContents(),y=document.createElement("code");y.className="tc-code-inline",y.appendChild(x),v.insertNode(y),v.selectNodeContents(y),b.removeAllRanges(),b.addRange(v)}else if(f==="link"){let p=globalThis.prompt("URL")?.trim();if(!p)return;document.execCommand("createLink",!1,p)}else if(f==="math"){let p=globalThis.prompt("LaTeX (e.g. E = mc^2). Wrap with $$ for display.")?.trim();if(!p)return;let b=p.startsWith("$$")&&p.endsWith("$$"),v=b?p.replace(/^\$\$|\$\$$/g,"").trim():p;za(t,v,b)}else if(f==="codeblock"){let p=r.getSelection?.()??globalThis.getSelection();if(!p||p.rangeCount===0)return;let b=p.getRangeAt(0),v=b.toString()||"// code",x=document.createElement("pre"),y=document.createElement("code");y.textContent=v,x.appendChild(y),b.deleteContents(),b.insertNode(x);let w=document.createRange();w.selectNodeContents(y),w.collapse(!1),p.removeAllRanges(),p.addRange(w)}else f==="formatBlock"?document.execCommand("formatBlock",!1,`<${m??"p"}>`):document.execCommand(f,!1,m);_t(t,a),Ft(r,a)}},o=f=>{let m=f.target?.closest?.(".tb-btn");if(!m)return;f.preventDefault();let p=m.dataset.cmd;p&&n(p,m.dataset.val)},s=()=>{Ke(a),_t(t,a)},i=()=>{let f=a.innerHTML;t._lastEmitted!==f&&(t._lastEmitted=f,t.dispatchEvent(new CustomEvent("tc-change",{detail:{html:f},bubbles:!0,composed:!0})))},l=f=>{if(t.readonly||t.pasteAs!=="text")return;f.preventDefault();let m=f.clipboardData?.getData("text/plain")??"";document.execCommand("insertText",!1,m)},c=f=>{if(t.readonly||!(f.metaKey||f.ctrlKey))return;let m=f.key.toLowerCase();m==="b"?(f.preventDefault(),n("bold")):m==="i"?(f.preventDefault(),n("italic")):m==="u"?(f.preventDefault(),n("underline")):m==="k"&&(f.preventDefault(),n("link"))},d=()=>{let f=globalThis.getSelection();!f||!f.anchorNode||a.contains(f.anchorNode)&&Ft(r,a)},u=r.querySelector(".toolbar");u?.addEventListener("click",o),a.addEventListener("input",s),a.addEventListener("blur",i),a.addEventListener("paste",l),a.addEventListener("keydown",c),document.addEventListener("selectionchange",d),t._editorCleanup=()=>{u?.removeEventListener("click",o),a.removeEventListener("input",s),a.removeEventListener("blur",i),a.removeEventListener("paste",l),a.removeEventListener("keydown",c),document.removeEventListener("selectionchange",d)}}function _t(e,t){let r=t.innerHTML;e.value=r,e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:r},bubbles:!0,composed:!0}))}function za(e,t,r){let a=e.shadowRoot;if(!a)return;let n=a.querySelector(".surface");if(!n)return;let o=a.getSelection?.()??globalThis.getSelection();if(!o||o.rangeCount===0)return;let s=o.getRangeAt(0),i=document.createElement(r?"div":"span");i.className=r?"tc-math display":"tc-math inline",i.setAttribute("contenteditable","false"),i.dataset.latex=t,i.innerHTML=Pt(e,t,r),s.deleteContents(),s.insertNode(i);let l=document.createTextNode("\u200B");i.parentNode?.insertBefore(l,i.nextSibling);let c=document.createRange();c.setStartAfter(l),c.collapse(!0),o.removeAllRanges(),o.addRange(c),e.dispatchEvent(new CustomEvent("tc-input",{detail:{html:n.innerHTML},bubbles:!0,composed:!0}))}function Pt(e,t,r){if(e.mathRenderer)try{return e.mathRenderer(t,r)}catch{}return`<code class="tc-math-src">${t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code>`}function Ot(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".surface");if(!r)return;r.querySelectorAll(".tc-math").forEach(n=>{let o=n,s=o.dataset.latex??"",i=o.classList.contains("display"),l=`${i?"d":"i"}:${s}`;o.dataset.stamp!==l&&(o.innerHTML=Pt(e,s,i),o.dataset.stamp=l)})}function Ft(e,t){e.querySelectorAll(".tb-btn").forEach(a=>{let n=a,o=n.dataset.cmd??"",s=n.dataset.val,i=!1;try{o==="formatBlock"&&s?i=(document.queryCommandValue("formatBlock")||"").toLowerCase().replace(/^[<]|[>]$/g,"")===s:(o==="bold"||o==="italic"||o==="underline"||o==="strikeThrough"||o==="insertOrderedList"||o==="insertUnorderedList")&&(i=document.queryCommandState(o))}catch{i=!1}n.classList.toggle("is-active",i)})}var Aa="tc-markdown";function E(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Re="\0M\0";function Ra(e,t){let r=[],a=(s,i)=>{let l=r.length;return r.push({latex:s,display:i}),`${Re}${l}${Re}`},n=e;n=n.replace(/\$\$([\s\S]+?)\$\$/g,(s,i)=>a(i.trim(),!0)),n=n.replace(/(^|[\s(])\$([^\$\n][^\$\n]*?)\$(?=[\s.,;:!?)\]]|$)/g,(s,i,l)=>`${i}${a(l.trim(),!1)}`);let o=E(n);return o=o.replace(/`([^`]+)`/g,"<code>$1</code>"),o=o.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),o=o.replace(/(?<!\*)\*([^*\n]+?)\*(?!\*)/g,"<em>$1</em>"),o=o.replace(/\b_(.+?)_\b/g,"<em>$1</em>"),o=o.replace(/~~(.+?)~~/g,"<del>$1</del>"),o=o.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(s,i,l)=>`<img src="${E(l)}" alt="${E(i)}" loading="lazy"/>`),o=o.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(s,i,l)=>`<a href="${E(l)}" target="_blank" rel="noopener">${i}</a>`),o=o.replace(new RegExp(`${Re}(\\d+)${Re}`,"g"),(s,i)=>{let l=r[Number(i)];if(!l)return"";let c=l.latex;if(t)try{let d=t(c,l.display);return l.display?`<div class="tc-md-math display" data-latex="${E(c)}">${d}</div>`:`<span class="tc-md-math inline" data-latex="${E(c)}">${d}</span>`}catch(d){return l.display?`<div class="tc-md-math error" title="${E(String(d))}">${E(c)}</div>`:`<span class="tc-md-math error" title="${E(String(d))}">${E(c)}</span>`}return l.display?`<div class="tc-md-math fallback display" data-latex="${E(c)}"><code>${E(c)}</code></div>`:`<span class="tc-md-math fallback inline" data-latex="${E(c)}"><code>${E(c)}</code></span>`}),o}function Na(e){let t=e.match(/^\[([ xX])\]\s+(.*)$/);return t?`<li class="tc-md-task"><input type="checkbox" disabled${t[1].toLowerCase()==="x"?" checked":""}/><span>${t[2]}</span></li>`:""}function Ia(e,t){let r=(o,s,i)=>{let l=i&&i!=="left"?` style="text-align:${i}"`:"";return`<${s}${l}>${o}</${s}>`},a=e[0]?.map((o,s)=>r(o,"th",t[s])).join("")??"",n=e.slice(1).map(o=>`<tr>${o.map((s,i)=>r(s,"td",t[i])).join("")}</tr>`).join("");return`<table class="tc-md-table"><thead><tr>${a}</tr></thead><tbody>${n}</tbody></table>`}function Ye(e,t){let r=t?.mathRenderer,a=t?.highlight,n=e.replace(/\r\n?/g,`
`).split(`
`),o=[],s=0,i=l=>Ra(l,r);for(;s<n.length;){let l=n[s],c=l.match(/^:::\s*([a-zA-Z][\w-]*)(?:\s+(.+))?\s*$/);if(c){let p=c[1].toLowerCase(),b=(c[2]??"").trim(),v=[];for(s++;s<n.length&&!/^:::\s*$/.test(n[s]);)v.push(n[s]),s++;s<n.length&&s++;let x=Ye(v.join(`
...
`),x=a&&p?(()=>{try{return a(v,p)}catch{return E(v)}})():E(v),y=p?` class="lang-${E(p)}"`:"";o.push(`<pre><code${y}>${x}</code></pre>`);continue}let u=l.match(/^(#{1,6})\s+(.*)$/);if(u){let p=u[1].length;o.push(`<h${p}>${i(u[2])}</h${p}>`),s++;continue}if(/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(l.trim())){o.push("<hr/>"),s++;continue}if(/^\s*\|.+\|\s*$/.test(l)&&s+1<n.length&&/^\s*\|?\s*:?-{3,}:?\s*(\|\s*:?-{3,}:?\s*)+\|?\s*$/.test(n[s+1])){let p=l.trim().replace(/^\||\|$/g,"").split("|").map(y=>y.trim()),b=n[s+1].trim().replace(/^\||\|$/g,"").split("|").map(y=>{let w=y.trim(),C=w.startsWith(":"),H=w.endsWith(":");return C&&H?"center":H?"right":C?"left":""}),v=[];for(s+=2;s<n.length&&/^\s*\|.+\|\s*$/.test(n[s]);)v.push(n[s].trim().replace(/^\||\|$/g,"").split("|").map(y=>i(y.trim()))),s++;let x=[p.map(y=>i(y)),...v];o.push(Ia(x,b));continue}if(/^>\s?/.test(l)){let p=[];for(;s<n.length&&/^>\s?/.test(n[s]);)p.push(n[s].replace(/^>\s?/,"")),s++;o.push(`<blockquote>${i(p.join(" "))}</blockquote>`);continue}let f=l.match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(f){let p=!!f[3],b=p?"ol":"ul",v=[],x=!1;for(;s<n.length;){let w=n[s].match(/^(\s*)(?:([-*+])|(\d+)\.)\s+(.*)$/);if(!w||!!w[3]!==p)break;let H=w[4],j=Na(H);j?(x=!0,v.push(j)):v.push(`<li>${i(H)}</li>`),s++}let y=x?' class="tc-md-tasks"':"";o.push(`<${b}${y}>${v.join("")}</${b}>`);continue}if(l.trim()===""){s++;continue}let m=[l];for(s++;s<n.length;){let p=n[s];if(p.trim()===""||/^#{1,6}\s+/.test(p)||/^```/.test(p)||/^>\s?/.test(p)||/^:::/.test(p)||/^(\s*)(?:[-*+]|\d+\.)\s+/.test(p)||/^\s*\|.+\|\s*$/.test(p)||/^(?:-\s*){3,}$|^(?:\*\s*){3,}$|^(?:_\s*){3,}$/.test(p.trim()))break;m.push(p),s++}o.push(`<p>${i(m.join(" "))}</p>`)}return o.join(`
`)}var Vt={bold:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4h7a4 4 0 0 1 0 8H6z"/><path d="M6 12h8a4 4 0 0 1 0 8H6z"/></svg>',italic:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>',heading:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6v12"/><path d="M12 6v12"/><path d="M4 12h8"/><path d="M16 18l4-12"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',link:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',bullet:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><circle cx="4" cy="6" r="1.2" fill="currentColor"/><circle cx="4" cy="12" r="1.2" fill="currentColor"/><circle cx="4" cy="18" r="1.2" fill="currentColor"/></svg>',ordered:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="9" y1="6" x2="20" y2="6"/><line x1="9" y1="12" x2="20" y2="12"/><line x1="9" y1="18" x2="20" y2="18"/><path d="M4 8V4l-1 1"/><path d="M3 14h2l-2 3h2"/></svg>',quote:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h3v6H4v-3a3 3 0 0 1 3-3z"/><path d="M16 7h3v6h-6v-3a3 3 0 0 1 3-3z"/></svg>',preview:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>'};function Ue(e,t,r,a,n,o="text"){let s=e.slice(t,r)||o;return{text:e.slice(0,t)+a+s+n+e.slice(r),selStart:t+a.length,selEnd:t+a.length+s.length}}function Ne(e,t,r,a){let n=e.lastIndexOf(`
`,t-1)+1,o=(()=>{let l=e.indexOf(`
`,r);return l===-1?e.length:l})(),i=e.slice(n,o).split(`
`).map(l=>a+l).join(`
`);return{text:e.slice(0,n)+i+e.slice(o),selStart:n,selEnd:n+i.length}}var Ut={bold:{key:"bold",label:"Bold",shortcut:"\u2318B",apply:(e,t,r)=>Ue(e,t,r,"**","**","bold text")},italic:{key:"italic",label:"Italic",shortcut:"\u2318I",apply:(e,t,r)=>Ue(e,t,r,"*","*","italic text")},heading:{key:"heading",label:"Heading",apply:(e,t,r)=>Ne(e,t,r,"## ")},code:{key:"code",label:"Code",apply:(e,t,r)=>Ue(e,t,r,"`","`","code")},link:{key:"link",label:"Link",shortcut:"\u2318K",apply:(e,t,r)=>{let a=globalThis.prompt?.("URL")?.trim();if(!a)return{text:e,selStart:t,selEnd:r};let n=e.slice(t,r)||"link text";return{text:e.slice(0,t)+`[${n}](${a})`+e.slice(r),selStart:t+1,selEnd:t+1+n.length}}},bullet:{key:"bullet",label:"Bulleted list",apply:(e,t,r)=>Ne(e,t,r,"- ")},ordered:{key:"ordered",label:"Numbered list",apply:(e,t,r)=>Ne(e,t,r,"1. ")},quote:{key:"quote",label:"Quote",apply:(e,t,r)=>Ne(e,t,r,"> ")}},Gt="bold,italic,heading,|,bullet,ordered,quote,|,link,code",Da=`
  <style>
    :host {
      display: block;
...
`;h(Aa,g({props:{value:{type:"string",default:""},placeholder:{type:"string",default:"Write some markdown\u2026"},mode:{type:"string",default:"split"},readonly:{type:"boolean",default:!1},minHeight:{type:"string",default:"240px"},toolbar:{type:"string",default:Gt}},theme:{"tc-md-bg":"var(--tc-color-surface, #ffffff)","tc-md-fg":"var(--tc-color-ink, #14171f)","tc-md-rule":"var(--tc-color-rule, #ece5d3)","tc-md-toolbar-bg":"var(--tc-color-bg, #faf8f3)","tc-md-preview-bg":"var(--tc-color-bg, #faf8f3)","tc-md-radius":"var(--tc-radius-md, 8px)","tc-md-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-md-mono-font":"var(--tc-font-mono, 'JetBrains Mono', ui-monospace, monospace)"},styles:{display:"block"},refs:{source:"textarea",preview:".preview"},template:({props:e,state:t})=>{let r=String(t.mode??e.mode??"split"),a=String(e.value??""),n=String(e.toolbar??Gt).split(",").map(f=>f.trim()).filter(Boolean),o=n.map(f=>{if(f==="|")return'<span class="tb-sep" aria-hidden="true"></span>';let m=Ut[f];if(!m||!Vt[m.key])return"";let p=m.shortcut?` (${E(m.shortcut)})`:"";return`<button type="button" class="tb-btn" data-op="${E(m.key)}" title="${E(m.label)}${p}" aria-label="${E(m.label)}">${Vt[m.key]}</button>`}).join(""),s=(f,m)=>`<button type="button" data-mode="${f}" class="${r===f?"is-active":""}" aria-pressed="${r===f?"true":"false"}">${m}</button>`,i=e,c=(i.render??(f=>Ye(f,{mathRenderer:i.mathRenderer,highlight:i.highlight})))(a),d=r==="source"?"panes source-only":r==="preview"?"panes preview-only":"panes";return`
        ...
        <header class="topbar">
          <div class="inner">
            ...
            <nav aria-label="Primary">
              ${r.map(n=>{let o=n.id===a,s=[n.hideOnSmall?"nav-hide-sm":"",o?"active":""].filter(Boolean).join(" "),i=o?' aria-current="page"':"",l=n.external?' target="_blank" rel="noopener"':"";return`<a href="${ke(n.href)}"${i}${l}${s?` class="${s}"`:""}>${ke(n.label)}</a>`}).join(`
              `)}
            </nav>
          </div>
        </header>
      ...
      `}}));function ke(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var _a="site-footer";h(_a,g({props:{base:{type:"string",default:""},year:{type:"string",default:"2026"}},styles:{display:"block"},template:({props:e})=>{let t=String(e.base??"");return`
        <footer class="foot">
          <div class="inner">
      ...
      `}}));function de(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Oa="site-search";var Y=null,De=null;function je(e){if(Y)return Promise.resolve(Y);if(De)return De;let t=`${e}search.json`;return De=fetch(t).then(r=>r.json()).then(r=>(Y=r.docs??[],Y)).catch(r=>(console.warn("[site-search] failed to load index:",r),Y=[],Y)),De}function Wt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Yt(e,t){let r=e.trim().toLowerCase();if(!r)return[];let a=r.split(/\s+/).filter(Boolean).map(o=>({raw:o,re:new RegExp(Wt(o),"i")})),n=[];for(let o of t){let s=o.title.toLowerCase(),i=(o.description??"").toLowerCase(),l=(o.text??"").toLowerCase(),c=0;for(let u of a){let f=u.raw;s===f&&(c+=50),s.startsWith(f)&&(c+=20),s.includes(f)&&(c+=10),i.includes(f)&&(c+=5),l.includes(f)&&(c+=1)}a.every(u=>u.re.test(o.title)||u.re.test(i)||u.re.test(l))&&c!==0&&(o.category==="blog"&&o.date&&(Date.now()-new Date(o.date).getTime())/864e5<30&&(c+=3),n.push({doc:o,score:c}))}return n.sort((o,s)=>s.score-o.score),n.slice(0,12)}function Fa(e,t,r=140){let a=e.trim().toLowerCase().split(/\s+/)[0];if(!a)return t.slice(0,r);let o=t.toLowerCase().indexOf(a);if(o===-1)return t.slice(0,r);let s=Math.max(0,o-40),i=Math.min(t.length,s+r),l=s>0?"\u2026 ":"",c=i<t.length?" \u2026":"";return l+t.slice(s,i)+c}function W(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Xe(e,t){let r=t.trim();if(!r)return W(e);let a=r.split(/\s+/).filter(Boolean),n=W(e);for(let o of a){let s=new RegExp(`(${Wt(W(o))})`,"gi");n=n.replace(s,"<mark>$1</mark>")}return n}function Pa(e){e.setState("open",!1),e.setState("query",""),e.setState("results",[]),e.setState("focusIdx",0)}var Va=`
        <style>
          :host { display: inline-block; }
...
`;h(Oa,g({props:{base:{type:"string",default:""}},styles:{display:"inline-block"},refs:{input:".search-input",results:".results",dialog:"dialog.modal"},template:({props:e,state:t})=>{let r=String(e.base??""),a=String(t.query??""),n=Number(t.focusIdx??0),o=t.results??[],s=`
      ...
      `,i=a.trim()===""?'<div class="empty">Start typing to search the site \u2014 docs, components, blog posts, examples.</div>':o.length===0?`<div class="empty">No results for "${W(a)}". Try a shorter query.</div>`:o.map((c,d)=>{let u=d===n?"row focused":"row",f=r+c.doc.url.replace(/^\//,""),m=Fa(a,c.doc.text);return`
              <a class="${u}" data-index="${d}" href="${W(f)}">
                <span class="row-cat ${W(c.doc.category)}">${W(c.doc.category)}</span>
                <div class="row-main">
                  <div class="row-title">${Xe(c.doc.title,a)}</div>
                  <div class="row-desc">${Xe(c.doc.description,a)}</div>
                  <div class="row-snippet">${Xe(m,a)}</div>
                </div>
              </a>
            `}).join(""),l=`
      ...
      `;return s+l+Va},events:{"click .trigger":(e,t)=>{let r=t.host,a=String(r.base??"");t.setState("open",!0),t.setState("query",""),t.setState("focusIdx",0),t.setState("results",[]),je(a)},"click .close":(e,t)=>Pa(t),"input .search-input":(e,t)=>{let r=e.target.value,a=t.host,n=String(a.base??"");t.setState("query",r),t.setState("focusIdx",0),Y?t.setState("results",Yt(r,Y)):je(n).then(o=>{t.setState("results",Yt(r,o))})},"keydown .search-input":(e,t)=>{let r=e,a=t.getState("results")??[],n=Number(t.getState("focusIdx")??0);if(r.key==="ArrowDown"){if(r.preventDefault(),a.length===0)return;t.setState("focusIdx",Math.min(a.length-1,n+1));return}if(r.key==="ArrowUp"){if(r.preventDefault(),a.length===0)return;t.setState("focusIdx",Math.max(0,n-1));return}if(r.key==="Enter"){if(a.length===0)return;r.preventDefault();let o=a[n];if(o){let s=t.host,l=String(s.base??"")+o.doc.url.replace(/^\//,"");globalThis.location.href=l}return}},"mouseover .row":(e,t)=>{let r=e.target.closest(".row");if(!r)return;let a=Number(r.dataset.index);Number.isNaN(a)||t.setState("focusIdx",a)}},afterMount(){let e=this,t=r=>{if(r.key.toLowerCase()==="k"&&(r.metaKey||r.ctrlKey)&&!r.altKey){if(r.preventDefault(),!e.setState)return;e.setState("open",!0),e.setState("query",""),e.setState("focusIdx",0),e.setState("results",[]),je(String(e.base??""));return}if(r.key==="/"&&!r.metaKey&&!r.ctrlKey&&!r.altKey){let a=document.activeElement,n=a?.tagName.toLowerCase();if(n==="input"||n==="textarea"||a?.isContentEditable===!0||(r.preventDefault(),!e.setState))return;e.setState("open",!0),e.setState("query",""),e.setState("focusIdx",0),e.setState("results",[]),je(String(e.base??""))}};document.addEventListener("keydown",t),e._searchKeyHandler=t},unmount(){let e=this;e._searchKeyHandler&&document.removeEventListener("keydown",e._searchKeyHandler)},afterRender(){let e=this,t=e.refs?.dialog??null;if(!t)return;let r=e.getState?!!e.getState("open"):!1;if(r&&!t.open){t.showModal(),(e.refs?.input??null)?.focus(),t.addEventListener("close",()=>{e.getState?.("open")&&(e.setState?.("open",!1),e.setState?.("query",""),e.setState?.("results",[]),e.setState?.("focusIdx",0))}),t.addEventListener("click",n=>{n.target===t&&t.close()});return}if(!r&&t.open){t.close();return}if(r){let a=e.refs?.input??null;a&&e.shadowRoot?.activeElement!==a&&a.focus()}}}));
