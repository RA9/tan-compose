var Ke=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],Ue=new Set(["string","number","boolean","json"]);function i(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Ke){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,a]of Object.entries(t)){if(a===null||typeof a!="object"||Array.isArray(a))throw new TypeError(`describe(): props.${r} must be a record`);if(!Ue.has(a.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var q=new Map,Ye=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,We=/^(\S+)(?:\s+(.+))?$/;function c(e,t){if(typeof e!="string"||!Ye.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(q.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),a=t.props??{},n=t.refs??{},s=Je(t);class d extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let o=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),Ze(o,s),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",o.appendChild(this.container),t.attributes&&F(this,t.attributes),this.ctx=Xe(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[o,l]of Object.entries(a)){let u=this.getAttribute(o),p=u!==null?N(u,l.type):l.default;this.propValues.set(o,p),this.maybeSyncFormValue(o,p),Object.defineProperty(this,o,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(o),set:b=>{let g=rt(b,l.type),m=this.propValues.get(o);Object.is(m,g)||(this.propValues.set(o,g),l.reflect&&at(this,o,g,l.type),this.maybeSyncFormValue(o,g),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(o,l){if(!this.internals||o!=="value")return;let u=l==null?null:String(l);this.internals.setFormValue(u)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(o){console.error(`[tan-compose] beforeMount threw for <${e}>:`,o)}if(this.renderInternal(),t.action){let o=t.action;this.addEventListener("click",o),this.mountCleanups.push(()=>this.removeEventListener("click",o))}if(t.emit)for(let o of t.emit)this.addEventListener(o.name,o.handler),this.mountCleanups.push(()=>this.removeEventListener(o.name,o.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(o){console.error(`[tan-compose] afterMount threw for <${e}>:`,o)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(o){console.error(`[tan-compose] unmount threw for <${e}>:`,o)}h(this.mountCleanups),h(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){O(t,o=>{let l=this.listSlots.get(o);if(l){for(let u of l.cache.values())h(u.cleanups);l.cache.clear()}})}attributeChangedCallback(o,l,u){if(l!==u){if(Object.prototype.hasOwnProperty.call(a,o)){let p=a[o],b=u!==null?N(u,p.type):p.default,g=this.propValues.get(o);Object.is(g,b)||(this.propValues.set(o,b),this.isMounted&&this.scheduleRender());return}this.state.set(o,u),this.isMounted&&this.scheduleRender()}}setState(o,l){let u=this.state.get(o);Object.is(u,l)||(this.state.set(o,l),this.isMounted&&this.scheduleRender())}getState(o){return this.state.get(o)}render(){this.renderInternal()}emitEvent(o,l){this.dispatchEvent(new CustomEvent(o,{detail:l,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(o){let l=this.listSlots.get(o);return l||(l={cache:new Map},this.listSlots.set(o,l)),l}renderInternal(){this.rendering=!0;try{h(this.renderCleanups),this.container.replaceChildren();let o={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let l=typeof t.template=="function"?t.template(this.ctx):t.template;l&&(this.container.innerHTML=l)}if(t.children)for(let l of t.children){let u=j(l,o,p=>this.getOrCreateSlot(p));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(o){console.error(`[tan-compose] afterRender threw for <${e}>:`,o)}}refreshRefs(){let o={},l=this.shadowRoot;for(let[u,p]of Object.entries(n))o[u]=l?l.querySelector(p):null;this.currentRefs=o}formAssociatedCallback(o){try{t.formAssociatedCallback?.call(this,o)}catch(l){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,l)}}formDisabledCallback(o){try{t.formDisabledCallback?.call(this,o)}catch(l){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,l)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(o){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,o)}}formStateRestoreCallback(o,l){try{t.formStateRestoreCallback?.call(this,o,l)}catch(u){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,u)}}attachDelegatedEvents(o){let l=new Map;for(let[u,p]of Object.entries(o)){let b=We.exec(u.trim());if(!b)continue;let[,g,m]=b;l.has(g)||l.set(g,[]),l.get(g).push({selector:m??null,handler:p})}for(let[u,p]of l){let b=g=>{for(let{selector:m,handler:C}of p){if(!m){C(g,this.ctx);continue}let _e=g.composedPath();for(let T of _e){if(T===this.shadowRoot||T===this)break;if(T instanceof Element&&this.shadowRoot?.contains(T)&&T.matches(m)){C(g,this.ctx);break}}}};this.shadowRoot.addEventListener(u,b),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(u,b))}}}return q.set(e,d),customElements.define(e,d),e}function j(e,t,r){return e.if&&!e.if(t.ctx)?null:D(e,t,r)}function D(e,t,r){let a=document.createElement(e.tag||"div");if(e.styles&&(a.style.cssText=Object.entries(e.styles).map(([n,s])=>`${n}: ${s}`).join("; ")),e.className&&(a.className=e.className),e.attributes&&F(a,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(a.innerHTML=n)}if(e.children)for(let n of e.children){let s=j(n,t,r);s&&a.appendChild(s)}if(e.for&&Qe(a,e,t,r),e.action){let n=e.action;a.addEventListener("click",n),t.cleanups.push(()=>a.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)a.addEventListener(n.name,n.handler),t.cleanups.push(()=>a.removeEventListener(n.name,n.handler));return a}function Qe(e,t,r,a){let n=t.for,s=a(t),d=n.items(r.ctx),f=new Map;for(let o=0;o<d.length;o++){let l=d[o],u=n.key(l,o),p,b=s.cache.get(u);if(b&&Object.is(b.lastItem,l))p=b;else{let g=[],m=n.render(l,o,r.ctx),C=D(m,{...r,cleanups:g},a);b&&h(b.cleanups),p={element:C,lastItem:l,cleanups:g}}f.set(u,p),e.appendChild(p.element)}for(let[o,l]of s.cache)f.has(o)||h(l.cleanups);s.cache=f}function O(e,t){if(e.for&&t(e),e.children)for(let r of e.children)O(r,t)}function Xe(e,t,r,a){return{host:e,get props(){let n={};for(let[s,d]of t)n[s]=d;return n},get state(){let n={};for(let[s,d]of r)n[s]=d;return n},get refs(){return a()},setState:(n,s)=>e.setState(n,s),getState:n=>e.getState(n),emit:(n,s)=>e.emitEvent(n,s)}}function Je(e){let t=e.theme?et(e.theme):void 0,r=e.styles?tt(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let s=new CSSStyleSheet;s.replaceSync(t),n.push(s)}if(r){let s=new CSSStyleSheet;s.replaceSync(r),n.push(s)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function Ze(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function F(e,t){for(let[r,a]of Object.entries(t))e.setAttribute(r,a)}function et(e){return`:host { ${Object.entries(e).map(([r,a])=>`--${r}: ${a};`).join(" ")} }`}function tt(e){return`.container { ${Object.entries(e).map(([r,a])=>`${r}: ${a};`).join(" ")} }`}function h(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function N(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function rt(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function at(e,t,r,a){if(a!=="json"){if(a==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var V="tc-button",G=V;c(V,i({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>`
      <button
        part="button"
        class="root v-${B(e.variant)} s-${B(e.size)}${e.block?" block":""}"
...
`;c(se,i({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[i({tag:"style",template:nt}),i({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),i({tag:"div",className:"wrap",children:[i({tag:"table",children:[i({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let s=a.sortKey===n.key,d=n.sortable!==!1,f=s?a.sortDir==="asc"?"\u25B2":"\u25BC":"",o=s?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${z(n.key)}"
                        class="${d?"sortable":""}"
                        aria-sort="${o}"
                      >${z(n.label)}<span class="sort">${f}</span></th>`}).join("")}</tr>`}}),i({tag:"tbody",children:[i({tag:"tr",className:"empty",if:({props:e,state:t})=>oe(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${z(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>oe(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],s=e;return i({tag:"tr",attributes:{"data-row-id":String(s.id??t)},template:n.map(d=>`<td>${typeof d.render=="function"?d.render(s):z(s[d.key]??"")}</td>`).join("")})}}})]})]}),i({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=R(e,r),n=e.pageSize??10,s=Math.max(1,Math.ceil(a.length/n)),d=Math.min(r.page??0,s-1),f=(e.rows??[]).length;return`
            <span class="count">${a.length} of ${f} rows</span>
            <span class="spacer"></span>
            <button class="prev" type="button" ${d<=0?"disabled":""}>\u2039 prev</button>
            <span class="page">page ${d+1} of ${s}</span>
            <button class="next" type="button" ${d>=s-1?"disabled":""}>next \u203A</button>
          `}})],refs:{filter:".filter"},afterRender(){let e=this,t=e.refs.filter;if(!t)return;let r=e.getState("q")??"";t.value!==r&&(t.value=r);let a=I.get(e);if(a){I.delete(e),t.focus();let n=Math.min(a.caret,t.value.length);try{t.setSelectionRange(n,n)}catch{}}},events:{"input .filter":(e,t)=>{let r=e.target;I.set(t.host,{caret:r.selectionStart??r.value.length}),t.setState("q",r.value),t.setState("page",0)},"click .prev":(e,t)=>{let r=(t.state.page??0)-1;t.setState("page",Math.max(0,r))},"click .next":(e,t)=>{let r=t.state,a=R(t.props,r).length,n=t.props.pageSize??10,s=Math.max(0,Math.ceil(a/n)-1),d=(r.page??0)+1;t.setState("page",Math.min(s,d))},"click th.sortable":(e,t)=>{let r=e.target.closest("th");if(!r)return;let a=r.dataset.col;if(!a)return;let n=t.state,s;n.sortKey!==a?s="asc":s=n.sortDir==="asc"?"desc":n.sortDir==="desc"?null:"asc",t.setState("sortKey",s?a:null),t.setState("sortDir",s),t.emit("tc-sort-change",{key:s?a:null,direction:s})},"click tr[data-row-id]":(e,t)=>{let r=e.target.closest("tr[data-row-id]");if(!r)return;let a=r.dataset.rowId;if(a===void 0)return;let n=R(t.props,t.state),s=n.find(d=>String(d.id)===a)??n[Number(a)];s&&t.emit("tc-row-click",{row:s})}}}));var I=new WeakMap;function R(e,t){let r=e.rows??[],a=e.columns??[],n=(t.q??"").trim().toLowerCase(),s=n.length===0?r.slice():r.filter(d=>a.some(f=>String(d[f.key]??"").toLowerCase().includes(n)));if(t.sortKey&&t.sortDir){let d=t.sortKey,f=t.sortDir==="asc"?1:-1;s=s.slice().sort((o,l)=>{let u=o[d],p=l[d];return u===p?0:u==null?1:p==null?-1:typeof u=="number"&&typeof p=="number"?(u-p)*f:String(u).localeCompare(String(p))*f})}return s}function oe(e,t){let r=e.pageSize??10,a=R(e,t),n=Math.max(1,Math.ceil(a.length/r)),s=Math.min(t.page??0,n-1);return a.slice(s*r,s*r+r)}function z(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ie="tc-tabs",ce=ie;c(ie,i({props:{tabs:{type:"json",default:[]},active:{type:"string",default:"",reflect:!0}},theme:{"tc-tabs-fg":"var(--tc-color-ink, #14171f)","tc-tabs-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-tabs-rule":"var(--tc-color-rule, #ece5d3)","tc-tabs-accent":"var(--tc-color-accent, #a16939)","tc-tabs-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block","font-family":"var(--tc-tabs-font)"},template:({props:e})=>{let t=e.tabs??[],r=e.active||t[0]?.id||"";return`
        <div role="tablist" class="strip">
          ${t.map(a=>`<button
              ...
              aria-controls="panel-${E(a.id)}"
              tabindex="${a.id===r?"0":"-1"}"
            >${E(a.label)}</button>`).join("")}
        </div>
        <div class="panels">
          ${t.map(a=>`<section
              role="tabpanel"
              ...
              aria-labelledby=""
              ${a.id===r?"":"hidden"}
            ><slot name="${E(a.id)}"></slot></section>`).join("")}
        </div>
        <style>
          .strip {
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{de(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&de(r,"backdrop")}},afterRender(){ot(this)},unmount(){let e=$.get(this);e&&(e.cleanup(),$.delete(this))}}));var $=new WeakMap;function ot(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=$.get(e);if(n&&n.dialog!==r&&(n.cleanup(),$.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!$.has(e)){let s=()=>{let d=e;d.open&&(d.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",s),$.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",s)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function de(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function ue(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var be="tc-toast",me=be,M=new WeakMap;c(be,i({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
      ...
      `}}));function S(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ke="tc-card",we=ke;c(ke,i({props:{title:{type:"string",default:""},subtitle:{type:"string",default:""},padded:{type:"boolean",default:!0},bordered:{type:"boolean",default:!0},elevated:{type:"boolean",default:!1}},theme:{"tc-card-surface":"var(--tc-color-surface, #ffffff)","tc-card-ink":"var(--tc-color-ink, #14171f)","tc-card-soft":"var(--tc-color-ink-soft, #5a6072)","tc-card-rule":"var(--tc-color-rule, #ece5d3)","tc-card-radius":"var(--tc-radius-lg, 12px)","tc-card-shadow":"var(--tc-shadow-md, 0 8px 24px rgba(20, 23, 31, 0.06))","tc-card-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-card-padding-x":"var(--tc-space-5, 20px)","tc-card-padding-y":"var(--tc-space-5, 20px)","tc-card-gap":"var(--tc-space-3, 12px)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.title||!!e.subtitle;return`
        <div class="${["card",e.bordered?"bordered":"",e.elevated?"elevated":"",e.padded?"padded":"",t?"has-header":""].filter(Boolean).join(" ")}">
          ...
          <div class="head">
            <slot name="header">
              ${e.title?`<div class="title">${xe(e.title)}</div>`:""}
              ${e.subtitle?`<div class="subtitle">${xe(e.subtitle)}</div>`:""}
            </slot>
          </div>
          <div class="body"><slot></slot></div>
    ...
    `}));function Ee(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Le="tc-stack",ze=Le;c(Le,i({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${lt(e.gap)}; --tc-stack-align: ${ct(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function lt(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${it(t)})`:t}function it(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Re="tc-cluster",Ae=Re;c(Re,i({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${ut(e.gap)};
        --tc-cluster-justify: ${dt(e.justify)};
    ...
    `}));function dt(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function ut(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${pt(t)})`:t}function pt(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function ft(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var He="tc-grid",qe=He;c(He,i({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${Ie(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${Ie(e.min)}, 1fr))`};
          --tc-grid-gap: ${gt(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `},events:{"click .copy":(e,t)=>{let r=t.host,a=r.shadowRoot?.querySelector("slot"),s=(a?a.assignedNodes({flatten:!0}):Array.from(r.childNodes)).map(f=>f.textContent??"").join(""),d=()=>{t.setState("copied",!0),t.emit("tc-copy",{text:s}),setTimeout(()=>t.setState("copied",!1),1600)};navigator.clipboard?.writeText?navigator.clipboard.writeText(s).then(d,d):d()}}}));var mt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>',vt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>';function Ne(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Be="tc-callout",Ve=Be;c(Be,i({props:{variant:{type:"string",default:"note"},title:{type:"string",default:""},compact:{type:"boolean",default:!1}},theme:{"tc-callout-radius":"var(--tc-radius-md, 8px)","tc-callout-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-callout-note-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-callout-note-fg":"var(--tc-color-ink-soft, #4a5061)","tc-callout-note-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-callout-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-callout-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-callout-info-border":"var(--tc-color-info, #3a5b8c)","tc-callout-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-callout-success-fg":"var(--tc-color-success-fg, #155b40)","tc-callout-success-border":"var(--tc-color-success, #207a5b)","tc-callout-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-callout-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-callout-warning-border":"var(--tc-color-warning, #a87326)","tc-callout-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-callout-danger-fg":"var(--tc-color-danger-fg, #7a1a14)","tc-callout-danger-border":"var(--tc-color-danger, #b3261e)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"note"),r=Oe[t]??Oe.note;return`
        <aside
          class="callout v-${Fe(t)} ${e.compact?"compact":""}"
          role="${t==="danger"?"alert":"note"}"
        >
          <span class="icon" aria-hidden="true">${r}</span>
          <div class="body">
            ${e.title?`<div class="title">${Fe(e.title)}</div>`:""}
      ...
      `},afterMount(){ht(this)},unmount(){A.get(this)?.observer?.disconnect(),A.delete(this)}}));function ht(e){A.get(e)?.observer?.disconnect();let r=e,a=r.target||"main",n=(r.levels||"h2,h3").split(",").map(l=>l.trim().toLowerCase()).filter(Boolean),s=document.querySelector(a);if(!s)return;let d=Array.from(s.querySelectorAll(n.join(","))).filter(l=>l instanceof HTMLElement),f=d.map(l=>(l.id||(l.id=yt(l.textContent??"")),{id:l.id,level:parseInt(l.tagName.slice(1),10),text:(l.textContent??"").trim()}));if(e.setState("items",f),typeof IntersectionObserver>"u")return;let o=new IntersectionObserver(l=>{let p=l.filter(g=>g.isIntersecting).sort((g,m)=>g.boundingClientRect.top-m.boundingClientRect.top)[0];if(!p)return;let b=p.target.id;b&&e.setState("activeId",b)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let l of d)o.observe(l);A.set(e,{observer:o,activeId:""})}function yt(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function H(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Or={button:G,input:_,textarea:U,select:W,checkbox:X,switch:ee,file:re,radioGroup:ne,table:le,tabs:ce,modal:fe,toast:me,stat:ye,card:we,badge:Te,skeleton:Ce,stack:ze,cluster:Ae,grid:qe,code:De,callout:Ve,toc:Pe};export{Or as tags};
