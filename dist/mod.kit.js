...
`;c(ae,i({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[i({tag:"style",template:Ke}),i({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),i({tag:"div",className:"wrap",children:[i({tag:"table",children:[i({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let s=a.sortKey===n.key,d=n.sortable!==!1,p=s?a.sortDir==="asc"?"\u25B2":"\u25BC":"",o=s?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${R(n.key)}"
                        class="${d?"sortable":""}"
                        aria-sort="${o}"
                      >${R(n.label)}<span class="sort">${p}</span></th>`}).join("")}</tr>`}}),i({tag:"tbody",children:[i({tag:"tr",className:"empty",if:({props:e,state:t})=>re(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${R(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>re(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],s=e;return i({tag:"tr",attributes:{"data-row-id":String(s.id??t)},template:n.map(d=>`<td>${R(s[d.key]??"")}</td>`).join("")})}}})]})]}),i({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=A(e,r),n=e.pageSize??10,s=Math.max(1,Math.ceil(a.length/n)),d=Math.min(r.page??0,s-1),p=(e.rows??[]).length;return`
    ...
    `}));function $e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Te="tc-stack",Me=Te;c(Te,i({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${Qe(e.gap)}; --tc-stack-align: ${Xe(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function Qe(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${We(t)})`:t}function We(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Xe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ce="tc-cluster",Le=Ce;c(Ce,i({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${Ze(e.gap)};
        --tc-cluster-justify: ${Je(e.justify)};
        --tc-cluster-align: ${tt(e.align)};
    ...
    `}));function Je(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Ze(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${et(t)})`:t}function et(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function tt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ae="tc-grid",ze=Ae;c(Ae,i({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${Re(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${Re(e.min)}, 1fr))`};
          --tc-grid-gap: ${rt(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `}}));function rt(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${at(t)})`:t}function at(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Re(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var gr={button:F,input:B,textarea:P,select:K,checkbox:Y,switch:X,file:Z,radioGroup:te,table:ne,tabs:se,modal:de,toast:pe,stat:me,card:ye,badge:we,skeleton:Ee,stack:Me,cluster:Le,grid:ze};export{gr as tags};
