...
build(
  ...
  describe({
    ...
    theme: {
      ...
      "tc-badge-neutral-bg": "#ece5d3",
      "tc-badge-neutral-fg": "#14171f",
      "tc-badge-info-bg": "#dde6f4",
      "tc-badge-info-fg": "#1f3a66",
      "tc-badge-success-bg": "#dbece2",
      "tc-badge-success-fg": "#155b40",
      "tc-badge-warning-bg": "#f5e7cf",
      "tc-badge-warning-fg": "#7a4f0a",
      "tc-badge-danger-bg": "#f4dad7",
      "tc-badge-danger-fg": "#7a1a14",
    },
    styles: {
