...
function build(tagName36, description) {
  if (typeof tagName36 !== "string" || !TAG_NAME_PATTERN.test(tagName36)) {
    throw new TypeError(
      `build(): "${tagName36}" is not a valid custom element name (must be lowercase and contain a hyphen).`
    );
  }
  if (componentRegistry.has(tagName36)) {
    console.warn(
      `Component "${tagName36}" is already registered. Skipping re-registration.`
    );
    return tagName36;
  }
  ...
  class CustomComponent extends HTMLElement {
    ...
    connectedCallback() {
      ...
      try {
        ...
        console.error(`[tan-compose] beforeMount threw for <${tagName36}>:`, err);
      }
      this.renderInternal();
      ...
      try {
        ...
        console.error(`[tan-compose] afterMount threw for <${tagName36}>:`, err);
      }
    }
    disconnectedCallback() {
      try {
        ...
        console.error(`[tan-compose] unmount threw for <${tagName36}>:`, err);
      }
    ...
    renderInternal() {
      ...
      try {
        ...
        console.error(`[tan-compose] afterRender threw for <${tagName36}>:`, err);
      }
    }
    ...
    formAssociatedCallback(form) {
      try {
        ...
        console.error(
          `[tan-compose] formAssociatedCallback threw for <${tagName36}>:`,
          err
        );
      }
    }
    formDisabledCallback(disabled) {
      try {
        ...
        console.error(
          `[tan-compose] formDisabledCallback threw for <${tagName36}>:`,
          err
        );
      }
    }
    formResetCallback() {
      try {
        ...
        console.error(
          `[tan-compose] formResetCallback threw for <${tagName36}>:`,
          err
        );
      }
    }
    formStateRestoreCallback(state, mode) {
      try {
        ...
        console.error(
          `[tan-compose] formStateRestoreCallback threw for <${tagName36}>:`,
          err
        );
      }
    }
  ...
  componentRegistry.set(tagName36, CustomComponent);
  customElements.define(tagName36, CustomComponent);
  return tagName36;
}
