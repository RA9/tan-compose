var Ir=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],Dr=new Set(["string","number","boolean","json"]);function p(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Ir){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,a]of Object.entries(t)){if(a===null||typeof a!="object"||Array.isArray(a))throw new TypeError(`describe(): props.${r} must be a record`);if(!Dr.has(a.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Ne=new Map,qr=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,jr=/^(\S+)(?:\s+(.+))?$/;function f(e,t){if(typeof e!="string"||!qr.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Ne.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),a=t.props??{},n=t.refs??{},i=_r(t);class s extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let l=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),Pr(l,i),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",l.appendChild(this.container),t.attributes&&je(this,t.attributes),this.ctx=Or(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[l,c]of Object.entries(a)){let d=this.getAttribute(l),u=d!==null?Re(d,c.type):c.default;this.propValues.set(l,u),this.maybeSyncFormValue(l,u),Object.defineProperty(this,l,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(l),set:m=>{let g=Gr(m,c.type),b=this.propValues.get(l);Object.is(b,g)||(this.propValues.set(l,g),c.reflect&&Ur(this,l,g,c.type),this.maybeSyncFormValue(l,g),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(l,c){if(!this.internals||l!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(l){console.error(`[tan-compose] beforeMount threw for <${e}>:`,l)}if(this.renderInternal(),t.action){let l=t.action;this.addEventListener("click",l),this.mountCleanups.push(()=>this.removeEventListener("click",l))}if(t.emit)for(let l of t.emit)this.addEventListener(l.name,l.handler),this.mountCleanups.push(()=>this.removeEventListener(l.name,l.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(l){console.error(`[tan-compose] afterMount threw for <${e}>:`,l)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(l){console.error(`[tan-compose] unmount threw for <${e}>:`,l)}U(this.mountCleanups),U(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){qe(t,l=>{let c=this.listSlots.get(l);if(c){for(let d of c.cache.values())U(d.cleanups);c.cache.clear()}})}attributeChangedCallback(l,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(a,l)){let u=a[l],m=d!==null?Re(d,u.type):u.default,g=this.propValues.get(l);Object.is(g,m)||(this.propValues.set(l,m),this.isMounted&&this.scheduleRender());return}this.state.set(l,d),this.isMounted&&this.scheduleRender()}}setState(l,c){let d=this.state.get(l);Object.is(d,c)||(this.state.set(l,c),this.isMounted&&this.scheduleRender())}getState(l){return this.state.get(l)}render(){this.renderInternal()}emitEvent(l,c){this.dispatchEvent(new CustomEvent(l,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(l){let c=this.listSlots.get(l);return c||(c={cache:new Map},this.listSlots.set(l,c)),c}renderInternal(){this.rendering=!0;let l=this.captureFocusInShadow();try{U(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let u=Ie(d,c,m=>this.getOrCreateSlot(m));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(l&&this.restoreFocusInShadow(l),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let l=this.shadowRoot;if(!l)return null;let c=l.activeElement;if(!c)return null;let d=[],u=c;for(;u&&u!==l;){let b=u.parentNode;if(!b)break;let v=u.tagName,k=Array.from(b.children).filter(x=>x.tagName===v).indexOf(u);if(d.unshift({tag:v,idx:k}),u=b instanceof Element?b:null,!u&&b===l)break}let m=null,g=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{m=c.selectionStart,g=c.selectionEnd}catch{}return{path:d,selectionStart:m,selectionEnd:g}}restoreFocusInShadow(l){let c=this.shadowRoot;if(!c)return;let d=c;for(let m of l.path){let g=Array.from(d.children??[]),E=(g.length>0?g:Array.from(d.children??[])).filter(k=>k.tagName===m.tag)[m.idx];if(!E)return;d=E}let u=d;if(!(!u||typeof u.focus!="function")&&c.activeElement!==u&&(u.focus(),l.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(l.selectionStart,l.selectionEnd??l.selectionStart)}catch{}}refreshRefs(){let l={},c=this.shadowRoot;for(let[d,u]of Object.entries(n))l[d]=c?c.querySelector(u):null;this.currentRefs=l}formAssociatedCallback(l){try{t.formAssociatedCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(l){try{t.formDisabledCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(l){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,l)}}formStateRestoreCallback(l,c){try{t.formStateRestoreCallback?.call(this,l,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(l){let c=new Map;for(let[d,u]of Object.entries(l)){let m=jr.exec(d.trim());if(!m)continue;let[,g,b]=m;c.has(g)||c.set(g,[]),c.get(g).push({selector:b??null,handler:u})}for(let[d,u]of c){let m=g=>{for(let{selector:b,handler:v}of u){if(!b){v(g,this.ctx);continue}let E=g.composedPath();for(let k of E){if(k===this.shadowRoot||k===this)break;if(k instanceof Element&&this.shadowRoot?.contains(k)&&k.matches(b)){v(g,this.ctx);break}}}};this.shadowRoot.addEventListener(d,m),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,m))}}}return Ne.set(e,s),customElements.define(e,s),e}function Ie(e,t,r){return e.if&&!e.if(t.ctx)?null:De(e,t,r)}function De(e,t,r){let a=document.createElement(e.tag||"div");if(e.styles&&(a.style.cssText=Object.entries(e.styles).map(([n,i])=>`${n}: ${i}`).join("; ")),e.className&&(a.className=e.className),e.attributes&&je(a,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(a.innerHTML=n)}if(e.children)for(let n of e.children){let i=Ie(n,t,r);i&&a.appendChild(i)}if(e.for&&Fr(a,e,t,r),e.action){let n=e.action;a.addEventListener("click",n),t.cleanups.push(()=>a.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)a.addEventListener(n.name,n.handler),t.cleanups.push(()=>a.removeEventListener(n.name,n.handler));return a}function Fr(e,t,r,a){let n=t.for,i=a(t),s=n.items(r.ctx),o=new Map;for(let l=0;l<s.length;l++){let c=s[l],d=n.key(c,l),u,m=i.cache.get(d);if(m&&Object.is(m.lastItem,c))u=m;else{let g=[],b=n.render(c,l,r.ctx),v=De(b,{...r,cleanups:g},a);m&&U(m.cleanups),u={element:v,lastItem:c,cleanups:g}}o.set(d,u),e.appendChild(u.element)}for(let[l,c]of i.cache)o.has(l)||U(c.cleanups);i.cache=o}function qe(e,t){if(e.for&&t(e),e.children)for(let r of e.children)qe(r,t)}function Or(e,t,r,a){return{host:e,get props(){let n={};for(let[i,s]of t)n[i]=s;return n},get state(){let n={};for(let[i,s]of r)n[i]=s;return n},get refs(){return a()},setState:(n,i)=>e.setState(n,i),getState:n=>e.getState(n),emit:(n,i)=>e.emitEvent(n,i)}}function _r(e){let t=e.theme?Br(e.theme):void 0,r=e.styles?Vr(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let i=new CSSStyleSheet;i.replaceSync(t),n.push(i)}if(r){let i=new CSSStyleSheet;i.replaceSync(r),n.push(i)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function Pr(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function je(e,t){for(let[r,a]of Object.entries(t))e.setAttribute(r,a)}function Br(e){return`:host { ${Object.entries(e).map(([r,a])=>`--${r}: ${a};`).join(" ")} }`}function Vr(e){return`.container { ${Object.entries(e).map(([r,a])=>`${r}: ${a};`).join(" ")} }`}function U(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function Re(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function Gr(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function Ur(e,t,r,a){if(a!=="json"){if(a==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var Oe="tc-button",_e=Oe,Fe=`
      <style>
        .root {
...
`;f(Oe,p({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${ne(e.variant)} s-${ne(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
        <span class="content"><slot></slot></span>`,a=String(e.href??""),n=a.length>0,i=!!(e.disabled||e.loading);if(n){let s=e.target?` target="${ne(e.target)}"`:"",o=e.rel?String(e.rel):String(e.target)==="_blank"?"noopener":"",l=o?` rel="${ne(o)}"`:"",c=i?"":` href="${ne(a)}"`;return`
      <a
        part="button"
        class="${t}"${c}${s}${l}${i?' aria-disabled="true"':""}${i?' tabindex="-1"':""}
        role="button"
      >
        ${r}
      </a>${Fe}`}return`
      ...
      `},events:{"input input":(e,t)=>{let r=e.target.value,a=t.host;a.internals?.setFormValue(r),a.value=r,t.emit("tc-input",{value:r})}},formResetCallback(){this.value=""}}));function Y(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ve="tc-textarea",Ge=Ve;f(Ve,p({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},rows:{type:"number",default:4},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},resize:{type:"string",default:"vertical"}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},refs:{input:"textarea"},template:({props:e})=>{let t=!!e.error;return`
        ...
        <textarea
          ...
          ${e.required?"required":""}
          aria-invalid="${t?"true":"false"}"
          style="resize: ${P(e.resize)};"
        >${P(e.value)}</textarea>
        ${e.error||e.helper?`<div class="${t?"error":"helper"}">${P(e.error||e.helper)}</div>`:""}
        <style>
          :host { font-family: var(--tc-input-font); }
          .label {
            display: block; font-size: 0.82rem; font-weight: 600;
      ...
      `},events:{"change select":(e,t)=>{let r=e.target.value,a=t.host;a.internals?.setFormValue(r),a.value=r,t.emit("tc-change",{value:r})}},formResetCallback(){this.value=""}}));function K(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ke="tc-checkbox",We=Ke;f(Ke,p({formAssociated:!0,props:{checked:{type:"boolean",default:!1,reflect:!0},name:{type:"string",default:""},value:{type:"string",default:"on"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},indeterminate:{type:"boolean",default:!1}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-sm, 4px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-checkbox-accent":"var(--tc-color-accent, #a16939)"},styles:{display:"block"},template:({props:e})=>{let t=!!e.error;return`
        <label class="row ${e.disabled?"is-disabled":""} ${t?"is-invalid":""}">
          <input
            ...
            aria-invalid="${t?"true":"false"}"
          />
          ${e.label?`<span class="label">${ge(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</span>`:"<span></span>"}
        </label>
        ${e.error||e.helper?`<div class="${t?"error":"helper"}">${ge(e.error||e.helper)}</div>`:""}
        <style>
      ...
      `},events:{"change input.r":(e,t)=>{let r=e.target.value,a=t.host;a.value=r,a.internals?.setFormValue(r),t.emit("tc-change",{value:r})}},afterMount(){let e=this;e.value&&e.internals?.setFormValue(e.value)},formResetCallback(){this.value=""}}));function X(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var nt="tc-table",ot=nt,Yr=`
...
`,Se=new WeakMap;f(nt,p({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[p({tag:"style",template:Yr}),p({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),p({tag:"div",className:"wrap",children:[p({tag:"table",children:[p({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let i=a.sortKey===n.key,s=n.sortable!==!1,o=i?a.sortDir==="asc"?"\u25B2":"\u25BC":"",l=i?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${me(n.key)}"
                        class="${s?"sortable":""}"
                        aria-sort="${l}"
                      >${me(n.label)}<span class="sort">${o}</span></th>`}).join("")}</tr>`}}),p({tag:"tbody",children:[p({tag:"tr",className:"empty",if:({props:e,state:t})=>at(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${me(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>at(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],i=e;return p({tag:"tr",attributes:{"data-row-id":String(i.id??t)},template:n.map(s=>`<td>${typeof s.render=="function"?s.render(i):me(i[s.key]??"")}</td>`).join("")})}}})]})]}),p({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=be(e,r),n=e.pageSize??10,i=Math.max(1,Math.ceil(a.length/n)),s=Math.min(r.page??0,i-1),o=(e.rows??[]).length;return`
            <span class="count">${a.length} of ${o} rows</span>
            <span class="spacer"></span>
            <button class="prev" type="button" ${s<=0?"disabled":""}>\u2039 prev</button>
            <span class="page">page ${s+1} of ${i}</span>
            <button class="next" type="button" ${s>=i-1?"disabled":""}>next \u203A</button>
          `}})],refs:{filter:".filter"},afterRender(){let e=this,t=e.refs.filter;if(!t)return;let r=e.getState("q")??"";t.value!==r&&(t.value=r);let a=Se.get(e);if(a){Se.delete(e),t.focus();let n=Math.min(a.caret,t.value.length);try{t.setSelectionRange(n,n)}catch{}}},events:{"input .filter":(e,t)=>{let r=e.target;Se.set(t.host,{caret:r.selectionStart??r.value.length}),t.setState("q",r.value),t.setState("page",0)},"click .prev":(e,t)=>{let r=(t.state.page??0)-1;t.setState("page",Math.max(0,r))},"click .next":(e,t)=>{let r=t.state,a=be(t.props,r).length,n=t.props.pageSize??10,i=Math.max(0,Math.ceil(a/n)-1),s=(r.page??0)+1;t.setState("page",Math.min(i,s))},"click th.sortable":(e,t)=>{let r=e.target.closest("th");if(!r)return;let a=r.dataset.col;if(!a)return;let n=t.state,i;n.sortKey!==a?i="asc":i=n.sortDir==="asc"?"desc":n.sortDir==="desc"?null:"asc",t.setState("sortKey",i?a:null),t.setState("sortDir",i),t.emit("tc-sort-change",{key:i?a:null,direction:i})},"click tr[data-row-id]":(e,t)=>{let r=e.target.closest("tr[data-row-id]");if(!r)return;let a=r.dataset.rowId;if(a===void 0)return;let n=be(t.props,t.state),i=n.find(s=>String(s.id)===a)??n[Number(a)];i&&t.emit("tc-row-click",{row:i})}}}));function be(e,t){let r=e.rows??[],a=e.columns??[],n=(t.q??"").trim().toLowerCase(),i=n.length===0?r.slice():r.filter(s=>a.some(o=>String(s[o.key]??"").toLowerCase().includes(n)));if(t.sortKey&&t.sortDir){let s=t.sortKey,o=t.sortDir==="asc"?1:-1;i=i.slice().sort((l,c)=>{let d=l[s],u=c[s];return d===u?0:d==null?1:u==null?-1:typeof d=="number"&&typeof u=="number"?(d-u)*o:String(d).localeCompare(String(u))*o})}return i}function at(e,t){let r=e.pageSize??10,a=be(e,t),n=Math.max(1,Math.ceil(a.length/r)),i=Math.min(t.page??0,n-1);return a.slice(i*r,i*r+r)}function me(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var st="tc-tabs",it=st;f(st,p({props:{tabs:{type:"json",default:[]},active:{type:"string",default:"",reflect:!0}},theme:{"tc-tabs-fg":"var(--tc-color-ink, #14171f)","tc-tabs-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-tabs-rule":"var(--tc-color-rule, #ece5d3)","tc-tabs-accent":"var(--tc-color-accent, #a16939)","tc-tabs-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block","font-family":"var(--tc-tabs-font)"},template:({props:e})=>{let t=e.tabs??[],r=e.active||t[0]?.id||"";return`
        <div role="tablist" class="strip">
          ${t.map(a=>`<button
              ...
              aria-controls="panel-${oe(a.id)}"
              tabindex="${a.id===r?"0":"-1"}"
            >${oe(a.label)}</button>`).join("")}
        </div>
        <div class="panels">
          ${t.map(a=>`<section
              role="tabpanel"
              ...
              aria-labelledby=""
              ${a.id===r?"":"hidden"}
            ><slot name="${oe(a.id)}"></slot></section>`).join("")}
        </div>
        <style>
          .strip {
      ...
      `},events:{"click .tab":(e,t)=>{let r=e.target.closest(".tab");if(!r)return;let a=r.dataset.tab;if(!a)return;let n=t.host,i=n.active;i!==a&&(n.active=a,t.emit("tc-tab-change",{active:a,previous:i}))},"keydown .tab":(e,t)=>{let r=e,a=t.props.tabs??[];if(a.length===0)return;let n=t.host,i=n.active||a[0].id,s=a.findIndex(c=>c.id===i),o=s;if(r.key==="ArrowRight")o=(s+1)%a.length;else if(r.key==="ArrowLeft")o=(s-1+a.length)%a.length;else if(r.key==="Home")o=0;else if(r.key==="End")o=a.length-1;else return;r.preventDefault();let l=a[o].id;n.active=l,t.emit("tc-tab-change",{active:l,previous:i}),queueMicrotask(()=>{t.host.shadowRoot?.querySelector(`.tab[data-tab="${l}"]`)?.focus()})}}}));function oe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var dt="tc-modal",ut=dt,J=new WeakMap;f(dt,p({props:{open:{type:"boolean",default:!1,reflect:!0},title:{type:"string",default:""},dismissible:{type:"boolean",default:!0},width:{type:"string",default:"min(560px, 92vw)"}},theme:{"tc-modal-surface":"var(--tc-color-surface, #ffffff)","tc-modal-ink":"var(--tc-color-ink, #14171f)","tc-modal-rule":"var(--tc-color-rule, #ece5d3)","tc-modal-soft":"var(--tc-color-ink-soft, #5a6072)","tc-modal-radius":"var(--tc-radius-lg, 12px)","tc-modal-backdrop":"rgba(20, 23, 31, 0.5)","tc-modal-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-modal-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"contents"},template:({props:e})=>`
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{lt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&lt(r,"backdrop")}},afterRender(){Kr(this)},unmount(){let e=J.get(this);e&&(e.cleanup(),J.delete(this))}}));function Kr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=J.get(e);if(n&&n.dialog!==r&&(n.cleanup(),J.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!J.has(e)){let i=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",i),J.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",i)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function lt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ft="tc-toast",gt=ft,se=new WeakMap;f(ft,p({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
        <div class="toast v-${pt(t)} ${e.open?"open":"closed"}" role="status" aria-live="polite">
          <span class="icon" aria-hidden="true">${r}</span>
          <span class="msg">${e.message?pt(e.message):"<slot></slot>"}</span>
      ...
      `},events:{"click .x":(e,t)=>mt(t.host,"button")},afterMount(){Wr(this)},unmount(){let e=se.get(this);e!==void 0&&(clearTimeout(e),se.delete(this))}}));function Wr(e){let t=e,r=se.get(e);if(r!==void 0&&clearTimeout(r),se.delete(e),!t.open||!t.duration||t.duration<=0)return;let a=setTimeout(()=>{t.open&&mt(e,"timeout")},t.duration);se.set(e,a)}function mt(e,t){let r=e;r.open&&(r.open=!1,e.dispatchEvent(new CustomEvent("tc-toast-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function pt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var bt="tc-stat",ht=bt;f(bt,p({props:{label:{type:"string",default:""},value:{type:"string",default:""},delta:{type:"string",default:""},trend:{type:"string",default:"neutral"},prefix:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-stat-surface":"var(--tc-color-surface, #ffffff)","tc-stat-rule":"var(--tc-color-rule, #ece5d3)","tc-stat-label":"var(--tc-color-ink-muted, #6b7280)","tc-stat-value":"var(--tc-color-ink, #14171f)","tc-stat-up":"var(--tc-color-success, #207a5b)","tc-stat-down":"var(--tc-color-danger, #b3261e)","tc-stat-neutral":"var(--tc-color-ink-muted, #6b7280)","tc-stat-radius":"var(--tc-radius-lg, 12px)","tc-stat-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"flex",height:"100%"},template:({props:e})=>{let t=String(e.trend??"neutral"),r=t==="up"?"\u25B2":t==="down"?"\u25BC":"\u2022";return`
        <div class="card">
          ${e.label?`<div class="label">${Q(e.label)}</div>`:""}
          <div class="value">
            ${e.prefix?`<span class="prefix">${Q(e.prefix)}</span>`:""}
            <span class="num">${Q(e.value)}</span>
            ${e.suffix?`<span class="suffix">${Q(e.suffix)}</span>`:""}
          </div>
          ${e.delta?`<div class="delta t-${Q(t)}">
        ...
        <div class="${["card",e.bordered?"bordered":"",e.elevated?"elevated":"",e.padded===!1?"nopad":"",t?"has-header":""].filter(Boolean).join(" ")}">
          ...
          <div class="head">
            <slot name="header">
              ...
              ${e.subtitle?`<div class="subtitle">${vt(e.subtitle)}</div>`:""}
            </slot>
          </div>
          <div class="body"><slot></slot></div>
    ...
    `}));function Et(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mt="tc-stack",Lt=Mt;f(Mt,p({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${Xr(e.gap)}; --tc-stack-align: ${Qr(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function Xr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Jr(t)})`:t}function Jr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Qr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ht="tc-cluster",zt=Ht;f(Ht,p({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${ea(e.gap)};
        --tc-cluster-justify: ${Zr(e.justify)};
        --tc-cluster-align: ${ra(e.align)};
    ...
    `}));function Zr(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function ea(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${ta(t)})`:t}function ta(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function ra(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var At="tc-grid",Nt=At;f(At,p({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${Ct(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${Ct(e.min)}, 1fr))`};
          --tc-grid-gap: ${aa(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `},events:{"click .copy":(e,t)=>{let r=t.host,a=r.shadowRoot?.querySelector("slot"),i=(a?a.assignedNodes({flatten:!0}):Array.from(r.childNodes)).map(o=>o.textContent??"").join(""),s=()=>{t.setState("copied",!0),t.emit("tc-copy",{text:i}),setTimeout(()=>t.setState("copied",!1),1600)};navigator.clipboard?.writeText?navigator.clipboard.writeText(i).then(s,s):s()}}}));function Rt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ft="tc-callout",Ot=Ft,qt={note:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',info:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',success:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',warning:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',danger:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>'};f(Ft,p({props:{variant:{type:"string",default:"note"},title:{type:"string",default:""},compact:{type:"boolean",default:!1}},theme:{"tc-callout-radius":"var(--tc-radius-md, 8px)","tc-callout-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-callout-note-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-callout-note-fg":"var(--tc-color-ink-soft, #4a5061)","tc-callout-note-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-callout-info-bg":"var(--tc-color-info-bg, #dde6f4)","tc-callout-info-fg":"var(--tc-color-info-fg, #1f3a66)","tc-callout-info-border":"var(--tc-color-info, #3a5b8c)","tc-callout-success-bg":"var(--tc-color-success-bg, #dbece2)","tc-callout-success-fg":"var(--tc-color-success-fg, #155b40)","tc-callout-success-border":"var(--tc-color-success, #207a5b)","tc-callout-warning-bg":"var(--tc-color-warning-bg, #f5e7cf)","tc-callout-warning-fg":"var(--tc-color-warning-fg, #7a4f0a)","tc-callout-warning-border":"var(--tc-color-warning, #a87326)","tc-callout-danger-bg":"var(--tc-color-danger-bg, #f4dad7)","tc-callout-danger-fg":"var(--tc-color-danger-fg, #7a1a14)","tc-callout-danger-border":"var(--tc-color-danger, #b3261e)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"note"),r=qt[t]??qt.note;return`
        <aside
          class="callout v-${jt(t)} ${e.compact?"compact":""}"
          role="${t==="danger"?"alert":"note"}"
        >
          <span class="icon" aria-hidden="true">${r}</span>
          <div class="body">
            ${e.title?`<div class="title">${jt(e.title)}</div>`:""}
      ...
      `},afterMount(){ia(this)},unmount(){he.get(this)?.observer?.disconnect(),he.delete(this)}}));function ia(e){he.get(e)?.observer?.disconnect();let r=e,a=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),i=document.querySelector(a);if(!i)return;let s=Array.from(i.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),o=s.map(c=>(c.id||(c.id=la(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",o),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(c=>{let u=c.filter(g=>g.isIntersecting).sort((g,b)=>g.boundingClientRect.top-b.boundingClientRect.top)[0];if(!u)return;let m=u.target.id;m&&e.setState("activeId",m)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of s)l.observe(c);he.set(e,{observer:l,activeId:""})}function la(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Te(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Bt="tc-pagination",Vt=Bt;f(Bt,p({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=ca(Number(e.current)|0,1,t),a=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let i=da(r,t,a,n),s=ve(String(e.size??"sm")),o=r<=1?" disabled":"",l=r>=t?" disabled":"",c=i.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${s}"
            variant="${u?"primary":"ghost"}"
            data-page="${d}"${u?' aria-current="page"':""}
          >${d}</tc-button>`}).join("");return`
        <nav aria-label="${ve(String(e.label??"Pagination"))}">
          <tc-button
            class="prev"
            size="${s}"
            variant="ghost"
            data-page="${r-1}"${o}
          >\u2190 ${ve(String(e["prev-label"]??"Prev"))}</tc-button>
          ...
          <tc-button
            ...
            variant="ghost"
            data-page="${r+1}"${l}
          >${ve(String(e["next-label"]??"Next"))} \u2192</tc-button>
        </nav>
        <style>
          :host { display: block; }
          nav {
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let a=r.getAttribute("data-page");if(a==null)return;let n=Number(a),i=t.host,s=Math.max(1,Number(i.total)|0),o=Number(i.current)|0;!Number.isFinite(n)||n<1||n>s||n!==o&&t.emit("tc-page-change",{page:n})}}}));function ca(e,t,r){return Math.min(r,Math.max(t,e))}function da(e,t,r,a){let n=new Set;for(let o=1;o<=Math.min(a,t);o++)n.add(o);for(let o=Math.max(1,t-a+1);o<=t;o++)n.add(o);for(let o=Math.max(1,e-r);o<=Math.min(t,e+r);o++)n.add(o);let i=[...n].sort((o,l)=>o-l),s=[];for(let o=0;o<i.length;o++)o>0&&i[o]-i[o-1]>1&&s.push("\u2026"),s.push(i[o]);return s}function ve(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Yt="tc-combobox",Kt=Yt;function ie(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function le(e){return e.join(",")}function ua(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var pa=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;f(Yt,p({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],a=!!e.multiple,n=e.searchable!==!1,i=!!e.disabled,s=!!e.error,o=ie(e.value),l=String(t.query??""),c=!!t.open&&!i,d=Number(t.focusedIndex??-1),u=Gt(r,l),m=new Set(o),g=o.map(y=>r.find(j=>j.value===y)).filter(y=>!!y),b=n&&(c||a&&o.length===0),v=!a&&o.length===1&&(!c||!n),E=o.length===0&&!b&&!v,k=a?g.map(y=>`<span class="chip" data-value="${H(y.value)}">
              ...
              <button
                ...
                ${i?"disabled":""}
              >&times;</button>
            </span>`).join(""):"",x=v&&g[0]?`<span class="single">
            ${g[0].icon?`<span class="single-icon">${H(g[0].icon)}</span>`:""}
            <span class="single-label">${H(g[0].label)}</span>
          </span>`:"",M=E?`<span class="placeholder">${H(e.placeholder??"")}</span>`:"",R=b?`<input
            type="text"
            class="search"
            part="search"
            value="${H(l)}"
            placeholder="${H(o.length===0?e.placeholder??"":"")}"
            ${i?"disabled":""}
            autocomplete="off"
            aria-autocomplete="list"
            aria-expanded="${c?"true":"false"}"
            role="combobox"
          />`:"",A=u.length===0?`<div class="empty">${H(e["empty-text"]??"No results")}</div>`:u.map((y,j)=>{let z=m.has(y.value);return`<div
            ...
            </div>`}).join(""),V=e.label?`<label class="label">${H(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",$e=s?`<div class="helper error">${H(e.error)}</div>`:e.helper?`<div class="helper">${H(e.helper)}</div>`:"";return`
        ${V}
        <div
          class="control ${s?"invalid":""} ${c?"open":""} ${i?"disabled":""}"
          part="control"
          tabindex="${i?"-1":"0"}"
        ...
        ${$e}
        ${pa}
      `},events:{"click .control":(e,t)=>{if(e.target.closest(".chip-remove")||t.host.disabled)return;let n=!!t.getState("open");t.setState("open",!0),n||t.emit("tc-open"),t.refs.search?.focus()},"keydown .control":(e,t)=>{let r=e;if(r.key==="Enter"||r.key===" "){if(r.preventDefault(),t.host.disabled)return;t.setState("open",!0),t.emit("tc-open"),t.refs.search?.focus()}},"input .search":(e,t)=>{let r=e.target.value;t.setState("query",r),t.setState("open",!0),t.setState("focusedIndex",0),t.emit("tc-search",{query:r})},"keydown .search":(e,t)=>{let r=e,a=e.target,n=t.host,i=!!n.multiple,s=n.options??[],o=Gt(s,String(t.getState("query")??""));if(r.key==="Backspace"&&a.value===""&&i){let l=ie(n.value);l.length>0&&(l.pop(),n.value=le(l),ye(t,l,n),t.emit("tc-change",{value:l.slice()}),r.preventDefault());return}if(r.key==="ArrowDown"){r.preventDefault(),t.setState("open",!0);let l=Number(t.getState("focusedIndex")??-1),c=Math.min(o.length-1,l+1);t.setState("focusedIndex",c);return}if(r.key==="ArrowUp"){r.preventDefault();let l=Number(t.getState("focusedIndex")??0),c=Math.max(0,l-1);t.setState("focusedIndex",c);return}if(r.key==="Enter"){r.preventDefault();let l=Number(t.getState("focusedIndex")??-1);l>=0&&l<o.length&&Ut(t,o[l],n);return}if(r.key==="Escape"){r.preventDefault(),t.setState("open",!1),t.setState("query",""),t.emit("tc-close");return}},"mousedown .option":(e,t)=>{e.preventDefault();let r=e.target.closest(".option");if(!r||r.classList.contains("disabled"))return;let a=r.dataset.value;if(a==null)return;let n=t.host,s=(n.options??[]).find(o=>o.value===a);s&&Ut(t,s,n)},"click .chip-remove":(e,t)=>{e.stopPropagation();let a=e.target.dataset.remove;if(a==null)return;let n=t.host,i=ie(n.value).filter(s=>s!==a);n.value=le(i),ye(t,i,n),t.emit("tc-change",{value:i.slice()})},"focusout .control":(e,t)=>{queueMicrotask(()=>{t.host.matches(":focus-within")||(t.setState("open",!1),t.setState("query",""),t.emit("tc-close"))})}},afterMount(){let e=this;if(!e.multiple||!e.internals)return;let t=ie(e.value),r=String(e.name??"");if(!r){e.internals.setFormValue(le(t));return}let a=new FormData;for(let n of t)a.append(r,n);e.internals.setFormValue(a)},afterRender(){let e=this;if(!(e.getState?!!e.getState("open"):!1))return;let r=e.refs?.search??null;if(!r||e.shadowRoot?.activeElement===r)return;r.focus();let n=r.value.length;try{r.setSelectionRange(n,n)}catch{}}}));function Gt(e,t){if(!t)return e;let r=new RegExp(ua(t),"i");return e.filter(a=>r.test(a.label)||r.test(a.value))}function Ut(e,t,r){let a=!!r.multiple,n=Number(r.max??0),i=ie(r.value);if(a){let s;if(i.includes(t.value))s=i.filter(o=>o!==t.value);else{if(n>0&&i.length>=n)return;s=i.concat(t.value)}r.value=le(s),ye(e,s,r),e.setState("query",""),e.emit("tc-change",{value:s.slice()}),queueMicrotask(()=>{e.refs.search?.focus()})}else r.value=t.value,ye(e,[t.value],r),e.setState("query",""),e.setState("open",!1),e.emit("tc-change",{value:t.value}),e.emit("tc-close")}function ye(e,t,r){let a=r.internals;if(!a)return;let n=String(r.name??"");if(!r.multiple){a.setFormValue(t[0]??"");return}if(!n){a.setFormValue(le(t));return}let i=new FormData;for(let s of t)i.append(n,s);a.setFormValue(i)}function H(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Qt="tc-carousel",Zt=Qt;function Wt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function xe(e){let t=0;for(let r of Array.from(e.children))r instanceof Element&&!r.hasAttribute("slot")&&t++;return t}function er(e,t,r){return t<=0?0:r?(e%t+t)%t:Math.max(0,Math.min(t-1,e))}function F(e,t){let r=xe(e);if(r===0)return;let a=e.value,n=er(t,r,e.loop);n!==a&&(e.value=n,e.dispatchEvent(new CustomEvent("tc-change",{detail:{index:n,previous:a},bubbles:!0,composed:!0})))}function Xt(e){Me(e),!(e.autoplay<=0)&&(xe(e)<=1||(e._carouselTimer=globalThis.setInterval(()=>{F(e,e.value+1)},e.autoplay)))}function Me(e){e._carouselTimer!==void 0&&(globalThis.clearInterval(e._carouselTimer),e._carouselTimer=void 0)}f(Qt,p({props:{value:{type:"number",default:0,reflect:!0},autoplay:{type:"number",default:0},loop:{type:"boolean",default:!0},orientation:{type:"string",default:"horizontal"},transition:{type:"string",default:"slide"},indicators:{type:"boolean",default:!0},controls:{type:"boolean",default:!0},swipe:{type:"boolean",default:!0},pauseOnHover:{type:"boolean",default:!0},ariaLabel:{type:"string",default:"Carousel"},height:{type:"string",default:""}},theme:{"tc-carousel-radius":"var(--tc-radius-lg, 12px)","tc-carousel-bg":"var(--tc-color-bg, #faf8f3)","tc-carousel-control-bg":"rgba(255, 255, 255, 0.85)","tc-carousel-control-bg-hover":"rgba(255, 255, 255, 1)","tc-carousel-control-fg":"var(--tc-color-ink, #14171f)","tc-carousel-control-size":"36px","tc-carousel-indicator":"rgba(20, 23, 31, 0.25)","tc-carousel-indicator-active":"var(--tc-color-accent, #a16939)","tc-carousel-duration":"320ms"},styles:{display:"block",position:"relative"},template:({props:e})=>{let t=Number(e.value??0),r=String(e.orientation)==="vertical",a=String(e.transition)==="fade",n=String(e.height??""),i=!!e.controls,s=!!e.indicators,o=Wt(e.ariaLabel??"Carousel");return`
        <div
          class="root ${r?"v":"h"} ${a?"fade":"slide"}"
          role="region"
          aria-roledescription="carousel"
          aria-label="${o}"
          style="${n?`--tc-carousel-height: ${Wt(n)};`:""}--tc-carousel-index: ${t};"
        >
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;F(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;F(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let a=Number(r.dataset.index);if(!Number.isFinite(a))return;let n=t.host;F(n,a)},"keydown .root":(e,t)=>{let r=e,a=t.host,n=a.orientation==="vertical",i=xe(a),s=n?"ArrowUp":"ArrowLeft",o=n?"ArrowDown":"ArrowRight";r.key===s?(r.preventDefault(),F(a,a.value-1)):r.key===o?(r.preventDefault(),F(a,a.value+1)):r.key==="Home"?(r.preventDefault(),F(a,0)):r.key==="End"&&(r.preventDefault(),F(a,i-1))}},afterMount(){let e=this,t=()=>Jt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let a=e.shadowRoot,n=a?.querySelector("slot"),i=()=>t();n?.addEventListener("slotchange",i),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",i)};let s=()=>Me(e),o=()=>{e.pauseOnHover&&Xt(e)};e.addEventListener("pointerenter",s),e.addEventListener("pointerleave",o),e.addEventListener("focusin",s),e.addEventListener("focusout",o),e._carouselHover=()=>{e.removeEventListener("pointerenter",s),e.removeEventListener("pointerleave",o),e.removeEventListener("focusin",s),e.removeEventListener("focusout",o)},fa(e),a?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&Xt(e)},afterRender(){Jt(this)},unmount(){let e=this;Me(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function Jt(e){let t=xe(e),r=e.shadowRoot;if(!r)return;let a=r.querySelector(".root");if(a&&t>0){let o=er(e.value,t,e.loop);o!==e.value&&(e.value=o),a.style.setProperty("--tc-carousel-index",String(o))}let n=r.querySelector(".indicators");if(n){let o=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===o?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=l}if(Array.from(e.children).filter(o=>o instanceof HTMLElement&&!o.hasAttribute("slot")).forEach((o,l)=>{o.setAttribute("role","group"),o.setAttribute("aria-roledescription","slide"),o.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?o.classList.toggle("is-active",l===e.value):o.classList.remove("is-active")}),!e.loop){let o=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");o&&(o.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let s=r.querySelector(".sr-status");s&&t>0&&(s.textContent=`Slide ${e.value+1} of ${t}`)}function fa(e){let t=0,r=0,a=!1,n=40,i=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,a=!0))},s=l=>{if(!a)return;a=!1;let c=l.clientX-t,d=l.clientY-r,m=e.orientation==="vertical"?d:c;Math.abs(m)<n||F(e,e.value+(m<0?1:-1))},o=()=>{a=!1};e.addEventListener("pointerdown",i),e.addEventListener("pointerup",s),e.addEventListener("pointercancel",o),e._carouselDrag=()=>{e.removeEventListener("pointerdown",i),e.removeEventListener("pointerup",s),e.removeEventListener("pointercancel",o)}}var tr="tc-accordion",rr=tr;f(tr,p({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this,t=i=>{let s=i.target;if(!(!s||s.tagName!=="DETAILS")){if(e.mode==="single"&&s.open)for(let o of we(e))o!==s&&o.open&&(o.open=!1);ga(e)}},r=i=>{let s=i.target;if(!s||s.tagName!=="SUMMARY")return;let o=we(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=o.indexOf(s);if(l===-1)return;let c=-1;i.key==="ArrowDown"?c=(l+1)%o.length:i.key==="ArrowUp"?c=(l-1+o.length)%o.length:i.key==="Home"?c=0:i.key==="End"&&(c=o.length-1),c!==-1&&(i.preventDefault(),o[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let a=()=>{for(let i of we(e)){let s=i.querySelector(":scope > summary");if(s&&!s.querySelector(".tc-accordion-caret")){let o=document.createElement("span");o.className="tc-accordion-caret",o.setAttribute("aria-hidden","true"),o.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",o.textContent="\u25B8",s.appendChild(o);let l=()=>{o.style.transform=i.open?"rotate(90deg)":"rotate(0)"};l(),i.addEventListener("toggle",l)}}};a();let n=new MutationObserver(a);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));function we(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function ga(e){let t=[];for(let r of we(e))if(r.open){let a=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(a)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var nr="tc-tooltip",or=nr;function ma(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(nr,p({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${ma(e.text)}</span>`:""}
    ...
    `,afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".tip");if(!r)return;let a=()=>{e.disabled||(clearTimeout(e._tooltipTimer),e._tooltipTimer=globalThis.setTimeout(()=>{if(typeof r.showPopover=="function")try{r.showPopover()}catch{r.style.visibility="visible",r.style.opacity="1"}else r.style.visibility="visible",r.style.opacity="1";ar(e,r)},Math.max(0,e.delay)))},n=()=>{clearTimeout(e._tooltipTimer);try{typeof r.hidePopover=="function"&&r.hidePopover()}catch{}r.style.opacity="",r.style.visibility=""},i=o=>{o.key==="Escape"&&n()};e.addEventListener("pointerenter",a),e.addEventListener("pointerleave",n),e.addEventListener("focusin",a),e.addEventListener("focusout",n),e.addEventListener("keydown",i);let s=()=>{r.matches(":popover-open")&&ar(e,r)};globalThis.addEventListener("scroll",s,!0),globalThis.addEventListener("resize",s),e._tooltipCleanup=()=>{clearTimeout(e._tooltipTimer),e.removeEventListener("pointerenter",a),e.removeEventListener("pointerleave",n),e.removeEventListener("focusin",a),e.removeEventListener("focusout",n),e.removeEventListener("keydown",i),globalThis.removeEventListener("scroll",s,!0),globalThis.removeEventListener("resize",s),n()}},unmount(){this._tooltipCleanup?.()}}));function ar(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,i=globalThis.innerHeight,s=e.offset,o=e.placement||"top",l=u=>u==="top"?r.top-a.height-s>=4:u==="bottom"?r.bottom+a.height+s<=i-4:u==="left"?r.left-a.width-s>=4:u==="right"?r.right+a.width+s<=n-4:!0;if(!l(o)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[o]??"top")&&(o=u[o])}let c=0,d=0;o==="top"?(c=r.top-a.height-s,d=r.left+r.width/2-a.width/2):o==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-a.width/2):o==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-s):o==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+s),c=Math.max(4,Math.min(i-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`,t.dataset.placement=o}var ir="tc-popover",lr=ir;f(ir,p({props:{open:{type:"boolean",default:!1,reflect:!0},placement:{type:"string",default:"bottom"},offset:{type:"number",default:8},dismissible:{type:"boolean",default:!0}},theme:{"tc-popover-bg":"var(--tc-color-surface, #ffffff)","tc-popover-fg":"var(--tc-color-ink, #14171f)","tc-popover-rule":"var(--tc-color-rule, #ece5d3)","tc-popover-radius":"var(--tc-radius-md, 8px)","tc-popover-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.18))","tc-popover-padding":"12px 14px","tc-popover-min-width":"200px","tc-popover-max-width":"340px","tc-popover-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative"},template:()=>`
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){sr(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},a=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&cr(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",a,!0),globalThis.addEventListener("resize",a),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",a,!0),globalThis.removeEventListener("resize",a)},sr(e)},unmount(){this._popoverCleanup?.()}}));function sr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let a=e.open,n=typeof r.showPopover=="function";if(a&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";cr(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!a&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function cr(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,i=globalThis.innerHeight,s=e.offset,o=e.placement||"bottom",l=u=>u==="top"?r.top-a.height-s>=4:u==="bottom"?r.bottom+a.height+s<=i-4:u==="left"?r.left-a.width-s>=4:u==="right"?r.right+a.width+s<=n-4:!0;if(!l(o)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[o]??"bottom")&&(o=u[o])}let c=0,d=0;o==="top"?(c=r.top-a.height-s,d=r.left+r.width/2-a.width/2):o==="bottom"?(c=r.bottom+s,d=r.left+r.width/2-a.width/2):o==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-s):o==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+s),c=Math.max(4,Math.min(i-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var ur="tc-drawer",pr=ur,Z=new WeakMap;function Le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(ur,p({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Le(e.size??"min(420px, 92vw)");return`
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{dr(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&dr(r,"backdrop")}},afterRender(){ba(this)},unmount(){let e=Z.get(this);e&&(e.cleanup(),Z.delete(this))}}));function ba(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=Z.get(e);if(n&&n.dialog!==r&&(n.cleanup(),Z.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!Z.has(e)){let i=()=>{let s=e;s.open&&(s.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",i),Z.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",i)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function dr(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var fr="tc-progress",gr=fr;function ee(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ha(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}f(fr,p({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),a=!!e.indeterminate,n=Number(e.value??0),i=Number(e.max??100),s=ha(n,i),o=e.label||(a?"Loading\u2026":`${Math.round(s)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,m=(d-u)/2,g=2*Math.PI*m,b=a?g*.25:s/100*g,v=a?`role="progressbar" aria-valuetext="${ee(o)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${i}"`;return`
          <div class="circ size-${ee(r)} ${a?"indet":""}" ${v}>
            <svg viewBox="0 0 ${d} ${d}" width="${d}" height="${d}" aria-hidden="true">
              <circle class="track" cx="${d/2}" cy="${d/2}" r="${m}" stroke-width="${u}" fill="none" />
              <circle
                class="fill"
                cx="${d/2}" cy="${d/2}" r="${m}"
                stroke-width="${u}" fill="none"
                stroke-dasharray="${b.toFixed(3)} ${(g-b).toFixed(3)}"
                stroke-dashoffset="${(g/4).toFixed(3)}"
                stroke-linecap="round"
              />
            </svg>
            ${e.showLabel?`<span class="label" aria-hidden="true">${ee(o)}</span>`:""}
          </div>
          <style>
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,c=a?`role="progressbar" aria-valuetext="${ee(o)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${i}"`;return`
        <div class="bar size-${ee(r)} ${a?"indet":""}" ${c}>
          <div class="track">
      ...
      `}}));var br="tc-stepper",hr=br;function mr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(br,p({props:{steps:{type:"json",default:[]},active:{type:"number",default:0,reflect:!0},orientation:{type:"string",default:"horizontal"},clickable:{type:"boolean",default:!1}},theme:{"tc-stepper-bg":"transparent","tc-stepper-ink":"var(--tc-color-ink, #14171f)","tc-stepper-soft":"var(--tc-color-ink-soft, #4a5061)","tc-stepper-rule":"var(--tc-color-rule, #ece5d3)","tc-stepper-accent":"var(--tc-color-accent, #a16939)","tc-stepper-done":"var(--tc-color-success, #2f7a52)","tc-stepper-radius":"999px","tc-stepper-marker-size":"28px","tc-stepper-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.steps??[],r=Number(e.active??0),a=String(e.orientation)==="vertical",n=!!e.clickable,i=t.map((s,o)=>{let l=o<r?"done":o===r?"current":"upcoming",c=l==="done"?'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>':`${o+1}`;return`
          <li class="step state-${l}" data-index="${o}">
            <${n?"button":"div"} class="row" ${n?`type="button" aria-current="${l==="current"?"step":"false"}"`:`aria-current="${l==="current"?"step":"false"}"`}>
              ...
              <span class="text">
                <span class="title">${mr(s.title)}</span>
                ${s.description?`<span class="desc">${mr(s.description)}</span>`:""}
              </span>
            </${n?"button":"div"}>
            ${o<t.length-1?`<span class="line ${o<r?"done":""}" aria-hidden="true"></span>`:""}
          </li>
        `}).join("");return`
      ...
      `},events:{"click .row":(e,t)=>{let r=t.host;if(!r.clickable)return;let a=e.target.closest(".step");if(!a)return;let n=Number(a.dataset.index);if(!Number.isFinite(n)||n===r.active)return;let i=r.active;r.active=n,t.emit("tc-step-change",{active:n,previous:i})}}}));var yr="tc-avatar",xr=yr;function O(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function vr(e){let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?"":t.length===1?t[0].slice(0,2).toUpperCase():(t[0][0]+t[t.length-1][0]).toUpperCase()}var He=[["#dde6f4","#1f3a66"],["#dbece2","#155b40"],["#efe2cf","#8a572d"],["#f4dad7","#7a1a14"],["#e3dcf1","#3d2a73"],["#d5e8e5","#0d4f49"],["#fbe3c5","#7a4f0a"]];function va(e){if(!e)return He[0];let t=0;for(let a=0;a<e.length;a++)t=t*31+e.charCodeAt(a)|0;let r=Math.abs(t)%He.length;return He[r]}f(yr,p({props:{src:{type:"string",default:""},alt:{type:"string",default:""},name:{type:"string",default:""},size:{type:"string",default:"md"},shape:{type:"string",default:"circle"},status:{type:"string",default:""},ring:{type:"boolean",default:!1}},theme:{"tc-avatar-bg":"var(--tc-color-rule, #ece5d3)","tc-avatar-fg":"var(--tc-color-ink, #14171f)","tc-avatar-ring":"var(--tc-color-surface, #ffffff)","tc-avatar-status-online":"#2f7a52","tc-avatar-status-away":"#d7a52f","tc-avatar-status-busy":"#b3261e","tc-avatar-status-offline":"#9aa0a6","tc-avatar-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative","vertical-align":"middle"},template:({props:e})=>{let t=String(e.name??""),r=String(e.src??""),a=String(e.alt??"")||t||"avatar",n=String(e.size??"md"),i=String(e.shape??"circle"),s=String(e.status??""),o=!!e.ring,[l,c]=va(t);return`
        <span class="root size-${O(n)} shape-${O(i)} ${o?"ringed":""}"
              style="--tc-avatar-tint-bg: ${l}; --tc-avatar-tint-fg: ${c};">
          ${r?`<img src="${O(r)}" alt="${O(a)}" loading="lazy" onerror="this.replaceWith(Object.assign(document.createElement('span'),{className:'fallback',textContent:'${O(vr(t))}'}))">`:`<span class="fallback" aria-label="${O(a)}">${O(vr(t))}</span>`}
    ...
    `,afterMount(){let e=this,t=()=>wr(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){wr(this)},unmount(){this._agroupCleanup?.()}}));function wr(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),a=Array.from(e.children).filter(l=>l instanceof HTMLElement),n=0;for(let l of a)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),n<t||t===0?(l.hidden=!1,n++):l.hidden=!0);let i=a.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,s=Math.max(0,i-n),o=e.shadowRoot?.querySelector(".overflow");o&&(s>0?(o.hidden=!1,o.textContent=`+${s}`):o.hidden=!0)}var Tr="tc-rating",Mr=Tr;function Er(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Sr="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";f(Tr,p({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),a=Number(e.value??0),n=Number(t.hover??-1),i=n>=0?n:a,s=String(e.size??"md"),o=!!e.readonly,l=!!e.allowHalf,c=Er(e.ariaLabel??"Rating"),d=s==="sm"?18:s==="lg"?32:24,u=[];for(let m=1;m<=r;m++){let g=i-(m-1),b=g>=1?100:g>=.5&&l?50:g>0&&!l?100:0,v=b===50;u.push(`
          <span class="star ${v?"half":b===100?"full":"empty"}" data-index="${m}">
            <svg viewBox="0 0 24 24" width="${d}" height="${d}" aria-hidden="true">
              <path class="track" d="${Sr}" fill="var(--tc-rating-track)" />
              ${b>0?`<path class="fill" d="${Sr}" fill="var(--tc-rating-fill)" clip-path="${v?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
            ${l&&!o?`<span class="hit-left" data-index="${m}" data-half="1"></span>
                 <span class="hit-right" data-index="${m}" data-half="0"></span>`:""}
          </span>
        `)}return`
        <div
          class="root size-${Er(s)} ${o?"readonly":""}"
          role="${o?"img":"slider"}"
          tabindex="${o?"-1":"0"}"
          aria-label="${c}"
          aria-valuenow="${a}"
      ...
      `},events:{"click .star":(e,t)=>{let r=t.host;if(r.readonly)return;let a=e.target,n=a.closest(".hit-left, .hit-right"),i=a.closest(".star");if(!i)return;let s=Number(i.dataset.index);if(!Number.isFinite(s))return;let o=s;n?.dataset.half==="1"&&r.allowHalf&&(o=s-.5),o===r.value&&(o=0);let l=r.value;r.value=o,t.emit("tc-change",{value:o,previous:l})},"mouseover .star":(e,t)=>{let r=t.host;if(r.readonly)return;let a=e.target,n=a.closest(".hit-left, .hit-right"),i=a.closest(".star");if(!i)return;let s=Number(i.dataset.index);if(!Number.isFinite(s))return;let o=s;n?.dataset.half==="1"&&r.allowHalf&&(o=s-.5),t.setState("hover",o)},"mouseleave .root":(e,t)=>{t.setState("hover",-1)},"keydown .root":(e,t)=>{let r=e,a=t.host;if(a.readonly)return;let n=a.allowHalf?.5:1,i=a.value,s=i;if(r.key==="ArrowRight"||r.key==="ArrowUp")s=Math.min(a.max,i+n);else if(r.key==="ArrowLeft"||r.key==="ArrowDown")s=Math.max(0,i-n);else if(r.key==="Home")s=0;else if(r.key==="End")s=a.max;else return;r.preventDefault(),s!==i&&(a.value=s,t.emit("tc-change",{value:s,previous:i}))}}}));var Lr="tc-slider",Hr=Lr;function ke(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(Lr,p({props:{value:{type:"number",default:0,reflect:!0},min:{type:"number",default:0},max:{type:"number",default:100},step:{type:"number",default:1},disabled:{type:"boolean",default:!1,reflect:!0},showValue:{type:"boolean",default:!1},showTicks:{type:"boolean",default:!1},label:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-slider-track":"var(--tc-color-rule, #ece5d3)","tc-slider-fill":"var(--tc-color-accent, #a16939)","tc-slider-thumb":"var(--tc-color-surface, #ffffff)","tc-slider-thumb-ring":"var(--tc-color-accent, #a16939)","tc-slider-radius":"999px","tc-slider-thumb-size":"20px","tc-slider-track-size":"6px","tc-slider-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-slider-fg":"var(--tc-color-ink, #14171f)","tc-slider-fg-muted":"var(--tc-color-ink-muted, #6b7280)"},styles:{display:"block"},template:({props:e})=>{let t=Number(e.value??0),r=Number(e.min??0),a=Number(e.max??100),n=Number(e.step??1),i=!!e.disabled,s=a>r?(t-r)/(a-r)*100:0,o=String(e.label??""),l=String(e.suffix??""),c=!!e.showValue,d=!!e.showTicks,u="";if(d&&n>0){let m=Math.floor((a-r)/n)+1;if(m<=50){let g=[];for(let b=0;b<m;b++){let E=(r+b*n-r)/(a-r)*100;g.push(`<span class="tick" style="left:${E.toFixed(2)}%"></span>`)}u=g.join("")}}return`
        ${o||c?`<div class="head">
              ${o?`<label for="r" class="lbl">${ke(o)}</label>`:"<span></span>"}
              ${c?`<span class="val">${ke(String(t))}${ke(l)}</span>`:""}
            </div>`:""}
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);a.value!==n&&(a.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:a.value})}}}));var Nr="tc-chart",Rr=Nr;function zr(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),a=e/Math.pow(10,r),n;return t?a<1.5?n=1:a<3?n=2:a<7?n=5:n=10:a<=1?n=1:a<=2?n=2:a<=5?n=5:n=10,n*Math.pow(10,r)}function ya(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let a=zr(t-e,!1),n=zr(a/(r-1),!0),i=Math.floor(e/n)*n,s=Math.ceil(t/n)*n,o=[];for(let l=i;l<=s+n*.5;l+=n)o.push(Number(l.toFixed(10)));return{min:i,max:s,ticks:o}}function ze(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(a=>`${a.x} ${a.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let a=0;a<e.length-1;a++){let n=e[a-1]??e[a],i=e[a],s=e[a+1],o=e[a+2]??s,l=i.x+(s.x-n.x)/6,c=i.y+(s.y-n.y)/6,d=s.x-(o.x-i.x)/6,u=s.y-(o.y-i.y)/6;r+=` C ${l},${c} ${d},${u} ${s.x},${s.y}`}return r}function ce(e,t,r,a){return{x:e+r*Math.sin(a),y:t-r*Math.cos(a)}}function xa(e,t,r,a,n,i){let s=i-n>Math.PI?1:0,o=ce(e,t,r,n),l=ce(e,t,r,i);if(a<=0)return`M ${e} ${t} L ${o.x} ${o.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} Z`;let c=ce(e,t,a,i),d=ce(e,t,a,n);return`M ${o.x} ${o.y} A ${r} ${r} 0 ${s} 1 ${l.x} ${l.y} L ${c.x} ${c.y} A ${a} ${a} 0 ${s} 0 ${d.x} ${d.y} Z`}function $(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function B(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function de(e,t){return t[e%t.length]}function wa(e,t){let{data:r,smooth:a,stacked:n,showAxes:i,showGrid:s,showLabels:o,showValues:l}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",m=u?4:16,g=u?4:i&&o?28:8,b=u?4:i?44:8,v=u?4:12,E=e.W-b-v,k=e.H-m-g,x=1/0,M=-1/0;if(n&&d.length>0){let w=c.length>0?c.map((h,T)=>d.reduce((L,I)=>L+(I.values?.[T]??0),0)):[];for(let h of w)h<x&&(x=h),h>M&&(M=h);x>0&&(x=0)}else for(let w of d)for(let h of w.values??[])h<x&&(x=h),h>M&&(M=h);(!Number.isFinite(x)||!Number.isFinite(M))&&(x=0,M=1),x===M&&(x-=1,M+=1);let R=ya(e.yMin??x,e.yMax??M,5),A=e.yMin??R.min,V=e.yMax??R.max,$e=V-A||1,y=c.length||d[0]?.values?.length||0,j=w=>y===1?b+E/2:t==="bar"?b+(w+.5)*(E/y):b+w/(y-1)*E,z=w=>m+k-(w-A)/$e*k,G=[];if(!u){if(s)for(let w of R.ticks){let h=z(w);G.push(`<line class="grid" x1="${b}" x2="${e.W-v}" y1="${h}" y2="${h}"/>`)}if(i){for(let h of R.ticks){let T=z(h);G.push(`<text class="axis-label y" x="${b-8}" y="${T}" text-anchor="end" dominant-baseline="middle">${$(B(h))}</text>`)}if(o&&c.length>0){let h=Math.max(1,Math.ceil(c.length/8));c.forEach((T,L)=>{L%h!==0&&L!==c.length-1||G.push(`<text class="axis-label x" x="${j(L)}" y="${e.H-g+16}" text-anchor="middle">${$(T)}</text>`)})}let w=A<=0&&V>=0?z(0):z(A);G.push(`<line class="axis" x1="${b}" x2="${e.W-v}" y1="${w}" y2="${w}"/>`)}}let q=[];if(t==="bar"){let w=E/y,h=w*.18,T=w-h*2;d.forEach((L,I)=>{let C=`series series-${I}`,D=de(I,e.palette),S=0;L.values?.forEach((N,_)=>{if(!Number.isFinite(N))return;let te=j(_),ue,pe,fe,Ee;if(n){ue=te-T/2,pe=T;let re=z(S+N),ae=z(S);fe=Math.min(re,ae),Ee=Math.abs(re-ae),S+=N}else{let re=T/d.length;ue=te-T/2+I*re,pe=re*.86;let ae=z(N),Ae=z(A<0&&V>0?0:A);fe=Math.min(ae,Ae),Ee=Math.abs(ae-Ae)}let Ce=`${$(L.name)}${c[_]?` \xB7 ${$(c[_])}`:""}: ${$(B(N))}`;q.push(`<g class="${C}"><rect class="hit" x="${ue}" y="${fe}" width="${pe}" height="${Ee}" rx="2" fill="${D}" data-tip="${Ce}" data-color="${D}"><title>${Ce}</title></rect>`+(l?`<text class="value-label" x="${ue+pe/2}" y="${fe-4}" text-anchor="middle">${$(B(N))}</text>`:"")+"</g>")})})}else if(n&&t==="area"){let w=new Array(y).fill(0);d.forEach((h,T)=>{let L=de(T,e.palette),I=[],C=[];for(let S=0;S<y;S++){let N=h.values?.[S]??0,_=w[S]+N;I.push({x:j(S),y:z(_)}),C.push({x:j(S),y:z(w[S])}),w[S]=_}let D=ze(I,a)+" L "+C.slice().reverse().map(S=>`${S.x} ${S.y}`).join(" L ")+" Z";q.push(`<path class="series-fill series-${T}" d="${D}" fill="${L}" fill-opacity="0.25" pointer-events="none"/>`),q.push(`<path class="series-line series-${T}" d="${ze(I,a)}" stroke="${L}" fill="none" pointer-events="none"/>`),I.forEach((S,N)=>{let _=h.values?.[N]??0,te=`${$(h.name)}${c[N]?` \xB7 ${$(c[N])}`:""}: ${$(B(_))}`;q.push(`<circle class="hit series-${T}" cx="${S.x}" cy="${S.y}" r="12" fill="transparent" data-tip="${te}" data-color="${L}"><title>${te}</title></circle>`)})})}else d.forEach((w,h)=>{let T=de(h,e.palette),L=(w.values??[]).map((C,D)=>({x:j(D),y:z(C)})),I=ze(L,a);if(t==="area"){let C=z(A<0&&V>0?0:A),D=I+` L ${L[L.length-1].x} ${C} L ${L[0].x} ${C} Z`;q.push(`<path class="series-fill series-${h}" d="${D}" fill="${T}" fill-opacity="0.25"/>`)}q.push(`<path class="series-line series-${h}" d="${I}" stroke="${T}" fill="none"/>`),u||L.forEach((C,D)=>{let S=w.values?.[D],N=`${$(w.name)}${c[D]?` \xB7 ${$(c[D])}`:""}: ${$(B(S??0))}`;q.push(`<circle class="series-point series-${h}" cx="${C.x}" cy="${C.y}" r="3.5" fill="${T}" pointer-events="none"/>`),q.push(`<circle class="hit series-${h}" cx="${C.x}" cy="${C.y}" r="12" fill="transparent" data-tip="${N}" data-color="${T}"><title>${N}</title></circle>`),l&&q.push(`<text class="value-label" x="${C.x}" y="${C.y-8}" text-anchor="middle" pointer-events="none">${$(B(S??0))}</text>`)})});return G.join("")+q.join("")}function ka(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let a=e.W/2,n=e.H/2,i=Math.min(e.W,e.H)/2-4,s=Math.max(0,Math.min(.9,e.innerRadius))*i,o=0,l=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let m=u/r*Math.PI*2,g=o,b=o+m,v=xa(a,n,i,s,g,b-.01),E=de(d,e.palette),k=(u/r*100).toFixed(1).replace(/\.0$/,""),x=`${$(c.name)}: ${$(B(u))} (${k}%)`;if(l.push(`<path class="series-segment hit series-${d}" d="${v}" fill="${E}" data-tip="${x}" data-color="${E}"><title>${x}</title></path>`),e.showValues){let M=(g+b)/2,R=(i+s)/2,A=ce(a,n,R,M);l.push(`<text class="value-label donut" x="${A.x}" y="${A.y}" text-anchor="middle" dominant-baseline="middle">${$(k)}%</text>`)}o=b}),l.join("")}function $a(e,t){return e.length===0?"":'<div class="legend" part="legend">'+e.map((r,a)=>`<span class="legend-item"><span class="swatch" style="background:${de(a,t)}"></span>${$(r.name)}</span>`).join("")+"</div>"}function Ea(e,t){if(e==="donut"){let n=(t.series??[]).reduce((s,o)=>s+(o.value??0),0);return`Donut chart: ${(t.series??[]).filter(s=>(s.value??0)>0).map(s=>{let o=n>0?(s.value??0)/n*100:0;return`${s.name} ${o.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(n=>n.name).join(", "),a=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${a} data point${a===1?"":"s"}.`}var Sa=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],Ta=`
  <style>
...
`;f(Nr,p({props:{type:{type:"string",default:"line"},data:{type:"json",default:{series:[]}},height:{type:"string",default:"240px"},smooth:{type:"boolean",default:!0},stacked:{type:"boolean",default:!1},showLegend:{type:"boolean",default:!0},showAxes:{type:"boolean",default:!0},showGrid:{type:"boolean",default:!0},showLabels:{type:"boolean",default:!0},showValues:{type:"boolean",default:!1},innerRadius:{type:"number",default:.6},yMin:{type:"json",default:null},yMax:{type:"json",default:null},ariaLabel:{type:"string",default:"Chart"},colors:{type:"json",default:null},src:{type:"string",default:""},srcKey:{type:"string",default:""},loadingText:{type:"string",default:"Loading chart\u2026"},errorText:{type:"string",default:"Couldn't load chart data"}},theme:{"tc-chart-bg":"transparent","tc-chart-fg":"var(--tc-color-ink, #14171f)","tc-chart-axis":"var(--tc-color-rule-strong, #d9cfb8)","tc-chart-grid":"var(--tc-color-rule, #ece5d3)","tc-chart-label":"var(--tc-color-ink-muted, #6b7280)","tc-chart-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e,state:t})=>{let r=String(e.type??"line").toLowerCase(),a=["line","area","bar","sparkline","donut"].includes(r)?r:"line",n=e.data,i=t.fetched,s=!!n&&Array.isArray(n.series)&&n.series.length>0,o=s?n:i??{series:[]},l=String(e.src??""),c=!!t.loading&&!s&&!i,d=l&&t.error?String(t.error):"",u=c?`<div class="overlay loading">${$(String(e.loadingText??"Loading chart\u2026"))}</div>`:d?`<div class="overlay error" role="alert">${$(String(e.errorText??"Couldn't load chart data"))}<small>${$(d)}</small></div>`:"",m=a==="sparkline",g=a==="donut",b=e.colors,v=Array.isArray(b)&&b.length>0?b:Sa,E=g?320:800,k=g?320:400,x={data:o,smooth:!!e.smooth,stacked:!!e.stacked,showAxes:!!e.showAxes,showGrid:!!e.showGrid,showLabels:!!e.showLabels,showValues:!!e.showValues,innerRadius:Number(e.innerRadius??.6),yMin:e.yMin==null?null:Number(e.yMin),yMax:e.yMax==null?null:Number(e.yMax),palette:v,W:E,H:k},M=g?ka(x):wa(x,a),R=Ea(a,o),A=$(String(e.height??"240px"));return`
        <div class="root" role="img" aria-label="${$(e.ariaLabel??"Chart")}">
          ...
          ${e.showLegend&&!m&&o.series&&o.series.length>0?$a(o.series,v):""}
        ...
        ${Ta}
      `},afterMount(){Cr(this),Ar(this)},afterRender(){Cr(this),Ar(this)},unmount(){let e=this;e._chartHoverCleanup?.(),e._chartFetchAborter?.abort()}}));function Cr(e){let t=e;t._chartHoverCleanup?.();let r=t.shadowRoot;if(!r)return;let a=r.querySelector(".canvas"),n=r.querySelector(".tip"),i=n?.querySelector(".tip-text"),s=n?.querySelector(".tip-swatch");if(!a||!n||!i||!s)return;let o=()=>{n.removeAttribute("data-open"),n.style.transform="translate(-9999px, -9999px)"},l=d=>{let u=d.target?.closest?.("[data-tip]");if(!u){o();return}let m=u.getAttribute("data-tip")||"",g=u.getAttribute("data-color")||"currentColor";i.textContent=m,s.style.background=g;let b=a.getBoundingClientRect(),v=n.offsetWidth||100,E=n.offsetHeight||24,k=d.clientX-b.left,x=d.clientY-b.top,M=k+12,R=x-E-8;M+v>b.width-4&&(M=k-v-12),R<4&&(R=x+16),n.style.transform=`translate(${M}px, ${R}px)`,n.setAttribute("data-open","1")},c=()=>o();a.addEventListener("pointermove",l),a.addEventListener("pointerleave",c),t._chartHoverCleanup=()=>{a.removeEventListener("pointermove",l),a.removeEventListener("pointerleave",c),o()}}function Ar(e){let t=e,r=String(t.src??"").trim();if(!r||!t.getState||!t.setState||t.getState("fetchedFrom")===r)return;t._chartFetchAborter?.abort();let n=new AbortController;t._chartFetchAborter=n,t.setState("fetchedFrom",r),t.setState("fetched",null),t.setState("error",null),t.setState("loading",!0);let i=String(t.srcKey??"").trim();fetch(r,{signal:n.signal}).then(s=>{if(!s.ok)throw new Error(`${s.status} ${s.statusText}`);return s.json()}).then(s=>{let o=i?Ma(s,i):s;if(!o||typeof o!="object"||!Array.isArray(o.series))throw new Error(i?`Payload at "${i}" doesn't look like ChartData`:"Payload doesn't look like ChartData");n.signal.aborted||(t.setState("fetched",o),t.setState("loading",!1))}).catch(s=>{n.signal.aborted||(t.setState("loading",!1),t.setState("error",s instanceof Error?s.message:String(s)))})}function Ma(e,t){return t.split(".").reduce((r,a)=>r&&typeof r=="object"?r[a]:void 0,e)}var jo={button:_e,input:Be,textarea:Ge,select:Ye,checkbox:We,switch:Qe,file:et,radioGroup:rt,slider:Hr,rating:Mr,table:ot,chart:Rr,tabs:it,modal:ut,drawer:pr,toast:gt,stat:ht,card:xt,badge:$t,skeleton:Tt,carousel:Zt,accordion:rr,tooltip:or,popover:lr,progress:gr,stepper:hr,avatar:xr,avatarGroup:$r,stack:Lt,cluster:zt,grid:Nt,code:Dt,callout:Ot,toc:Pt,pagination:Vt,combobox:Kt};export{jo as tags};
