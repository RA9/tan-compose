var nr=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],or=new Set(["string","number","boolean","json"]);function u(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of nr){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,a]of Object.entries(t)){if(a===null||typeof a!="object"||Array.isArray(a))throw new TypeError(`describe(): props.${r} must be a record`);if(!or.has(a.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var re=new Map,sr=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,ir=/^(\S+)(?:\s+(.+))?$/;function f(e,t){if(typeof e!="string"||!sr.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(re.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),a=t.props??{},n=t.refs??{},o=dr(t);class l extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let i=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),ur(i,o),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",i.appendChild(this.container),t.attributes&&ie(this,t.attributes),this.ctx=cr(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[i,c]of Object.entries(a)){let d=this.getAttribute(i),p=d!==null?ae(d,c.type):c.default;this.propValues.set(i,p),this.maybeSyncFormValue(i,p),Object.defineProperty(this,i,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(i),set:g=>{let m=gr(g,c.type),b=this.propValues.get(i);Object.is(b,m)||(this.propValues.set(i,m),c.reflect&&mr(this,i,m,c.type),this.maybeSyncFormValue(i,m),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(i,c){if(!this.internals||i!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(i){console.error(`[tan-compose] beforeMount threw for <${e}>:`,i)}if(this.renderInternal(),t.action){let i=t.action;this.addEventListener("click",i),this.mountCleanups.push(()=>this.removeEventListener("click",i))}if(t.emit)for(let i of t.emit)this.addEventListener(i.name,i.handler),this.mountCleanups.push(()=>this.removeEventListener(i.name,i.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(i){console.error(`[tan-compose] afterMount threw for <${e}>:`,i)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(i){console.error(`[tan-compose] unmount threw for <${e}>:`,i)}T(this.mountCleanups),T(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){se(t,i=>{let c=this.listSlots.get(i);if(c){for(let d of c.cache.values())T(d.cleanups);c.cache.clear()}})}attributeChangedCallback(i,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(a,i)){let p=a[i],g=d!==null?ae(d,p.type):p.default,m=this.propValues.get(i);Object.is(m,g)||(this.propValues.set(i,g),this.isMounted&&this.scheduleRender());return}this.state.set(i,d),this.isMounted&&this.scheduleRender()}}setState(i,c){let d=this.state.get(i);Object.is(d,c)||(this.state.set(i,c),this.isMounted&&this.scheduleRender())}getState(i){return this.state.get(i)}render(){this.renderInternal()}emitEvent(i,c){this.dispatchEvent(new CustomEvent(i,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(i){let c=this.listSlots.get(i);return c||(c={cache:new Map},this.listSlots.set(i,c)),c}renderInternal(){this.rendering=!0;let i=this.captureFocusInShadow();try{T(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let p=ne(d,c,g=>this.getOrCreateSlot(g));p&&this.container.appendChild(p)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(i&&this.restoreFocusInShadow(i),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let i=this.shadowRoot;if(!i)return null;let c=i.activeElement;if(!c)return null;let d=[],p=c;for(;p&&p!==i;){let b=p.parentNode;if(!b)break;let h=p.tagName,x=Array.from(b.children).filter(X=>X.tagName===h).indexOf(p);if(d.unshift({tag:h,idx:x}),p=b instanceof Element?b:null,!p&&b===i)break}let g=null,m=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{g=c.selectionStart,m=c.selectionEnd}catch{}return{path:d,selectionStart:g,selectionEnd:m}}restoreFocusInShadow(i){let c=this.shadowRoot;if(!c)return;let d=c;for(let g of i.path){let m=Array.from(d.children??[]),w=(m.length>0?m:Array.from(d.children??[])).filter(x=>x.tagName===g.tag)[g.idx];if(!w)return;d=w}let p=d;if(!(!p||typeof p.focus!="function")&&c.activeElement!==p&&(p.focus(),i.selectionStart!=null&&(p instanceof HTMLInputElement||p instanceof HTMLTextAreaElement)))try{p.setSelectionRange(i.selectionStart,i.selectionEnd??i.selectionStart)}catch{}}refreshRefs(){let i={},c=this.shadowRoot;for(let[d,p]of Object.entries(n))i[d]=c?c.querySelector(p):null;this.currentRefs=i}formAssociatedCallback(i){try{t.formAssociatedCallback?.call(this,i)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(i){try{t.formDisabledCallback?.call(this,i)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(i){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,i)}}formStateRestoreCallback(i,c){try{t.formStateRestoreCallback?.call(this,i,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(i){let c=new Map;for(let[d,p]of Object.entries(i)){let g=ir.exec(d.trim());if(!g)continue;let[,m,b]=g;c.has(m)||c.set(m,[]),c.get(m).push({selector:b??null,handler:p})}for(let[d,p]of c){let g=m=>{for(let{selector:b,handler:h}of p){if(!b){h(m,this.ctx);continue}let w=m.composedPath();for(let x of w){if(x===this.shadowRoot||x===this)break;if(x instanceof Element&&this.shadowRoot?.contains(x)&&x.matches(b)){h(m,this.ctx);break}}}};this.shadowRoot.addEventListener(d,g),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,g))}}}return re.set(e,l),customElements.define(e,l),e}function ne(e,t,r){return e.if&&!e.if(t.ctx)?null:oe(e,t,r)}function oe(e,t,r){let a=document.createElement(e.tag||"div");if(e.styles&&(a.style.cssText=Object.entries(e.styles).map(([n,o])=>`${n}: ${o}`).join("; ")),e.className&&(a.className=e.className),e.attributes&&ie(a,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(a.innerHTML=n)}if(e.children)for(let n of e.children){let o=ne(n,t,r);o&&a.appendChild(o)}if(e.for&&lr(a,e,t,r),e.action){let n=e.action;a.addEventListener("click",n),t.cleanups.push(()=>a.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)a.addEventListener(n.name,n.handler),t.cleanups.push(()=>a.removeEventListener(n.name,n.handler));return a}function lr(e,t,r,a){let n=t.for,o=a(t),l=n.items(r.ctx),s=new Map;for(let i=0;i<l.length;i++){let c=l[i],d=n.key(c,i),p,g=o.cache.get(d);if(g&&Object.is(g.lastItem,c))p=g;else{let m=[],b=n.render(c,i,r.ctx),h=oe(b,{...r,cleanups:m},a);g&&T(g.cleanups),p={element:h,lastItem:c,cleanups:m}}s.set(d,p),e.appendChild(p.element)}for(let[i,c]of o.cache)s.has(i)||T(c.cleanups);o.cache=s}function se(e,t){if(e.for&&t(e),e.children)for(let r of e.children)se(r,t)}function cr(e,t,r,a){return{host:e,get props(){let n={};for(let[o,l]of t)n[o]=l;return n},get state(){let n={};for(let[o,l]of r)n[o]=l;return n},get refs(){return a()},setState:(n,o)=>e.setState(n,o),getState:n=>e.getState(n),emit:(n,o)=>e.emitEvent(n,o)}}function dr(e){let t=e.theme?pr(e.theme):void 0,r=e.styles?fr(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let o=new CSSStyleSheet;o.replaceSync(t),n.push(o)}if(r){let o=new CSSStyleSheet;o.replaceSync(r),n.push(o)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function ur(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function ie(e,t){for(let[r,a]of Object.entries(t))e.setAttribute(r,a)}function pr(e){return`:host { ${Object.entries(e).map(([r,a])=>`--${r}: ${a};`).join(" ")} }`}function fr(e){return`.container { ${Object.entries(e).map(([r,a])=>`${r}: ${a};`).join(" ")} }`}function T(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function ae(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function gr(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function mr(e,t,r,a){if(a!=="json"){if(a==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var ce="tc-button",de=ce,le=`
      <style>
        .root {
...
`;f(ce,u({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${R(e.variant)} s-${R(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
      ...
      `},events:{"input textarea":(e,t)=>{let r=e.target.value,a=t.host;a.internals?.setFormValue(r),a.value=r,t.emit("tc-input",{value:r})}},formResetCallback(){this.value=""}}));function E(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var me="tc-select",be=me;f(me,u({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},placeholder:{type:"string",default:""},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.options??[],r=!!e.error;return`
        ...
        <div class="wrap">
          ...
          >
            ${e.placeholder?`<option value="" disabled ${e.value===""?"selected":""}>${M(e.placeholder)}</option>`:""}
            ${t.map(a=>`<option value="${M(a.value)}"${a.disabled?" disabled":""}${a.value===e.value?" selected":""}>${M(a.label)}</option>`).join("")}
          </select>
      ...
      `},events:{"click .track":(e,t)=>{let r=t.host;r.disabled||(r.checked=!r.checked,r.internals?.setFormValue(r.checked?r.value:null),t.emit("tc-change",{checked:r.checked}))},"keydown .track":(e,t)=>{let r=e;if(r.key!==" "&&r.key!=="Enter")return;r.preventDefault();let a=t.host;a.disabled||(a.checked=!a.checked,a.internals?.setFormValue(a.checked?a.value:null),t.emit("tc-change",{checked:a.checked}))}},afterMount(){let e=this;e.internals?.setFormValue(e.checked?e.value:null)},formResetCallback(){this.checked=!1}}));function ye(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ke="tc-file",$e=ke;f(ke,u({formAssociated:!0,props:{name:{type:"string",default:""},accept:{type:"string",default:""},multiple:{type:"boolean",default:!1,reflect:!0},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},buttonText:{type:"string",default:"Choose file"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-file-zone-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-file-zone-fg":"var(--tc-color-ink-soft, #4a5061)"},styles:{display:"block"},refs:{input:"input[type='file']"},template:({props:e,state:t})=>{let r=!!e.error,a=t.files??[],n=a.length===0?"No file selected":a.length===1?L(a[0].name):`${a.length} files selected`;return`
      ...
      `},events:{"click .btn":(e,t)=>{t.refs.input?.click()},"change input[type='file']":(e,t)=>{let r=e.target,a=Array.from(r.files??[]);t.setState("files",a);let n=t.host;if(n.internals)if(a.length===0)n.internals.setFormValue(null);else if(a.length===1)n.internals.setFormValue(a[0]);else{let o=new FormData,l=n.name;for(let s of a)o.append(l,s);n.internals.setFormValue(o)}t.emit("tc-files",{files:a})}},formResetCallback(){let t=this.shadowRoot?.querySelector(".native");t&&(t.value=""),this.setState("files",[])}}));function L(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ee="tc-radio-group",Te=Ee;f(Ee,u({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},layout:{type:"string",default:"vertical"},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0}},theme:{"tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-radio-accent":"var(--tc-color-accent, #a16939)"},styles:{display:"block"},template:({props:e})=>{let t=e.options??[],r=!!e.error,a=String(e.layout??"vertical");return`
        <fieldset class="group" ${e.disabled?"disabled":""}>
          ...
          <div class="opts l-${H(a)}" role="radiogroup" aria-invalid="${r?"true":"false"}">
      ...
      `},events:{"change input.r":(e,t)=>{let r=e.target.value,a=t.host;a.value=r,a.internals?.setFormValue(r),t.emit("tc-change",{value:r})}},afterMount(){let e=this;e.value&&e.internals?.setFormValue(e.value)},formResetCallback(){this.value=""}}));function H(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Me="tc-table",Le=Me,br=`
...
`,J=new WeakMap;f(Me,u({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[u({tag:"style",template:br}),u({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),u({tag:"div",className:"wrap",children:[u({tag:"table",children:[u({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let o=a.sortKey===n.key,l=n.sortable!==!1,s=o?a.sortDir==="asc"?"\u25B2":"\u25BC":"",i=o?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${B(n.key)}"
                        class="${l?"sortable":""}"
                        aria-sort="${i}"
                      >${B(n.label)}<span class="sort">${s}</span></th>`}).join("")}</tr>`}}),u({tag:"tbody",children:[u({tag:"tr",className:"empty",if:({props:e,state:t})=>Se(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${B(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>Se(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],o=e;return u({tag:"tr",attributes:{"data-row-id":String(o.id??t)},template:n.map(l=>`<td>${typeof l.render=="function"?l.render(o):B(o[l.key]??"")}</td>`).join("")})}}})]})]}),u({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=_(e,r),n=e.pageSize??10,o=Math.max(1,Math.ceil(a.length/n)),l=Math.min(r.page??0,o-1),s=(e.rows??[]).length;return`
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Ce(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&Ce(r,"backdrop")}},afterRender(){vr(this)},unmount(){let e=z.get(this);e&&(e.cleanup(),z.delete(this))}}));function vr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=z.get(e);if(n&&n.dialog!==r&&(n.cleanup(),z.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!z.has(e)){let o=()=>{let l=e;l.open&&(l.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),z.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Ce(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function Ae(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var De="tc-toast",qe=De,D=new WeakMap;f(De,u({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
      ...
      `},events:{"click .x":(e,t)=>Oe(t.host,"button")},afterMount(){hr(this)},unmount(){let e=D.get(this);e!==void 0&&(clearTimeout(e),D.delete(this))}}));function hr(e){let t=e,r=D.get(e);if(r!==void 0&&clearTimeout(r),D.delete(e),!t.open||!t.duration||t.duration<=0)return;let a=setTimeout(()=>{t.open&&Oe(e,"timeout")},t.duration);D.set(e,a)}function Oe(e,t){let r=e;r.open&&(r.open=!1,e.dispatchEvent(new CustomEvent("tc-toast-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function Ie(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var je="tc-stat",Fe=je;f(je,u({props:{label:{type:"string",default:""},value:{type:"string",default:""},delta:{type:"string",default:""},trend:{type:"string",default:"neutral"},prefix:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-stat-surface":"var(--tc-color-surface, #ffffff)","tc-stat-rule":"var(--tc-color-rule, #ece5d3)","tc-stat-label":"var(--tc-color-ink-muted, #6b7280)","tc-stat-value":"var(--tc-color-ink, #14171f)","tc-stat-up":"var(--tc-color-success, #207a5b)","tc-stat-down":"var(--tc-color-danger, #b3261e)","tc-stat-neutral":"var(--tc-color-ink-muted, #6b7280)","tc-stat-radius":"var(--tc-radius-lg, 12px)","tc-stat-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.trend??"neutral"),r=t==="up"?"\u25B2":t==="down"?"\u25BC":"\u2022";return`
        <div class="card">
          ${e.label?`<div class="label">${C(e.label)}</div>`:""}
          <div class="value">
            ${e.prefix?`<span class="prefix">${C(e.prefix)}</span>`:""}
            <span class="num">${C(e.value)}</span>
            ${e.suffix?`<span class="suffix">${C(e.suffix)}</span>`:""}
          </div>
          ${e.delta?`<div class="delta t-${C(t)}">
    ...
    `}));function Ke(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var We="tc-stack",Je=We;f(We,u({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${yr(e.gap)}; --tc-stack-align: ${wr(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function yr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${xr(t)})`:t}function xr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function wr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Qe="tc-cluster",Ze=Qe;f(Qe,u({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${$r(e.gap)};
        --tc-cluster-justify: ${kr(e.justify)};
        --tc-cluster-align: ${Tr(e.align)};
    ...
    `}));function kr(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function $r(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Er(t)})`:t}function Er(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function Tr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var tt="tc-grid",rt=tt;f(tt,u({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${et(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${et(e.min)}, 1fr))`};
          --tc-grid-gap: ${Sr(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `},afterMount(){zr(this)},unmount(){P.get(this)?.observer?.disconnect(),P.delete(this)}}));function zr(e){P.get(e)?.observer?.disconnect();let r=e,a=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),o=document.querySelector(a);if(!o)return;let l=Array.from(o.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),s=l.map(c=>(c.id||(c.id=Cr(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",s),typeof IntersectionObserver>"u")return;let i=new IntersectionObserver(c=>{let p=c.filter(m=>m.isIntersecting).sort((m,b)=>m.boundingClientRect.top-b.boundingClientRect.top)[0];if(!p)return;let g=p.target.id;g&&e.setState("activeId",g)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of l)i.observe(c);P.set(e,{observer:i,activeId:""})}function Cr(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Q(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var pt="tc-pagination",ft=pt;f(pt,u({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=Ar(Number(e.current)|0,1,t),a=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let o=Nr(r,t,a,n),l=G(String(e.size??"sm")),s=r<=1?" disabled":"",i=r>=t?" disabled":"",c=o.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let p=d===r;return`<tc-button
            class="num"
            size="${l}"
            variant="${p?"primary":"ghost"}"
            data-page="${d}"${p?' aria-current="page"':""}
          >${d}</tc-button>`}).join("");return`
        <nav aria-label="${G(String(e.label??"Pagination"))}">
          <tc-button
            class="prev"
            size="${l}"
            variant="ghost"
            data-page="${r-1}"${s}
          >\u2190 ${G(String(e["prev-label"]??"Prev"))}</tc-button>
          ...
          <tc-button
            ...
            variant="ghost"
            data-page="${r+1}"${i}
          >${G(String(e["next-label"]??"Next"))} \u2192</tc-button>
        </nav>
        <style>
          :host { display: block; }
          nav {
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let a=r.getAttribute("data-page");if(a==null)return;let n=Number(a),o=t.host,l=Math.max(1,Number(o.total)|0),s=Number(o.current)|0;!Number.isFinite(n)||n<1||n>l||n!==s&&t.emit("tc-page-change",{page:n})}}}));function Ar(e,t,r){return Math.min(r,Math.max(t,e))}function Nr(e,t,r,a){let n=new Set;for(let s=1;s<=Math.min(a,t);s++)n.add(s);for(let s=Math.max(1,t-a+1);s<=t;s++)n.add(s);for(let s=Math.max(1,e-r);s<=Math.min(t,e+r);s++)n.add(s);let o=[...n].sort((s,i)=>s-i),l=[];for(let s=0;s<o.length;s++)s>0&&o[s]-o[s-1]>1&&l.push("\u2026"),l.push(o[s]);return l}function G(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var bt="tc-combobox",vt=bt;function q(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function O(e){return e.join(",")}function Rr(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var Ir=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;f(bt,u({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],a=!!e.multiple,n=e.searchable!==!1,o=!!e.disabled,l=!!e.error,s=q(e.value),i=String(t.query??""),c=!!t.open&&!o,d=Number(t.focusedIndex??-1),p=gt(r,i),g=new Set(s),m=s.map(v=>r.find(j=>j.value===v)).filter(v=>!!v),b=n&&(c||a&&s.length===0),h=!a&&s.length===1&&(!c||!n),w=s.length===0&&!b&&!h,x=a?m.map(v=>`<span class="chip" data-value="${y(v.value)}">
              ${v.icon?`<span class="chip-icon">${y(v.icon)}</span>`:""}
              <span class="chip-label">${y(v.label)}</span>
              <button
                type="button"
                class="chip-remove"
                data-remove="${y(v.value)}"
                aria-label="Remove ${y(v.label)}"
                ${o?"disabled":""}
              >&times;</button>
          ...
          </span>`:"",Zt=w?`<span class="placeholder">${y(e.placeholder??"")}</span>`:"",er=b?`<input
            type="text"
            class="search"
            part="search"
            value="${y(i)}"
            placeholder="${y(s.length===0?e.placeholder??"":"")}"
            ${o?"disabled":""}
            autocomplete="off"
            aria-autocomplete="list"
            aria-expanded="${c?"true":"false"}"
            role="combobox"
          />`:"",tr=p.length===0?`<div class="empty">${y(e["empty-text"]??"No results")}</div>`:p.map((v,j)=>{let W=g.has(v.value);return`<div
              class="${["option",W?"selected":"",j===d?"focused":"",v.disabled?"disabled":""].filter(Boolean).join(" ")}"
              role="option"
              data-value="${y(v.value)}"
              data-index="${j}"
              aria-selected="${W?"true":"false"}"
              ${v.disabled?'aria-disabled="true"':""}
            >
              ${a?`<span class="check" aria-hidden="true">${W?"\u2713":""}</span>`:""}
              ${v.icon?`<span class="opt-icon">${y(v.icon)}</span>`:""}
              <span class="opt-label">${y(v.label)}</span>
            </div>`}).join(""),rr=e.label?`<label class="label">${y(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",ar=l?`<div class="helper error">${y(e.error)}</div>`:e.helper?`<div class="helper">${y(e.helper)}</div>`:"";return`
        ${rr}
        <div
        ...
        ${ar}
        ${Ir}
      `},events:{"click .control":(e,t)=>{if(e.target.closest(".chip-remove")||t.host.disabled)return;let n=!!t.getState("open");t.setState("open",!0),n||t.emit("tc-open"),t.refs.search?.focus()},"keydown .control":(e,t)=>{let r=e;if(r.key==="Enter"||r.key===" "){if(r.preventDefault(),t.host.disabled)return;t.setState("open",!0),t.emit("tc-open"),t.refs.search?.focus()}},"input .search":(e,t)=>{let r=e.target.value;t.setState("query",r),t.setState("open",!0),t.setState("focusedIndex",0),t.emit("tc-search",{query:r})},"keydown .search":(e,t)=>{let r=e,a=e.target,n=t.host,o=!!n.multiple,l=n.options??[],s=gt(l,String(t.getState("query")??""));if(r.key==="Backspace"&&a.value===""&&o){let i=q(n.value);i.length>0&&(i.pop(),n.value=O(i),V(t,i,n),t.emit("tc-change",{value:i.slice()}),r.preventDefault());return}if(r.key==="ArrowDown"){r.preventDefault(),t.setState("open",!0);let i=Number(t.getState("focusedIndex")??-1),c=Math.min(s.length-1,i+1);t.setState("focusedIndex",c);return}if(r.key==="ArrowUp"){r.preventDefault();let i=Number(t.getState("focusedIndex")??0),c=Math.max(0,i-1);t.setState("focusedIndex",c);return}if(r.key==="Enter"){r.preventDefault();let i=Number(t.getState("focusedIndex")??-1);i>=0&&i<s.length&&mt(t,s[i],n);return}if(r.key==="Escape"){r.preventDefault(),t.setState("open",!1),t.setState("query",""),t.emit("tc-close");return}},"mousedown .option":(e,t)=>{e.preventDefault();let r=e.target.closest(".option");if(!r||r.classList.contains("disabled"))return;let a=r.dataset.value;if(a==null)return;let n=t.host,l=(n.options??[]).find(s=>s.value===a);l&&mt(t,l,n)},"click .chip-remove":(e,t)=>{e.stopPropagation();let a=e.target.dataset.remove;if(a==null)return;let n=t.host,o=q(n.value).filter(l=>l!==a);n.value=O(o),V(t,o,n),t.emit("tc-change",{value:o.slice()})},"focusout .control":(e,t)=>{queueMicrotask(()=>{t.host.matches(":focus-within")||(t.setState("open",!1),t.setState("query",""),t.emit("tc-close"))})}},afterMount(){let e=this;if(!e.multiple||!e.internals)return;let t=q(e.value),r=String(e.name??"");if(!r){e.internals.setFormValue(O(t));return}let a=new FormData;for(let n of t)a.append(r,n);e.internals.setFormValue(a)},afterRender(){let e=this;if(!(e.getState?!!e.getState("open"):!1))return;let r=e.refs?.search??null;if(!r||e.shadowRoot?.activeElement===r)return;r.focus();let n=r.value.length;try{r.setSelectionRange(n,n)}catch{}}}));function gt(e,t){if(!t)return e;let r=new RegExp(Rr(t),"i");return e.filter(a=>r.test(a.label)||r.test(a.value))}function mt(e,t,r){let a=!!r.multiple,n=Number(r.max??0),o=q(r.value);if(a){let l;if(o.includes(t.value))l=o.filter(s=>s!==t.value);else{if(n>0&&o.length>=n)return;l=o.concat(t.value)}r.value=O(l),V(e,l,r),e.setState("query",""),e.emit("tc-change",{value:l.slice()}),queueMicrotask(()=>{e.refs.search?.focus()})}else r.value=t.value,V(e,[t.value],r),e.setState("query",""),e.setState("open",!1),e.emit("tc-change",{value:t.value}),e.emit("tc-close")}function V(e,t,r){let a=r.internals;if(!a)return;let n=String(r.name??"");if(!r.multiple){a.setFormValue(t[0]??"");return}if(!n){a.setFormValue(O(t));return}let o=new FormData;for(let l of t)o.append(n,l);a.setFormValue(o)}function y(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var wt="tc-carousel",kt=wt;function ht(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function U(e){let t=0;for(let r of Array.from(e.children))r instanceof Element&&!r.hasAttribute("slot")&&t++;return t}function $t(e,t,r){return t<=0?0:r?(e%t+t)%t:Math.max(0,Math.min(t-1,e))}function k(e,t){let r=U(e);if(r===0)return;let a=e.value,n=$t(t,r,e.loop);n!==a&&(e.value=n,e.dispatchEvent(new CustomEvent("tc-change",{detail:{index:n,previous:a},bubbles:!0,composed:!0})))}function yt(e){Z(e),!(e.autoplay<=0)&&(U(e)<=1||(e._carouselTimer=globalThis.setInterval(()=>{k(e,e.value+1)},e.autoplay)))}function Z(e){e._carouselTimer!==void 0&&(globalThis.clearInterval(e._carouselTimer),e._carouselTimer=void 0)}f(wt,u({props:{value:{type:"number",default:0,reflect:!0},autoplay:{type:"number",default:0},loop:{type:"boolean",default:!0},orientation:{type:"string",default:"horizontal"},transition:{type:"string",default:"slide"},indicators:{type:"boolean",default:!0},controls:{type:"boolean",default:!0},swipe:{type:"boolean",default:!0},pauseOnHover:{type:"boolean",default:!0},ariaLabel:{type:"string",default:"Carousel"},height:{type:"string",default:""}},theme:{"tc-carousel-radius":"var(--tc-radius-lg, 12px)","tc-carousel-bg":"var(--tc-color-bg, #faf8f3)","tc-carousel-control-bg":"rgba(255, 255, 255, 0.85)","tc-carousel-control-bg-hover":"rgba(255, 255, 255, 1)","tc-carousel-control-fg":"var(--tc-color-ink, #14171f)","tc-carousel-control-size":"36px","tc-carousel-indicator":"rgba(20, 23, 31, 0.25)","tc-carousel-indicator-active":"var(--tc-color-accent, #a16939)","tc-carousel-duration":"320ms"},styles:{display:"block",position:"relative"},template:({props:e})=>{let t=Number(e.value??0),r=String(e.orientation)==="vertical",a=String(e.transition)==="fade",n=String(e.height??""),o=!!e.controls,l=!!e.indicators,s=ht(e.ariaLabel??"Carousel");return`
        <div
          class="root ${r?"v":"h"} ${a?"fade":"slide"}"
          role="region"
          aria-roledescription="carousel"
          aria-label="${s}"
          style="${n?`--tc-carousel-height: ${ht(n)};`:""}--tc-carousel-index: ${t};"
        >
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;k(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;k(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let a=Number(r.dataset.index);if(!Number.isFinite(a))return;let n=t.host;k(n,a)},"keydown .root":(e,t)=>{let r=e,a=t.host,n=a.orientation==="vertical",o=U(a),l=n?"ArrowUp":"ArrowLeft",s=n?"ArrowDown":"ArrowRight";r.key===l?(r.preventDefault(),k(a,a.value-1)):r.key===s?(r.preventDefault(),k(a,a.value+1)):r.key==="Home"?(r.preventDefault(),k(a,0)):r.key==="End"&&(r.preventDefault(),k(a,o-1))}},afterMount(){let e=this,t=()=>xt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let a=e.shadowRoot,n=a?.querySelector("slot"),o=()=>t();n?.addEventListener("slotchange",o),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",o)};let l=()=>Z(e),s=()=>{e.pauseOnHover&&yt(e)};e.addEventListener("pointerenter",l),e.addEventListener("pointerleave",s),e.addEventListener("focusin",l),e.addEventListener("focusout",s),e._carouselHover=()=>{e.removeEventListener("pointerenter",l),e.removeEventListener("pointerleave",s),e.removeEventListener("focusin",l),e.removeEventListener("focusout",s)},Dr(e),a?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&yt(e)},afterRender(){xt(this)},unmount(){let e=this;Z(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function xt(e){let t=U(e),r=e.shadowRoot;if(!r)return;let a=r.querySelector(".root");if(a&&t>0){let s=$t(e.value,t,e.loop);s!==e.value&&(e.value=s),a.style.setProperty("--tc-carousel-index",String(s))}let n=r.querySelector(".indicators");if(n){let s=e.value,i="";for(let c=0;c<t;c++)i+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===s?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=i}if(Array.from(e.children).filter(s=>s instanceof HTMLElement&&!s.hasAttribute("slot")).forEach((s,i)=>{s.setAttribute("role","group"),s.setAttribute("aria-roledescription","slide"),s.setAttribute("aria-label",`${i+1} of ${t}`),e.transition==="fade"?s.classList.toggle("is-active",i===e.value):s.classList.remove("is-active")}),!e.loop){let s=r.querySelector(".ctrl.prev"),i=r.querySelector(".ctrl.next");s&&(s.disabled=e.value<=0),i&&(i.disabled=e.value>=t-1)}let l=r.querySelector(".sr-status");l&&t>0&&(l.textContent=`Slide ${e.value+1} of ${t}`)}function Dr(e){let t=0,r=0,a=!1,n=40,o=i=>{e.swipe&&(i.button!==0&&i.pointerType==="mouse"||(t=i.clientX,r=i.clientY,a=!0))},l=i=>{if(!a)return;a=!1;let c=i.clientX-t,d=i.clientY-r,g=e.orientation==="vertical"?d:c;Math.abs(g)<n||k(e,e.value+(g<0?1:-1))},s=()=>{a=!1};e.addEventListener("pointerdown",o),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",s),e._carouselDrag=()=>{e.removeEventListener("pointerdown",o),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",s)}}var Et="tc-accordion",Tt=Et;f(Et,u({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this,t=o=>{let l=o.target;if(!(!l||l.tagName!=="DETAILS")){if(e.mode==="single"&&l.open)for(let s of K(e))s!==l&&s.open&&(s.open=!1);qr(e)}},r=o=>{let l=o.target;if(!l||l.tagName!=="SUMMARY")return;let s=K(e).map(d=>d.querySelector("summary")).filter(d=>!!d),i=s.indexOf(l);if(i===-1)return;let c=-1;o.key==="ArrowDown"?c=(i+1)%s.length:o.key==="ArrowUp"?c=(i-1+s.length)%s.length:o.key==="Home"?c=0:o.key==="End"&&(c=s.length-1),c!==-1&&(o.preventDefault(),s[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let a=()=>{for(let o of K(e)){let l=o.querySelector(":scope > summary");if(l&&!l.querySelector(".tc-accordion-caret")){let s=document.createElement("span");s.className="tc-accordion-caret",s.setAttribute("aria-hidden","true"),s.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",s.textContent="\u25B8",l.appendChild(s);let i=()=>{s.style.transform=o.open?"rotate(90deg)":"rotate(0)"};i(),o.addEventListener("toggle",i)}}};a();let n=new MutationObserver(a);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));function K(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function qr(e){let t=[];for(let r of K(e))if(r.open){let a=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(a)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var Mt="tc-tooltip",Lt=Mt;function Or(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(Mt,u({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${Or(e.text)}</span>`:""}
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){Ht(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},a=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&At(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",a,!0),globalThis.addEventListener("resize",a),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",a,!0),globalThis.removeEventListener("resize",a)},Ht(e)},unmount(){this._popoverCleanup?.()}}));function Ht(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let a=e.open,n=typeof r.showPopover=="function";if(a&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";At(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!a&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function At(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,o=globalThis.innerHeight,l=e.offset,s=e.placement||"bottom",i=p=>p==="top"?r.top-a.height-l>=4:p==="bottom"?r.bottom+a.height+l<=o-4:p==="left"?r.left-a.width-l>=4:p==="right"?r.right+a.width+l<=n-4:!0;if(!i(s)){let p={top:"bottom",bottom:"top",left:"right",right:"left"};i(p[s]??"bottom")&&(s=p[s])}let c=0,d=0;s==="top"?(c=r.top-a.height-l,d=r.left+r.width/2-a.width/2):s==="bottom"?(c=r.bottom+l,d=r.left+r.width/2-a.width/2):s==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-l):s==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+l),c=Math.max(4,Math.min(o-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var Rt="tc-drawer",It=Rt,A=new WeakMap;function ee(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(Rt,u({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=ee(e.size??"min(420px, 92vw)");return`
        <dialog
          class="dlg side-${ee(t)}"
        ...
        >
          ${e.title||e.dismissible?`<header class="head">
                ${e.title?`<h2 id="title" class="title">${ee(e.title)}</h2>`:"<span></span>"}
                ${e.dismissible?'<button class="x" type="button" aria-label="Close">\xD7</button>':""}
              </header>`:""}
          <div class="body"><slot></slot></div>
          <footer class="foot"><slot name="footer"></slot></footer>
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{Nt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&Nt(r,"backdrop")}},afterRender(){jr(this)},unmount(){let e=A.get(this);e&&(e.cleanup(),A.delete(this))}}));function jr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=A.get(e);if(n&&n.dialog!==r&&(n.cleanup(),A.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!A.has(e)){let o=()=>{let l=e;l.open&&(l.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),A.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function Nt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var Dt="tc-progress",qt=Dt;function N(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Fr(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}f(Dt,u({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),a=!!e.indeterminate,n=Number(e.value??0),o=Number(e.max??100),l=Fr(n,o),s=e.label||(a?"Loading\u2026":`${Math.round(l)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,p=r==="sm"?3:r==="lg"?6:4,g=(d-p)/2,m=2*Math.PI*g,b=a?m*.25:l/100*m,h=a?`role="progressbar" aria-valuetext="${N(s)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${o}"`;return`
          <div class="circ size-${N(r)} ${a?"indet":""}" ${h}>
            <svg viewBox="0 0 ${d} ${d}" width="${d}" height="${d}" aria-hidden="true">
              <circle class="track" cx="${d/2}" cy="${d/2}" r="${g}" stroke-width="${p}" fill="none" />
              <circle
                class="fill"
                cx="${d/2}" cy="${d/2}" r="${g}"
            ...
            ${e.showLabel?`<span class="label" aria-hidden="true">${N(s)}</span>`:""}
          </div>
          <style>
        ...
        `}let i=r==="sm"?4:r==="lg"?12:8,c=a?`role="progressbar" aria-valuetext="${N(s)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${o}"`;return`
        <div class="bar size-${N(r)} ${a?"indet":""}" ${c}>
          <div class="track">
      ...
      `}}));var jt="tc-stepper",Ft=jt;function Ot(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(jt,u({props:{steps:{type:"json",default:[]},active:{type:"number",default:0,reflect:!0},orientation:{type:"string",default:"horizontal"},clickable:{type:"boolean",default:!1}},theme:{"tc-stepper-bg":"transparent","tc-stepper-ink":"var(--tc-color-ink, #14171f)","tc-stepper-soft":"var(--tc-color-ink-soft, #4a5061)","tc-stepper-rule":"var(--tc-color-rule, #ece5d3)","tc-stepper-accent":"var(--tc-color-accent, #a16939)","tc-stepper-done":"var(--tc-color-success, #2f7a52)","tc-stepper-radius":"999px","tc-stepper-marker-size":"28px","tc-stepper-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.steps??[],r=Number(e.active??0),a=String(e.orientation)==="vertical",n=!!e.clickable,o=t.map((l,s)=>{let i=s<r?"done":s===r?"current":"upcoming",c=i==="done"?'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>':`${s+1}`;return`
          <li class="step state-${i}" data-index="${s}">
            <${n?"button":"div"} class="row" ${n?`type="button" aria-current="${i==="current"?"step":"false"}"`:`aria-current="${i==="current"?"step":"false"}"`}>
              ...
              <span class="text">
                <span class="title">${Ot(l.title)}</span>
                ${l.description?`<span class="desc">${Ot(l.description)}</span>`:""}
              </span>
            </${n?"button":"div"}>
    ...
    `,afterMount(){let e=this,t=()=>Gt(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){Gt(this)},unmount(){this._agroupCleanup?.()}}));function Gt(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),a=Array.from(e.children).filter(i=>i instanceof HTMLElement),n=0;for(let i of a)i.tagName.toLowerCase()==="tc-avatar"&&(i.getAttribute("size")||i.setAttribute("size",r),n<t||t===0?(i.hidden=!1,n++):i.hidden=!0);let o=a.filter(i=>i.tagName.toLowerCase()==="tc-avatar").length,l=Math.max(0,o-n),s=e.shadowRoot?.querySelector(".overflow");s&&(l>0?(s.hidden=!1,s.textContent=`+${l}`):s.hidden=!0)}var Xt="tc-rating",Wt=Xt;function Kt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Yt="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";f(Xt,u({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),a=Number(e.value??0),n=Number(t.hover??-1),o=n>=0?n:a,l=String(e.size??"md"),s=!!e.readonly,i=!!e.allowHalf,c=Kt(e.ariaLabel??"Rating"),d=l==="sm"?18:l==="lg"?32:24,p=[];for(let g=1;g<=r;g++){let m=o-(g-1),b=m>=1?100:m>=.5&&i?50:m>0&&!i?100:0,h=b===50;p.push(`
          <span class="star ${h?"half":b===100?"full":"empty"}" data-index="${g}">
            <svg viewBox="0 0 24 24" width="${d}" height="${d}" aria-hidden="true">
              <path class="track" d="${Yt}" fill="var(--tc-rating-track)" />
              ${b>0?`<path class="fill" d="${Yt}" fill="var(--tc-rating-fill)" clip-path="${h?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
        ...
        `)}return`
        <div
          class="root size-${Kt(l)} ${s?"readonly":""}"
          role="${s?"img":"slider"}"
          tabindex="${s?"-1":"0"}"
          aria-label="${c}"
          aria-valuenow="${a}"
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);a.value!==n&&(a.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:a.value})}}}));var Wn={button:de,input:pe,textarea:ge,select:be,checkbox:he,switch:we,file:$e,radioGroup:Te,slider:Qt,rating:Wt,table:Le,tabs:ze,modal:Re,drawer:It,toast:qe,stat:Fe,card:Pe,badge:Ue,skeleton:Xe,carousel:kt,accordion:Tt,tooltip:Lt,popover:Ct,progress:qt,stepper:Ft,avatar:Pt,avatarGroup:Ut,stack:Je,cluster:Ze,grid:rt,code:ot,callout:ct,toc:ut,pagination:ft,combobox:vt};export{Wn as tags};
