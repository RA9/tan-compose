var Dr=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],qr=new Set(["string","number","boolean","json"]);function p(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Dr){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,a]of Object.entries(t)){if(a===null||typeof a!="object"||Array.isArray(a))throw new TypeError(`describe(): props.${r} must be a record`);if(!qr.has(a.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Ne=new Map,Fr=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,jr=/^(\S+)(?:\s+(.+))?$/;function f(e,t){if(typeof e!="string"||!Fr.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Ne.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),a=t.props??{},n=t.refs??{},s=Pr(t);class o extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let l=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),Br(l,s),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",l.appendChild(this.container),t.attributes&&Fe(this,t.attributes),this.ctx=_r(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[l,c]of Object.entries(a)){let d=this.getAttribute(l),u=d!==null?Re(d,c.type):c.default;this.propValues.set(l,u),this.maybeSyncFormValue(l,u),Object.defineProperty(this,l,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(l),set:g=>{let m=Ur(g,c.type),b=this.propValues.get(l);Object.is(b,m)||(this.propValues.set(l,m),c.reflect&&Yr(this,l,m,c.type),this.maybeSyncFormValue(l,m),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(l,c){if(!this.internals||l!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(l){console.error(`[tan-compose] beforeMount threw for <${e}>:`,l)}if(this.renderInternal(),t.action){let l=t.action;this.addEventListener("click",l),this.mountCleanups.push(()=>this.removeEventListener("click",l))}if(t.emit)for(let l of t.emit)this.addEventListener(l.name,l.handler),this.mountCleanups.push(()=>this.removeEventListener(l.name,l.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(l){console.error(`[tan-compose] afterMount threw for <${e}>:`,l)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(l){console.error(`[tan-compose] unmount threw for <${e}>:`,l)}K(this.mountCleanups),K(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){qe(t,l=>{let c=this.listSlots.get(l);if(c){for(let d of c.cache.values())K(d.cleanups);c.cache.clear()}})}attributeChangedCallback(l,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(a,l)){let u=a[l],g=d!==null?Re(d,u.type):u.default,m=this.propValues.get(l);Object.is(m,g)||(this.propValues.set(l,g),this.isMounted&&this.scheduleRender());return}this.state.set(l,d),this.isMounted&&this.scheduleRender()}}setState(l,c){let d=this.state.get(l);Object.is(d,c)||(this.state.set(l,c),this.isMounted&&this.scheduleRender())}getState(l){return this.state.get(l)}render(){this.renderInternal()}emitEvent(l,c){this.dispatchEvent(new CustomEvent(l,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(l){let c=this.listSlots.get(l);return c||(c={cache:new Map},this.listSlots.set(l,c)),c}renderInternal(){this.rendering=!0;let l=this.captureFocusInShadow();try{K(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let u=Ie(d,c,g=>this.getOrCreateSlot(g));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(l&&this.restoreFocusInShadow(l),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let l=this.shadowRoot;if(!l)return null;let c=l.activeElement;if(!c)return null;let d=[],u=c;for(;u&&u!==l;){let b=u.parentNode;if(!b)break;let v=u.tagName,S=Array.from(b.children).filter(w=>w.tagName===v).indexOf(u);if(d.unshift({tag:v,idx:S}),u=b instanceof Element?b:null,!u&&b===l)break}let g=null,m=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{g=c.selectionStart,m=c.selectionEnd}catch{}return{path:d,selectionStart:g,selectionEnd:m}}restoreFocusInShadow(l){let c=this.shadowRoot;if(!c)return;let d=c;for(let g of l.path){let m=Array.from(d.children??[]),E=(m.length>0?m:Array.from(d.children??[])).filter(S=>S.tagName===g.tag)[g.idx];if(!E)return;d=E}let u=d;if(!(!u||typeof u.focus!="function")&&c.activeElement!==u&&(u.focus(),l.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(l.selectionStart,l.selectionEnd??l.selectionStart)}catch{}}refreshRefs(){let l={},c=this.shadowRoot;for(let[d,u]of Object.entries(n))l[d]=c?c.querySelector(u):null;this.currentRefs=l}formAssociatedCallback(l){try{t.formAssociatedCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(l){try{t.formDisabledCallback?.call(this,l)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(l){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,l)}}formStateRestoreCallback(l,c){try{t.formStateRestoreCallback?.call(this,l,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(l){let c=new Map;for(let[d,u]of Object.entries(l)){let g=jr.exec(d.trim());if(!g)continue;let[,m,b]=g;c.has(m)||c.set(m,[]),c.get(m).push({selector:b??null,handler:u})}for(let[d,u]of c){let g=m=>{for(let{selector:b,handler:v}of u){if(!b){v(m,this.ctx);continue}let E=m.composedPath();for(let S of E){if(S===this.shadowRoot||S===this)break;if(S instanceof Element&&this.shadowRoot?.contains(S)&&S.matches(b)){v(m,this.ctx);break}}}};this.shadowRoot.addEventListener(d,g),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,g))}}}return Ne.set(e,o),customElements.define(e,o),e}function Ie(e,t,r){return e.if&&!e.if(t.ctx)?null:De(e,t,r)}function De(e,t,r){let a=document.createElement(e.tag||"div");if(e.styles&&(a.style.cssText=Object.entries(e.styles).map(([n,s])=>`${n}: ${s}`).join("; ")),e.className&&(a.className=e.className),e.attributes&&Fe(a,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(a.innerHTML=n)}if(e.children)for(let n of e.children){let s=Ie(n,t,r);s&&a.appendChild(s)}if(e.for&&Or(a,e,t,r),e.action){let n=e.action;a.addEventListener("click",n),t.cleanups.push(()=>a.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)a.addEventListener(n.name,n.handler),t.cleanups.push(()=>a.removeEventListener(n.name,n.handler));return a}function Or(e,t,r,a){let n=t.for,s=a(t),o=n.items(r.ctx),i=new Map;for(let l=0;l<o.length;l++){let c=o[l],d=n.key(c,l),u,g=s.cache.get(d);if(g&&Object.is(g.lastItem,c))u=g;else{let m=[],b=n.render(c,l,r.ctx),v=De(b,{...r,cleanups:m},a);g&&K(g.cleanups),u={element:v,lastItem:c,cleanups:m}}i.set(d,u),e.appendChild(u.element)}for(let[l,c]of s.cache)i.has(l)||K(c.cleanups);s.cache=i}function qe(e,t){if(e.for&&t(e),e.children)for(let r of e.children)qe(r,t)}function _r(e,t,r,a){return{host:e,get props(){let n={};for(let[s,o]of t)n[s]=o;return n},get state(){let n={};for(let[s,o]of r)n[s]=o;return n},get refs(){return a()},setState:(n,s)=>e.setState(n,s),getState:n=>e.getState(n),emit:(n,s)=>e.emitEvent(n,s)}}function Pr(e){let t=e.theme?Vr(e.theme):void 0,r=e.styles?Gr(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let s=new CSSStyleSheet;s.replaceSync(t),n.push(s)}if(r){let s=new CSSStyleSheet;s.replaceSync(r),n.push(s)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function Br(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function Fe(e,t){for(let[r,a]of Object.entries(t))e.setAttribute(r,a)}function Vr(e){return`:host { ${Object.entries(e).map(([r,a])=>`--${r}: ${a};`).join(" ")} }`}function Gr(e){return`.container { ${Object.entries(e).map(([r,a])=>`${r}: ${a};`).join(" ")} }`}function K(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function Re(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function Ur(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function Yr(e,t,r,a){if(a!=="json"){if(a==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var Oe="tc-button",_e=Oe,je=`
      <style>
        .root {
...
`,Se=new WeakMap;f(nt,p({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[p({tag:"style",template:Kr}),p({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),p({tag:"div",className:"wrap",children:[p({tag:"table",children:[p({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let s=a.sortKey===n.key,o=n.sortable!==!1,i=s?a.sortDir==="asc"?"\u25B2":"\u25BC":"",l=s?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${be(n.key)}"
                        class="${o?"sortable":""}"
                        aria-sort="${l}"
                      >${be(n.label)}<span class="sort">${i}</span></th>`}).join("")}</tr>`}}),p({tag:"tbody",children:[p({tag:"tr",className:"empty",if:({props:e,state:t})=>at(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${be(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>at(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],s=e;return p({tag:"tr",attributes:{"data-row-id":String(s.id??t)},template:n.map(o=>`<td>${typeof o.render=="function"?o.render(s):be(s[o.key]??"")}</td>`).join("")})}}})]})]}),p({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=he(e,r),n=e.pageSize??10,s=Math.max(1,Math.ceil(a.length/n)),o=Math.min(r.page??0,s-1),i=(e.rows??[]).length;return`
        ...
        <div role="tablist" class="strip">
          ${t.map(a=>`<button
              ...
              aria-controls="panel-${ie(a.id)}"
              tabindex="${a.id===r?"0":"-1"}"
            >${ie(a.label)}</button>`).join("")}
        </div>
        <div class="panels">
          ${t.map(a=>`<section
              role="tabpanel"
              ...
              aria-labelledby=""
              ${a.id===r?"":"hidden"}
            ><slot name="${ie(a.id)}"></slot></section>`).join("")}
        </div>
        <style>
          .strip {
    ...
    `,refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{lt(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&lt(r,"backdrop")}},afterRender(){Wr(this)},unmount(){let e=Z.get(this);e&&(e.cleanup(),Z.delete(this))}}));function Wr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=Z.get(e);if(n&&n.dialog!==r&&(n.cleanup(),Z.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!Z.has(e)){let s=()=>{let o=e;o.open&&(o.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",s),Z.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",s)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function lt(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}function ct(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var ft="tc-toast",gt=ft,le=new WeakMap;f(ft,p({props:{open:{type:"boolean",default:!1,reflect:!0},variant:{type:"string",default:"info"},message:{type:"string",default:""},duration:{type:"number",default:4e3},dismissible:{type:"boolean",default:!0}},theme:{"tc-toast-info":"var(--tc-color-info, #3a5b8c)","tc-toast-success":"var(--tc-color-success, #207a5b)","tc-toast-warning":"var(--tc-color-warning, #a87326)","tc-toast-error":"var(--tc-color-danger, #b3261e)","tc-toast-fg":"var(--tc-color-surface, #ffffff)","tc-toast-radius":"var(--tc-radius-lg, 10px)","tc-toast-shadow":"var(--tc-shadow-lg, 0 12px 30px rgba(20, 23, 31, 0.18))","tc-toast-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.variant??"info"),r=t==="success"?"\u2713":t==="warning"?"!":t==="error"?"\u2715":"i";return`
    ...
    `}));function Et(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mt="tc-stack",Lt=Mt;f(Mt,p({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${Jr(e.gap)}; --tc-stack-align: ${Zr(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function Jr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Qr(t)})`:t}function Qr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Zr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ht="tc-cluster",zt=Ht;f(Ht,p({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${ta(e.gap)};
        --tc-cluster-justify: ${ea(e.justify)};
        --tc-cluster-align: ${aa(e.align)};
    ...
    `}));function ea(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function ta(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${ra(t)})`:t}function ra(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function aa(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var At="tc-grid",Nt=At;f(At,p({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${Ct(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${Ct(e.min)}, 1fr))`};
          --tc-grid-gap: ${na(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `},afterMount(){la(this)},unmount(){ve.get(this)?.observer?.disconnect(),ve.delete(this)}}));function la(e){ve.get(e)?.observer?.disconnect();let r=e,a=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),s=document.querySelector(a);if(!s)return;let o=Array.from(s.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),i=o.map(c=>(c.id||(c.id=ca(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",i),typeof IntersectionObserver>"u")return;let l=new IntersectionObserver(c=>{let u=c.filter(m=>m.isIntersecting).sort((m,b)=>m.boundingClientRect.top-b.boundingClientRect.top)[0];if(!u)return;let g=u.target.id;g&&e.setState("activeId",g)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of o)l.observe(c);ve.set(e,{observer:l,activeId:""})}function ca(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Te(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Bt="tc-pagination",Vt=Bt;f(Bt,p({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=da(Number(e.current)|0,1,t),a=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let s=ua(r,t,a,n),o=ye(String(e.size??"sm")),i=r<=1?" disabled":"",l=r>=t?" disabled":"",c=s.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${o}"
            variant="${u?"primary":"ghost"}"
            data-page="${d}"${u?' aria-current="page"':""}
          >${d}</tc-button>`}).join("");return`
        <nav aria-label="${ye(String(e.label??"Pagination"))}">
          <tc-button
            class="prev"
            size="${o}"
            variant="ghost"
            data-page="${r-1}"${i}
          >\u2190 ${ye(String(e["prev-label"]??"Prev"))}</tc-button>
          ...
          <tc-button
            ...
            variant="ghost"
            data-page="${r+1}"${l}
          >${ye(String(e["next-label"]??"Next"))} \u2192</tc-button>
        </nav>
        <style>
          :host { display: block; }
          nav {
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let a=r.getAttribute("data-page");if(a==null)return;let n=Number(a),s=t.host,o=Math.max(1,Number(s.total)|0),i=Number(s.current)|0;!Number.isFinite(n)||n<1||n>o||n!==i&&t.emit("tc-page-change",{page:n})}}}));function da(e,t,r){return Math.min(r,Math.max(t,e))}function ua(e,t,r,a){let n=new Set;for(let i=1;i<=Math.min(a,t);i++)n.add(i);for(let i=Math.max(1,t-a+1);i<=t;i++)n.add(i);for(let i=Math.max(1,e-r);i<=Math.min(t,e+r);i++)n.add(i);let s=[...n].sort((i,l)=>i-l),o=[];for(let i=0;i<s.length;i++)i>0&&s[i]-s[i-1]>1&&o.push("\u2026"),o.push(s[i]);return o}function ye(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Yt="tc-combobox",Kt=Yt;function ce(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function de(e){return e.join(",")}function pa(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var fa=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;f(Yt,p({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],a=!!e.multiple,n=e.searchable!==!1,s=!!e.disabled,o=!!e.error,i=ce(e.value),l=String(t.query??""),c=!!t.open&&!s,d=Number(t.focusedIndex??-1),u=Gt(r,l),g=new Set(i),m=i.map(y=>r.find(j=>j.value===y)).filter(y=>!!y),b=n&&(c||a&&i.length===0),v=!a&&i.length===1&&(!c||!n),E=i.length===0&&!b&&!v,S=a?m.map(y=>`<span class="chip" data-value="${H(y.value)}">
          ...
          </span>`:"",M=E?`<span class="placeholder">${H(e.placeholder??"")}</span>`:"",A=b?`<input
            type="text"
            class="search"
            part="search"
            value="${H(l)}"
            ...
            role="combobox"
          />`:"",R=u.length===0?`<div class="empty">${H(e["empty-text"]??"No results")}</div>`:u.map((y,j)=>{let z=g.has(y.value);return`<div
            ...
            </div>`}).join(""),q=e.label?`<label class="label">${H(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",ae=o?`<div class="helper error">${H(e.error)}</div>`:e.helper?`<div class="helper">${H(e.helper)}</div>`:"";return`
        ${q}
        <div
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;_(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;_(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let a=Number(r.dataset.index);if(!Number.isFinite(a))return;let n=t.host;_(n,a)},"keydown .root":(e,t)=>{let r=e,a=t.host,n=a.orientation==="vertical",s=we(a),o=n?"ArrowUp":"ArrowLeft",i=n?"ArrowDown":"ArrowRight";r.key===o?(r.preventDefault(),_(a,a.value-1)):r.key===i?(r.preventDefault(),_(a,a.value+1)):r.key==="Home"?(r.preventDefault(),_(a,0)):r.key==="End"&&(r.preventDefault(),_(a,s-1))}},afterMount(){let e=this,t=()=>Jt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let a=e.shadowRoot,n=a?.querySelector("slot"),s=()=>t();n?.addEventListener("slotchange",s),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",s)};let o=()=>Me(e),i=()=>{e.pauseOnHover&&Xt(e)};e.addEventListener("pointerenter",o),e.addEventListener("pointerleave",i),e.addEventListener("focusin",o),e.addEventListener("focusout",i),e._carouselHover=()=>{e.removeEventListener("pointerenter",o),e.removeEventListener("pointerleave",i),e.removeEventListener("focusin",o),e.removeEventListener("focusout",i)},ga(e),a?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&Xt(e)},afterRender(){Jt(this)},unmount(){let e=this;Me(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function Jt(e){let t=we(e),r=e.shadowRoot;if(!r)return;let a=r.querySelector(".root");if(a&&t>0){let i=er(e.value,t,e.loop);i!==e.value&&(e.value=i),a.style.setProperty("--tc-carousel-index",String(i))}let n=r.querySelector(".indicators");if(n){let i=e.value,l="";for(let c=0;c<t;c++)l+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===i?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=l}if(Array.from(e.children).filter(i=>i instanceof HTMLElement&&!i.hasAttribute("slot")).forEach((i,l)=>{i.setAttribute("role","group"),i.setAttribute("aria-roledescription","slide"),i.setAttribute("aria-label",`${l+1} of ${t}`),e.transition==="fade"?i.classList.toggle("is-active",l===e.value):i.classList.remove("is-active")}),!e.loop){let i=r.querySelector(".ctrl.prev"),l=r.querySelector(".ctrl.next");i&&(i.disabled=e.value<=0),l&&(l.disabled=e.value>=t-1)}let o=r.querySelector(".sr-status");o&&t>0&&(o.textContent=`Slide ${e.value+1} of ${t}`)}function ga(e){let t=0,r=0,a=!1,n=40,s=l=>{e.swipe&&(l.button!==0&&l.pointerType==="mouse"||(t=l.clientX,r=l.clientY,a=!0))},o=l=>{if(!a)return;a=!1;let c=l.clientX-t,d=l.clientY-r,g=e.orientation==="vertical"?d:c;Math.abs(g)<n||_(e,e.value+(g<0?1:-1))},i=()=>{a=!1};e.addEventListener("pointerdown",s),e.addEventListener("pointerup",o),e.addEventListener("pointercancel",i),e._carouselDrag=()=>{e.removeEventListener("pointerdown",s),e.removeEventListener("pointerup",o),e.removeEventListener("pointercancel",i)}}var tr="tc-accordion",rr=tr;f(tr,p({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this,t=s=>{let o=s.target;if(!(!o||o.tagName!=="DETAILS")){if(e.mode==="single"&&o.open)for(let i of ke(e))i!==o&&i.open&&(i.open=!1);ma(e)}},r=s=>{let o=s.target;if(!o||o.tagName!=="SUMMARY")return;let i=ke(e).map(d=>d.querySelector("summary")).filter(d=>!!d),l=i.indexOf(o);if(l===-1)return;let c=-1;s.key==="ArrowDown"?c=(l+1)%i.length:s.key==="ArrowUp"?c=(l-1+i.length)%i.length:s.key==="Home"?c=0:s.key==="End"&&(c=i.length-1),c!==-1&&(s.preventDefault(),i[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let a=()=>{for(let s of ke(e)){let o=s.querySelector(":scope > summary");if(o&&!o.querySelector(".tc-accordion-caret")){let i=document.createElement("span");i.className="tc-accordion-caret",i.setAttribute("aria-hidden","true"),i.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",i.textContent="\u25B8",o.appendChild(i);let l=()=>{i.style.transform=s.open?"rotate(90deg)":"rotate(0)"};l(),s.addEventListener("toggle",l)}}};a();let n=new MutationObserver(a);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));function ke(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function ma(e){let t=[];for(let r of ke(e))if(r.open){let a=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(a)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var nr="tc-tooltip",or=nr;function ba(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(nr,p({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${ba(e.text)}</span>`:""}
    ...
    `,afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".tip");if(!r)return;let a=()=>{e.disabled||(clearTimeout(e._tooltipTimer),e._tooltipTimer=globalThis.setTimeout(()=>{if(typeof r.showPopover=="function")try{r.showPopover()}catch{r.style.visibility="visible",r.style.opacity="1"}else r.style.visibility="visible",r.style.opacity="1";ar(e,r)},Math.max(0,e.delay)))},n=()=>{clearTimeout(e._tooltipTimer);try{typeof r.hidePopover=="function"&&r.hidePopover()}catch{}r.style.opacity="",r.style.visibility=""},s=i=>{i.key==="Escape"&&n()};e.addEventListener("pointerenter",a),e.addEventListener("pointerleave",n),e.addEventListener("focusin",a),e.addEventListener("focusout",n),e.addEventListener("keydown",s);let o=()=>{r.matches(":popover-open")&&ar(e,r)};globalThis.addEventListener("scroll",o,!0),globalThis.addEventListener("resize",o),e._tooltipCleanup=()=>{clearTimeout(e._tooltipTimer),e.removeEventListener("pointerenter",a),e.removeEventListener("pointerleave",n),e.removeEventListener("focusin",a),e.removeEventListener("focusout",n),e.removeEventListener("keydown",s),globalThis.removeEventListener("scroll",o,!0),globalThis.removeEventListener("resize",o),n()}},unmount(){this._tooltipCleanup?.()}}));function ar(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,s=globalThis.innerHeight,o=e.offset,i=e.placement||"top",l=u=>u==="top"?r.top-a.height-o>=4:u==="bottom"?r.bottom+a.height+o<=s-4:u==="left"?r.left-a.width-o>=4:u==="right"?r.right+a.width+o<=n-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"top")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-a.height-o,d=r.left+r.width/2-a.width/2):i==="bottom"?(c=r.bottom+o,d=r.left+r.width/2-a.width/2):i==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-o):i==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+o),c=Math.max(4,Math.min(s-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`,t.dataset.placement=i}var ir="tc-popover",lr=ir;f(ir,p({props:{open:{type:"boolean",default:!1,reflect:!0},placement:{type:"string",default:"bottom"},offset:{type:"number",default:8},dismissible:{type:"boolean",default:!0}},theme:{"tc-popover-bg":"var(--tc-color-surface, #ffffff)","tc-popover-fg":"var(--tc-color-ink, #14171f)","tc-popover-rule":"var(--tc-color-rule, #ece5d3)","tc-popover-radius":"var(--tc-radius-md, 8px)","tc-popover-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.18))","tc-popover-padding":"12px 14px","tc-popover-min-width":"200px","tc-popover-max-width":"340px","tc-popover-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative"},template:()=>`
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){sr(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},a=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&cr(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",a,!0),globalThis.addEventListener("resize",a),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",a,!0),globalThis.removeEventListener("resize",a)},sr(e)},unmount(){this._popoverCleanup?.()}}));function sr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let a=e.open,n=typeof r.showPopover=="function";if(a&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";cr(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!a&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function cr(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,s=globalThis.innerHeight,o=e.offset,i=e.placement||"bottom",l=u=>u==="top"?r.top-a.height-o>=4:u==="bottom"?r.bottom+a.height+o<=s-4:u==="left"?r.left-a.width-o>=4:u==="right"?r.right+a.width+o<=n-4:!0;if(!l(i)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};l(u[i]??"bottom")&&(i=u[i])}let c=0,d=0;i==="top"?(c=r.top-a.height-o,d=r.left+r.width/2-a.width/2):i==="bottom"?(c=r.bottom+o,d=r.left+r.width/2-a.width/2):i==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-o):i==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+o),c=Math.max(4,Math.min(s-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var ur="tc-drawer",pr=ur,te=new WeakMap;function Le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(ur,p({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Le(e.size??"min(420px, 92vw)");return`
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{dr(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&dr(r,"backdrop")}},afterRender(){ha(this)},unmount(){let e=te.get(this);e&&(e.cleanup(),te.delete(this))}}));function ha(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=te.get(e);if(n&&n.dialog!==r&&(n.cleanup(),te.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!te.has(e)){let s=()=>{let o=e;o.open&&(o.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",s),te.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",s)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function dr(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var fr="tc-progress",gr=fr;function re(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function va(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}f(fr,p({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),a=!!e.indeterminate,n=Number(e.value??0),s=Number(e.max??100),o=va(n,s),i=e.label||(a?"Loading\u2026":`${Math.round(o)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,g=(d-u)/2,m=2*Math.PI*g,b=a?m*.25:o/100*m,v=a?`role="progressbar" aria-valuetext="${re(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${s}"`;return`
          <div class="circ size-${re(r)} ${a?"indet":""}" ${v}>
        ...
        `}let l=r==="sm"?4:r==="lg"?12:8,c=a?`role="progressbar" aria-valuetext="${re(i)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${s}"`;return`
      ...
      `}}));var br="tc-stepper",hr=br;function mr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(br,p({props:{steps:{type:"json",default:[]},active:{type:"number",default:0,reflect:!0},orientation:{type:"string",default:"horizontal"},clickable:{type:"boolean",default:!1}},theme:{"tc-stepper-bg":"transparent","tc-stepper-ink":"var(--tc-color-ink, #14171f)","tc-stepper-soft":"var(--tc-color-ink-soft, #4a5061)","tc-stepper-rule":"var(--tc-color-rule, #ece5d3)","tc-stepper-accent":"var(--tc-color-accent, #a16939)","tc-stepper-done":"var(--tc-color-success, #2f7a52)","tc-stepper-radius":"999px","tc-stepper-marker-size":"28px","tc-stepper-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=e.steps??[],r=Number(e.active??0),a=String(e.orientation)==="vertical",n=!!e.clickable,s=t.map((o,i)=>{let l=i<r?"done":i===r?"current":"upcoming",c=l==="done"?'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>':`${i+1}`;return`
          <li class="step state-${l}" data-index="${i}">
            <${n?"button":"div"} class="row" ${n?`type="button" aria-current="${l==="current"?"step":"false"}"`:`aria-current="${l==="current"?"step":"false"}"`}>
              ...
              <span class="text">
                <span class="title">${mr(o.title)}</span>
                ${o.description?`<span class="desc">${mr(o.description)}</span>`:""}
              </span>
            </${n?"button":"div"}>
    ...
    `,afterMount(){let e=this,t=()=>wr(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){wr(this)},unmount(){this._agroupCleanup?.()}}));function wr(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),a=Array.from(e.children).filter(l=>l instanceof HTMLElement),n=0;for(let l of a)l.tagName.toLowerCase()==="tc-avatar"&&(l.getAttribute("size")||l.setAttribute("size",r),n<t||t===0?(l.hidden=!1,n++):l.hidden=!0);let s=a.filter(l=>l.tagName.toLowerCase()==="tc-avatar").length,o=Math.max(0,s-n),i=e.shadowRoot?.querySelector(".overflow");i&&(o>0?(i.hidden=!1,i.textContent=`+${o}`):i.hidden=!0)}var Tr="tc-rating",Mr=Tr;function Er(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Sr="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";f(Tr,p({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),a=Number(e.value??0),n=Number(t.hover??-1),s=n>=0?n:a,o=String(e.size??"md"),i=!!e.readonly,l=!!e.allowHalf,c=Er(e.ariaLabel??"Rating"),d=o==="sm"?18:o==="lg"?32:24,u=[];for(let g=1;g<=r;g++){let m=s-(g-1),b=m>=1?100:m>=.5&&l?50:m>0&&!l?100:0,v=b===50;u.push(`
        ...
        `)}return`
        <div
          class="root size-${Er(o)} ${i?"readonly":""}"
          role="${i?"img":"slider"}"
          tabindex="${i?"-1":"0"}"
          aria-label="${c}"
          aria-valuenow="${a}"
      ...
      `},events:{"click .star":(e,t)=>{let r=t.host;if(r.readonly)return;let a=e.target,n=a.closest(".hit-left, .hit-right"),s=a.closest(".star");if(!s)return;let o=Number(s.dataset.index);if(!Number.isFinite(o))return;let i=o;n?.dataset.half==="1"&&r.allowHalf&&(i=o-.5),i===r.value&&(i=0);let l=r.value;r.value=i,t.emit("tc-change",{value:i,previous:l})},"mouseover .star":(e,t)=>{let r=t.host;if(r.readonly)return;let a=e.target,n=a.closest(".hit-left, .hit-right"),s=a.closest(".star");if(!s)return;let o=Number(s.dataset.index);if(!Number.isFinite(o))return;let i=o;n?.dataset.half==="1"&&r.allowHalf&&(i=o-.5),t.setState("hover",i)},"mouseleave .root":(e,t)=>{t.setState("hover",-1)},"keydown .root":(e,t)=>{let r=e,a=t.host;if(a.readonly)return;let n=a.allowHalf?.5:1,s=a.value,o=s;if(r.key==="ArrowRight"||r.key==="ArrowUp")o=Math.min(a.max,s+n);else if(r.key==="ArrowLeft"||r.key==="ArrowDown")o=Math.max(0,s-n);else if(r.key==="Home")o=0;else if(r.key==="End")o=a.max;else return;r.preventDefault(),o!==s&&(a.value=o,t.emit("tc-change",{value:o,previous:s}))}}}));var Lr="tc-slider",Hr=Lr;function $e(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(Lr,p({props:{value:{type:"number",default:0,reflect:!0},min:{type:"number",default:0},max:{type:"number",default:100},step:{type:"number",default:1},disabled:{type:"boolean",default:!1,reflect:!0},showValue:{type:"boolean",default:!1},showTicks:{type:"boolean",default:!1},label:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-slider-track":"var(--tc-color-rule, #ece5d3)","tc-slider-fill":"var(--tc-color-accent, #a16939)","tc-slider-thumb":"var(--tc-color-surface, #ffffff)","tc-slider-thumb-ring":"var(--tc-color-accent, #a16939)","tc-slider-radius":"999px","tc-slider-thumb-size":"20px","tc-slider-track-size":"6px","tc-slider-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-slider-fg":"var(--tc-color-ink, #14171f)","tc-slider-fg-muted":"var(--tc-color-ink-muted, #6b7280)"},styles:{display:"block"},template:({props:e})=>{let t=Number(e.value??0),r=Number(e.min??0),a=Number(e.max??100),n=Number(e.step??1),s=!!e.disabled,o=a>r?(t-r)/(a-r)*100:0,i=String(e.label??""),l=String(e.suffix??""),c=!!e.showValue,d=!!e.showTicks,u="";if(d&&n>0){let g=Math.floor((a-r)/n)+1;if(g<=50){let m=[];for(let b=0;b<g;b++){let E=(r+b*n-r)/(a-r)*100;m.push(`<span class="tick" style="left:${E.toFixed(2)}%"></span>`)}u=m.join("")}}return`
        ${i||c?`<div class="head">
              ${i?`<label for="r" class="lbl">${$e(i)}</label>`:"<span></span>"}
              ${c?`<span class="val">${$e(String(t))}${$e(l)}</span>`:""}
            </div>`:""}
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);a.value!==n&&(a.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:a.value})}}}));var Nr="tc-chart",Rr=Nr;function zr(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),a=e/Math.pow(10,r),n;return t?a<1.5?n=1:a<3?n=2:a<7?n=5:n=10:a<=1?n=1:a<=2?n=2:a<=5?n=5:n=10,n*Math.pow(10,r)}function xa(e,t,r=5){if(e===t){let l=Math.abs(e)||1;return{min:e-l,max:t+l,ticks:[e-l,e,e+l]}}let a=zr(t-e,!1),n=zr(a/(r-1),!0),s=Math.floor(e/n)*n,o=Math.ceil(t/n)*n,i=[];for(let l=s;l<=o+n*.5;l+=n)i.push(Number(l.toFixed(10)));return{min:s,max:o,ticks:i}}function ze(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(a=>`${a.x} ${a.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let a=0;a<e.length-1;a++){let n=e[a-1]??e[a],s=e[a],o=e[a+1],i=e[a+2]??o,l=s.x+(o.x-n.x)/6,c=s.y+(o.y-n.y)/6,d=o.x-(i.x-s.x)/6,u=o.y-(i.y-s.y)/6;r+=` C ${l},${c} ${d},${u} ${o.x},${o.y}`}return r}function ue(e,t,r,a){return{x:e+r*Math.sin(a),y:t-r*Math.cos(a)}}function wa(e,t,r,a,n,s){let o=s-n>Math.PI?1:0,i=ue(e,t,r,n),l=ue(e,t,r,s);if(a<=0)return`M ${e} ${t} L ${i.x} ${i.y} A ${r} ${r} 0 ${o} 1 ${l.x} ${l.y} Z`;let c=ue(e,t,a,s),d=ue(e,t,a,n);return`M ${i.x} ${i.y} A ${r} ${r} 0 ${o} 1 ${l.x} ${l.y} L ${c.x} ${c.y} A ${a} ${a} 0 ${o} 0 ${d.x} ${d.y} Z`}function x(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function U(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function pe(e,t){return t[e%t.length]}function ka(e,t){let{data:r,smooth:a,stacked:n,showAxes:s,showGrid:o,showLabels:i,showValues:l}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",g=u?4:16,m=u?4:s&&i?28:8,b=u?4:s?44:8,v=u?4:12,E=e.W-b-v,S=e.H-g-m,w=1/0,M=-1/0;if(n&&d.length>0){let k=c.length>0?c.map((h,T)=>d.reduce((L,I)=>L+(I.values?.[T]??0),0)):[];for(let h of k)h<w&&(w=h),h>M&&(M=h);w>0&&(w=0)}else for(let k of d)for(let h of k.values??[])h<w&&(w=h),h>M&&(M=h);(!Number.isFinite(w)||!Number.isFinite(M))&&(w=0,M=1),w===M&&(w-=1,M+=1);let A=xa(e.yMin??w,e.yMax??M,5),R=e.yMin??A.min,q=e.yMax??A.max,ae=q-R||1,y=c.length||d[0]?.values?.length||0,j=k=>y===1?b+E/2:t==="bar"?b+(k+.5)*(E/y):b+k/(y-1)*E,z=k=>g+S-(k-R)/ae*S,Y=[];if(!u){if(o)for(let k of A.ticks){let h=z(k);Y.push(`<line class="grid" x1="${b}" x2="${e.W-v}" y1="${h}" y2="${h}"/>`)}if(s){for(let h of A.ticks){let T=z(h);Y.push(`<text class="axis-label y" x="${b-8}" y="${T}" text-anchor="end" dominant-baseline="middle">${x(U(h))}</text>`)}if(i&&c.length>0){let h=Math.max(1,Math.ceil(c.length/8));c.forEach((T,L)=>{L%h!==0&&L!==c.length-1||Y.push(`<text class="axis-label x" x="${j(L)}" y="${e.H-m+16}" text-anchor="middle">${x(T)}</text>`)})}let k=R<=0&&q>=0?z(0):z(R);Y.push(`<line class="axis" x1="${b}" x2="${e.W-v}" y1="${k}" y2="${k}"/>`)}}let F=[];if(t==="bar"){let k=E/y,h=k*.18,T=k-h*2;d.forEach((L,I)=>{let B=`series series-${I}`,C=pe(I,e.palette),N=0;L.values?.forEach(($,D)=>{if(!Number.isFinite($))return;let O=j(D),V,fe,ge,Ee;if(n){V=O-T/2,fe=T;let ne=z(N+$),oe=z(N);ge=Math.min(ne,oe),Ee=Math.abs(ne-oe),N+=$}else{let ne=T/d.length;V=O-T/2+I*ne,fe=ne*.86;let oe=z($),Ae=z(R<0&&q>0?0:R);ge=Math.min(oe,Ae),Ee=Math.abs(oe-Ae)}let Ce=`${x(L.name)}${c[D]?` \xB7 ${x(c[D])}`:""}: ${x(U($))}`,Ir=(D*.04).toFixed(3);F.push(`<g class="${B}"><rect class="hit" x="${V}" y="${ge}" width="${fe}" height="${Ee}" rx="2" fill="${C}" data-tip="${Ce}" data-color="${C}" style="animation-delay: ${Ir}s"><title>${Ce}</title></rect>`+(l?`<text class="value-label" x="${V+fe/2}" y="${ge-4}" text-anchor="middle">${x(U($))}</text>`:"")+"</g>")})})}else if(n&&t==="area"){let k=new Array(y).fill(0);d.forEach((h,T)=>{let L=pe(T,e.palette),I=[],B=[];for(let $=0;$<y;$++){let D=h.values?.[$]??0,O=k[$]+D;I.push({x:j($),y:z(O)}),B.push({x:j($),y:z(k[$])}),k[$]=O}let C=ze(I,a)+" L "+B.slice().reverse().map($=>`${$.x} ${$.y}`).join(" L ")+" Z",N=(T*.15).toFixed(3);F.push(`<path class="series-fill series-${T}" d="${C}" fill="${L}" fill-opacity="0.25" pointer-events="none" style="animation-delay: ${N}s"/>`),F.push(`<path class="series-line series-${T}" d="${ze(I,a)}" stroke="${L}" fill="none" pointer-events="none" style="animation-delay: ${N}s"/>`),I.forEach(($,D)=>{let O=h.values?.[D]??0,V=`${x(h.name)}${c[D]?` \xB7 ${x(c[D])}`:""}: ${x(U(O))}`;F.push(`<circle class="hit series-${T}" cx="${$.x}" cy="${$.y}" r="12" fill="transparent" data-tip="${V}" data-color="${L}"><title>${V}</title></circle>`)})})}else d.forEach((k,h)=>{let T=pe(h,e.palette),L=(k.values??[]).map((C,N)=>({x:j(N),y:z(C)})),I=ze(L,a),B=(h*.15).toFixed(3);if(t==="area"){let C=z(R<0&&q>0?0:R),N=I+` L ${L[L.length-1].x} ${C} L ${L[0].x} ${C} Z`;F.push(`<path class="series-fill series-${h}" d="${N}" fill="${T}" fill-opacity="0.25" style="animation-delay: ${B}s"/>`)}F.push(`<path class="series-line series-${h}" d="${I}" stroke="${T}" fill="none" style="animation-delay: ${B}s"/>`),u||L.forEach((C,N)=>{let $=k.values?.[N],D=`${x(k.name)}${c[N]?` \xB7 ${x(c[N])}`:""}: ${x(U($??0))}`,O=(h*.15+N*.025+.55).toFixed(3);F.push(`<circle class="series-point series-${h}" cx="${C.x}" cy="${C.y}" r="3.5" fill="${T}" pointer-events="none" style="animation-delay: ${O}s"/>`),F.push(`<circle class="hit series-${h}" cx="${C.x}" cy="${C.y}" r="12" fill="transparent" data-tip="${D}" data-color="${T}"><title>${D}</title></circle>`),l&&F.push(`<text class="value-label" x="${C.x}" y="${C.y-8}" text-anchor="middle" pointer-events="none">${x(U($??0))}</text>`)})});return Y.join("")+F.join("")}function $a(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let a=e.W/2,n=e.H/2,s=Math.min(e.W,e.H)/2-4,o=Math.max(0,Math.min(.9,e.innerRadius))*s,i=0,l=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let g=u/r*Math.PI*2,m=i,b=i+g,v=wa(a,n,s,o,m,b-.01),E=pe(d,e.palette),S=(u/r*100).toFixed(1).replace(/\.0$/,""),w=`${x(c.name)}: ${x(U(u))} (${S}%)`,M=(d*.08).toFixed(3);if(l.push(`<path class="series-segment hit series-${d}" d="${v}" fill="${E}" data-tip="${w}" data-color="${E}" style="animation-delay: ${M}s"><title>${w}</title></path>`),e.showValues){let A=(m+b)/2,R=(s+o)/2,q=ue(a,n,R,A);l.push(`<text class="value-label donut" x="${q.x}" y="${q.y}" text-anchor="middle" dominant-baseline="middle">${x(S)}%</text>`)}i=b}),l.join("")}function Ea(e,t,r){return e.length===0?"":'<div class="legend" part="legend">'+e.map((a,n)=>{let s=pe(n,t),o=r.includes(a.name);return`<button class="${o?"legend-item is-hidden":"legend-item"}" type="button" data-series="${x(a.name)}" aria-pressed="${o?"true":"false"}" title="${o?"Show":"Hide"} series '${x(a.name)}'"><span class="swatch" style="background:${s}"></span>${x(a.name)}</button>`}).join("")+"</div>"}function Sa(e,t){if(e==="donut"){let n=(t.series??[]).reduce((o,i)=>o+(i.value??0),0);return`Donut chart: ${(t.series??[]).filter(o=>(o.value??0)>0).map(o=>{let i=n>0?(o.value??0)/n*100:0;return`${o.name} ${i.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(n=>n.name).join(", "),a=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${a} data point${a===1?"":"s"}.`}var Ta=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],Ma=`
  <style>
...
`;f(Nr,p({props:{type:{type:"string",default:"line"},data:{type:"json",default:{series:[]}},height:{type:"string",default:"240px"},smooth:{type:"boolean",default:!0},stacked:{type:"boolean",default:!1},showLegend:{type:"boolean",default:!0},showAxes:{type:"boolean",default:!0},showGrid:{type:"boolean",default:!0},showLabels:{type:"boolean",default:!0},showValues:{type:"boolean",default:!1},innerRadius:{type:"number",default:.6},yMin:{type:"json",default:null},yMax:{type:"json",default:null},ariaLabel:{type:"string",default:"Chart"},colors:{type:"json",default:null},src:{type:"string",default:""},srcKey:{type:"string",default:""},loadingText:{type:"string",default:"Loading chart\u2026"},errorText:{type:"string",default:"Couldn't load chart data"}},theme:{"tc-chart-bg":"transparent","tc-chart-fg":"var(--tc-color-ink, #14171f)","tc-chart-axis":"var(--tc-color-rule-strong, #d9cfb8)","tc-chart-grid":"var(--tc-color-rule, #ece5d3)","tc-chart-label":"var(--tc-color-ink-muted, #6b7280)","tc-chart-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e,state:t})=>{let r=String(e.type??"line").toLowerCase(),a=["line","area","bar","sparkline","donut"].includes(r)?r:"line",n=e.data,s=t.fetched,o=!!n&&Array.isArray(n.series)&&n.series.length>0,i=o?n:s??{series:[]},l=Array.isArray(t.hiddenSeries)?t.hiddenSeries:[],c={labels:i.labels,series:(i.series??[]).filter(y=>!l.includes(y.name))},d=String(e.src??""),u=!!t.loading&&!o&&!s,g=d&&t.error?String(t.error):"",m=u?`<div class="overlay loading">${x(String(e.loadingText??"Loading chart\u2026"))}</div>`:g?`<div class="overlay error" role="alert">${x(String(e.errorText??"Couldn't load chart data"))}<small>${x(g)}</small></div>`:"",b=a==="sparkline",v=a==="donut",E=e.colors,S=Array.isArray(E)&&E.length>0?E:Ta,w=v?320:800,M=v?320:400,A={data:c,smooth:!!e.smooth,stacked:!!e.stacked,showAxes:!!e.showAxes,showGrid:!!e.showGrid,showLabels:!!e.showLabels,showValues:!!e.showValues,innerRadius:Number(e.innerRadius??.6),yMin:e.yMin==null?null:Number(e.yMin),yMax:e.yMax==null?null:Number(e.yMax),palette:S,W:w,H:M},R=v?$a(A):ka(A,a),q=Sa(a,c),ae=x(String(e.height??"240px"));return`
        <div class="root" role="img" aria-label="${x(e.ariaLabel??"Chart")}">
          ...
          ${e.showLegend&&!b&&i.series&&i.series.length>0?Ea(i.series,S,l):""}
        ...
        ${Ma}
      `},events:{"click .legend-item":(e,t)=>{let r=e.target?.closest(".legend-item");if(!r)return;let a=r.dataset.series;if(!a)return;let n=t.getState("hiddenSeries")??[],s=n.includes(a)?n.filter(o=>o!==a):[...n,a];t.setState("hiddenSeries",s)},"keydown .legend-item":(e,t)=>{let r=e;if(r.key!=="Enter"&&r.key!==" ")return;r.preventDefault();let n=r.target.closest(".legend-item")?.dataset.series;if(!n)return;let s=t.getState("hiddenSeries")??[],o=s.includes(n)?s.filter(i=>i!==n):[...s,n];t.setState("hiddenSeries",o)}},afterMount(){Cr(this),Ar(this)},afterRender(){Cr(this),Ar(this)},unmount(){let e=this;e._chartHoverCleanup?.(),e._chartFetchAborter?.abort()}}));function Cr(e){let t=e;t._chartHoverCleanup?.();let r=t.shadowRoot;if(!r)return;let a=r.querySelector(".canvas"),n=r.querySelector(".tip"),s=n?.querySelector(".tip-text"),o=n?.querySelector(".tip-swatch");if(!a||!n||!s||!o)return;let i=()=>{n.removeAttribute("data-open"),n.style.transform="translate(-9999px, -9999px)"},l=d=>{let u=d.target?.closest?.("[data-tip]");if(!u){i();return}let g=u.getAttribute("data-tip")||"",m=u.getAttribute("data-color")||"currentColor";s.textContent=g,o.style.background=m;let b=a.getBoundingClientRect(),v=n.offsetWidth||100,E=n.offsetHeight||24,S=d.clientX-b.left,w=d.clientY-b.top,M=S+12,A=w-E-8;M+v>b.width-4&&(M=S-v-12),A<4&&(A=w+16),n.style.transform=`translate(${M}px, ${A}px)`,n.setAttribute("data-open","1")},c=()=>i();a.addEventListener("pointermove",l),a.addEventListener("pointerleave",c),t._chartHoverCleanup=()=>{a.removeEventListener("pointermove",l),a.removeEventListener("pointerleave",c),i()}}function Ar(e){let t=e,r=String(t.src??"").trim();if(!r||!t.getState||!t.setState||t.getState("fetchedFrom")===r)return;t._chartFetchAborter?.abort();let n=new AbortController;t._chartFetchAborter=n,t.setState("fetchedFrom",r),t.setState("fetched",null),t.setState("error",null),t.setState("loading",!0);let s=String(t.srcKey??"").trim();fetch(r,{signal:n.signal}).then(o=>{if(!o.ok)throw new Error(`${o.status} ${o.statusText}`);return o.json()}).then(o=>{let i=s?La(o,s):o;if(!i||typeof i!="object"||!Array.isArray(i.series))throw new Error(s?`Payload at "${s}" doesn't look like ChartData`:"Payload doesn't look like ChartData");n.signal.aborted||(t.setState("fetched",i),t.setState("loading",!1))}).catch(o=>{n.signal.aborted||(t.setState("loading",!1),t.setState("error",o instanceof Error?o.message:String(o)))})}function La(e,t){return t.split(".").reduce((r,a)=>r&&typeof r=="object"?r[a]:void 0,e)}var jo={button:_e,input:Be,textarea:Ge,select:Ye,checkbox:We,switch:Qe,file:et,radioGroup:rt,slider:Hr,rating:Mr,table:ot,chart:Rr,tabs:it,modal:ut,drawer:pr,toast:gt,stat:ht,card:xt,badge:$t,skeleton:Tt,carousel:Zt,accordion:rr,tooltip:or,popover:lr,progress:gr,stepper:hr,avatar:xr,avatarGroup:$r,stack:Lt,cluster:zt,grid:Nt,code:Dt,callout:Ot,toc:Pt,pagination:Vt,combobox:Kt};export{jo as tags};
