var Rr=["beforeMount","afterMount","afterRender","unmount","action","formAssociatedCallback","formDisabledCallback","formResetCallback","formStateRestoreCallback"],Ir=new Set(["string","number","boolean","json"]);function p(e){if(e===null||typeof e!="object")throw new TypeError("describe(): options must be an object");if(e.tag!==void 0&&typeof e.tag!="string")throw new TypeError("describe(): `tag` must be a string");if(e.className!==void 0&&typeof e.className!="string")throw new TypeError("describe(): `className` must be a string");if(e.template!==void 0&&typeof e.template!="string"&&typeof e.template!="function")throw new TypeError("describe(): `template` must be a string or function");if(e.children!==void 0&&!Array.isArray(e.children))throw new TypeError("describe(): `children` must be an array");if(e.emit!==void 0&&!Array.isArray(e.emit))throw new TypeError("describe(): `emit` must be an array");if(e.observedAttributes!==void 0&&(!Array.isArray(e.observedAttributes)||e.observedAttributes.some(t=>typeof t!="string")))throw new TypeError("describe(): `observedAttributes` must be an array of strings");for(let t of["theme","styles","attributes","events","refs"]){let r=e[t];if(r!==void 0&&(r===null||typeof r!="object"||Array.isArray(r)))throw new TypeError(`describe(): \`${t}\` must be a record`)}if(e.refs!==void 0){for(let[t,r]of Object.entries(e.refs))if(typeof r!="string")throw new TypeError(`describe(): refs.${t} must be a CSS selector string`)}if(e.formAssociated!==void 0&&typeof e.formAssociated!="boolean")throw new TypeError("describe(): `formAssociated` must be a boolean");for(let t of Rr){let r=e[t];if(r!==void 0&&typeof r!="function")throw new TypeError(`describe(): \`${t}\` must be a function`)}if(e.if!==void 0&&typeof e.if!="function")throw new TypeError("describe(): `if` must be a function");if(e.for!==void 0){let t=e.for;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `for` must be a record");if(typeof t.items!="function")throw new TypeError("describe(): `for.items` must be a function");if(typeof t.key!="function")throw new TypeError("describe(): `for.key` must be a function");if(typeof t.render!="function")throw new TypeError("describe(): `for.render` must be a function")}if(e.props!==void 0){let t=e.props;if(t===null||typeof t!="object"||Array.isArray(t))throw new TypeError("describe(): `props` must be a record");for(let[r,a]of Object.entries(t)){if(a===null||typeof a!="object"||Array.isArray(a))throw new TypeError(`describe(): props.${r} must be a record`);if(!Ir.has(a.type))throw new TypeError(`describe(): props.${r}.type must be one of "string", "number", "boolean", "json"`)}}return{...e}}var Ne=new Map,Dr=/^[a-z][a-z0-9]*(-[a-z0-9]+)+$/,qr=/^(\S+)(?:\s+(.+))?$/;function f(e,t){if(typeof e!="string"||!Dr.test(e))throw new TypeError(`build(): "${e}" is not a valid custom element name (must be lowercase and contain a hyphen).`);if(Ne.has(e))return console.warn(`Component "${e}" is already registered. Skipping re-registration.`),e;if(typeof HTMLElement>"u"||typeof customElements>"u")return console.warn("HTMLElement or customElements not available; skipping component registration."),e;let r=Array.from(new Set([...t.observedAttributes??[],...Object.keys(t.props??{})])),a=t.props??{},n=t.refs??{},o=Or(t);class l extends HTMLElement{static get observedAttributes(){return r}static get formAssociated(){return t.formAssociated===!0}isMounted=!1;mountCleanups=[];renderCleanups=[];state=new Map;propValues=new Map;listSlots=new WeakMap;currentRefs={};container;ctx;rendering=!1;renderQueued=!1;internals;constructor(){super();let i=this.attachShadow({mode:"open"});t.formAssociated&&typeof this.attachInternals=="function"&&(this.internals=this.attachInternals()),_r(i,o),this.container=document.createElement("div"),this.container.className=t.className?`container ${t.className}`:"container",i.appendChild(this.container),t.attributes&&je(this,t.attributes),this.ctx=Fr(this,this.propValues,this.state,()=>this.currentRefs),this.initProps()}get refs(){return this.currentRefs}initProps(){for(let[i,c]of Object.entries(a)){let d=this.getAttribute(i),u=d!==null?Re(d,c.type):c.default;this.propValues.set(i,u),this.maybeSyncFormValue(i,u),Object.defineProperty(this,i,{configurable:!0,enumerable:!0,get:()=>this.propValues.get(i),set:g=>{let m=Vr(g,c.type),b=this.propValues.get(i);Object.is(b,m)||(this.propValues.set(i,m),c.reflect&&Gr(this,i,m,c.type),this.maybeSyncFormValue(i,m),this.isMounted&&this.scheduleRender())}})}}maybeSyncFormValue(i,c){if(!this.internals||i!=="value")return;let d=c==null?null:String(c);this.internals.setFormValue(d)}connectedCallback(){if(!this.isMounted){try{t.beforeMount?.call(this)}catch(i){console.error(`[tan-compose] beforeMount threw for <${e}>:`,i)}if(this.renderInternal(),t.action){let i=t.action;this.addEventListener("click",i),this.mountCleanups.push(()=>this.removeEventListener("click",i))}if(t.emit)for(let i of t.emit)this.addEventListener(i.name,i.handler),this.mountCleanups.push(()=>this.removeEventListener(i.name,i.handler));t.events&&this.attachDelegatedEvents(t.events),this.isMounted=!0;try{t.afterMount?.call(this)}catch(i){console.error(`[tan-compose] afterMount threw for <${e}>:`,i)}}}disconnectedCallback(){try{t.unmount?.call(this)}catch(i){console.error(`[tan-compose] unmount threw for <${e}>:`,i)}U(this.mountCleanups),U(this.renderCleanups),this.flushListSlots(),this.isMounted=!1}flushListSlots(){qe(t,i=>{let c=this.listSlots.get(i);if(c){for(let d of c.cache.values())U(d.cleanups);c.cache.clear()}})}attributeChangedCallback(i,c,d){if(c!==d){if(Object.prototype.hasOwnProperty.call(a,i)){let u=a[i],g=d!==null?Re(d,u.type):u.default,m=this.propValues.get(i);Object.is(m,g)||(this.propValues.set(i,g),this.isMounted&&this.scheduleRender());return}this.state.set(i,d),this.isMounted&&this.scheduleRender()}}setState(i,c){let d=this.state.get(i);Object.is(d,c)||(this.state.set(i,c),this.isMounted&&this.scheduleRender())}getState(i){return this.state.get(i)}render(){this.renderInternal()}emitEvent(i,c){this.dispatchEvent(new CustomEvent(i,{detail:c,bubbles:!0,composed:!0}))}scheduleRender(){if(this.rendering){this.renderQueued=!0;return}this.renderInternal()}getOrCreateSlot(i){let c=this.listSlots.get(i);return c||(c={cache:new Map},this.listSlots.set(i,c)),c}renderInternal(){this.rendering=!0;let i=this.captureFocusInShadow();try{U(this.renderCleanups),this.container.replaceChildren();let c={host:this,cleanups:this.renderCleanups,ctx:this.ctx};if(t.template!==void 0){let d=typeof t.template=="function"?t.template(this.ctx):t.template;d&&(this.container.innerHTML=d)}if(t.children)for(let d of t.children){let u=Ie(d,c,g=>this.getOrCreateSlot(g));u&&this.container.appendChild(u)}this.container.appendChild(document.createElement("slot")),this.refreshRefs()}finally{this.rendering=!1}if(i&&this.restoreFocusInShadow(i),this.renderQueued){this.renderQueued=!1,this.renderInternal();return}try{t.afterRender?.call(this)}catch(c){console.error(`[tan-compose] afterRender threw for <${e}>:`,c)}}captureFocusInShadow(){let i=this.shadowRoot;if(!i)return null;let c=i.activeElement;if(!c)return null;let d=[],u=c;for(;u&&u!==i;){let b=u.parentNode;if(!b)break;let v=u.tagName,$=Array.from(b.children).filter(w=>w.tagName===v).indexOf(u);if(d.unshift({tag:v,idx:$}),u=b instanceof Element?b:null,!u&&b===i)break}let g=null,m=null;if(c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement)try{g=c.selectionStart,m=c.selectionEnd}catch{}return{path:d,selectionStart:g,selectionEnd:m}}restoreFocusInShadow(i){let c=this.shadowRoot;if(!c)return;let d=c;for(let g of i.path){let m=Array.from(d.children??[]),S=(m.length>0?m:Array.from(d.children??[])).filter($=>$.tagName===g.tag)[g.idx];if(!S)return;d=S}let u=d;if(!(!u||typeof u.focus!="function")&&c.activeElement!==u&&(u.focus(),i.selectionStart!=null&&(u instanceof HTMLInputElement||u instanceof HTMLTextAreaElement)))try{u.setSelectionRange(i.selectionStart,i.selectionEnd??i.selectionStart)}catch{}}refreshRefs(){let i={},c=this.shadowRoot;for(let[d,u]of Object.entries(n))i[d]=c?c.querySelector(u):null;this.currentRefs=i}formAssociatedCallback(i){try{t.formAssociatedCallback?.call(this,i)}catch(c){console.error(`[tan-compose] formAssociatedCallback threw for <${e}>:`,c)}}formDisabledCallback(i){try{t.formDisabledCallback?.call(this,i)}catch(c){console.error(`[tan-compose] formDisabledCallback threw for <${e}>:`,c)}}formResetCallback(){try{t.formResetCallback?.call(this)}catch(i){console.error(`[tan-compose] formResetCallback threw for <${e}>:`,i)}}formStateRestoreCallback(i,c){try{t.formStateRestoreCallback?.call(this,i,c)}catch(d){console.error(`[tan-compose] formStateRestoreCallback threw for <${e}>:`,d)}}attachDelegatedEvents(i){let c=new Map;for(let[d,u]of Object.entries(i)){let g=qr.exec(d.trim());if(!g)continue;let[,m,b]=g;c.has(m)||c.set(m,[]),c.get(m).push({selector:b??null,handler:u})}for(let[d,u]of c){let g=m=>{for(let{selector:b,handler:v}of u){if(!b){v(m,this.ctx);continue}let S=m.composedPath();for(let $ of S){if($===this.shadowRoot||$===this)break;if($ instanceof Element&&this.shadowRoot?.contains($)&&$.matches(b)){v(m,this.ctx);break}}}};this.shadowRoot.addEventListener(d,g),this.mountCleanups.push(()=>this.shadowRoot?.removeEventListener(d,g))}}}return Ne.set(e,l),customElements.define(e,l),e}function Ie(e,t,r){return e.if&&!e.if(t.ctx)?null:De(e,t,r)}function De(e,t,r){let a=document.createElement(e.tag||"div");if(e.styles&&(a.style.cssText=Object.entries(e.styles).map(([n,o])=>`${n}: ${o}`).join("; ")),e.className&&(a.className=e.className),e.attributes&&je(a,e.attributes),e.template!==void 0){let n=typeof e.template=="function"?e.template(t.ctx):e.template;n&&(a.innerHTML=n)}if(e.children)for(let n of e.children){let o=Ie(n,t,r);o&&a.appendChild(o)}if(e.for&&jr(a,e,t,r),e.action){let n=e.action;a.addEventListener("click",n),t.cleanups.push(()=>a.removeEventListener("click",n))}if(e.emit)for(let n of e.emit)a.addEventListener(n.name,n.handler),t.cleanups.push(()=>a.removeEventListener(n.name,n.handler));return a}function jr(e,t,r,a){let n=t.for,o=a(t),l=n.items(r.ctx),s=new Map;for(let i=0;i<l.length;i++){let c=l[i],d=n.key(c,i),u,g=o.cache.get(d);if(g&&Object.is(g.lastItem,c))u=g;else{let m=[],b=n.render(c,i,r.ctx),v=De(b,{...r,cleanups:m},a);g&&U(g.cleanups),u={element:v,lastItem:c,cleanups:m}}s.set(d,u),e.appendChild(u.element)}for(let[i,c]of o.cache)s.has(i)||U(c.cleanups);o.cache=s}function qe(e,t){if(e.for&&t(e),e.children)for(let r of e.children)qe(r,t)}function Fr(e,t,r,a){return{host:e,get props(){let n={};for(let[o,l]of t)n[o]=l;return n},get state(){let n={};for(let[o,l]of r)n[o]=l;return n},get refs(){return a()},setState:(n,o)=>e.setState(n,o),getState:n=>e.getState(n),emit:(n,o)=>e.emitEvent(n,o)}}function Or(e){let t=e.theme?Pr(e.theme):void 0,r=e.styles?Br(e.styles):void 0;if(!t&&!r)return{kind:"adopted",sheets:[]};if(typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"){let n=[];if(t){let o=new CSSStyleSheet;o.replaceSync(t),n.push(o)}if(r){let o=new CSSStyleSheet;o.replaceSync(r),n.push(o)}return{kind:"adopted",sheets:n}}return{kind:"fallback",theme:t,styles:r}}function _r(e,t){if(t.kind==="adopted"){if(t.sheets.length>0)try{e.adoptedStyleSheets=t.sheets}catch{}return}if(t.theme){let r=document.createElement("style");r.textContent=t.theme,e.appendChild(r)}if(t.styles){let r=document.createElement("style");r.textContent=t.styles,e.appendChild(r)}}function je(e,t){for(let[r,a]of Object.entries(t))e.setAttribute(r,a)}function Pr(e){return`:host { ${Object.entries(e).map(([r,a])=>`--${r}: ${a};`).join(" ")} }`}function Br(e){return`.container { ${Object.entries(e).map(([r,a])=>`${r}: ${a};`).join(" ")} }`}function U(e){for(;e.length>0;){let t=e.pop();try{t?.()}catch(r){console.error("[tan-compose] cleanup threw:",r)}}}function Re(e,t){switch(t){case"string":return e;case"number":{let r=Number(e);return Number.isNaN(r)?void 0:r}case"boolean":return e!=="false"&&e!=="0";case"json":try{return JSON.parse(e)}catch{return}}}function Vr(e,t){switch(t){case"string":return e==null?e:String(e);case"number":return e==null?e:Number(e);case"boolean":return!!e;case"json":return e}}function Gr(e,t,r,a){if(a!=="json"){if(a==="boolean"){r?e.setAttribute(t,""):e.removeAttribute(t);return}if(r==null){e.removeAttribute(t);return}e.setAttribute(t,String(r))}}var Oe="tc-button",_e=Oe,Fe=`
      <style>
        .root {
...
`;f(Oe,p({props:{variant:{type:"string",default:"primary"},size:{type:"string",default:"md"},disabled:{type:"boolean",default:!1,reflect:!0},loading:{type:"boolean",default:!1},block:{type:"boolean",default:!1},href:{type:"string",default:""},target:{type:"string",default:""},rel:{type:"string",default:""}},theme:{"tc-btn-primary-bg":"var(--tc-color-ink, #14171f)","tc-btn-primary-fg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-bg":"var(--tc-color-surface, #ffffff)","tc-btn-secondary-fg":"var(--tc-color-ink, #14171f)","tc-btn-secondary-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-btn-ghost-fg":"var(--tc-color-ink, #14171f)","tc-btn-ghost-border":"transparent","tc-btn-danger-bg":"var(--tc-color-danger, #b3261e)","tc-btn-danger-fg":"var(--tc-color-surface, #ffffff)","tc-btn-radius":"var(--tc-radius-md, 8px)","tc-btn-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block","vertical-align":"middle"},template:({props:e})=>{let t=`root v-${ne(e.variant)} s-${ne(e.size)}${e.block?" block":""}`,r=`${e.loading?'<span class="spinner" aria-hidden="true"></span>':""}
        <span class="content"><slot></slot></span>`,a=String(e.href??""),n=a.length>0,o=!!(e.disabled||e.loading);if(n){let l=e.target?` target="${ne(e.target)}"`:"",s=e.rel?String(e.rel):String(e.target)==="_blank"?"noopener":"",i=s?` rel="${ne(s)}"`:"",c=o?"":` href="${ne(a)}"`;return`
      <a
        part="button"
        class="${t}"${c}${l}${i}${o?' aria-disabled="true"':""}${o?' tabindex="-1"':""}
        role="button"
      >
        ${r}
      </a>${Fe}`}return`
...
`,Te=new WeakMap;f(nt,p({props:{rows:{type:"json",default:[]},columns:{type:"json",default:[]},pageSize:{type:"number",default:10},filterable:{type:"boolean",default:!0},emptyText:{type:"string",default:"No results."},rowKey:{type:"string",default:"id"}},theme:{"tc-table-surface":"var(--tc-color-surface, #ffffff)","tc-table-ink":"var(--tc-color-ink, #14171f)","tc-table-soft":"var(--tc-color-ink-soft, #5a6072)","tc-table-rule":"var(--tc-color-rule, #ece5d3)","tc-table-head-bg":"var(--tc-color-surface-alt, #faf8f3)","tc-table-row-hover":"rgba(161, 105, 57, 0.05)","tc-table-accent":"var(--tc-color-accent, #a16939)","tc-table-radius":"var(--tc-radius-lg, 10px)","tc-table-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},children:[p({tag:"style",template:Ur}),p({if:({props:e})=>!!e.filterable,tag:"input",className:"filter",attributes:{placeholder:"Search...",type:"text"}}),p({tag:"div",className:"wrap",children:[p({tag:"table",children:[p({tag:"thead",template:({props:e,state:t})=>{let r=e.columns??[],a=t;return`<tr>${r.map(n=>{let o=a.sortKey===n.key,l=n.sortable!==!1,s=o?a.sortDir==="asc"?"\u25B2":"\u25BC":"",i=o?a.sortDir==="asc"?"ascending":"descending":"none";return`<th
                        data-col="${me(n.key)}"
                        class="${l?"sortable":""}"
                        aria-sort="${i}"
                      >${me(n.label)}<span class="sort">${s}</span></th>`}).join("")}</tr>`}}),p({tag:"tbody",children:[p({tag:"tr",className:"empty",if:({props:e,state:t})=>at(e,t).length===0,template:({props:e})=>`<td colspan="${(e.columns??[]).length||1}">${me(e.emptyText)}</td>`})],for:{items:({props:e,state:t})=>at(e,t),key:(e,t)=>e["id"]??t,render:(e,t,r)=>{let n=r.props.columns??[],o=e;return p({tag:"tr",attributes:{"data-row-id":String(o.id??t)},template:n.map(l=>`<td>${typeof l.render=="function"?l.render(o):me(o[l.key]??"")}</td>`).join("")})}}})]})]}),p({tag:"footer",className:"pager",template:({props:e,state:t})=>{let r=t,a=be(e,r),n=e.pageSize??10,o=Math.max(1,Math.ceil(a.length/n)),l=Math.min(r.page??0,o-1),s=(e.rows??[]).length;return`
            <span class="count">${a.length} of ${s} rows</span>
            <span class="spacer"></span>
            <button class="prev" type="button" ${l<=0?"disabled":""}>\u2039 prev</button>
            <span class="page">page ${l+1} of ${o}</span>
            <button class="next" type="button" ${l>=o-1?"disabled":""}>next \u203A</button>
          `}})],refs:{filter:".filter"},afterRender(){let e=this,t=e.refs.filter;if(!t)return;let r=e.getState("q")??"";t.value!==r&&(t.value=r);let a=Te.get(e);if(a){Te.delete(e),t.focus();let n=Math.min(a.caret,t.value.length);try{t.setSelectionRange(n,n)}catch{}}},events:{"input .filter":(e,t)=>{let r=e.target;Te.set(t.host,{caret:r.selectionStart??r.value.length}),t.setState("q",r.value),t.setState("page",0)},"click .prev":(e,t)=>{let r=(t.state.page??0)-1;t.setState("page",Math.max(0,r))},"click .next":(e,t)=>{let r=t.state,a=be(t.props,r).length,n=t.props.pageSize??10,o=Math.max(0,Math.ceil(a/n)-1),l=(r.page??0)+1;t.setState("page",Math.min(o,l))},"click th.sortable":(e,t)=>{let r=e.target.closest("th");if(!r)return;let a=r.dataset.col;if(!a)return;let n=t.state,o;n.sortKey!==a?o="asc":o=n.sortDir==="asc"?"desc":n.sortDir==="desc"?null:"asc",t.setState("sortKey",o?a:null),t.setState("sortDir",o),t.emit("tc-sort-change",{key:o?a:null,direction:o})},"click tr[data-row-id]":(e,t)=>{let r=e.target.closest("tr[data-row-id]");if(!r)return;let a=r.dataset.rowId;if(a===void 0)return;let n=be(t.props,t.state),o=n.find(l=>String(l.id)===a)??n[Number(a)];o&&t.emit("tc-row-click",{row:o})}}}));function be(e,t){let r=e.rows??[],a=e.columns??[],n=(t.q??"").trim().toLowerCase(),o=n.length===0?r.slice():r.filter(l=>a.some(s=>String(l[s.key]??"").toLowerCase().includes(n)));if(t.sortKey&&t.sortDir){let l=t.sortKey,s=t.sortDir==="asc"?1:-1;o=o.slice().sort((i,c)=>{let d=i[l],u=c[l];return d===u?0:d==null?1:u==null?-1:typeof d=="number"&&typeof u=="number"?(d-u)*s:String(d).localeCompare(String(u))*s})}return o}function at(e,t){let r=e.pageSize??10,a=be(e,t),n=Math.max(1,Math.ceil(a.length/r)),o=Math.min(t.page??0,n-1);return a.slice(o*r,o*r+r)}function me(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var st="tc-tabs",it=st;f(st,p({props:{tabs:{type:"json",default:[]},active:{type:"string",default:"",reflect:!0}},theme:{"tc-tabs-fg":"var(--tc-color-ink, #14171f)","tc-tabs-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-tabs-rule":"var(--tc-color-rule, #ece5d3)","tc-tabs-accent":"var(--tc-color-accent, #a16939)","tc-tabs-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block","font-family":"var(--tc-tabs-font)"},template:({props:e})=>{let t=e.tabs??[],r=e.active||t[0]?.id||"";return`
    ...
    `}));function Et(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Mt="tc-stack",Lt=Mt;f(Mt,p({props:{gap:{type:"string",default:"4"},align:{type:"string",default:"stretch"}},styles:{display:"block"},template:({props:e})=>`
      <div class="stack" style="--tc-stack-gap: ${Wr(e.gap)}; --tc-stack-align: ${Jr(e.align)};">
        <slot></slot>
      </div>
      <style>
        .stack {
    ...
    `}));function Wr(e){let t=String(e??"4").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${Xr(t)})`:t}function Xr(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"16px"}function Jr(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Ht="tc-cluster",zt=Ht;f(Ht,p({props:{gap:{type:"string",default:"3"},justify:{type:"string",default:"start"},align:{type:"string",default:"center"},wrap:{type:"boolean",default:!0}},styles:{display:"block"},template:({props:e})=>`
      <div class="cluster" style="
        --tc-cluster-gap: ${Zr(e.gap)};
        --tc-cluster-justify: ${Qr(e.justify)};
        --tc-cluster-align: ${ta(e.align)};
    ...
    `}));function Qr(e){let t=String(e??"start").trim();switch(t){case"between":return"space-between";case"around":return"space-around";case"evenly":return"space-evenly";default:return t}}function Zr(e){let t=String(e??"3").trim();return/^[1-8]$/.test(t)?`var(--tc-space-${t}, ${ea(t)})`:t}function ea(e){return{1:"4px",2:"8px",3:"12px",4:"16px",5:"24px",6:"32px",7:"48px",8:"64px"}[e]??"12px"}function ta(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var At="tc-grid",Nt=At;f(At,p({props:{min:{type:"string",default:"260px"},gap:{type:"string",default:"4"},columns:{type:"string",default:""}},styles:{display:"block"},template:({props:e})=>{let t=String(e.columns??"").trim();return`
        <div class="grid" style="
          --tc-grid-template: ${t?`repeat(${Ct(t)}, minmax(0, 1fr))`:`repeat(auto-fit, minmax(${Ct(e.min)}, 1fr))`};
          --tc-grid-gap: ${ra(e.gap)};
        ">
          <slot></slot>
        </div>
        <style>
      ...
      `}}));function jt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var _t="tc-toc",Pt=_t,he=new WeakMap;f(_t,p({props:{target:{type:"string",default:"main"},levels:{type:"string",default:"h2,h3"},sticky:{type:"boolean",default:!0},label:{type:"string",default:"On this page"}},theme:{"tc-toc-fg":"var(--tc-color-ink, #14171f)","tc-toc-fg-muted":"var(--tc-color-ink-muted, #6b7280)","tc-toc-active":"var(--tc-color-accent, #a16939)","tc-toc-rule":"var(--tc-color-rule, #ece5d3)","tc-toc-label":"var(--tc-color-ink-soft, #4a5061)","tc-toc-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, sans-serif)","tc-toc-top":"80px"},styles:{display:"block"},template:({props:e,state:t})=>{let r=t.items??[],a=t.activeId??"";return`
        ...
        >
          ...
          ${r.length===0?'<p class="empty">No sections yet.</p>':`<ol class="list">${r.map(n=>`<li class="lvl-${n.level}${n.id===a?" active":""}"><a href="#${Se(n.id)}">${Se(n.text)}</a></li>`).join("")}</ol>`}
        </nav>
        <style>
      ...
      `},afterMount(){sa(this)},unmount(){he.get(this)?.observer?.disconnect(),he.delete(this)}}));function sa(e){he.get(e)?.observer?.disconnect();let r=e,a=r.target||"main",n=(r.levels||"h2,h3").split(",").map(c=>c.trim().toLowerCase()).filter(Boolean),o=document.querySelector(a);if(!o)return;let l=Array.from(o.querySelectorAll(n.join(","))).filter(c=>c instanceof HTMLElement),s=l.map(c=>(c.id||(c.id=ia(c.textContent??"")),{id:c.id,level:parseInt(c.tagName.slice(1),10),text:(c.textContent??"").trim()}));if(e.setState("items",s),typeof IntersectionObserver>"u")return;let i=new IntersectionObserver(c=>{let u=c.filter(m=>m.isIntersecting).sort((m,b)=>m.boundingClientRect.top-b.boundingClientRect.top)[0];if(!u)return;let g=u.target.id;g&&e.setState("activeId",g)},{rootMargin:"0px 0px -70% 0px",threshold:0});for(let c of l)i.observe(c);he.set(e,{observer:i,activeId:""})}function ia(e){return e.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")||"section"}function Se(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Bt="tc-pagination",Vt=Bt;f(Bt,p({props:{current:{type:"number",default:1},total:{type:"number",default:1},siblings:{type:"number",default:1},boundaries:{type:"number",default:1},size:{type:"string",default:"sm"},"prev-label":{type:"string",default:"Prev"},"next-label":{type:"string",default:"Next"},label:{type:"string",default:"Pagination"}},styles:{display:"block"},template:({props:e})=>{let t=Math.max(1,Number(e.total)|0),r=la(Number(e.current)|0,1,t),a=Math.max(0,Number(e.siblings)|0),n=Math.max(0,Number(e.boundaries)|0);if(t<=1)return"";let o=ca(r,t,a,n),l=ve(String(e.size??"sm")),s=r<=1?" disabled":"",i=r>=t?" disabled":"",c=o.map(d=>{if(d==="\u2026")return'<span class="ellipsis" aria-hidden="true">\u2026</span>';let u=d===r;return`<tc-button
            class="num"
            size="${l}"
      ...
      `},events:{"click tc-button":(e,t)=>{let r=e.target.closest("tc-button");if(!r||r.hasAttribute("disabled"))return;let a=r.getAttribute("data-page");if(a==null)return;let n=Number(a),o=t.host,l=Math.max(1,Number(o.total)|0),s=Number(o.current)|0;!Number.isFinite(n)||n<1||n>l||n!==s&&t.emit("tc-page-change",{page:n})}}}));function la(e,t,r){return Math.min(r,Math.max(t,e))}function ca(e,t,r,a){let n=new Set;for(let s=1;s<=Math.min(a,t);s++)n.add(s);for(let s=Math.max(1,t-a+1);s<=t;s++)n.add(s);for(let s=Math.max(1,e-r);s<=Math.min(t,e+r);s++)n.add(s);let o=[...n].sort((s,i)=>s-i),l=[];for(let s=0;s<o.length;s++)s>0&&o[s]-o[s-1]>1&&l.push("\u2026"),l.push(o[s]);return l}function ve(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Yt="tc-combobox",Kt=Yt;function ie(e){if(Array.isArray(e))return e.map(r=>String(r)).filter(Boolean);let t=String(e??"").trim();return t?t.split(",").map(r=>r.trim()).filter(Boolean):[]}function le(e){return e.join(",")}function da(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}var ua=`
        <style>
          :host {
            display: block;
            position: relative;
...
`;f(Yt,p({formAssociated:!0,props:{value:{type:"string",default:""},name:{type:"string",default:""},options:{type:"json",default:[]},multiple:{type:"boolean",default:!1},searchable:{type:"boolean",default:!0},placeholder:{type:"string",default:""},"empty-text":{type:"string",default:"No results"},label:{type:"string",default:""},helper:{type:"string",default:""},error:{type:"string",default:""},disabled:{type:"boolean",default:!1,reflect:!0},required:{type:"boolean",default:!1,reflect:!0},max:{type:"number",default:0}},theme:{"tc-input-bg":"var(--tc-color-surface, #ffffff)","tc-input-fg":"var(--tc-color-ink, #14171f)","tc-input-border":"var(--tc-color-rule-strong, #d9cfb8)","tc-input-border-focus":"var(--tc-color-accent, #a16939)","tc-input-error":"var(--tc-color-danger, #b3261e)","tc-input-helper":"var(--tc-color-ink-muted, #6b7280)","tc-input-radius":"var(--tc-radius-md, 8px)","tc-input-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-combobox-chip-bg":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-chip-fg":"var(--tc-color-accent-hover, #8a572d)","tc-combobox-popup-bg":"var(--tc-color-surface, #ffffff)","tc-combobox-popup-hover":"var(--tc-color-accent-soft, #efe2cf)","tc-combobox-popup-active":"var(--tc-color-accent-soft, #efe2cf)"},styles:{display:"block"},refs:{search:".search",popup:".popup"},template:({props:e,state:t})=>{let r=e.options??[],a=!!e.multiple,n=e.searchable!==!1,o=!!e.disabled,l=!!e.error,s=ie(e.value),i=String(t.query??""),c=!!t.open&&!o,d=Number(t.focusedIndex??-1),u=Gt(r,i),g=new Set(s),m=s.map(y=>r.find(j=>j.value===y)).filter(y=>!!y),b=n&&(c||a&&s.length===0),v=!a&&s.length===1&&(!c||!n),S=s.length===0&&!b&&!v,$=a?m.map(y=>`<span class="chip" data-value="${H(y.value)}">
          ...
          </span>`:"",L=S?`<span class="placeholder">${H(e.placeholder??"")}</span>`:"",I=b?`<input
            type="text"
            class="search"
            part="search"
            value="${H(i)}"
            placeholder="${H(s.length===0?e.placeholder??"":"")}"
            ${o?"disabled":""}
            autocomplete="off"
          ...
          />`:"",N=u.length===0?`<div class="empty">${H(e["empty-text"]??"No results")}</div>`:u.map((y,j)=>{let z=g.has(y.value);return`<div
            ...
            </div>`}).join(""),V=e.label?`<label class="label">${H(e.label)}${e.required?' <span class="req" aria-hidden="true">*</span>':""}</label>`:"",$e=l?`<div class="helper error">${H(e.error)}</div>`:e.helper?`<div class="helper">${H(e.helper)}</div>`:"";return`
        ${V}
        <div
          class="control ${l?"invalid":""} ${c?"open":""} ${o?"disabled":""}"
          part="control"
          tabindex="${o?"-1":"0"}"
      ...
      `},events:{"click .control":(e,t)=>{if(e.target.closest(".chip-remove")||t.host.disabled)return;let n=!!t.getState("open");t.setState("open",!0),n||t.emit("tc-open"),t.refs.search?.focus()},"keydown .control":(e,t)=>{let r=e;if(r.key==="Enter"||r.key===" "){if(r.preventDefault(),t.host.disabled)return;t.setState("open",!0),t.emit("tc-open"),t.refs.search?.focus()}},"input .search":(e,t)=>{let r=e.target.value;t.setState("query",r),t.setState("open",!0),t.setState("focusedIndex",0),t.emit("tc-search",{query:r})},"keydown .search":(e,t)=>{let r=e,a=e.target,n=t.host,o=!!n.multiple,l=n.options??[],s=Gt(l,String(t.getState("query")??""));if(r.key==="Backspace"&&a.value===""&&o){let i=ie(n.value);i.length>0&&(i.pop(),n.value=le(i),ye(t,i,n),t.emit("tc-change",{value:i.slice()}),r.preventDefault());return}if(r.key==="ArrowDown"){r.preventDefault(),t.setState("open",!0);let i=Number(t.getState("focusedIndex")??-1),c=Math.min(s.length-1,i+1);t.setState("focusedIndex",c);return}if(r.key==="ArrowUp"){r.preventDefault();let i=Number(t.getState("focusedIndex")??0),c=Math.max(0,i-1);t.setState("focusedIndex",c);return}if(r.key==="Enter"){r.preventDefault();let i=Number(t.getState("focusedIndex")??-1);i>=0&&i<s.length&&Ut(t,s[i],n);return}if(r.key==="Escape"){r.preventDefault(),t.setState("open",!1),t.setState("query",""),t.emit("tc-close");return}},"mousedown .option":(e,t)=>{e.preventDefault();let r=e.target.closest(".option");if(!r||r.classList.contains("disabled"))return;let a=r.dataset.value;if(a==null)return;let n=t.host,l=(n.options??[]).find(s=>s.value===a);l&&Ut(t,l,n)},"click .chip-remove":(e,t)=>{e.stopPropagation();let a=e.target.dataset.remove;if(a==null)return;let n=t.host,o=ie(n.value).filter(l=>l!==a);n.value=le(o),ye(t,o,n),t.emit("tc-change",{value:o.slice()})},"focusout .control":(e,t)=>{queueMicrotask(()=>{t.host.matches(":focus-within")||(t.setState("open",!1),t.setState("query",""),t.emit("tc-close"))})}},afterMount(){let e=this;if(!e.multiple||!e.internals)return;let t=ie(e.value),r=String(e.name??"");if(!r){e.internals.setFormValue(le(t));return}let a=new FormData;for(let n of t)a.append(r,n);e.internals.setFormValue(a)},afterRender(){let e=this;if(!(e.getState?!!e.getState("open"):!1))return;let r=e.refs?.search??null;if(!r||e.shadowRoot?.activeElement===r)return;r.focus();let n=r.value.length;try{r.setSelectionRange(n,n)}catch{}}}));function Gt(e,t){if(!t)return e;let r=new RegExp(da(t),"i");return e.filter(a=>r.test(a.label)||r.test(a.value))}function Ut(e,t,r){let a=!!r.multiple,n=Number(r.max??0),o=ie(r.value);if(a){let l;if(o.includes(t.value))l=o.filter(s=>s!==t.value);else{if(n>0&&o.length>=n)return;l=o.concat(t.value)}r.value=le(l),ye(e,l,r),e.setState("query",""),e.emit("tc-change",{value:l.slice()}),queueMicrotask(()=>{e.refs.search?.focus()})}else r.value=t.value,ye(e,[t.value],r),e.setState("query",""),e.setState("open",!1),e.emit("tc-change",{value:t.value}),e.emit("tc-close")}function ye(e,t,r){let a=r.internals;if(!a)return;let n=String(r.name??"");if(!r.multiple){a.setFormValue(t[0]??"");return}if(!n){a.setFormValue(le(t));return}let o=new FormData;for(let l of t)o.append(n,l);a.setFormValue(o)}function H(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Qt="tc-carousel",Zt=Qt;function Wt(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function xe(e){let t=0;for(let r of Array.from(e.children))r instanceof Element&&!r.hasAttribute("slot")&&t++;return t}function er(e,t,r){return t<=0?0:r?(e%t+t)%t:Math.max(0,Math.min(t-1,e))}function F(e,t){let r=xe(e);if(r===0)return;let a=e.value,n=er(t,r,e.loop);n!==a&&(e.value=n,e.dispatchEvent(new CustomEvent("tc-change",{detail:{index:n,previous:a},bubbles:!0,composed:!0})))}function Xt(e){Me(e),!(e.autoplay<=0)&&(xe(e)<=1||(e._carouselTimer=globalThis.setInterval(()=>{F(e,e.value+1)},e.autoplay)))}function Me(e){e._carouselTimer!==void 0&&(globalThis.clearInterval(e._carouselTimer),e._carouselTimer=void 0)}f(Qt,p({props:{value:{type:"number",default:0,reflect:!0},autoplay:{type:"number",default:0},loop:{type:"boolean",default:!0},orientation:{type:"string",default:"horizontal"},transition:{type:"string",default:"slide"},indicators:{type:"boolean",default:!0},controls:{type:"boolean",default:!0},swipe:{type:"boolean",default:!0},pauseOnHover:{type:"boolean",default:!0},ariaLabel:{type:"string",default:"Carousel"},height:{type:"string",default:""}},theme:{"tc-carousel-radius":"var(--tc-radius-lg, 12px)","tc-carousel-bg":"var(--tc-color-bg, #faf8f3)","tc-carousel-control-bg":"rgba(255, 255, 255, 0.85)","tc-carousel-control-bg-hover":"rgba(255, 255, 255, 1)","tc-carousel-control-fg":"var(--tc-color-ink, #14171f)","tc-carousel-control-size":"36px","tc-carousel-indicator":"rgba(20, 23, 31, 0.25)","tc-carousel-indicator-active":"var(--tc-color-accent, #a16939)","tc-carousel-duration":"320ms"},styles:{display:"block",position:"relative"},template:({props:e})=>{let t=Number(e.value??0),r=String(e.orientation)==="vertical",a=String(e.transition)==="fade",n=String(e.height??""),o=!!e.controls,l=!!e.indicators,s=Wt(e.ariaLabel??"Carousel");return`
        ...
        >
          ...
          `:""}
          ${l?'<div class="indicators" role="tablist" part="indicators"></div>':""}
      ...
      `},events:{"click .prev":(e,t)=>{let r=t.host;F(r,r.value-1)},"click .next":(e,t)=>{let r=t.host;F(r,r.value+1)},"click .dot":(e,t)=>{let r=e.target.closest(".dot");if(!r)return;let a=Number(r.dataset.index);if(!Number.isFinite(a))return;let n=t.host;F(n,a)},"keydown .root":(e,t)=>{let r=e,a=t.host,n=a.orientation==="vertical",o=xe(a),l=n?"ArrowUp":"ArrowLeft",s=n?"ArrowDown":"ArrowRight";r.key===l?(r.preventDefault(),F(a,a.value-1)):r.key===s?(r.preventDefault(),F(a,a.value+1)):r.key==="Home"?(r.preventDefault(),F(a,0)):r.key==="End"&&(r.preventDefault(),F(a,o-1))}},afterMount(){let e=this,t=()=>Jt(e),r=new MutationObserver(t);r.observe(e,{childList:!0});let a=e.shadowRoot,n=a?.querySelector("slot"),o=()=>t();n?.addEventListener("slotchange",o),e._carouselSlotObs=()=>{r.disconnect(),n?.removeEventListener("slotchange",o)};let l=()=>Me(e),s=()=>{e.pauseOnHover&&Xt(e)};e.addEventListener("pointerenter",l),e.addEventListener("pointerleave",s),e.addEventListener("focusin",l),e.addEventListener("focusout",s),e._carouselHover=()=>{e.removeEventListener("pointerenter",l),e.removeEventListener("pointerleave",s),e.removeEventListener("focusin",l),e.removeEventListener("focusout",s)},pa(e),a?.querySelector(".root")?.setAttribute("tabindex","0"),t(),e.autoplay>0&&Xt(e)},afterRender(){Jt(this)},unmount(){let e=this;Me(e),e._carouselSlotObs?.(),e._carouselHover?.(),e._carouselDrag?.()}}));function Jt(e){let t=xe(e),r=e.shadowRoot;if(!r)return;let a=r.querySelector(".root");if(a&&t>0){let s=er(e.value,t,e.loop);s!==e.value&&(e.value=s),a.style.setProperty("--tc-carousel-index",String(s))}let n=r.querySelector(".indicators");if(n){let s=e.value,i="";for(let c=0;c<t;c++)i+=`<button type="button" class="dot" role="tab" data-index="${c}"
        aria-current="${c===s?"true":"false"}"
        aria-label="Go to slide ${c+1}"></button>`;n.innerHTML=i}if(Array.from(e.children).filter(s=>s instanceof HTMLElement&&!s.hasAttribute("slot")).forEach((s,i)=>{s.setAttribute("role","group"),s.setAttribute("aria-roledescription","slide"),s.setAttribute("aria-label",`${i+1} of ${t}`),e.transition==="fade"?s.classList.toggle("is-active",i===e.value):s.classList.remove("is-active")}),!e.loop){let s=r.querySelector(".ctrl.prev"),i=r.querySelector(".ctrl.next");s&&(s.disabled=e.value<=0),i&&(i.disabled=e.value>=t-1)}let l=r.querySelector(".sr-status");l&&t>0&&(l.textContent=`Slide ${e.value+1} of ${t}`)}function pa(e){let t=0,r=0,a=!1,n=40,o=i=>{e.swipe&&(i.button!==0&&i.pointerType==="mouse"||(t=i.clientX,r=i.clientY,a=!0))},l=i=>{if(!a)return;a=!1;let c=i.clientX-t,d=i.clientY-r,g=e.orientation==="vertical"?d:c;Math.abs(g)<n||F(e,e.value+(g<0?1:-1))},s=()=>{a=!1};e.addEventListener("pointerdown",o),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",s),e._carouselDrag=()=>{e.removeEventListener("pointerdown",o),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",s)}}var tr="tc-accordion",rr=tr;f(tr,p({props:{mode:{type:"string",default:"single"},bordered:{type:"boolean",default:!0}},theme:{"tc-accordion-bg":"var(--tc-color-surface, #ffffff)","tc-accordion-ink":"var(--tc-color-ink, #14171f)","tc-accordion-ink-soft":"var(--tc-color-ink-soft, #4a5061)","tc-accordion-rule":"var(--tc-color-rule, #ece5d3)","tc-accordion-radius":"var(--tc-radius-md, 8px)","tc-accordion-accent":"var(--tc-color-accent, #a16939)","tc-accordion-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>`
    ...
    `,afterMount(){let e=this,t=o=>{let l=o.target;if(!(!l||l.tagName!=="DETAILS")){if(e.mode==="single"&&l.open)for(let s of we(e))s!==l&&s.open&&(s.open=!1);fa(e)}},r=o=>{let l=o.target;if(!l||l.tagName!=="SUMMARY")return;let s=we(e).map(d=>d.querySelector("summary")).filter(d=>!!d),i=s.indexOf(l);if(i===-1)return;let c=-1;o.key==="ArrowDown"?c=(i+1)%s.length:o.key==="ArrowUp"?c=(i-1+s.length)%s.length:o.key==="Home"?c=0:o.key==="End"&&(c=s.length-1),c!==-1&&(o.preventDefault(),s[c]?.focus())};e.addEventListener("toggle",t,!0),e.addEventListener("keydown",r);let a=()=>{for(let o of we(e)){let l=o.querySelector(":scope > summary");if(l&&!l.querySelector(".tc-accordion-caret")){let s=document.createElement("span");s.className="tc-accordion-caret",s.setAttribute("aria-hidden","true"),s.style.cssText="display:inline-block;flex:0 0 auto;transition:transform .2s ease;color:var(--tc-color-ink-muted,#6b7280);font-size:0.8rem;",s.textContent="\u25B8",l.appendChild(s);let i=()=>{s.style.transform=o.open?"rotate(90deg)":"rotate(0)"};i(),o.addEventListener("toggle",i)}}};a();let n=new MutationObserver(a);n.observe(e,{childList:!0,subtree:!1}),e._accordionCleanup=()=>{e.removeEventListener("toggle",t,!0),e.removeEventListener("keydown",r),n.disconnect()}},unmount(){this._accordionCleanup?.()}}));function we(e){let t=[];for(let r of Array.from(e.children))r instanceof HTMLDetailsElement&&t.push(r);return t}function fa(e){let t=[];for(let r of we(e))if(r.open){let a=r.id||r.querySelector("summary")?.textContent?.trim()||"";t.push(a)}e.dispatchEvent(new CustomEvent("tc-change",{detail:{open:t},bubbles:!0,composed:!0}))}var nr="tc-tooltip",or=nr;function ga(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(nr,p({props:{text:{type:"string",default:""},placement:{type:"string",default:"top"},delay:{type:"number",default:200},offset:{type:"number",default:8},disabled:{type:"boolean",default:!1}},theme:{"tc-tooltip-bg":"var(--tc-color-ink, #14171f)","tc-tooltip-fg":"var(--tc-color-surface, #ffffff)","tc-tooltip-radius":"var(--tc-radius-sm, 6px)","tc-tooltip-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-tooltip-shadow":"0 10px 30px rgba(0, 0, 0, 0.25)","tc-tooltip-padding":"6px 10px","tc-tooltip-max-width":"240px"},styles:{display:"inline-block",position:"relative"},template:({props:e})=>`
      ...
      <div
        ...
        part="tip"
      >
        ${e.text?`<span class="tip-text">${ga(e.text)}</span>`:""}
    ...
    `,afterMount(){let e=this,t=e.shadowRoot;if(!t)return;let r=t.querySelector(".tip");if(!r)return;let a=()=>{e.disabled||(clearTimeout(e._tooltipTimer),e._tooltipTimer=globalThis.setTimeout(()=>{if(typeof r.showPopover=="function")try{r.showPopover()}catch{r.style.visibility="visible",r.style.opacity="1"}else r.style.visibility="visible",r.style.opacity="1";ar(e,r)},Math.max(0,e.delay)))},n=()=>{clearTimeout(e._tooltipTimer);try{typeof r.hidePopover=="function"&&r.hidePopover()}catch{}r.style.opacity="",r.style.visibility=""},o=s=>{s.key==="Escape"&&n()};e.addEventListener("pointerenter",a),e.addEventListener("pointerleave",n),e.addEventListener("focusin",a),e.addEventListener("focusout",n),e.addEventListener("keydown",o);let l=()=>{r.matches(":popover-open")&&ar(e,r)};globalThis.addEventListener("scroll",l,!0),globalThis.addEventListener("resize",l),e._tooltipCleanup=()=>{clearTimeout(e._tooltipTimer),e.removeEventListener("pointerenter",a),e.removeEventListener("pointerleave",n),e.removeEventListener("focusin",a),e.removeEventListener("focusout",n),e.removeEventListener("keydown",o),globalThis.removeEventListener("scroll",l,!0),globalThis.removeEventListener("resize",l),n()}},unmount(){this._tooltipCleanup?.()}}));function ar(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,o=globalThis.innerHeight,l=e.offset,s=e.placement||"top",i=u=>u==="top"?r.top-a.height-l>=4:u==="bottom"?r.bottom+a.height+l<=o-4:u==="left"?r.left-a.width-l>=4:u==="right"?r.right+a.width+l<=n-4:!0;if(!i(s)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};i(u[s]??"top")&&(s=u[s])}let c=0,d=0;s==="top"?(c=r.top-a.height-l,d=r.left+r.width/2-a.width/2):s==="bottom"?(c=r.bottom+l,d=r.left+r.width/2-a.width/2):s==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-l):s==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+l),c=Math.max(4,Math.min(o-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`,t.dataset.placement=s}var ir="tc-popover",lr=ir;f(ir,p({props:{open:{type:"boolean",default:!1,reflect:!0},placement:{type:"string",default:"bottom"},offset:{type:"number",default:8},dismissible:{type:"boolean",default:!0}},theme:{"tc-popover-bg":"var(--tc-color-surface, #ffffff)","tc-popover-fg":"var(--tc-color-ink, #14171f)","tc-popover-rule":"var(--tc-color-rule, #ece5d3)","tc-popover-radius":"var(--tc-radius-md, 8px)","tc-popover-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.18))","tc-popover-padding":"12px 14px","tc-popover-min-width":"200px","tc-popover-max-width":"340px","tc-popover-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative"},template:()=>`
    ...
    `,events:{"click .trigger-wrap":(e,t)=>{let r=t.host;r.open=!r.open}},afterRender(){sr(this)},afterMount(){let e=this,t=n=>{!e.open||!e.dismissible||n.composedPath().includes(e)||(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"outside"},bubbles:!0,composed:!0})))},r=n=>{!e.open||!e.dismissible||n.key==="Escape"&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))},a=()=>{let n=e.shadowRoot?.querySelector(".panel");n?.matches(":popover-open")&&cr(e,n)};document.addEventListener("click",t,!0),document.addEventListener("keydown",r),globalThis.addEventListener("scroll",a,!0),globalThis.addEventListener("resize",a),e._popoverCleanup=()=>{document.removeEventListener("click",t,!0),document.removeEventListener("keydown",r),globalThis.removeEventListener("scroll",a,!0),globalThis.removeEventListener("resize",a)},sr(e)},unmount(){this._popoverCleanup?.()}}));function sr(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".panel");if(!r)return;let a=e.open,n=typeof r.showPopover=="function";if(a&&!r.matches(":popover-open")){if(n)try{r.showPopover()}catch{r.style.display="block"}else r.style.display="block";cr(e,r),e.dispatchEvent(new CustomEvent("tc-open",{bubbles:!0,composed:!0}))}else if(!a&&r.matches(":popover-open"))if(n)try{r.hidePopover()}catch{r.style.display="none"}else r.style.display="none"}function cr(e,t){let r=e.getBoundingClientRect();t.style.top="0px",t.style.left="0px";let a=t.getBoundingClientRect(),n=globalThis.innerWidth,o=globalThis.innerHeight,l=e.offset,s=e.placement||"bottom",i=u=>u==="top"?r.top-a.height-l>=4:u==="bottom"?r.bottom+a.height+l<=o-4:u==="left"?r.left-a.width-l>=4:u==="right"?r.right+a.width+l<=n-4:!0;if(!i(s)){let u={top:"bottom",bottom:"top",left:"right",right:"left"};i(u[s]??"bottom")&&(s=u[s])}let c=0,d=0;s==="top"?(c=r.top-a.height-l,d=r.left+r.width/2-a.width/2):s==="bottom"?(c=r.bottom+l,d=r.left+r.width/2-a.width/2):s==="left"?(c=r.top+r.height/2-a.height/2,d=r.left-a.width-l):s==="right"&&(c=r.top+r.height/2-a.height/2,d=r.right+l),c=Math.max(4,Math.min(o-a.height-4,c)),d=Math.max(4,Math.min(n-a.width-4,d)),t.style.top=`${c}px`,t.style.left=`${d}px`}var ur="tc-drawer",pr=ur,Z=new WeakMap;function Le(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(ur,p({props:{open:{type:"boolean",default:!1,reflect:!0},side:{type:"string",default:"right"},size:{type:"string",default:"min(420px, 92vw)"},dismissible:{type:"boolean",default:!0},title:{type:"string",default:""}},theme:{"tc-drawer-bg":"var(--tc-color-surface, #ffffff)","tc-drawer-ink":"var(--tc-color-ink, #14171f)","tc-drawer-rule":"var(--tc-color-rule, #ece5d3)","tc-drawer-soft":"var(--tc-color-ink-soft, #5a6072)","tc-drawer-shadow":"var(--tc-shadow-lg, 0 24px 60px rgba(20, 23, 31, 0.25))","tc-drawer-backdrop":"rgba(20, 23, 31, 0.5)","tc-drawer-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-drawer-duration":"260ms"},styles:{display:"contents"},template:({props:e})=>{let t=String(e.side??"right"),r=Le(e.size??"min(420px, 92vw)");return`
      ...
      `},refs:{dialog:".dlg"},events:{"click .x":(e,t)=>{dr(t.host,"button")},"click .dlg":(e,t)=>{let r=t.host;if(!r.dismissible)return;let a=t.refs.dialog;a&&e.target===a&&dr(r,"backdrop")}},afterRender(){ma(this)},unmount(){let e=Z.get(this);e&&(e.cleanup(),Z.delete(this))}}));function ma(e){let t=e.shadowRoot;if(!t)return;let r=t.querySelector(".dlg");if(!r)return;let a=e.open,n=Z.get(e);if(n&&n.dialog!==r&&(n.cleanup(),Z.delete(e)),a&&!r.open){if(typeof r.showModal=="function")try{r.showModal()}catch{r.setAttribute("open","")}else r.setAttribute("open","");if(!Z.has(e)){let o=()=>{let l=e;l.open&&(l.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:"escape"},bubbles:!0,composed:!0})))};r.addEventListener("close",o),Z.set(e,{dialog:r,cleanup:()=>r.removeEventListener("close",o)})}}else if(!a&&r.open)try{r.close()}catch{r.removeAttribute("open")}}function dr(e,t){e.open&&(e.open=!1,e.dispatchEvent(new CustomEvent("tc-close",{detail:{reason:t},bubbles:!0,composed:!0})))}var fr="tc-progress",gr=fr;function ee(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ba(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Math.max(0,Math.min(100,e/t*100))}f(fr,p({props:{value:{type:"number",default:0},max:{type:"number",default:100},variant:{type:"string",default:"linear"},size:{type:"string",default:"md"},indeterminate:{type:"boolean",default:!1},showLabel:{type:"boolean",default:!1},label:{type:"string",default:""}},theme:{"tc-progress-track":"var(--tc-color-rule, #ece5d3)","tc-progress-fill":"var(--tc-color-accent, #a16939)","tc-progress-radius":"999px","tc-progress-fg":"var(--tc-color-ink, #14171f)","tc-progress-font":"var(--tc-font-mono, 'JetBrains Mono', monospace)"},styles:{display:"inline-block"},template:({props:e})=>{let t=String(e.variant??"linear"),r=String(e.size??"md"),a=!!e.indeterminate,n=Number(e.value??0),o=Number(e.max??100),l=ba(n,o),s=e.label||(a?"Loading\u2026":`${Math.round(l)}%`);if(t==="circular"){let d=r==="sm"?28:r==="lg"?72:48,u=r==="sm"?3:r==="lg"?6:4,g=(d-u)/2,m=2*Math.PI*g,b=a?m*.25:l/100*m,v=a?`role="progressbar" aria-valuetext="${ee(s)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${o}"`;return`
          <div class="circ size-${ee(r)} ${a?"indet":""}" ${v}>
            ...
            ${e.showLabel?`<span class="label" aria-hidden="true">${ee(s)}</span>`:""}
          </div>
          <style>
        ...
        `}let i=r==="sm"?4:r==="lg"?12:8,c=a?`role="progressbar" aria-valuetext="${ee(s)}"`:`role="progressbar" aria-valuenow="${n}" aria-valuemin="0" aria-valuemax="${o}"`;return`
        <div class="bar size-${ee(r)} ${a?"indet":""}" ${c}>
          <div class="track">
            <div class="fill" style="width: ${l.toFixed(2)}%"></div>
          </div>
          ${e.showLabel?`<span class="label" aria-hidden="true">${ee(s)}</span>`:""}
        </div>
        <style>
      ...
      `},events:{"click .row":(e,t)=>{let r=t.host;if(!r.clickable)return;let a=e.target.closest(".step");if(!a)return;let n=Number(a.dataset.index);if(!Number.isFinite(n)||n===r.active)return;let o=r.active;r.active=n,t.emit("tc-step-change",{active:n,previous:o})}}}));var yr="tc-avatar",xr=yr;function O(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function vr(e){let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?"":t.length===1?t[0].slice(0,2).toUpperCase():(t[0][0]+t[t.length-1][0]).toUpperCase()}var He=[["#dde6f4","#1f3a66"],["#dbece2","#155b40"],["#efe2cf","#8a572d"],["#f4dad7","#7a1a14"],["#e3dcf1","#3d2a73"],["#d5e8e5","#0d4f49"],["#fbe3c5","#7a4f0a"]];function ha(e){if(!e)return He[0];let t=0;for(let a=0;a<e.length;a++)t=t*31+e.charCodeAt(a)|0;let r=Math.abs(t)%He.length;return He[r]}f(yr,p({props:{src:{type:"string",default:""},alt:{type:"string",default:""},name:{type:"string",default:""},size:{type:"string",default:"md"},shape:{type:"string",default:"circle"},status:{type:"string",default:""},ring:{type:"boolean",default:!1}},theme:{"tc-avatar-bg":"var(--tc-color-rule, #ece5d3)","tc-avatar-fg":"var(--tc-color-ink, #14171f)","tc-avatar-ring":"var(--tc-color-surface, #ffffff)","tc-avatar-status-online":"#2f7a52","tc-avatar-status-away":"#d7a52f","tc-avatar-status-busy":"#b3261e","tc-avatar-status-offline":"#9aa0a6","tc-avatar-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"inline-block",position:"relative","vertical-align":"middle"},template:({props:e})=>{let t=String(e.name??""),r=String(e.src??""),a=String(e.alt??"")||t||"avatar",n=String(e.size??"md"),o=String(e.shape??"circle"),l=String(e.status??""),s=!!e.ring,[i,c]=ha(t);return`
        <span class="root size-${O(n)} shape-${O(o)} ${s?"ringed":""}"
          ...
          ${l?`<span class="status status-${O(l)}" aria-label="${O(l)}"></span>`:""}
        </span>
        <style>
    ...
    `,afterMount(){let e=this,t=()=>wr(e);t();let r=new MutationObserver(t);r.observe(e,{childList:!0}),e._agroupCleanup=()=>r.disconnect()},afterRender(){wr(this)},unmount(){this._agroupCleanup?.()}}));function wr(e){let t=Math.max(0,Number(e.max??4)),r=String(e.size??"md"),a=Array.from(e.children).filter(i=>i instanceof HTMLElement),n=0;for(let i of a)i.tagName.toLowerCase()==="tc-avatar"&&(i.getAttribute("size")||i.setAttribute("size",r),n<t||t===0?(i.hidden=!1,n++):i.hidden=!0);let o=a.filter(i=>i.tagName.toLowerCase()==="tc-avatar").length,l=Math.max(0,o-n),s=e.shadowRoot?.querySelector(".overflow");s&&(l>0?(s.hidden=!1,s.textContent=`+${l}`):s.hidden=!0)}var Sr="tc-rating",Mr=Sr;function Er(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var Tr="M12 17.27 18.18 21 16.54 13.97 22 9.24 14.81 8.63 12 2 9.19 8.63 2 9.24 7.46 13.97 5.82 21z";f(Sr,p({props:{value:{type:"number",default:0,reflect:!0},max:{type:"number",default:5},readonly:{type:"boolean",default:!1,reflect:!0},allowHalf:{type:"boolean",default:!1},size:{type:"string",default:"md"},ariaLabel:{type:"string",default:"Rating"}},theme:{"tc-rating-fill":"var(--tc-color-warning, #d7a52f)","tc-rating-track":"var(--tc-color-rule, #ece5d3)"},styles:{display:"inline-block"},template:({props:e,state:t})=>{let r=Math.max(1,Number(e.max??5)),a=Number(e.value??0),n=Number(t.hover??-1),o=n>=0?n:a,l=String(e.size??"md"),s=!!e.readonly,i=!!e.allowHalf,c=Er(e.ariaLabel??"Rating"),d=l==="sm"?18:l==="lg"?32:24,u=[];for(let g=1;g<=r;g++){let m=o-(g-1),b=m>=1?100:m>=.5&&i?50:m>0&&!i?100:0,v=b===50;u.push(`
          <span class="star ${v?"half":b===100?"full":"empty"}" data-index="${g}">
            <svg viewBox="0 0 24 24" width="${d}" height="${d}" aria-hidden="true">
              <path class="track" d="${Tr}" fill="var(--tc-rating-track)" />
              ${b>0?`<path class="fill" d="${Tr}" fill="var(--tc-rating-fill)" clip-path="${v?"inset(0 50% 0 0)":"none"}" />`:""}
            </svg>
            ${i&&!s?`<span class="hit-left" data-index="${g}" data-half="1"></span>
                 <span class="hit-right" data-index="${g}" data-half="0"></span>`:""}
          </span>
        `)}return`
        <div
          class="root size-${Er(l)} ${s?"readonly":""}"
          role="${s?"img":"slider"}"
          tabindex="${s?"-1":"0"}"
          aria-label="${c}"
          aria-valuenow="${a}"
      ...
      `},events:{"click .star":(e,t)=>{let r=t.host;if(r.readonly)return;let a=e.target,n=a.closest(".hit-left, .hit-right"),o=a.closest(".star");if(!o)return;let l=Number(o.dataset.index);if(!Number.isFinite(l))return;let s=l;n?.dataset.half==="1"&&r.allowHalf&&(s=l-.5),s===r.value&&(s=0);let i=r.value;r.value=s,t.emit("tc-change",{value:s,previous:i})},"mouseover .star":(e,t)=>{let r=t.host;if(r.readonly)return;let a=e.target,n=a.closest(".hit-left, .hit-right"),o=a.closest(".star");if(!o)return;let l=Number(o.dataset.index);if(!Number.isFinite(l))return;let s=l;n?.dataset.half==="1"&&r.allowHalf&&(s=l-.5),t.setState("hover",s)},"mouseleave .root":(e,t)=>{t.setState("hover",-1)},"keydown .root":(e,t)=>{let r=e,a=t.host;if(a.readonly)return;let n=a.allowHalf?.5:1,o=a.value,l=o;if(r.key==="ArrowRight"||r.key==="ArrowUp")l=Math.min(a.max,o+n);else if(r.key==="ArrowLeft"||r.key==="ArrowDown")l=Math.max(0,o-n);else if(r.key==="Home")l=0;else if(r.key==="End")l=a.max;else return;r.preventDefault(),l!==o&&(a.value=l,t.emit("tc-change",{value:l,previous:o}))}}}));var Lr="tc-slider",Hr=Lr;function ke(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}f(Lr,p({props:{value:{type:"number",default:0,reflect:!0},min:{type:"number",default:0},max:{type:"number",default:100},step:{type:"number",default:1},disabled:{type:"boolean",default:!1,reflect:!0},showValue:{type:"boolean",default:!1},showTicks:{type:"boolean",default:!1},label:{type:"string",default:""},suffix:{type:"string",default:""}},theme:{"tc-slider-track":"var(--tc-color-rule, #ece5d3)","tc-slider-fill":"var(--tc-color-accent, #a16939)","tc-slider-thumb":"var(--tc-color-surface, #ffffff)","tc-slider-thumb-ring":"var(--tc-color-accent, #a16939)","tc-slider-radius":"999px","tc-slider-thumb-size":"20px","tc-slider-track-size":"6px","tc-slider-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)","tc-slider-fg":"var(--tc-color-ink, #14171f)","tc-slider-fg-muted":"var(--tc-color-ink-muted, #6b7280)"},styles:{display:"block"},template:({props:e})=>{let t=Number(e.value??0),r=Number(e.min??0),a=Number(e.max??100),n=Number(e.step??1),o=!!e.disabled,l=a>r?(t-r)/(a-r)*100:0,s=String(e.label??""),i=String(e.suffix??""),c=!!e.showValue,d=!!e.showTicks,u="";if(d&&n>0){let g=Math.floor((a-r)/n)+1;if(g<=50){let m=[];for(let b=0;b<g;b++){let S=(r+b*n-r)/(a-r)*100;m.push(`<span class="tick" style="left:${S.toFixed(2)}%"></span>`)}u=m.join("")}}return`
        ${s||c?`<div class="head">
              ${s?`<label for="r" class="lbl">${ke(s)}</label>`:"<span></span>"}
              ${c?`<span class="val">${ke(String(t))}${ke(i)}</span>`:""}
            </div>`:""}
        <div class="rail" style="--tc-slider-pct: ${l.toFixed(2)}%;">
      ...
      `},refs:{range:".range"},events:{"input .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);a.value!==n&&(a.value=n,t.emit("tc-input",{value:n}))},"change .range":(e,t)=>{let r=e.target,a=t.host,n=Number(r.value);t.emit("tc-change",{value:n,previous:a.value})}}}));var Ar="tc-chart",Nr=Ar;function zr(e,t){if(e<=0)return 1;let r=Math.floor(Math.log10(e)),a=e/Math.pow(10,r),n;return t?a<1.5?n=1:a<3?n=2:a<7?n=5:n=10:a<=1?n=1:a<=2?n=2:a<=5?n=5:n=10,n*Math.pow(10,r)}function va(e,t,r=5){if(e===t){let i=Math.abs(e)||1;return{min:e-i,max:t+i,ticks:[e-i,e,e+i]}}let a=zr(t-e,!1),n=zr(a/(r-1),!0),o=Math.floor(e/n)*n,l=Math.ceil(t/n)*n,s=[];for(let i=o;i<=l+n*.5;i+=n)s.push(Number(i.toFixed(10)));return{min:o,max:l,ticks:s}}function ze(e,t){if(e.length===0)return"";if(e.length===1||!t)return"M "+e.map(a=>`${a.x} ${a.y}`).join(" L ");let r=`M ${e[0].x} ${e[0].y}`;for(let a=0;a<e.length-1;a++){let n=e[a-1]??e[a],o=e[a],l=e[a+1],s=e[a+2]??l,i=o.x+(l.x-n.x)/6,c=o.y+(l.y-n.y)/6,d=l.x-(s.x-o.x)/6,u=l.y-(s.y-o.y)/6;r+=` C ${i},${c} ${d},${u} ${l.x},${l.y}`}return r}function ce(e,t,r,a){return{x:e+r*Math.sin(a),y:t-r*Math.cos(a)}}function ya(e,t,r,a,n,o){let l=o-n>Math.PI?1:0,s=ce(e,t,r,n),i=ce(e,t,r,o);if(a<=0)return`M ${e} ${t} L ${s.x} ${s.y} A ${r} ${r} 0 ${l} 1 ${i.x} ${i.y} Z`;let c=ce(e,t,a,o),d=ce(e,t,a,n);return`M ${s.x} ${s.y} A ${r} ${r} 0 ${l} 1 ${i.x} ${i.y} L ${c.x} ${c.y} A ${a} ${a} 0 ${l} 0 ${d.x} ${d.y} Z`}function T(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function B(e){if(!Number.isFinite(e))return"";let t=Math.abs(e);return t>=1e6?(e/1e6).toFixed(1).replace(/\.0$/,"")+"M":t>=1e3?(e/1e3).toFixed(1).replace(/\.0$/,"")+"K":t>0&&t<1?e.toFixed(2):String(Math.round(e*100)/100)}function de(e,t){return t[e%t.length]}function xa(e,t){let{data:r,smooth:a,stacked:n,showAxes:o,showGrid:l,showLabels:s,showValues:i}=e,c=r.labels??[],d=r.series??[],u=t==="sparkline",g=u?4:16,m=u?4:o&&s?28:8,b=u?4:o?44:8,v=u?4:12,S=e.W-b-v,$=e.H-g-m,w=1/0,L=-1/0;if(n&&d.length>0){let x=c.length>0?c.map((h,E)=>d.reduce((M,R)=>M+(R.values?.[E]??0),0)):[];for(let h of x)h<w&&(w=h),h>L&&(L=h);w>0&&(w=0)}else for(let x of d)for(let h of x.values??[])h<w&&(w=h),h>L&&(L=h);(!Number.isFinite(w)||!Number.isFinite(L))&&(w=0,L=1),w===L&&(w-=1,L+=1);let I=va(e.yMin??w,e.yMax??L,5),N=e.yMin??I.min,V=e.yMax??I.max,$e=V-N||1,y=c.length||d[0]?.values?.length||0,j=x=>y===1?b+S/2:t==="bar"?b+(x+.5)*(S/y):b+x/(y-1)*S,z=x=>g+$-(x-N)/$e*$,G=[];if(!u){if(l)for(let x of I.ticks){let h=z(x);G.push(`<line class="grid" x1="${b}" x2="${e.W-v}" y1="${h}" y2="${h}"/>`)}if(o){for(let h of I.ticks){let E=z(h);G.push(`<text class="axis-label y" x="${b-8}" y="${E}" text-anchor="end" dominant-baseline="middle">${T(B(h))}</text>`)}if(s&&c.length>0){let h=Math.max(1,Math.ceil(c.length/8));c.forEach((E,M)=>{M%h!==0&&M!==c.length-1||G.push(`<text class="axis-label x" x="${j(M)}" y="${e.H-m+16}" text-anchor="middle">${T(E)}</text>`)})}let x=N<=0&&V>=0?z(0):z(N);G.push(`<line class="axis" x1="${b}" x2="${e.W-v}" y1="${x}" y2="${x}"/>`)}}let q=[];if(t==="bar"){let x=S/y,h=x*.18,E=x-h*2;d.forEach((M,R)=>{let C=`series series-${R}`,D=de(R,e.palette),k=0;M.values?.forEach((A,_)=>{if(!Number.isFinite(A))return;let te=j(_),ue,pe,fe,Ee;if(n){ue=te-E/2,pe=E;let re=z(k+A),ae=z(k);fe=Math.min(re,ae),Ee=Math.abs(re-ae),k+=A}else{let re=E/d.length;ue=te-E/2+R*re,pe=re*.86;let ae=z(A),Ae=z(N<0&&V>0?0:N);fe=Math.min(ae,Ae),Ee=Math.abs(ae-Ae)}let Ce=`${T(M.name)}${c[_]?` \xB7 ${T(c[_])}`:""}: ${T(B(A))}`;q.push(`<g class="${C}"><rect class="hit" x="${ue}" y="${fe}" width="${pe}" height="${Ee}" rx="2" fill="${D}" data-tip="${Ce}" data-color="${D}"><title>${Ce}</title></rect>`+(i?`<text class="value-label" x="${ue+pe/2}" y="${fe-4}" text-anchor="middle">${T(B(A))}</text>`:"")+"</g>")})})}else if(n&&t==="area"){let x=new Array(y).fill(0);d.forEach((h,E)=>{let M=de(E,e.palette),R=[],C=[];for(let k=0;k<y;k++){let A=h.values?.[k]??0,_=x[k]+A;R.push({x:j(k),y:z(_)}),C.push({x:j(k),y:z(x[k])}),x[k]=_}let D=ze(R,a)+" L "+C.slice().reverse().map(k=>`${k.x} ${k.y}`).join(" L ")+" Z";q.push(`<path class="series-fill series-${E}" d="${D}" fill="${M}" fill-opacity="0.25" pointer-events="none"/>`),q.push(`<path class="series-line series-${E}" d="${ze(R,a)}" stroke="${M}" fill="none" pointer-events="none"/>`),R.forEach((k,A)=>{let _=h.values?.[A]??0,te=`${T(h.name)}${c[A]?` \xB7 ${T(c[A])}`:""}: ${T(B(_))}`;q.push(`<circle class="hit series-${E}" cx="${k.x}" cy="${k.y}" r="12" fill="transparent" data-tip="${te}" data-color="${M}"><title>${te}</title></circle>`)})})}else d.forEach((x,h)=>{let E=de(h,e.palette),M=(x.values??[]).map((C,D)=>({x:j(D),y:z(C)})),R=ze(M,a);if(t==="area"){let C=z(N<0&&V>0?0:N),D=R+` L ${M[M.length-1].x} ${C} L ${M[0].x} ${C} Z`;q.push(`<path class="series-fill series-${h}" d="${D}" fill="${E}" fill-opacity="0.25"/>`)}q.push(`<path class="series-line series-${h}" d="${R}" stroke="${E}" fill="none"/>`),u||M.forEach((C,D)=>{let k=x.values?.[D],A=`${T(x.name)}${c[D]?` \xB7 ${T(c[D])}`:""}: ${T(B(k??0))}`;q.push(`<circle class="series-point series-${h}" cx="${C.x}" cy="${C.y}" r="3.5" fill="${E}" pointer-events="none"/>`),q.push(`<circle class="hit series-${h}" cx="${C.x}" cy="${C.y}" r="12" fill="transparent" data-tip="${A}" data-color="${E}"><title>${A}</title></circle>`),i&&q.push(`<text class="value-label" x="${C.x}" y="${C.y-8}" text-anchor="middle" pointer-events="none">${T(B(k??0))}</text>`)})});return G.join("")+q.join("")}function wa(e){let t=e.data.series??[],r=t.reduce((c,d)=>c+(d.value??0),0);if(r<=0)return"";let a=e.W/2,n=e.H/2,o=Math.min(e.W,e.H)/2-4,l=Math.max(0,Math.min(.9,e.innerRadius))*o,s=0,i=[];return t.forEach((c,d)=>{let u=c.value??0;if(u<=0)return;let g=u/r*Math.PI*2,m=s,b=s+g,v=ya(a,n,o,l,m,b-.01),S=de(d,e.palette),$=(u/r*100).toFixed(1).replace(/\.0$/,""),w=`${T(c.name)}: ${T(B(u))} (${$}%)`;if(i.push(`<path class="series-segment hit series-${d}" d="${v}" fill="${S}" data-tip="${w}" data-color="${S}"><title>${w}</title></path>`),e.showValues){let L=(m+b)/2,I=(o+l)/2,N=ce(a,n,I,L);i.push(`<text class="value-label donut" x="${N.x}" y="${N.y}" text-anchor="middle" dominant-baseline="middle">${T($)}%</text>`)}s=b}),i.join("")}function ka(e,t){return e.length===0?"":'<div class="legend" part="legend">'+e.map((r,a)=>`<span class="legend-item"><span class="swatch" style="background:${de(a,t)}"></span>${T(r.name)}</span>`).join("")+"</div>"}function $a(e,t){if(e==="donut"){let n=(t.series??[]).reduce((l,s)=>l+(s.value??0),0);return`Donut chart: ${(t.series??[]).filter(l=>(l.value??0)>0).map(l=>{let s=n>0?(l.value??0)/n*100:0;return`${l.name} ${s.toFixed(1).replace(/\.0$/,"")}%`}).join(", ")}.`}let r=(t.series??[]).map(n=>n.name).join(", "),a=t.labels?.length??t.series[0]?.values?.length??0;return`${e.charAt(0).toUpperCase()}${e.slice(1)} chart with ${(t.series??[]).length} series (${r}) and ${a} data point${a===1?"":"s"}.`}var Ea=["var(--tc-chart-color-1, var(--tc-color-accent, #a16939))","var(--tc-chart-color-2, var(--tc-color-info, #3a5b8c))","var(--tc-chart-color-3, var(--tc-color-success, #2f7a52))","var(--tc-chart-color-4, var(--tc-color-warning, #d7a52f))","var(--tc-chart-color-5, var(--tc-color-danger, #b3261e))","var(--tc-chart-color-6, #6f4e7c)","var(--tc-chart-color-7, #0b6e6e)","var(--tc-chart-color-8, #b0566c)"],Ta=`
  <style>
...
`;f(Ar,p({props:{type:{type:"string",default:"line"},data:{type:"json",default:{series:[]}},height:{type:"string",default:"240px"},smooth:{type:"boolean",default:!0},stacked:{type:"boolean",default:!1},showLegend:{type:"boolean",default:!0},showAxes:{type:"boolean",default:!0},showGrid:{type:"boolean",default:!0},showLabels:{type:"boolean",default:!0},showValues:{type:"boolean",default:!1},innerRadius:{type:"number",default:.6},yMin:{type:"json",default:null},yMax:{type:"json",default:null},ariaLabel:{type:"string",default:"Chart"},colors:{type:"json",default:null}},theme:{"tc-chart-bg":"transparent","tc-chart-fg":"var(--tc-color-ink, #14171f)","tc-chart-axis":"var(--tc-color-rule-strong, #d9cfb8)","tc-chart-grid":"var(--tc-color-rule, #ece5d3)","tc-chart-label":"var(--tc-color-ink-muted, #6b7280)","tc-chart-font":"var(--tc-font-sans, 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif)"},styles:{display:"block"},template:({props:e})=>{let t=String(e.type??"line").toLowerCase(),r=["line","area","bar","sparkline","donut"].includes(t)?t:"line",a=e.data??{series:[]},n=r==="sparkline",o=r==="donut",l=e.colors,s=Array.isArray(l)&&l.length>0?l:Ea,i=o?320:800,c=o?320:400,d={data:a,smooth:!!e.smooth,stacked:!!e.stacked,showAxes:!!e.showAxes,showGrid:!!e.showGrid,showLabels:!!e.showLabels,showValues:!!e.showValues,innerRadius:Number(e.innerRadius??.6),yMin:e.yMin==null?null:Number(e.yMin),yMax:e.yMax==null?null:Number(e.yMax),palette:s,W:i,H:c},u=o?wa(d):xa(d,r),g=$a(r,a),m=T(String(e.height??"240px"));return`
        <div class="root" role="img" aria-label="${T(e.ariaLabel??"Chart")}">
          ...
          ${e.showLegend&&!n&&a.series&&a.series.length>0?ka(a.series,s):""}
          <span class="visually-hidden" style="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;">${T(g)}</span>
        </div>
        ${Ta}
      `},afterMount(){Cr(this)},afterRender(){Cr(this)},unmount(){this._chartHoverCleanup?.()}}));function Cr(e){let t=e;t._chartHoverCleanup?.();let r=t.shadowRoot;if(!r)return;let a=r.querySelector(".canvas"),n=r.querySelector(".tip"),o=n?.querySelector(".tip-text"),l=n?.querySelector(".tip-swatch");if(!a||!n||!o||!l)return;let s=()=>{n.removeAttribute("data-open"),n.style.transform="translate(-9999px, -9999px)"},i=d=>{let u=d.target?.closest?.("[data-tip]");if(!u){s();return}let g=u.getAttribute("data-tip")||"",m=u.getAttribute("data-color")||"currentColor";o.textContent=g,l.style.background=m;let b=a.getBoundingClientRect(),v=n.offsetWidth||100,S=n.offsetHeight||24,$=d.clientX-b.left,w=d.clientY-b.top,L=$+12,I=w-S-8;L+v>b.width-4&&(L=$-v-12),I<4&&(I=w+16),n.style.transform=`translate(${L}px, ${I}px)`,n.setAttribute("data-open","1")},c=()=>s();a.addEventListener("pointermove",i),a.addEventListener("pointerleave",c),t._chartHoverCleanup=()=>{a.removeEventListener("pointermove",i),a.removeEventListener("pointerleave",c),s()}}var Do={button:_e,input:Be,textarea:Ge,select:Ye,checkbox:We,switch:Qe,file:et,radioGroup:rt,slider:Hr,rating:Mr,table:ot,chart:Nr,tabs:it,modal:ut,drawer:pr,toast:gt,stat:ht,card:xt,badge:$t,skeleton:St,carousel:Zt,accordion:rr,tooltip:or,popover:lr,progress:gr,stepper:hr,avatar:xr,avatarGroup:$r,stack:Lt,cluster:zt,grid:Nt,code:Dt,callout:Ot,toc:Pt,pagination:Vt,combobox:Kt};export{Do as tags};
